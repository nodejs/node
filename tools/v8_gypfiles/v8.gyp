...
# found in the LICENSE file.
{
  'variables': {
    ...
    'torque_files': [
      ...
      "<(V8_ROOT)/src/builtins/builtins-bigint.tq",
      ...
      "<(V8_ROOT)/src/objects/js-break-iterator.tq",
      "<(V8_ROOT)/src/objects/js-collator.tq",
      "<(V8_ROOT)/src/objects/js-collection-iterator.tq",
      "<(V8_ROOT)/src/objects/js-collection.tq",
      "<(V8_ROOT)/src/objects/js-date-time-format.tq",
      "<(V8_ROOT)/src/objects/js-display-names.tq",
      "<(V8_ROOT)/src/objects/js-function.tq",
      "<(V8_ROOT)/src/objects/js-generator.tq",
      "<(V8_ROOT)/src/objects/js-list-format.tq",
      "<(V8_ROOT)/src/objects/js-locale.tq",
      "<(V8_ROOT)/src/objects/js-number-format.tq",
      "<(V8_ROOT)/src/objects/js-objects.tq",
      "<(V8_ROOT)/src/objects/js-plural-rules.tq",
      ...
      "<(V8_ROOT)/src/objects/js-relative-time-format.tq",
      "<(V8_ROOT)/src/objects/js-segment-iterator.tq",
      "<(V8_ROOT)/src/objects/js-segmenter.tq",
      "<(V8_ROOT)/src/objects/js-segments.tq",
      ...
      "<(V8_ROOT)/src/objects/templates.tq",
      "<(V8_ROOT)/src/objects/torque-defined-classes.tq",
    ...
    'torque_files_replaced': ['<!@pymod_do_main(ForEachReplace ".tq" "-tq" <@(torque_files))'],
