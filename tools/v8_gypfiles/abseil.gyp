  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        '<(ABSEIL_ROOT)/absl/extend/internal/aggregate.h',
        '<(ABSEIL_ROOT)/absl/extend/internal/dependencies.h',
        '<(ABSEIL_ROOT)/absl/extend/internal/is_tuple_hashtable.h',
        '<(ABSEIL_ROOT)/absl/extend/internal/num_bases.h',
        '<(ABSEIL_ROOT)/absl/extend/internal/num_initializers.h',
        '<(ABSEIL_ROOT)/absl/extend/internal/reflection.h',
        '<(ABSEIL_ROOT)/absl/extend/internal/reflection.cc',
        '<(ABSEIL_ROOT)/absl/extend/internal/tuple.h',
