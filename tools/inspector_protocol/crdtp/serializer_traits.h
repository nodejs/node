...
#ifndef V8_INSPECTOR_PROTOCOL_CRDTP_SERIALIZER_TRAITS_H_
#define V8_INSPECTOR_PROTOCOL_CRDTP_SERIALIZER_TRAITS_H_
...
#endif  // V8_INSPECTOR_PROTOCOL_CRDTP_SERIALIZER_TRAITS_H_
