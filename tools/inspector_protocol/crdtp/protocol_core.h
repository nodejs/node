...
#ifndef V8_INSPECTOR_PROTOCOL_CRDTP_PROTOCOL_CORE_H_
#define V8_INSPECTOR_PROTOCOL_CRDTP_PROTOCOL_CORE_H_
...
#define V8_INSPECTOR_PROTOCOL_CRDTP_DESERIALIZE_FILED_IMPL(name, field, is_optional)  \
  {                                                                \
...
// clang-format off
#define V8_INSPECTOR_PROTOCOL_CRDTP_BEGIN_DESERIALIZER(type)                                      \
...
#define V8_INSPECTOR_PROTOCOL_CRDTP_END_DESERIALIZER()                    \
    };                                              \
...
#define V8_INSPECTOR_PROTOCOL_CRDTP_DESERIALIZE_FIELD(name, field) \
  V8_CRDTP_DESERIALIZE_FILED_IMPL(name, field, false)
#define V8_INSPECTOR_PROTOCOL_CRDTP_DESERIALIZE_FIELD_OPT(name, field) \
  V8_CRDTP_DESERIALIZE_FILED_IMPL(name, field, true)

#define V8_INSPECTOR_PROTOCOL_CRDTP_BEGIN_SERIALIZER(type)                               \
...
#define V8_INSPECTOR_PROTOCOL_CRDTP_SERIALIZE_FIELD(name, field) \
    __serializer.AddField(MakeSpan(name), field)

#define V8_INSPECTOR_PROTOCOL_CRDTP_END_SERIALIZER() \
...
#endif  // V8_INSPECTOR_PROTOCOL_CRDTP_PROTOCOL_CORE_H_
