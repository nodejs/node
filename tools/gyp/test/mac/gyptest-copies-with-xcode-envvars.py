...
if sys.platform == 'darwin':
  ...
  out_path = test.built_file_path(contents_path + 'MacOS/file2', chdir='copies-with-xcode-envvars')
  test.must_contain(out_path, 'file2 contents\n')
  out_path = test.built_file_path(contents_path + 'Resources/file3', chdir='copies-with-xcode-envvars')
  test.must_contain(out_path, 'file3 contents\n')
  out_path = test.built_file_path(contents_path + 'Resources/testimages/file4', chdir='copies-with-xcode-envvars')
  test.must_contain(out_path, 'file4 contents\n')
  out_path = test.built_file_path(contents_path + 'Resources/Java/file5', chdir='copies-with-xcode-envvars')
