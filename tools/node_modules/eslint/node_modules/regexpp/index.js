...
var Reader = (function () {
    ...
    Object.defineProperty(Reader.prototype, "source", {
        get: function () {
            return this._s;
        },
        enumerable: true,
    ...
    Object.defineProperty(Reader.prototype, "index", {
        get: function () {
            return this._i;
        },
        enumerable: true,
    ...
    Object.defineProperty(Reader.prototype, "currentCodePoint", {
        get: function () {
            return this._cp1;
        },
        enumerable: true,
    ...
    Object.defineProperty(Reader.prototype, "nextCodePoint", {
        get: function () {
            return this._cp2;
        },
        enumerable: true,
    ...
    Object.defineProperty(Reader.prototype, "nextCodePoint2", {
        get: function () {
            return this._cp3;
        },
        enumerable: true,
    ...
    Object.defineProperty(Reader.prototype, "nextCodePoint3", {
        get: function () {
            return this._cp4;
        },
        enumerable: true,
    ...
    Reader.prototype.reset = function (source, start, end, uFlag) {
        this._impl = uFlag ? unicodeImpl : legacyImpl;
        this._s = source;
        this._end = end;
        this.rewind(start);
    };
    Reader.prototype.rewind = function (index) {
        var impl = this._impl;
        this._i = index;
    ...
    Reader.prototype.eat = function (cp) {
        if (this._cp1 === cp) {
            this.advance();
            return true;
        }
    ...
    Reader.prototype.eat2 = function (cp1, cp2) {
    ...
    Reader.prototype.eat3 = function (cp1, cp2, cp3) {
...
var RegExpSyntaxError = (function (_super) {
    __extends(RegExpSyntaxError, _super);
    function RegExpSyntaxError(source, uFlag, index, message) {
        ...
        _this = _super.call(this, "Invalid regular expression" + source + ": " + message) || this;
        _this.index = index;
        return _this;
    }
...
var RegExpValidator = (function () {
    ...
    RegExpValidator.prototype.validateLiteral = function (source, start, end) {
    ...
    RegExpValidator.prototype.validateFlags = function (source, start, end) {
        if (start === void 0) { start = 0; }
        if (end === void 0) { end = source.length; }
    ...
    RegExpValidator.prototype.validatePattern = function (source, start, end, uFlag) {
        if (start === void 0) { start = 0; }
        if (end === void 0) { end = source.length; }
        if (uFlag === void 0) { uFlag = false; }
    ...
    Object.defineProperty(RegExpValidator.prototype, "strict", {
        get: function () {
    ...
    Object.defineProperty(RegExpValidator.prototype, "ecmaVersion", {
        get: function () {
    ...
    RegExpValidator.prototype.onLiteralEnter = function (start) {
        if (this._options.onLiteralEnter) {
            this._options.onLiteralEnter(start);
        }
    };
    RegExpValidator.prototype.onLiteralLeave = function (start, end) {
        if (this._options.onLiteralLeave) {
            this._options.onLiteralLeave(start, end);
        }
    };
    RegExpValidator.prototype.onFlags = function (start, end, global, ignoreCase, multiline, unicode, sticky, dotAll) {
        if (this._options.onFlags) {
            this._options.onFlags(start, end, global, ignoreCase, multiline, unicode, sticky, dotAll);
        }
    };
    RegExpValidator.prototype.onPatternEnter = function (start) {
        if (this._options.onPatternEnter) {
            this._options.onPatternEnter(start);
        }
    };
    RegExpValidator.prototype.onPatternLeave = function (start, end) {
        if (this._options.onPatternLeave) {
            this._options.onPatternLeave(start, end);
        }
    };
    RegExpValidator.prototype.onDisjunctionEnter = function (start) {
        if (this._options.onDisjunctionEnter) {
            this._options.onDisjunctionEnter(start);
        }
    };
    RegExpValidator.prototype.onDisjunctionLeave = function (start, end) {
        if (this._options.onDisjunctionLeave) {
            this._options.onDisjunctionLeave(start, end);
        }
    };
    RegExpValidator.prototype.onAlternativeEnter = function (start, index) {
        if (this._options.onAlternativeEnter) {
            this._options.onAlternativeEnter(start, index);
        }
    };
    RegExpValidator.prototype.onAlternativeLeave = function (start, end, index) {
        if (this._options.onAlternativeLeave) {
            this._options.onAlternativeLeave(start, end, index);
        }
    };
    RegExpValidator.prototype.onGroupEnter = function (start) {
        if (this._options.onGroupEnter) {
            this._options.onGroupEnter(start);
        }
    };
    RegExpValidator.prototype.onGroupLeave = function (start, end) {
        if (this._options.onGroupLeave) {
            this._options.onGroupLeave(start, end);
        }
    };
    RegExpValidator.prototype.onCapturingGroupEnter = function (start, name) {
        if (this._options.onCapturingGroupEnter) {
            this._options.onCapturingGroupEnter(start, name);
        }
    };
    RegExpValidator.prototype.onCapturingGroupLeave = function (start, end, name) {
        if (this._options.onCapturingGroupLeave) {
            this._options.onCapturingGroupLeave(start, end, name);
        }
    };
    RegExpValidator.prototype.onQuantifier = function (start, end, min, max, greedy) {
    ...
    RegExpValidator.prototype.onEdgeAssertion = function (start, end, kind) {
        if (this._options.onEdgeAssertion) {
            this._options.onEdgeAssertion(start, end, kind);
        }
    };
    RegExpValidator.prototype.onWordBoundaryAssertion = function (start, end, kind, negate) {
        if (this._options.onWordBoundaryAssertion) {
            this._options.onWordBoundaryAssertion(start, end, kind, negate);
        }
    };
    RegExpValidator.prototype.onAnyCharacterSet = function (start, end, kind) {
        if (this._options.onAnyCharacterSet) {
            this._options.onAnyCharacterSet(start, end, kind);
        }
    };
    RegExpValidator.prototype.onEscapeCharacterSet = function (start, end, kind, negate) {
        if (this._options.onEscapeCharacterSet) {
            this._options.onEscapeCharacterSet(start, end, kind, negate);
        }
    };
    RegExpValidator.prototype.onUnicodePropertyCharacterSet = function (start, end, kind, key, value, negate) {
        if (this._options.onUnicodePropertyCharacterSet) {
            this._options.onUnicodePropertyCharacterSet(start, end, kind, key, value, negate);
        }
    };
    RegExpValidator.prototype.onCharacter = function (start, end, value) {
        if (this._options.onCharacter) {
            this._options.onCharacter(start, end, value);
        }
    };
    RegExpValidator.prototype.onBackreference = function (start, end, ref) {
        if (this._options.onBackreference) {
            this._options.onBackreference(start, end, ref);
        }
    };
    RegExpValidator.prototype.onCharacterClassEnter = function (start, negate) {
        if (this._options.onCharacterClassEnter) {
            this._options.onCharacterClassEnter(start, negate);
        }
    };
    RegExpValidator.prototype.onCharacterClassLeave = function (start, end, negate) {
        if (this._options.onCharacterClassLeave) {
            this._options.onCharacterClassLeave(start, end, negate);
        }
    };
    RegExpValidator.prototype.onCharacterClassRange = function (start, end, min, max) {
        if (this._options.onCharacterClassRange) {
            this._options.onCharacterClassRange(start, end, min, max);
        }
    };
    Object.defineProperty(RegExpValidator.prototype, "source", {
        get: function () {
    ...
    Object.defineProperty(RegExpValidator.prototype, "index", {
        get: function () {
    ...
    Object.defineProperty(RegExpValidator.prototype, "currentCodePoint", {
        get: function () {
    ...
    Object.defineProperty(RegExpValidator.prototype, "nextCodePoint", {
        get: function () {
    ...
    Object.defineProperty(RegExpValidator.prototype, "nextCodePoint2", {
        get: function () {
    ...
    Object.defineProperty(RegExpValidator.prototype, "nextCodePoint3", {
        get: function () {
    ...
    RegExpValidator.prototype.reset = function (source, start, end) {
        this._reader.reset(source, start, end, this._uFlag);
    };
    RegExpValidator.prototype.rewind = function (index) {
        this._reader.rewind(index);
    };
    RegExpValidator.prototype.advance = function () {
        this._reader.advance();
    };
    RegExpValidator.prototype.eat = function (cp) {
        return this._reader.eat(cp);
    };
    RegExpValidator.prototype.eat2 = function (cp1, cp2) {
        return this._reader.eat2(cp1, cp2);
    };
    RegExpValidator.prototype.eat3 = function (cp1, cp2, cp3) {
        return this._reader.eat3(cp1, cp2, cp3);
    };
    RegExpValidator.prototype.raise = function (message) {
        throw new RegExpSyntaxError(this.source, this._uFlag, this.index, message);
    };
    RegExpValidator.prototype.eatRegExpBody = function () {
    ...
    RegExpValidator.prototype.pattern = function () {
        var _this = this;
        var start = this.index;
        ...
        this._backreferenceNames.forEach(function (name) {
            if (!_this._groupNames.has(name)) {
                _this.raise("Invalid named capture referenced");
            }
        });
        this.onPatternLeave(start, this.index);
    };
    RegExpValidator.prototype.countCapturingParens = function () {
        var start = this.index;
        var inClass = false;
        var escaped = false;
        var count = 0;
    ...
    RegExpValidator.prototype.disjunction = function () {
        var start = this.index;
        var i = 0;
    ...
    RegExpValidator.prototype.alternative = function (i) {
        var start = this.index;
    ...
    RegExpValidator.prototype.eatTerm = function () {
    ...
    RegExpValidator.prototype.eatAssertion = function () {
        var start = this.index;
        this._lastAssertionIsQuantifiable = false;
    ...
    RegExpValidator.prototype.eatQuantifier = function (noError) {
    ...
    RegExpValidator.prototype.eatBracedQuantifier = function (noError) {
        var start = this.index;
        if (this.eat(LeftCurlyBracket)) {
            this._lastMinValue = 0;
    ...
    RegExpValidator.prototype.eatAtom = function () {
    ...
    RegExpValidator.prototype.eatDot = function () {
    ...
    RegExpValidator.prototype.eatReverseSolidusAtomEscape = function () {
        var start = this.index;
    ...
    RegExpValidator.prototype.eatUncapturingGroup = function () {
        var start = this.index;
    ...
    RegExpValidator.prototype.eatCapturingGroup = function () {
        var start = this.index;
    ...
    RegExpValidator.prototype.eatExtendedAtom = function () {
        return (this.eatDot() ||
            this.eatReverseSolidusAtomEscape() ||
            this.eatCharacterClass() ||
            this.eatUncapturingGroup() ||
    ...
    RegExpValidator.prototype.eatInvalidBracedQuantifier = function () {
        if (this.eatBracedQuantifier(true)) {
            this.raise("Nothing to repeat");
        }
        return false;
    };
    RegExpValidator.prototype.eatSyntaxCharacter = function () {
    ...
    RegExpValidator.prototype.eatPatternCharacter = function () {
        var start = this.index;
        var cp = this.currentCodePoint;
    ...
    RegExpValidator.prototype.eatExtendedPatternCharacter = function () {
        var start = this.index;
        var cp = this.currentCodePoint;
        if (cp !== -1 &&
            cp !== CircumflexAccent &&
    ...
    RegExpValidator.prototype.groupSpecifier = function () {
        this._lastStrValue = "";
    ...
    RegExpValidator.prototype.eatGroupName = function () {
        this._lastStrValue = "";
    ...
    RegExpValidator.prototype.eatRegExpIdentifierName = function () {
        this._lastStrValue = "";
    ...
    RegExpValidator.prototype.eatRegExpIdentifierStart = function () {
        var start = this.index;
        var cp = this.currentCodePoint;
        this.advance();
    ...
    RegExpValidator.prototype.eatRegExpIdentifierPart = function () {
        var start = this.index;
        var cp = this.currentCodePoint;
        this.advance();
        if (cp === ReverseSolidus && this.eatRegExpUnicodeEscapeSequence()) {
    ...
    RegExpValidator.prototype.eatAtomEscape = function () {
    ...
    RegExpValidator.prototype.eatBackreference = function () {
        var start = this.index;
    ...
    RegExpValidator.prototype.eatKGroupName = function () {
        var start = this.index;
    ...
    RegExpValidator.prototype.eatCharacterEscape = function () {
        var start = this.index;
    ...
    RegExpValidator.prototype.eatCControlLetter = function () {
        var start = this.index;
    ...
    RegExpValidator.prototype.eatZero = function () {
    ...
    RegExpValidator.prototype.eatControlEscape = function () {
    ...
    RegExpValidator.prototype.eatControlLetter = function () {
        var cp = this.currentCodePoint;
        if (isLatinLetter(cp)) {
            this.advance();
    ...
    RegExpValidator.prototype.eatRegExpUnicodeEscapeSequence = function () {
        var start = this.index;
    ...
    RegExpValidator.prototype.eatIdentityEscape = function () {
        if (this._uFlag) {
    ...
    RegExpValidator.prototype.isValidIdentityEscape = function (cp) {
        if (cp === -1) {
            return false;
        }
        if (this.strict) {
    ...
    RegExpValidator.prototype.eatDecimalEscape = function () {
        this._lastIntValue = 0;
        var cp = this.currentCodePoint;
    ...
    RegExpValidator.prototype.eatCharacterClassEscape = function () {
        var start = this.index;
    ...
    RegExpValidator.prototype.eatUnicodePropertyValueExpression = function () {
        var start = this.index;
    ...
    RegExpValidator.prototype.eatUnicodePropertyName = function () {
        this._lastStrValue = "";
    ...
    RegExpValidator.prototype.eatUnicodePropertyValue = function () {
        this._lastStrValue = "";
    ...
    RegExpValidator.prototype.eatLoneUnicodePropertyNameOrValue = function () {
        return this.eatUnicodePropertyValue();
    };
    RegExpValidator.prototype.eatCharacterClass = function () {
        var start = this.index;
    ...
    RegExpValidator.prototype.classRanges = function () {
        var start = this.index;
    ...
    RegExpValidator.prototype.eatClassAtom = function () {
        var start = this.index;
        if (this.eat(ReverseSolidus)) {
    ...
    RegExpValidator.prototype.eatClassEscape = function () {
        var start = this.index;
    ...
    RegExpValidator.prototype.eatClassControlLetter = function () {
        var cp = this.currentCodePoint;
    ...
    RegExpValidator.prototype.eatHexEscapeSequence = function () {
        var start = this.index;
    ...
    RegExpValidator.prototype.eatDecimalDigits = function () {
        var start = this.index;
        this._lastIntValue = 0;
    ...
    RegExpValidator.prototype.eatHexDigits = function () {
        var start = this.index;
        this._lastIntValue = 0;
    ...
    RegExpValidator.prototype.eatLegacyOctalEscapeSequence = function () {
    ...
    RegExpValidator.prototype.eatOctalDigit = function () {
        var cp = this.currentCodePoint;
        if (isOctalDigit(cp)) {
            this.advance();
    ...
    RegExpValidator.prototype.eatFixedHexDigits = function (length) {
        var start = this.index;
        this._lastIntValue = 0;
...
var RegExpParserState = (function () {
    ...
    Object.defineProperty(RegExpParserState.prototype, "pattern", {
        get: function () {
    ...
    Object.defineProperty(RegExpParserState.prototype, "flags", {
        get: function () {
    ...
    RegExpParserState.prototype.onFlags = function (start, end, global, ignoreCase, multiline, unicode, sticky, dotAll) {
        this._flags = {
            type: "Flags",
            parent: null,
            start: start,
    ...
    RegExpParserState.prototype.onPatternEnter = function (start) {
        this._node = {
            type: "Pattern",
            parent: null,
            start: start,
    ...
    RegExpParserState.prototype.onPatternLeave = function (start, end) {
        this._node.end = end;
        this._node.raw = this.source.slice(start, end);
        var _loop_1 = function (reference) {
            var ref = reference.ref;
            var group = typeof ref === "number"
                ? this_1._capturingGroups[ref - 1]
                : this_1._capturingGroups.find(function (g) { return g.name === ref; });
            reference.resolved = group;
            group.references.push(reference);
        };
        var this_1 = this;
        for (var _i = 0, _a = this._backreferences; _i < _a.length; _i++) {
            var reference = _a[_i];
            _loop_1(reference);
        }
    };
    RegExpParserState.prototype.onDisjunctionEnter = function (start) {
        this._disjunctionStartStack.push(start);
    };
    RegExpParserState.prototype.onDisjunctionLeave = function (start, end) {
        this._disjunctionStartStack.pop();
    };
    RegExpParserState.prototype.onAlternativeEnter = function (start, index) {
        if (index === 0) {
            return;
        }
    ...
    RegExpParserState.prototype.onAlternativeLeave = function (start, end, index) {
        if (index === 0) {
            return;
        }
        this._node.end = end;
    ...
    RegExpParserState.prototype.onGroupEnter = function (start) {
        var parentNode = this._node;
    ...
    RegExpParserState.prototype.onGroupLeave = function (start, end) {
        this._node.end = end;
        this._node.raw = this.source.slice(start, end);
        this._node = this._node.parent;
    };
    RegExpParserState.prototype.onCapturingGroupEnter = function (start, name) {
        var parentNode = this._node;
        if (parentNode.type === "CharacterClass") {
            throw new Error("UnknownError");
        }
    ...
    RegExpParserState.prototype.onCapturingGroupLeave = function (start, end, name) {
        this._node.end = end;
        this._node.raw = this.source.slice(start, end);
        this._node = this._node.parent;
    };
    RegExpParserState.prototype.onQuantifier = function (start, end, min, max, greedy) {
        var parentNode = this._node;
        if (parentNode.type === "CharacterClass") {
            throw new Error("UnknownError");
        }
        var elements = parentNode.type === "Disjunction"
    ...
    RegExpParserState.prototype.onLookaroundAssertionEnter = function (start, kind, negate) {
        var parentNode = this._node;
        if (parentNode.type === "CharacterClass") {
            throw new Error("UnknownError");
        }
    ...
    RegExpParserState.prototype.onLookaroundAssertionLeave = function (start, end, kind, negate) {
        this._node.end = end;
        this._node.raw = this.source.slice(start, end);
        this._node = this._node.parent;
    };
    RegExpParserState.prototype.onEdgeAssertion = function (start, end, kind) {
        var parentNode = this._node;
        if (parentNode.type === "CharacterClass") {
            throw new Error("UnknownError");
        }
    ...
    RegExpParserState.prototype.onWordBoundaryAssertion = function (start, end, kind, negate) {
        var parentNode = this._node;
        if (parentNode.type === "CharacterClass") {
            throw new Error("UnknownError");
        }
    ...
    RegExpParserState.prototype.onAnyCharacterSet = function (start, end, kind) {
        var parentNode = this._node;
        if (parentNode.type === "CharacterClass") {
            throw new Error("UnknownError");
        }
    ...
    RegExpParserState.prototype.onEscapeCharacterSet = function (start, end, kind, negate) {
    ...
    RegExpParserState.prototype.onUnicodePropertyCharacterSet = function (start, end, kind, key, value, negate) {
        addCommonElement(this._node, {
            type: "CharacterSet",
            parent: this._node,
            start: start,
    ...
    RegExpParserState.prototype.onCharacter = function (start, end, value) {
        addCommonElement(this._node, {
            type: "Character",
            parent: this._node,
            start: start,
    ...
    RegExpParserState.prototype.onBackreference = function (start, end, ref) {
        var parentNode = this._node;
        if (parentNode.type === "CharacterClass") {
            throw new Error("UnknownError");
        }
    ...
    RegExpParserState.prototype.onCharacterClassEnter = function (start, negate) {
        var parentNode = this._node;
        if (parentNode.type === "CharacterClass") {
            throw new Error("UnknownError");
        }
    ...
    RegExpParserState.prototype.onCharacterClassLeave = function (start, end, negate) {
        this._node.end = end;
        this._node.raw = this.source.slice(start, end);
        this._node = this._node.parent;
    };
    RegExpParserState.prototype.onCharacterClassRange = function (start, end, min, max) {
        var parentNode = this._node;
        if (parentNode.type !== "CharacterClass") {
            throw new Error("UnknownError");
        }
...
var RegExpParser = (function () {
    ...
    RegExpParser.prototype.parseLiteral = function (source, start, end) {
        if (start === void 0) { start = 0; }
        if (end === void 0) { end = source.length; }
    ...
    RegExpParser.prototype.parseFlags = function (source, start, end) {
        if (start === void 0) { start = 0; }
        if (end === void 0) { end = source.length; }
        this._state.source = source;
    ...
    RegExpParser.prototype.parsePattern = function (source, start, end, uFlag) {
        if (start === void 0) { start = 0; }
        if (end === void 0) { end = source.length; }
        if (uFlag === void 0) { uFlag = false; }
        this._state.source = source;
