...
const extractSentences = (text, abbreviationsRegex) => {
  ...
  const sentenceEndGrouping = /([.?!])(?:\s+|$)/u; // eslint-disable-next-line unicorn/no-array-method-this-argument

  const puncts = new _mainUmd.RegExtras(sentenceEndGrouping).map(txt, punct => {
    return punct;
  });
