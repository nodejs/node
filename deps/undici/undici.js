...
var require_client = __commonJS({
  "lib/client.js"(exports2, module2) {
    ...
    var llhttpWasmData = require_llhttp_wasm();
    var llhttpSimdWasmData = require_llhttp_simd_wasm();
    var {
      kUrl,
      kReset,
      kServerName,
    ...
    var Client2 = class extends Dispatcher2 {
      constructor(url, {
        maxHeaderSize,
        headersTimeout,
        socketTimeout,
...
var require_pool_base = __commonJS({
  "lib/pool-base.js"(exports2, module2) {
    ...
    var { kSize, kRunning, kPending, kBusy, kUrl } = require_symbols();
    ...
    var PoolBase = class extends Dispatcher2 {
      constructor() {
        super();
  ...
  "lib/balanced-pool.js"(exports2, module2) {
    ...
    var BalancedPool2 = class extends PoolBase {
      ...
      addUpstream(upstream) {
        ...
        this[kAddClient](new Pool2(upstream, Object.assign({}, this[kOptions])));
        return this;
      }
...
var require_agent = __commonJS({
  "lib/agent.js"(exports2, module2) {
    ...
    var { kClients, kRunning } = require_symbols();
    var Dispatcher2 = require_dispatcher();
    var Pool2 = require_pool();
    var Client2 = require_client();
    var util2 = require_util();
    ...
    var Agent2 = class extends Dispatcher2 {
      ...
      close(callback) {
        if (callback != null && typeof callback !== "function") {
          throw new InvalidArgumentError2("callback must be a function");
        }
        this[kClosed] = true;
        const closePromises = [];
        for (const ref of this[kClients].values()) {
  ...
  "lib/api/api-request.js"(exports2, module2) {
    ...
    var RequestHandler = class extends AsyncResource {
      ...
      onHeaders(statusCode, headers, resume) {
        ...
        if (statusCode < 200) {
          if (this.onInfo) {
            this.onInfo({ statusCode, headers: util2.parseHeaders(headers) });
          }
          return;
        }
        const parsedHeaders = util2.parseHeaders(headers);
...
var require_proxy_agent = __commonJS({
  "lib/proxy-agent.js"(exports2, module2) {
    ...
    var ProxyAgent2 = class extends Dispatcher2 {
      constructor(opts) {
        super(opts);
