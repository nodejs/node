...
static int parse_env(struct OPENSSL_s390xcap_st *cap)
{
    ...
    while (tok_begin != NULL) {
        ...
        /* query function tokens */
                ...
                /* CPU model tokens */
                else if TOK_CPU (z900) else if TOK_CPU (z990) else if TOK_CPU (z9) else if TOK_CPU (z10) else if TOK_CPU (z196) else if TOK_CPU (zEC12) else if TOK_CPU (z13) else if TOK_CPU (z14) else if TOK_CPU (z15)
