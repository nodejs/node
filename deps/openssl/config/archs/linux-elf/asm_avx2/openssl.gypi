{
  'variables': {
    ...
    'openssl_sources_linux-elf': [
      ...
      './config/archs/linux-elf/asm_avx2/crypto/camellia/cmll-x86.S',
      './config/archs/linux-elf/asm_avx2/crypto/chacha/chacha-x86.S',
      './config/archs/linux-elf/asm_avx2/crypto/des/crypt586.S',
      './config/archs/linux-elf/asm_avx2/crypto/des/des-586.S',
      './config/archs/linux-elf/asm_avx2/crypto/ec/ecp_nistz256-x86.S',
      './config/archs/linux-elf/asm_avx2/crypto/params_idx.c',
      './config/archs/linux-elf/asm_avx2/crypto/x86cpuid.S',
      './config/archs/linux-elf/asm_avx2/crypto/md5/md5-586.S',
      './config/archs/linux-elf/asm_avx2/crypto/modes/ghash-x86.S',
      './config/archs/linux-elf/asm_avx2/crypto/poly1305/poly1305-x86.S',
      './config/archs/linux-elf/asm_avx2/crypto/rc4/rc4-586.S',
      './config/archs/linux-elf/asm_avx2/crypto/ripemd/rmd-586.S',
      './config/archs/linux-elf/asm_avx2/crypto/sha/sha1-586.S',
      './config/archs/linux-elf/asm_avx2/crypto/sha/sha256-586.S',
      './config/archs/linux-elf/asm_avx2/crypto/sha/sha512-586.S',
      './config/archs/linux-elf/asm_avx2/crypto/whrlpool/wp-mmx.S',
      './config/archs/linux-elf/asm_avx2/engines/e_padlock-x86.S',
      './config/archs/linux-elf/asm_avx2/providers/common/der/der_sm2_gen.c',
      './config/archs/linux-elf/asm_avx2/providers/common/der/der_digests_gen.c',
      './config/archs/linux-elf/asm_avx2/providers/common/der/der_dsa_gen.c',
      './config/archs/linux-elf/asm_avx2/providers/common/der/der_ec_gen.c',
      './config/archs/linux-elf/asm_avx2/providers/common/der/der_ecx_gen.c',
      './config/archs/linux-elf/asm_avx2/providers/common/der/der_ml_dsa_gen.c',
      './config/archs/linux-elf/asm_avx2/providers/common/der/der_rsa_gen.c',
      './config/archs/linux-elf/asm_avx2/providers/common/der/der_slh_dsa_gen.c',
    ...
    'openssl_defines_exported_linux-elf': [
      'NDEBUG',
      'OPENSSL_USE_NODELETE',
      'L_ENDIAN',
      'OPENSSL_BUILDING_OPENSSL',
  ...
  'direct_dependent_settings': {
    ...
    'defines': ['<@(openssl_defines_exported_linux-elf)'],
  },
}
