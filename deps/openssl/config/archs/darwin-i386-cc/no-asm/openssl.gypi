{
  'variables': {
    ...
    'openssl_sources_darwin-i386-cc': [
      './config/archs/darwin-i386-cc/no-asm/crypto/params_idx.c',
      ...
      './config/archs/darwin-i386-cc/no-asm/providers/common/der/der_ml_dsa_gen.c',
      './config/archs/darwin-i386-cc/no-asm/providers/common/der/der_rsa_gen.c',
      './config/archs/darwin-i386-cc/no-asm/providers/common/der/der_slh_dsa_gen.c',
    ...
    'openssl_defines_exported_darwin-i386-cc': [
      'NDEBUG',
      'L_ENDIAN',
      'OPENSSL_BUILDING_OPENSSL',
      'OPENSSL_PIC',
  ...
  'direct_dependent_settings': {
    ...
    'defines': ['<@(openssl_defines_exported_darwin-i386-cc)'],
  },
}
