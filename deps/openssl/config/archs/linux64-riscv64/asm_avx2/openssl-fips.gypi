{
  'variables': {
    'openssl_sources': [
      ...
      'openssl/crypto/bn/bn_rsa_fips186_5.c',
      ...
      'openssl/crypto/evp/evp_pkey_type.c',
      ...
      'openssl/crypto/aligned_alloc.c',
      'openssl/crypto/array_alloc.c',
      ...
      'openssl/providers/implementations/ciphers/cipher_aes_cbc_hmac_sha1_etm_hw.c',
      'openssl/providers/implementations/ciphers/cipher_aes_cbc_hmac_sha1_hw.c',
      'openssl/providers/implementations/ciphers/cipher_aes_cbc_hmac_sha256_etm_hw.c',
      'openssl/providers/implementations/ciphers/cipher_aes_cbc_hmac_sha256_hw.c',
      'openssl/providers/implementations/ciphers/cipher_aes_cbc_hmac_sha512_etm_hw.c',
      'openssl/providers/implementations/ciphers/cipher_aes_cbc_hmac_sha_etm.c',
      'openssl/providers/implementations/ciphers/cipher_aes_ccm.c',
      'openssl/providers/implementations/ciphers/cipher_aes_ccm_hw.c',
      'openssl/providers/implementations/ciphers/cipher_aes_cfb_hw.c',
    ...
    'openssl_sources_linux64-riscv64': [
      './config/archs/linux64-riscv64/asm_avx2/crypto/aes/aes-riscv64-zkn.s',
      './config/archs/linux64-riscv64/asm_avx2/crypto/aes/aes-riscv64-zvbb-zvkg-zvkned.s',
      './config/archs/linux64-riscv64/asm_avx2/crypto/aes/aes-riscv64-zvkb-zvkned.s',
      './config/archs/linux64-riscv64/asm_avx2/crypto/aes/aes-riscv64-zvkned.s',
      './config/archs/linux64-riscv64/asm_avx2/crypto/aes/aes-riscv64.s',
      './config/archs/linux64-riscv64/asm_avx2/crypto/bn/riscv64-mont.S',
      './config/archs/linux64-riscv64/asm_avx2/crypto/chacha/chacha-riscv64-v-zbb-zvkb.s',
      './config/archs/linux64-riscv64/asm_avx2/crypto/chacha/chacha-riscv64-v-zbb.s',
      './config/archs/linux64-riscv64/asm_avx2/crypto/ec/ecp_sm2p256-riscv64.S',
      './config/archs/linux64-riscv64/asm_avx2/crypto/riscv64cpuid.s',
      './config/archs/linux64-riscv64/asm_avx2/crypto/md5/md5-riscv64-zbb.S',
      './config/archs/linux64-riscv64/asm_avx2/crypto/md5/md5-riscv64.S',
      './config/archs/linux64-riscv64/asm_avx2/crypto/modes/aes-gcm-riscv64-zvkb-zvkg-zvkned.s',
      './config/archs/linux64-riscv64/asm_avx2/crypto/modes/ghash-riscv64-zvkb-zvbc.s',
      './config/archs/linux64-riscv64/asm_avx2/crypto/modes/ghash-riscv64-zvkg.s',
      './config/archs/linux64-riscv64/asm_avx2/crypto/modes/ghash-riscv64.s',
      './config/archs/linux64-riscv64/asm_avx2/crypto/sha/sha256-riscv64-zbb.S',
      './config/archs/linux64-riscv64/asm_avx2/crypto/sha/sha256-riscv64-zvkb-zvknha_or_zvknhb.S',
      './config/archs/linux64-riscv64/asm_avx2/crypto/sha/sha256-riscv64.S',
      './config/archs/linux64-riscv64/asm_avx2/crypto/sha/sha512-riscv64-zbb.S',
      './config/archs/linux64-riscv64/asm_avx2/crypto/sha/sha512-riscv64-zvkb-zvknhb.S',
      './config/archs/linux64-riscv64/asm_avx2/crypto/sm3/sm3-riscv64-zbb.S',
      './config/archs/linux64-riscv64/asm_avx2/crypto/sm3/sm3-riscv64-zvksh.S',
      './config/archs/linux64-riscv64/asm_avx2/crypto/sm4/sm4-riscv64-zvksed.s',
      './config/archs/linux64-riscv64/asm_avx2/providers/common/der/der_sm2_gen.c',
      './config/archs/linux64-riscv64/asm_avx2/providers/common/der/der_digests_gen.c',
      './config/archs/linux64-riscv64/asm_avx2/providers/common/der/der_dsa_gen.c',
      './config/archs/linux64-riscv64/asm_avx2/providers/common/der/der_ec_gen.c',
      './config/archs/linux64-riscv64/asm_avx2/providers/common/der/der_ecx_gen.c',
      './config/archs/linux64-riscv64/asm_avx2/providers/common/der/der_hkdf_gen.c',
      './config/archs/linux64-riscv64/asm_avx2/providers/common/der/der_ml_dsa_gen.c',
      './config/archs/linux64-riscv64/asm_avx2/providers/common/der/der_rsa_gen.c',
      './config/archs/linux64-riscv64/asm_avx2/providers/common/der/der_slh_dsa_gen.c',
      './config/archs/linux64-riscv64/asm_avx2/providers/common/der/der_wrap_gen.c',
      './config/archs/linux64-riscv64/asm_avx2/providers/legacy.ld',
      './config/archs/linux64-riscv64/asm_avx2/providers/fips.ld',
    ...
    'linker_script': '<(PRODUCT_DIR)/../../deps/openssl/config/archs/linux64-riscv64/asm_avx2/providers/fips.ld'
  },
  'include_dirs': [
    '.',
    './include',
  ...
  'defines': ['<@(openssl_defines_linux64-riscv64)'],
  'cflags': ['<@(openssl_cflags_linux64-riscv64)'],
  'libraries': ['<@(openssl_ex_libs_linux64-riscv64)'],
  'ldflags': ['-Wl,--version-script=<@(linker_script)'],
  'sources': ['<@(openssl_sources)', '<@(openssl_sources_linux64-riscv64)'],
