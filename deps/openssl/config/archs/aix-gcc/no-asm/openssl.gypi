{
  'variables': {
    ...
    'openssl_sources_aix-gcc': [
      './config/archs/aix-gcc/no-asm/providers/common/der/der_sm2_gen.c',
      './config/archs/aix-gcc/no-asm/providers/common/der/der_digests_gen.c',
      './config/archs/aix-gcc/no-asm/providers/common/der/der_dsa_gen.c',
      './config/archs/aix-gcc/no-asm/providers/common/der/der_ec_gen.c',
      './config/archs/aix-gcc/no-asm/providers/common/der/der_ecx_gen.c',
      './config/archs/aix-gcc/no-asm/providers/common/der/der_rsa_gen.c',
      './config/archs/aix-gcc/no-asm/providers/common/der/der_wrap_gen.c',
      './config/archs/aix-gcc/no-asm/providers/legacy.ld',
      './config/archs/aix-gcc/no-asm/providers/fips.ld',
    ],
