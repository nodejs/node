...
_aesni_xts_avx512_eligible:
	...
	cmpl	$0xc0030000,%ecx
	jne	L$_done
	movl	_OPENSSL_ia32cap_P+12(%rip),%ecx
...
.private_extern	_aesni_xts_128_encrypt_avx512
...
L$_main_loop_run_16_hEgxyDlCngwrfFe:
	...
	subq	$0x100,%rdx
	cmpq	$0x100,%rdx
	jae	L$_main_loop_run_16_hEgxyDlCngwrfFe
	cmpq	$0x80,%rdx
	jae	L$_main_loop_run_8_hEgxyDlCngwrfFe
...
.private_extern	_aesni_xts_128_decrypt_avx512
...
.private_extern	_aesni_xts_256_encrypt_avx512
...
.byte	243,15,30,250
	...
	cmpq	$0x80,%rdx
	jl	L$_less_than_128_bytes_wcpqaDvsGlbjGoe
	vpbroadcastq	%r10,%zmm25
	cmpq	$0x100,%rdx
	jge	L$_start_by16_wcpqaDvsGlbjGoe
	cmpq	$0x80,%rdx
	jge	L$_start_by8_wcpqaDvsGlbjGoe

L$_do_n_blocks_wcpqaDvsGlbjGoe:
	cmpq	$0x0,%rdx
	je	L$_ret_wcpqaDvsGlbjGoe
	cmpq	$0x70,%rdx
	jge	L$_remaining_num_blocks_is_7_wcpqaDvsGlbjGoe
	cmpq	$0x60,%rdx
	jge	L$_remaining_num_blocks_is_6_wcpqaDvsGlbjGoe
	cmpq	$0x50,%rdx
	jge	L$_remaining_num_blocks_is_5_wcpqaDvsGlbjGoe
	cmpq	$0x40,%rdx
	jge	L$_remaining_num_blocks_is_4_wcpqaDvsGlbjGoe
	cmpq	$0x30,%rdx
	jge	L$_remaining_num_blocks_is_3_wcpqaDvsGlbjGoe
	cmpq	$0x20,%rdx
	jge	L$_remaining_num_blocks_is_2_wcpqaDvsGlbjGoe
	cmpq	$0x10,%rdx
	jge	L$_remaining_num_blocks_is_1_wcpqaDvsGlbjGoe
	vmovdqa	%xmm0,%xmm8
	vmovdqa	%xmm9,%xmm0
	jmp	L$_steal_cipher_wcpqaDvsGlbjGoe
...
L$_main_loop_run_16_wcpqaDvsGlbjGoe:
	...
	subq	$0x100,%rdx
	cmpq	$0x100,%rdx
	jae	L$_main_loop_run_16_wcpqaDvsGlbjGoe
	cmpq	$0x80,%rdx
	jae	L$_main_loop_run_8_wcpqaDvsGlbjGoe
	vextracti32x4	$0x3,%zmm4,%xmm0
	jmp	L$_do_n_blocks_wcpqaDvsGlbjGoe
...
L$_less_than_128_bytes_wcpqaDvsGlbjGoe:
	...
	andq	$0x70,%r8
	cmpq	$0x60,%r8
	je	L$_num_blocks_is_6_wcpqaDvsGlbjGoe
	cmpq	$0x50,%r8
	je	L$_num_blocks_is_5_wcpqaDvsGlbjGoe
	cmpq	$0x40,%r8
	je	L$_num_blocks_is_4_wcpqaDvsGlbjGoe
	cmpq	$0x30,%r8
	je	L$_num_blocks_is_3_wcpqaDvsGlbjGoe
	cmpq	$0x20,%r8
	je	L$_num_blocks_is_2_wcpqaDvsGlbjGoe
	cmpq	$0x10,%r8
	je	L$_num_blocks_is_1_wcpqaDvsGlbjGoe
...
.private_extern	_aesni_xts_256_decrypt_avx512
...
.byte	243,15,30,250
	...
	cmpq	$0x80,%rdx
	jb	L$_less_than_128_bytes_EmbgEptodyewbFa
	vpbroadcastq	%r10,%zmm25
	cmpq	$0x100,%rdx
	jge	L$_start_by16_EmbgEptodyewbFa
	jmp	L$_start_by8_EmbgEptodyewbFa

L$_do_n_blocks_EmbgEptodyewbFa:
	cmpq	$0x0,%rdx
	je	L$_ret_EmbgEptodyewbFa
	cmpq	$0x70,%rdx
	jge	L$_remaining_num_blocks_is_7_EmbgEptodyewbFa
	cmpq	$0x60,%rdx
	jge	L$_remaining_num_blocks_is_6_EmbgEptodyewbFa
	cmpq	$0x50,%rdx
	jge	L$_remaining_num_blocks_is_5_EmbgEptodyewbFa
	cmpq	$0x40,%rdx
	jge	L$_remaining_num_blocks_is_4_EmbgEptodyewbFa
	cmpq	$0x30,%rdx
	jge	L$_remaining_num_blocks_is_3_EmbgEptodyewbFa
	cmpq	$0x20,%rdx
	jge	L$_remaining_num_blocks_is_2_EmbgEptodyewbFa
	cmpq	$0x10,%rdx
	jge	L$_remaining_num_blocks_is_1_EmbgEptodyewbFa
...
.byte	98, 211, 181, 8, 115, 194, 1
	vpslldq	$0x8,%xmm13,%xmm13
	vpxorq	%xmm13,%xmm0,%xmm0
	jmp	L$_steal_cipher_EmbgEptodyewbFa
...
L$_remaining_num_blocks_is_7_EmbgEptodyewbFa:
	...
	addq	$0x70,%rdi
	andq	$0xf,%rdx
	je	L$_done_7_remain_EmbgEptodyewbFa
	vextracti32x4	$0x2,%zmm10,%xmm12
	vextracti32x4	$0x3,%zmm10,%xmm13
	vinserti32x4	$0x2,%xmm13,%zmm10,%zmm10
...
L$_remaining_num_blocks_is_6_EmbgEptodyewbFa:
	...
	addq	$0x60,%rdi
	andq	$0xf,%rdx
	je	L$_done_6_remain_EmbgEptodyewbFa
	vextracti32x4	$0x1,%zmm10,%xmm12
	vextracti32x4	$0x2,%zmm10,%xmm13
	vinserti32x4	$0x1,%xmm13,%zmm10,%zmm10
...
L$_remaining_num_blocks_is_5_EmbgEptodyewbFa:
	...
	addq	$0x50,%rdi
	andq	$0xf,%rdx
	je	L$_done_5_remain_EmbgEptodyewbFa
	vmovdqa	%xmm10,%xmm12
	vextracti32x4	$0x1,%zmm10,%xmm10
...
L$_remaining_num_blocks_is_4_EmbgEptodyewbFa:
	...
	addq	$0x40,%rdi
	andq	$0xf,%rdx
	je	L$_done_4_remain_EmbgEptodyewbFa
	vextracti32x4	$0x3,%zmm9,%xmm12
	vinserti32x4	$0x3,%xmm10,%zmm9,%zmm9
...
L$_remaining_num_blocks_is_3_EmbgEptodyewbFa:
	...
	addq	$0x30,%rdi
	andq	$0xf,%rdx
	je	L$_done_3_remain_EmbgEptodyewbFa
	vextracti32x4	$0x2,%zmm9,%xmm13
	vextracti32x4	$0x1,%zmm9,%xmm10
	vextracti32x4	$0x3,%zmm9,%xmm11
	vpxor	%xmm9,%xmm1,%xmm1
...
L$_remaining_num_blocks_is_2_EmbgEptodyewbFa:
	...
	addq	$0x20,%rdi
	andq	$0xf,%rdx
	je	L$_done_2_remain_EmbgEptodyewbFa
	vextracti32x4	$0x2,%zmm9,%xmm10
	vextracti32x4	$0x1,%zmm9,%xmm12
	vpxor	%xmm9,%xmm1,%xmm1
	vpxor	%xmm10,%xmm2,%xmm2
...
L$_remaining_num_blocks_is_1_EmbgEptodyewbFa:
	...
	addq	$0x10,%rdi
	andq	$0xf,%rdx
	je	L$_done_1_remain_EmbgEptodyewbFa
	vextracti32x4	$0x1,%zmm9,%xmm11
	vpxor	%xmm11,%xmm1,%xmm1
	vmovdqu	(%rcx),%xmm0
	vpxor	%xmm0,%xmm1,%xmm1
...
L$_main_loop_run_16_EmbgEptodyewbFa:
	...
	subq	$0x100,%rdx
	cmpq	$0x100,%rdx
	jge	L$_main_loop_run_16_EmbgEptodyewbFa

	cmpq	$0x80,%rdx
	jge	L$_main_loop_run_8_EmbgEptodyewbFa
	jmp	L$_do_n_blocks_EmbgEptodyewbFa
...
L$_less_than_128_bytes_EmbgEptodyewbFa:
	cmpq	$0x10,%rdx
	jb	L$_ret_EmbgEptodyewbFa

	movq	%rdx,%r8
	andq	$0x70,%r8
	cmpq	$0x60,%r8
	je	L$_num_blocks_is_6_EmbgEptodyewbFa
	cmpq	$0x50,%r8
	je	L$_num_blocks_is_5_EmbgEptodyewbFa
	cmpq	$0x40,%r8
	je	L$_num_blocks_is_4_EmbgEptodyewbFa
	cmpq	$0x30,%r8
	je	L$_num_blocks_is_3_EmbgEptodyewbFa
	cmpq	$0x20,%r8
	je	L$_num_blocks_is_2_EmbgEptodyewbFa
	cmpq	$0x10,%r8
	je	L$_num_blocks_is_1_EmbgEptodyewbFa
