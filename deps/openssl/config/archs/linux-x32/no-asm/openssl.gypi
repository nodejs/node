{
  'variables': {
    ...
    'openssl_sources_linux-x32': [
      './config/archs/linux-x32/no-asm/providers/common/der/der_sm2_gen.c',
      './config/archs/linux-x32/no-asm/providers/common/der/der_digests_gen.c',
      './config/archs/linux-x32/no-asm/providers/common/der/der_dsa_gen.c',
      './config/archs/linux-x32/no-asm/providers/common/der/der_ec_gen.c',
      './config/archs/linux-x32/no-asm/providers/common/der/der_ecx_gen.c',
      './config/archs/linux-x32/no-asm/providers/common/der/der_rsa_gen.c',
      './config/archs/linux-x32/no-asm/providers/common/der/der_wrap_gen.c',
      './config/archs/linux-x32/no-asm/providers/legacy.ld',
      './config/archs/linux-x32/no-asm/providers/fips.ld',
    ],
