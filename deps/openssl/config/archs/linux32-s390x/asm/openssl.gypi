{
  'variables': {
    ...
    'openssl_sources_linux32-s390x': [
      ...
      './config/archs/linux32-s390x/asm/crypto/params_idx.c',
      ...
      './config/archs/linux32-s390x/asm/providers/common/der/der_ml_dsa_gen.c',
      './config/archs/linux32-s390x/asm/providers/common/der/der_rsa_gen.c',
      './config/archs/linux32-s390x/asm/providers/common/der/der_slh_dsa_gen.c',
    ...
    'openssl_defines_exported_linux32-s390x': [
      'NDEBUG',
      'OPENSSL_USE_NODELETE',
      'B_ENDIAN',
      'OPENSSL_BUILDING_OPENSSL',
  ...
  'direct_dependent_settings': {
    ...
    'defines': ['<@(openssl_defines_exported_linux32-s390x)'],
  },
}
