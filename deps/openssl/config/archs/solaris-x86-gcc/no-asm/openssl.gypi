{
  'variables': {
    ...
    'openssl_sources_solaris-x86-gcc': [
      './config/archs/solaris-x86-gcc/no-asm/crypto/params_idx.c',
      ...
      './config/archs/solaris-x86-gcc/no-asm/providers/common/der/der_ml_dsa_gen.c',
      './config/archs/solaris-x86-gcc/no-asm/providers/common/der/der_rsa_gen.c',
      './config/archs/solaris-x86-gcc/no-asm/providers/common/der/der_slh_dsa_gen.c',
    ...
    'openssl_defines_exported_solaris-x86-gcc': [
      'NDEBUG',
      'FILIO_H',
      'L_ENDIAN',
      'OPENSSL_BUILDING_OPENSSL',
  ...
  'direct_dependent_settings': {
    ...
    'defines': ['<@(openssl_defines_exported_solaris-x86-gcc)'],
  },
}
