...
our %target = (
  _conf_fname_int => [ "Configurations/00-base-templates.conf", "Configurations/00-base-templates.conf", "Configurations/10-main.conf", "Configurations/10-main.conf", "Configurations/10-main.conf" ],
  ...
  cast_obj => "c_enc.o",
  cc => "cc",
  cflags => "-DL_ENDIAN -Wall -O3 -pthread -D_THREAD_SAFE -D_REENTRANT",
