{
  'variables': {
    ...
    'openssl_sources_linux64-loongarch64': [
      './config/archs/linux64-loongarch64/asm/crypto/aes/vpaes-loongarch64.S',
      './config/archs/linux64-loongarch64/asm/crypto/chacha/chacha-loongarch64.S',
      './config/archs/linux64-loongarch64/asm/crypto/loongarch64cpuid.s',
      './config/archs/linux64-loongarch64/asm/crypto/params_idx.c',
      './config/archs/linux64-loongarch64/asm/crypto/md5/md5-loongarch64.S',
      './config/archs/linux64-loongarch64/asm/providers/common/der/der_sm2_gen.c',
      './config/archs/linux64-loongarch64/asm/providers/common/der/der_digests_gen.c',
      './config/archs/linux64-loongarch64/asm/providers/common/der/der_dsa_gen.c',
      './config/archs/linux64-loongarch64/asm/providers/common/der/der_ec_gen.c',
      './config/archs/linux64-loongarch64/asm/providers/common/der/der_ecx_gen.c',
      './config/archs/linux64-loongarch64/asm/providers/common/der/der_ml_dsa_gen.c',
      './config/archs/linux64-loongarch64/asm/providers/common/der/der_rsa_gen.c',
      './config/archs/linux64-loongarch64/asm/providers/common/der/der_slh_dsa_gen.c',
      './config/archs/linux64-loongarch64/asm/providers/common/der/der_wrap_gen.c',
      './config/archs/linux64-loongarch64/asm/providers/legacy.ld',
      './config/archs/linux64-loongarch64/asm/providers/fips.ld',
    ],
    ...
    'openssl_defines_exported_linux64-loongarch64': [
      'NDEBUG',
      'OPENSSL_USE_NODELETE',
      'L_ENDIAN',
      'OPENSSL_BUILDING_OPENSSL',
  ...
  'direct_dependent_settings': {
    ...
    'defines': ['<@(openssl_defines_exported_linux64-loongarch64)'],
  },
}
