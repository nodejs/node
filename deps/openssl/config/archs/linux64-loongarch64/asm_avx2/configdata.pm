...
unless (caller) {
    ...
    use lib '/root/build-slack/nodejs/build-node/deps/openssl/openssl/util/perl';
    use OpenSSL::fallback '/root/build-slack/nodejs/build-node/deps/openssl/openssl/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib '/root/build-slack/nodejs/build-node/deps/openssl/openssl/Configurations';
        use gentemplate;
