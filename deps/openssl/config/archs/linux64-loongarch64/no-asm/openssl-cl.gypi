{
  'variables': {
    'openssl_defines_linux64-loongarch64': [
      'NDEBUG',
    ...
    'openssl_cli_srcs_linux64-loongarch64': [
      ...
      './config/archs/linux64-loongarch64/no-asm/apps/progs.c',
      'openssl/apps/rand.c',
  ...
  'defines': ['<@(openssl_defines_linux64-loongarch64)'],
  'include_dirs': [
    './include',
  ],
  'cflags' : ['<@(openssl_cflags_linux64-loongarch64)'],
  'libraries': ['<@(openssl_ex_libs_linux64-loongarch64)'],
  'sources': ['<@(openssl_cli_srcs_linux64-loongarch64)'],
}
