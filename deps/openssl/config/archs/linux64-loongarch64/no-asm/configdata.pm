...
our %config = (
    ...
    "patch" => "7",
    "perl_archname" => "loongarch64-linux-gnu-thread-multi",
...
unless (caller) {
    ...
    use lib '/home/zhangxi/new_node/node/deps/openssl/openssl/util/perl';
    use OpenSSL::fallback '/home/zhangxi/new_node/node/deps/openssl/openssl/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib '/home/zhangxi/new_node/node/deps/openssl/openssl/Configurations';
        use gentemplate;
