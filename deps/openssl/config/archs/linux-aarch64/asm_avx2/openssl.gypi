{
  'variables': {
    ...
    'openssl_sources_linux-aarch64': [
      ...
      './config/archs/linux-aarch64/asm_avx2/crypto/aes/bsaes-armv8.S',
      './config/archs/linux-aarch64/asm_avx2/crypto/aes/vpaes-armv8.S',
      './config/archs/linux-aarch64/asm_avx2/crypto/bn/armv8-mont.S',
      './config/archs/linux-aarch64/asm_avx2/crypto/chacha/chacha-armv8-sve.S',
      './config/archs/linux-aarch64/asm_avx2/crypto/chacha/chacha-armv8.S',
      './config/archs/linux-aarch64/asm_avx2/crypto/ec/ecp_nistz256-armv8.S',
      './config/archs/linux-aarch64/asm_avx2/crypto/ec/ecp_sm2p256-armv8.S',
      './config/archs/linux-aarch64/asm_avx2/crypto/arm64cpuid.S',
      './config/archs/linux-aarch64/asm_avx2/crypto/params_idx.c',
      './config/archs/linux-aarch64/asm_avx2/crypto/md5/md5-aarch64.S',
      './config/archs/linux-aarch64/asm_avx2/crypto/modes/aes-gcm-armv8-unroll8_64.S',
      './config/archs/linux-aarch64/asm_avx2/crypto/modes/aes-gcm-armv8_64.S',
      './config/archs/linux-aarch64/asm_avx2/crypto/modes/ghashv8-armx.S',
      './config/archs/linux-aarch64/asm_avx2/crypto/poly1305/poly1305-armv8.S',
      './config/archs/linux-aarch64/asm_avx2/crypto/sha/keccak1600-armv8.S',
      './config/archs/linux-aarch64/asm_avx2/crypto/sha/sha1-armv8.S',
      './config/archs/linux-aarch64/asm_avx2/crypto/sha/sha256-armv8.S',
      './config/archs/linux-aarch64/asm_avx2/crypto/sha/sha512-armv8.S',
      './config/archs/linux-aarch64/asm_avx2/crypto/sm3/sm3-armv8.S',
      './config/archs/linux-aarch64/asm_avx2/crypto/sm4/sm4-armv8.S',
      './config/archs/linux-aarch64/asm_avx2/crypto/sm4/vpsm4-armv8.S',
      './config/archs/linux-aarch64/asm_avx2/crypto/sm4/vpsm4_ex-armv8.S',
      './config/archs/linux-aarch64/asm_avx2/providers/common/der/der_sm2_gen.c',
      './config/archs/linux-aarch64/asm_avx2/providers/common/der/der_digests_gen.c',
      './config/archs/linux-aarch64/asm_avx2/providers/common/der/der_dsa_gen.c',
      './config/archs/linux-aarch64/asm_avx2/providers/common/der/der_ec_gen.c',
      './config/archs/linux-aarch64/asm_avx2/providers/common/der/der_ecx_gen.c',
      './config/archs/linux-aarch64/asm_avx2/providers/common/der/der_ml_dsa_gen.c',
      './config/archs/linux-aarch64/asm_avx2/providers/common/der/der_rsa_gen.c',
      './config/archs/linux-aarch64/asm_avx2/providers/common/der/der_slh_dsa_gen.c',
    ...
    'openssl_defines_exported_linux-aarch64': [
      'NDEBUG',
      'OPENSSL_USE_NODELETE',
      'OPENSSL_BUILDING_OPENSSL',
      'BSAES_ASM',
  ...
  'direct_dependent_settings': {
    ...
    'defines': ['<@(openssl_defines_exported_linux-aarch64)'],
  },
}
