...
",
    ...
    "dso_scheme" => "win32",
    "enable" => [],
    "ex_libs" => "ZLIB1 libzstd brotlicommon.lib brotlidec.lib brotlienc.lib ws2_32.lib gdi32.lib advapi32.lib crypt32.lib user32.lib",
    "includes" => [
        "../../brotli/c/include",
        "../../zlib",
        "../../zstd/lib"
