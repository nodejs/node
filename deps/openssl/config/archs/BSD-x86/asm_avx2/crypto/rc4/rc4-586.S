...
L004PIC_me_up:
	popl	%ebp
	leal	__GLOBAL_OFFSET_TABLE_+[.-L004PIC_me_up](%ebp),%ebp
...
L010PIC_me_up:
	popl	%edx
	leal	__GLOBAL_OFFSET_TABLE_+[.-L010PIC_me_up](%edx),%edx
...
L020PIC_me_up:
	popl	%edx
	leal	__GLOBAL_OFFSET_TABLE_+[.-L020PIC_me_up](%edx),%edx
	movl	_OPENSSL_ia32cap_P@GOT(%edx),%edx
	movl	(%edx),%edx
	btl	$20,%edx
	jc	L0211xchar
