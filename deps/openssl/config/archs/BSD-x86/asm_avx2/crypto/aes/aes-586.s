...
L004pic_point:
	popl	%ebp
	leal	__GLOBAL_OFFSET_TABLE_+[.-L004pic_point](%ebp),%eax
...
L010pic_point:
	popl	%ebp
	leal	__GLOBAL_OFFSET_TABLE_+[.-L010pic_point](%ebp),%eax
	movl	_OPENSSL_ia32cap_P@GOT(%eax),%eax
...
.type	_AES_cbc_encrypt,@function
.align	4
_AES_cbc_encrypt:
...
L013pic_point:
	popl	%ebp
	leal	__GLOBAL_OFFSET_TABLE_+[.-L013pic_point](%ebp),%eax
	movl	_OPENSSL_ia32cap_P@GOT(%eax),%eax
	cmpl	$0,40(%esp)
...
.type	_AES_set_encrypt_key,@function
.align	4
