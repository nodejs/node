{
  'variables': {
    ...
    'openssl_sources_BSD-x86': [
      './config/archs/BSD-x86/no-asm/crypto/params_idx.c',
      ...
      './config/archs/BSD-x86/no-asm/providers/common/der/der_ml_dsa_gen.c',
      './config/archs/BSD-x86/no-asm/providers/common/der/der_rsa_gen.c',
      './config/archs/BSD-x86/no-asm/providers/common/der/der_slh_dsa_gen.c',
