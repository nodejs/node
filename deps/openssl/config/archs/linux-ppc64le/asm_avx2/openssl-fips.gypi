{
  'variables': {
    ...
    'openssl_sources_linux-ppc64le': [
      ...
      './config/archs/linux-ppc64le/asm_avx2/crypto/params_idx.c',
      './config/archs/linux-ppc64le/asm_avx2/crypto/ppccpuid.s',
      './config/archs/linux-ppc64le/asm_avx2/crypto/modes/aes-gcm-ppc.s',
      ...
      './config/archs/linux-ppc64le/asm_avx2/providers/common/der/der_ml_dsa_gen.c',
      './config/archs/linux-ppc64le/asm_avx2/providers/common/der/der_rsa_gen.c',
      './config/archs/linux-ppc64le/asm_avx2/providers/common/der/der_slh_dsa_gen.c',
