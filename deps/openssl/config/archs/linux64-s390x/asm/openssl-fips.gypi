{
  'variables': {
    'openssl_sources': [
      ...
      'openssl/crypto/hmac/hmac_s390x.c',
    ...
    'openssl_sources_linux64-s390x': [
      ...
      './config/archs/linux64-s390x/asm/crypto/params_idx.c',
      ...
      './config/archs/linux64-s390x/asm/providers/common/der/der_ml_dsa_gen.c',
      './config/archs/linux64-s390x/asm/providers/common/der/der_rsa_gen.c',
      './config/archs/linux64-s390x/asm/providers/common/der/der_slh_dsa_gen.c',
    ...
    'linker_script': '<(PRODUCT_DIR)/../../deps/openssl/config/archs/linux64-s390x/asm/providers/fips.ld'
  },
  'include_dirs': [
    '.',
    './include',
