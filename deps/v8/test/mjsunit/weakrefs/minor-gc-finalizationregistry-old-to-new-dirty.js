...
// Flags: --expose-gc --no-incremental-marking --no-single-generation --no-gc-global --no-minor-ms --handle-weak-ref-weakly-in-minor-gc --no-scavenger-chaos-mode --allow-natives-syntax --scavenger-chaos-mode --scavenger-chaos-mode-threshold=0
