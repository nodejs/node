...
function myfun() {
  // Big enough that the inliner picks `myfun` over the Math.ceil callsite.
  for (let i = 0; i < 5; i++);
  return Math.ceil;
}
...
// Smi path: Math.ceil of an integer returns the integer directly.
