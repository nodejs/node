...
sum = 0;
assertEquals(9, foo([1, 2, 3, 4], 9, false));
assertEquals(22, sum);
sum = 0;
assertEquals(9, foo([1, 2, 3, 4], 9, false));
assertEquals(22, sum);
...
// Reopting using this known deopt loop: we'll still do the same escape analysis
// optimization when reopting.
deopt = false;
%OptimizeFunctionOnNextCall(foo);
sum = 0;
assertEquals(20, foo([1, 2, 3, 4], 3, true));
assertEquals(22, sum);
assertUnoptimized(foo);
