...
function myfun() {
  // Big enough that the inliner picks `myfun` over the Math.floor callsite.
  for (let i = 0; i < 5; i++);
  return Math.floor;
}
...
// Smi path: Math.floor of an integer returns the integer directly.
