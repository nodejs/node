...
// Each of these size variants takes two inputs, one with the same size as the
// output, and one with the same lane count but half the width as the output.
...
// 2D Low
builder.addFunction("main_vector_2D_L_U", makeSig([kWasmI32, kWasmI64], [kWasmI64]))
.addBody([
  kExprLocalGet, 0,
...
builder.addFunction("main_vector_2D_L_S", makeSig([kWasmI32, kWasmI64], [kWasmI64]))
.addBody([
  kExprLocalGet, 0,
  ...SimdInstr(kExprI32x4Splat),
...
// 2D High
builder.addFunction("main_vector_2D_H_U", makeSig([kWasmI32, kWasmI64], [kWasmI64]))
.addBody([
  kExprLocalGet, 0,
  ...SimdInstr(kExprI32x4Splat),
...
builder.addFunction("main_vector_2D_H_S", makeSig([kWasmI32, kWasmI64], [kWasmI64]))
.addBody([
  kExprLocalGet, 0,
  ...SimdInstr(kExprI32x4Splat),
...
function test_vector_sub(s1, s2, array, signed_func, unsigned_func) {
  for (let i = 0; i < array.length-2; i++) {
    ...
    let ub = BigInt.asUintN(s2, b);
    let sa = BigInt.asIntN(s1, a);
    let sb = BigInt.asIntN(s2, b);
    assertEquals(
...
// 2D
test_vector_sub(32, 64, uint64_array, module.exports.main_vector_2D_L_S, module.exports.main_vector_2D_L_U);
test_vector_sub(32, 64, uint64_array, module.exports.main_vector_2D_H_S, module.exports.main_vector_2D_H_U);
// 4S
test_vector_sub(16, 32, int32_array, module.exports.main_vector_4S_L_S, module.exports.main_vector_4S_L_U);
test_vector_sub(16, 32, int32_array, module.exports.main_vector_4S_H_S, module.exports.main_vector_4S_H_U);
// 2H
test_vector_sub(8, 16, int16_array, module.exports.main_vector_2H_L_S, module.exports.main_vector_2H_L_U);
test_vector_sub(8, 16, int16_array, module.exports.main_vector_2H_H_S, module.exports.main_vector_2H_H_U);
