...
// Flags: --allow-natives-syntax --homomorphic-ic --maglev --no-turbofan
...
// 1. Interceptor object: Maglev homomorphic access must deopt.
{
  function load(o) {
    return o.a;
  }
...
// 2. Access checked object: Maglev homomorphic access must deopt.
{
  function load(o) {
    return o.a;
  }
