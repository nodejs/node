...
// Forked from test\fuzzer\wasm\init-expr.cc to work with the Wasm interpreter.
// TODO(choongwoo.han@microsoft.com): Deduplicate code.

void FuzzIt(base::Vector<const uint8_t> data) {
  i::wasm::fuzzing::InitializeDrumbrakeForFuzzing();
