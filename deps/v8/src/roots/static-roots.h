...
struct StaticReadOnlyRoot {
  ...
  static constexpr Tagged_t kPromiseOnStackMap = 0x130d;
  ...
  static constexpr Tagged_t kUncompiledDataWithoutPreparseDataMap = 0x1655;
  static constexpr Tagged_t kUncompiledDataWithPreparseDataMap = 0x167d;
  static constexpr Tagged_t kUncompiledDataWithoutPreparseDataWithJobMap =
      0x16a5;
  static constexpr Tagged_t kUncompiledDataWithPreparseDataAndJobMap = 0x16cd;
  static constexpr Tagged_t kOnHeapBasicBlockProfilerDataMap = 0x16f5;
  static constexpr Tagged_t kFunctionTemplateInfoMap = 0x171d;
  ...
  static constexpr Tagged_t kSourceTextModuleMap = 0x1d5d;
  static constexpr Tagged_t kSyntheticModuleMap = 0x1d85;
  static constexpr Tagged_t kGlobalConstTrackingLetCellMap = 0x1dad;
  static constexpr Tagged_t kWasmApiFunctionRefMap = 0x1dd5;
  static constexpr Tagged_t kWasmCapiFunctionDataMap = 0x1dfd;
  static constexpr Tagged_t kWasmExportedFunctionDataMap = 0x1e25;
  static constexpr Tagged_t kWasmInternalFunctionMap = 0x1e4d;
  static constexpr Tagged_t kWasmFuncRefMap = 0x1e75;
  static constexpr Tagged_t kWasmJSFunctionDataMap = 0x1e9d;
  static constexpr Tagged_t kWasmResumeDataMap = 0x1ec5;
  static constexpr Tagged_t kWasmTypeInfoMap = 0x1eed;
  static constexpr Tagged_t kWasmContinuationObjectMap = 0x1f15;
  static constexpr Tagged_t kWasmNullMap = 0x1f3d;
  static constexpr Tagged_t kWasmTrustedInstanceDataMap = 0x1f65;
  static constexpr Tagged_t kWasmDispatchTableMap = 0x1f8d;
  static constexpr Tagged_t kWeakCellMap = 0x1fb5;
  static constexpr Tagged_t kExternalPointerArrayMap = 0x1fdd;
  static constexpr Tagged_t kInterpreterDataMap = 0x2005;
  static constexpr Tagged_t kSharedFunctionInfoWrapperMap = 0x202d;
  static constexpr Tagged_t kDictionaryTemplateInfoMap = 0x2055;
  static constexpr Tagged_t kNoOpInterceptorInfo = 0x207d;
  static constexpr Tagged_t kEmptyArrayList = 0x20a5;
  static constexpr Tagged_t kEmptyObjectBoilerplateDescription = 0x20b1;
  static constexpr Tagged_t kEmptyArrayBoilerplateDescription = 0x20c1;
  static constexpr Tagged_t kEmptyClosureFeedbackCellArray = 0x20cd;
  static constexpr Tagged_t kEmptySwissPropertyDictionary = 0x20e1;
  static constexpr Tagged_t kSingleCharacterStringTable = 0x2101;
  static constexpr Tagged_t kdot_string = 0x27e9;
  static constexpr Tagged_t kzero_string = 0x2809;
  static constexpr Tagged_t kone_string = 0x2819;
  static constexpr Tagged_t kadoptText_string = 0x3509;
  static constexpr Tagged_t kapproximatelySign_string = 0x3521;
  static constexpr Tagged_t kbaseName_string = 0x3541;
  static constexpr Tagged_t kaccounting_string = 0x3555;
  static constexpr Tagged_t kbreakType_string = 0x356d;
  static constexpr Tagged_t kcalendars_string = 0x3585;
  static constexpr Tagged_t kcardinal_string = 0x359d;
  static constexpr Tagged_t kcaseFirst_string = 0x35b1;
  static constexpr Tagged_t kceil_string = 0x35c9;
  static constexpr Tagged_t kcompare_string = 0x35d9;
  static constexpr Tagged_t kcollation_string = 0x35ed;
  static constexpr Tagged_t kcollations_string = 0x3605;
  static constexpr Tagged_t kcompact_string = 0x361d;
  static constexpr Tagged_t kcompactDisplay_string = 0x3631;
  static constexpr Tagged_t kcurrency_string = 0x364d;
  static constexpr Tagged_t kcurrencyDisplay_string = 0x3661;
  static constexpr Tagged_t kcurrencySign_string = 0x367d;
  static constexpr Tagged_t kdateStyle_string = 0x3695;
  static constexpr Tagged_t kdateTimeField_string = 0x36ad;
  static constexpr Tagged_t kdayPeriod_string = 0x36c9;
  static constexpr Tagged_t kdaysDisplay_string = 0x36e1;
  static constexpr Tagged_t kdecimal_string = 0x36f9;
  static constexpr Tagged_t kdialect_string = 0x370d;
  static constexpr Tagged_t kdigital_string = 0x3721;
  static constexpr Tagged_t kdirection_string = 0x3735;
  static constexpr Tagged_t kendRange_string = 0x374d;
  static constexpr Tagged_t kengineering_string = 0x3761;
  static constexpr Tagged_t kexceptZero_string = 0x3779;
  static constexpr Tagged_t kexpand_string = 0x3791;
  static constexpr Tagged_t kexponentInteger_string = 0x37a5;
  static constexpr Tagged_t kexponentMinusSign_string = 0x37c1;
  static constexpr Tagged_t kexponentSeparator_string = 0x37e1;
  static constexpr Tagged_t kfallback_string = 0x3801;
  static constexpr Tagged_t kfirst_string = 0x3815;
  static constexpr Tagged_t kfirstDay_string = 0x3829;
  static constexpr Tagged_t kfloor_string = 0x383d;
  static constexpr Tagged_t kformat_string = 0x3851;
  static constexpr Tagged_t kfraction_string = 0x3865;
  static constexpr Tagged_t kfractionalDigits_string = 0x3879;
  static constexpr Tagged_t kfractionalSecond_string = 0x3895;
  static constexpr Tagged_t kfull_string = 0x38b1;
  static constexpr Tagged_t kgranularity_string = 0x38c1;
  static constexpr Tagged_t kgrapheme_string = 0x38d9;
  static constexpr Tagged_t kgroup_string = 0x38ed;
  static constexpr Tagged_t kh11_string = 0x3901;
  static constexpr Tagged_t kh12_string = 0x3911;
  static constexpr Tagged_t kh23_string = 0x3921;
  static constexpr Tagged_t kh24_string = 0x3931;
  static constexpr Tagged_t khalfCeil_string = 0x3941;
  static constexpr Tagged_t khalfEven_string = 0x3955;
  static constexpr Tagged_t khalfExpand_string = 0x3969;
  static constexpr Tagged_t khalfFloor_string = 0x3981;
  static constexpr Tagged_t khalfTrunc_string = 0x3999;
  static constexpr Tagged_t khour12_string = 0x39b1;
  static constexpr Tagged_t khourCycle_string = 0x39c5;
  static constexpr Tagged_t khourCycles_string = 0x39dd;
  static constexpr Tagged_t khoursDisplay_string = 0x39f5;
  static constexpr Tagged_t kideo_string = 0x3a0d;
  static constexpr Tagged_t kignorePunctuation_string = 0x3a1d;
  static constexpr Tagged_t kInvalid_Date_string = 0x3a3d;
  static constexpr Tagged_t kinteger_string = 0x3a55;
  static constexpr Tagged_t kisWordLike_string = 0x3a69;
  static constexpr Tagged_t kkana_string = 0x3a81;
  static constexpr Tagged_t klanguage_string = 0x3a91;
  static constexpr Tagged_t klanguageDisplay_string = 0x3aa5;
  static constexpr Tagged_t klessPrecision_string = 0x3ac1;
  static constexpr Tagged_t kletter_string = 0x3add;
  static constexpr Tagged_t klist_string = 0x3af1;
  static constexpr Tagged_t kliteral_string = 0x3b01;
  static constexpr Tagged_t klocale_string = 0x3b15;
  static constexpr Tagged_t kloose_string = 0x3b29;
  static constexpr Tagged_t klower_string = 0x3b3d;
  static constexpr Tagged_t kltr_string = 0x3b51;
  static constexpr Tagged_t kmaximumFractionDigits_string = 0x3b61;
  static constexpr Tagged_t kmaximumSignificantDigits_string = 0x3b85;
  static constexpr Tagged_t kmicrosecondsDisplay_string = 0x3ba9;
  static constexpr Tagged_t kmillisecondsDisplay_string = 0x3bc9;
  static constexpr Tagged_t kmin2_string = 0x3be9;
  static constexpr Tagged_t kminimalDays_string = 0x3bf9;
  static constexpr Tagged_t kminimumFractionDigits_string = 0x3c11;
  static constexpr Tagged_t kminimumIntegerDigits_string = 0x3c35;
  static constexpr Tagged_t kminimumSignificantDigits_string = 0x3c55;
  static constexpr Tagged_t kminus_0 = 0x3c79;
  static constexpr Tagged_t kminusSign_string = 0x3c89;
  static constexpr Tagged_t kminutesDisplay_string = 0x3ca1;
  static constexpr Tagged_t kmonthsDisplay_string = 0x3cbd;
  static constexpr Tagged_t kmorePrecision_string = 0x3cd9;
  static constexpr Tagged_t knan_string = 0x3cf5;
  static constexpr Tagged_t knanosecondsDisplay_string = 0x3d05;
  static constexpr Tagged_t knarrowSymbol_string = 0x3d25;
  static constexpr Tagged_t knegative_string = 0x3d3d;
  static constexpr Tagged_t knever_string = 0x3d51;
  static constexpr Tagged_t knone_string = 0x3d65;
  static constexpr Tagged_t knotation_string = 0x3d75;
  static constexpr Tagged_t knormal_string = 0x3d89;
  static constexpr Tagged_t knumberingSystem_string = 0x3d9d;
  static constexpr Tagged_t knumberingSystems_string = 0x3db9;
  static constexpr Tagged_t knumeric_string = 0x3dd5;
  static constexpr Tagged_t kordinal_string = 0x3de9;
  static constexpr Tagged_t kpercentSign_string = 0x3dfd;
  static constexpr Tagged_t kplusSign_string = 0x3e15;
  static constexpr Tagged_t kquarter_string = 0x3e29;
  static constexpr Tagged_t kregion_string = 0x3e3d;
  static constexpr Tagged_t krelatedYear_string = 0x3e51;
  static constexpr Tagged_t kroundingMode_string = 0x3e69;
  static constexpr Tagged_t kroundingPriority_string = 0x3e81;
  static constexpr Tagged_t krtl_string = 0x3e9d;
  static constexpr Tagged_t kscientific_string = 0x3ead;
  static constexpr Tagged_t ksecondsDisplay_string = 0x3ec5;
  static constexpr Tagged_t ksegment_string = 0x3ee1;
  static constexpr Tagged_t kSegmentIterator_string = 0x3ef5;
  static constexpr Tagged_t kSegments_string = 0x3f11;
  static constexpr Tagged_t ksensitivity_string = 0x3f25;
  static constexpr Tagged_t ksep_string = 0x3f3d;
  static constexpr Tagged_t kshared_string = 0x3f4d;
  static constexpr Tagged_t ksignDisplay_string = 0x3f61;
  static constexpr Tagged_t kstandard_string = 0x3f79;
  static constexpr Tagged_t kstartRange_string = 0x3f8d;
  static constexpr Tagged_t kstrict_string = 0x3fa5;
  static constexpr Tagged_t kstripIfInteger_string = 0x3fb9;
  static constexpr Tagged_t kstyle_string = 0x3fd5;
  static constexpr Tagged_t kterm_string = 0x3fe9;
  static constexpr Tagged_t ktextInfo_string = 0x3ff9;
  static constexpr Tagged_t ktimeStyle_string = 0x400d;
  static constexpr Tagged_t ktimeZones_string = 0x4025;
  static constexpr Tagged_t ktimeZoneName_string = 0x403d;
  static constexpr Tagged_t ktrailingZeroDisplay_string = 0x4055;
  static constexpr Tagged_t ktrunc_string = 0x4075;
  static constexpr Tagged_t ktwo_digit_string = 0x4089;
  static constexpr Tagged_t ktype_string = 0x409d;
  static constexpr Tagged_t kunknown_string = 0x40ad;
  static constexpr Tagged_t kupper_string = 0x40c1;
  static constexpr Tagged_t kusage_string = 0x40d5;
  static constexpr Tagged_t kuseGrouping_string = 0x40e9;
  static constexpr Tagged_t kunitDisplay_string = 0x4101;
  static constexpr Tagged_t kweekday_string = 0x4119;
  static constexpr Tagged_t kweekend_string = 0x412d;
  static constexpr Tagged_t kweeksDisplay_string = 0x4141;
  static constexpr Tagged_t kweekInfo_string = 0x4159;
  static constexpr Tagged_t kyearName_string = 0x416d;
  static constexpr Tagged_t kyearsDisplay_string = 0x4181;
  static constexpr Tagged_t kadd_string = 0x4199;
  static constexpr Tagged_t kAggregateError_string = 0x41a9;
  static constexpr Tagged_t kalways_string = 0x41c5;
  static constexpr Tagged_t kanonymous_function_string = 0x41d9;
  static constexpr Tagged_t kanonymous_string = 0x41f9;
  static constexpr Tagged_t kapply_string = 0x4211;
  static constexpr Tagged_t kArguments_string = 0x4225;
  static constexpr Tagged_t karguments_string = 0x423d;
  static constexpr Tagged_t karguments_to_string = 0x4255;
  static constexpr Tagged_t kArray_string = 0x4275;
  static constexpr Tagged_t karray_to_string = 0x4289;
  static constexpr Tagged_t kArrayBuffer_string = 0x42a5;
  static constexpr Tagged_t kArrayIterator_string = 0x42bd;
  static constexpr Tagged_t kas_string = 0x42d9;
  static constexpr Tagged_t kassert_string = 0x42e9;
  static constexpr Tagged_t kasync_string = 0x42fd;
  static constexpr Tagged_t kAtomicsCondition_string = 0x4311;
  static constexpr Tagged_t kAtomicsMutex_string = 0x4331;
  static constexpr Tagged_t kauto_string = 0x434d;
  static constexpr Tagged_t kawait_string = 0x435d;
  static constexpr Tagged_t kBigInt_string = 0x4371;
  static constexpr Tagged_t kbigint_string = 0x4385;
  static constexpr Tagged_t kBigInt64Array_string = 0x4399;
  static constexpr Tagged_t kBigUint64Array_string = 0x43b5;
  static constexpr Tagged_t kbind_string = 0x43d1;
  static constexpr Tagged_t kblank_string = 0x43e1;
  static constexpr Tagged_t kBoolean_string = 0x43f5;
  static constexpr Tagged_t kboolean_string = 0x4409;
  static constexpr Tagged_t kboolean_to_string = 0x441d;
  static constexpr Tagged_t kbound__string = 0x4439;
  static constexpr Tagged_t kbuffer_string = 0x444d;
  static constexpr Tagged_t kbyte_length_string = 0x4461;
  static constexpr Tagged_t kbyte_offset_string = 0x4479;
  static constexpr Tagged_t kCompileError_string = 0x4491;
  static constexpr Tagged_t kcalendar_string = 0x44a9;
  static constexpr Tagged_t kcallee_string = 0x44bd;
  static constexpr Tagged_t kcaller_string = 0x44d1;
  static constexpr Tagged_t kcause_string = 0x44e5;
  static constexpr Tagged_t kcharacter_string = 0x44f9;
  static constexpr Tagged_t kcode_string = 0x4511;
  static constexpr Tagged_t kcolumn_string = 0x4521;
  static constexpr Tagged_t kcomputed_string = 0x4535;
  static constexpr Tagged_t kconjunction_string = 0x454d;
  static constexpr Tagged_t kconsole_string = 0x4565;
  static constexpr Tagged_t kconstrain_string = 0x4579;
  static constexpr Tagged_t kconstruct_string = 0x4591;
  static constexpr Tagged_t kcurrent_string = 0x45a9;
  static constexpr Tagged_t kDate_string = 0x45bd;
  static constexpr Tagged_t kdate_to_string = 0x45cd;
  static constexpr Tagged_t kdateAdd_string = 0x45e9;
  static constexpr Tagged_t kdateFromFields_string = 0x45fd;
  static constexpr Tagged_t kdateUntil_string = 0x4619;
  static constexpr Tagged_t kday_string = 0x4631;
  static constexpr Tagged_t kdayOfWeek_string = 0x4641;
  static constexpr Tagged_t kdayOfYear_string = 0x4659;
  static constexpr Tagged_t kdays_string = 0x4671;
  static constexpr Tagged_t kdaysInMonth_string = 0x4681;
  static constexpr Tagged_t kdaysInWeek_string = 0x4699;
  static constexpr Tagged_t kdaysInYear_string = 0x46b1;
  static constexpr Tagged_t kdefault_string = 0x46c9;
  static constexpr Tagged_t kdefineProperty_string = 0x46dd;
  static constexpr Tagged_t kdeleteProperty_string = 0x46f9;
  static constexpr Tagged_t kdetached_string = 0x4715;
  static constexpr Tagged_t kdisjunction_string = 0x4729;
  static constexpr Tagged_t kdone_string = 0x4741;
  static constexpr Tagged_t kdot_brand_string = 0x4751;
  static constexpr Tagged_t kdot_catch_string = 0x4765;
  static constexpr Tagged_t kdot_default_string = 0x4779;
  static constexpr Tagged_t kdot_for_string = 0x478d;
  static constexpr Tagged_t kdot_generator_object_string = 0x479d;
  static constexpr Tagged_t kdot_home_object_string = 0x47bd;
  static constexpr Tagged_t kdot_new_target_string = 0x47d5;
  static constexpr Tagged_t knew_target_string = 0x47d5;
  static constexpr Tagged_t kdot_result_string = 0x47ed;
  static constexpr Tagged_t kdot_repl_result_string = 0x4801;
  static constexpr Tagged_t kdot_static_home_object_string = 0x4819;
  static constexpr Tagged_t kdot_switch_tag_string = 0x4839;
  static constexpr Tagged_t kdotAll_string = 0x4851;
  static constexpr Tagged_t kError_string = 0x4865;
  static constexpr Tagged_t kEvalError_string = 0x4879;
  static constexpr Tagged_t kelement_string = 0x4891;
  static constexpr Tagged_t kepochMicroseconds_string = 0x48a5;
  static constexpr Tagged_t kepochMilliseconds_string = 0x48c5;
  static constexpr Tagged_t kepochNanoseconds_string = 0x48e5;
  static constexpr Tagged_t kepochSeconds_string = 0x4901;
  static constexpr Tagged_t kera_string = 0x4919;
  static constexpr Tagged_t keraYear_string = 0x4929;
  static constexpr Tagged_t kerror_string = 0x493d;
  static constexpr Tagged_t kerrors_string = 0x4951;
  static constexpr Tagged_t kerror_to_string = 0x4965;
  static constexpr Tagged_t keval_string = 0x4981;
  static constexpr Tagged_t kexception_string = 0x4991;
  static constexpr Tagged_t kexec_string = 0x49a9;
  static constexpr Tagged_t kfalse_string = 0x49b9;
  static constexpr Tagged_t kfields_string = 0x49cd;
  static constexpr Tagged_t kFinalizationRegistry_string = 0x49e1;
  static constexpr Tagged_t kflags_string = 0x4a01;
  static constexpr Tagged_t kFloat16Array_string = 0x4a15;
  static constexpr Tagged_t kFloat32Array_string = 0x4a2d;
  static constexpr Tagged_t kFloat64Array_string = 0x4a45;
  static constexpr Tagged_t kfractionalSecondDigits_string = 0x4a5d;
  static constexpr Tagged_t kfrom_string = 0x4a81;
  static constexpr Tagged_t kFunction_string = 0x4a91;
  static constexpr Tagged_t kfunction_native_code_string = 0x4aa5;
  static constexpr Tagged_t kfunction_string = 0x4ad1;
  static constexpr Tagged_t kfunction_to_string = 0x4ae5;
  static constexpr Tagged_t kGenerator_string = 0x4b05;
  static constexpr Tagged_t kget_space_string = 0x4b1d;
  static constexpr Tagged_t kget_string = 0x4b2d;
  static constexpr Tagged_t kgetOffsetNanosecondsFor_string = 0x4b3d;
  static constexpr Tagged_t kgetOwnPropertyDescriptor_string = 0x4b61;
  static constexpr Tagged_t kgetPossibleInstantsFor_string = 0x4b85;
  static constexpr Tagged_t kgetPrototypeOf_string = 0x4ba9;
  static constexpr Tagged_t kglobal_string = 0x4bc5;
  static constexpr Tagged_t kglobalThis_string = 0x4bd9;
  static constexpr Tagged_t kgroups_string = 0x4bf1;
  static constexpr Tagged_t kgrowable_string = 0x4c05;
  static constexpr Tagged_t khas_string = 0x4c19;
  static constexpr Tagged_t khasIndices_string = 0x4c29;
  static constexpr Tagged_t khour_string = 0x4c41;
  static constexpr Tagged_t khours_string = 0x4c51;
  static constexpr Tagged_t khoursInDay_string = 0x4c65;
  static constexpr Tagged_t kignoreCase_string = 0x4c7d;
  static constexpr Tagged_t kid_string = 0x4c95;
  static constexpr Tagged_t killegal_access_string = 0x4ca5;
  static constexpr Tagged_t killegal_argument_string = 0x4cc1;
  static constexpr Tagged_t kinLeapYear_string = 0x4cdd;
  static constexpr Tagged_t kindex_string = 0x4cf5;
  static constexpr Tagged_t kindices_string = 0x4d09;
  static constexpr Tagged_t kInfinity_string = 0x4d1d;
  static constexpr Tagged_t kinfinity_string = 0x4d31;
  static constexpr Tagged_t kinput_string = 0x4d45;
  static constexpr Tagged_t kinstance_members_initializer_string = 0x4d59;
  static constexpr Tagged_t kInt16Array_string = 0x4d85;
  static constexpr Tagged_t kInt32Array_string = 0x4d9d;
  static constexpr Tagged_t kInt8Array_string = 0x4db5;
  static constexpr Tagged_t kisExtensible_string = 0x4dcd;
  static constexpr Tagged_t kiso8601_string = 0x4de5;
  static constexpr Tagged_t kisoDay_string = 0x4df9;
  static constexpr Tagged_t kisoHour_string = 0x4e0d;
  static constexpr Tagged_t kisoMicrosecond_string = 0x4e21;
  static constexpr Tagged_t kisoMillisecond_string = 0x4e3d;
  static constexpr Tagged_t kisoMinute_string = 0x4e59;
  static constexpr Tagged_t kisoMonth_string = 0x4e71;
  static constexpr Tagged_t kisoNanosecond_string = 0x4e85;
  static constexpr Tagged_t kisoSecond_string = 0x4ea1;
  static constexpr Tagged_t kisoYear_string = 0x4eb9;
  static constexpr Tagged_t kIterator_string = 0x4ecd;
  static constexpr Tagged_t kjsMemoryEstimate_string = 0x4ee1;
  static constexpr Tagged_t kjsMemoryRange_string = 0x4efd;
  static constexpr Tagged_t kkeys_string = 0x4f19;
  static constexpr Tagged_t klargestUnit_string = 0x4f29;
  static constexpr Tagged_t klastIndex_string = 0x4f41;
  static constexpr Tagged_t klet_string = 0x4f59;
  static constexpr Tagged_t kline_string = 0x4f69;
  static constexpr Tagged_t klinear_string = 0x4f79;
  static constexpr Tagged_t kLinkError_string = 0x4f8d;
  static constexpr Tagged_t klong_string = 0x4fa5;
  static constexpr Tagged_t kMap_string = 0x4fb5;
  static constexpr Tagged_t kMapIterator_string = 0x4fc5;
  static constexpr Tagged_t kmax_byte_length_string = 0x4fdd;
  static constexpr Tagged_t kmedium_string = 0x4ff9;
  static constexpr Tagged_t kmergeFields_string = 0x500d;
  static constexpr Tagged_t kmessage_string = 0x5025;
  static constexpr Tagged_t kmeta_string = 0x5039;
  static constexpr Tagged_t kminus_Infinity_string = 0x5049;
  static constexpr Tagged_t kmicrosecond_string = 0x5061;
  static constexpr Tagged_t kmicroseconds_string = 0x5079;
  static constexpr Tagged_t kmillisecond_string = 0x5091;
  static constexpr Tagged_t kmilliseconds_string = 0x50a9;
  static constexpr Tagged_t kminute_string = 0x50c1;
  static constexpr Tagged_t kminutes_string = 0x50d5;
  static constexpr Tagged_t kModule_string = 0x50e9;
  static constexpr Tagged_t kmonth_string = 0x50fd;
  static constexpr Tagged_t kmonthDayFromFields_string = 0x5111;
  static constexpr Tagged_t kmonths_string = 0x5131;
  static constexpr Tagged_t kmonthsInYear_string = 0x5145;
  static constexpr Tagged_t kmonthCode_string = 0x515d;
  static constexpr Tagged_t kmultiline_string = 0x5175;
  static constexpr Tagged_t kNaN_string = 0x518d;
  static constexpr Tagged_t knanosecond_string = 0x519d;
  static constexpr Tagged_t knanoseconds_string = 0x51b5;
  static constexpr Tagged_t knarrow_string = 0x51cd;
  static constexpr Tagged_t knative_string = 0x51e1;
  static constexpr Tagged_t kNFC_string = 0x51f5;
  static constexpr Tagged_t kNFD_string = 0x5205;
  static constexpr Tagged_t kNFKC_string = 0x5215;
  static constexpr Tagged_t kNFKD_string = 0x5225;
  static constexpr Tagged_t knot_equal_string = 0x5235;
  static constexpr Tagged_t knull_string = 0x524d;
  static constexpr Tagged_t knull_to_string = 0x525d;
  static constexpr Tagged_t kNumber_string = 0x5279;
  static constexpr Tagged_t knumber_string = 0x528d;
  static constexpr Tagged_t knumber_to_string = 0x52a1;
  static constexpr Tagged_t kObject_string = 0x52bd;
  static constexpr Tagged_t kobject_string = 0x52d1;
  static constexpr Tagged_t kobject_to_string = 0x52e5;
  static constexpr Tagged_t kObject_prototype_string = 0x5301;
  static constexpr Tagged_t kof_string = 0x531d;
  ...
  static constexpr Tagged_t kconsole_context_id_symbol = 0x5d21;
  static constexpr Tagged_t kconsole_context_name_symbol = 0x5d31;
