...
struct StaticReadOnlyRoot {
  ...
  static constexpr Tagged_t kdefineProperty_string = 0x417d;
  static constexpr Tagged_t kdeleteProperty_string = 0x4199;
  static constexpr Tagged_t kdetached_string = 0x41b5;
  static constexpr Tagged_t kdirection_string = 0x41c9;
  static constexpr Tagged_t kdisambiguation_string = 0x41e1;
  static constexpr Tagged_t kdisjunction_string = 0x41fd;
  static constexpr Tagged_t kdisposed_string = 0x4215;
  static constexpr Tagged_t kdone_string = 0x4229;
  static constexpr Tagged_t kdot_brand_string = 0x4239;
  static constexpr Tagged_t kdot_catch_string = 0x424d;
  static constexpr Tagged_t kdot_default_string = 0x4261;
  static constexpr Tagged_t kdot_for_string = 0x4275;
  static constexpr Tagged_t kdot_generator_object_string = 0x4285;
  static constexpr Tagged_t kdot_home_object_string = 0x42a5;
  static constexpr Tagged_t kdot_new_target_string = 0x42bd;
  static constexpr Tagged_t kdot_repl_result_string = 0x42d5;
  static constexpr Tagged_t kdot_result_string = 0x42ed;
  static constexpr Tagged_t kdot_static_home_object_string = 0x4301;
  static constexpr Tagged_t kdot_switch_tag_string = 0x4321;
  static constexpr Tagged_t kdot_this_function_string = 0x4339;
  static constexpr Tagged_t kdotAll_string = 0x4355;
  static constexpr Tagged_t kelement_string = 0x4369;
  static constexpr Tagged_t kepochMilliseconds_string = 0x437d;
  static constexpr Tagged_t kepochNanoseconds_string = 0x439d;
  static constexpr Tagged_t kera_string = 0x43b9;
  static constexpr Tagged_t keraYear_string = 0x43c9;
  static constexpr Tagged_t kError_string = 0x43dd;
  static constexpr Tagged_t kerror_string = 0x43f1;
  static constexpr Tagged_t kerror_to_string = 0x4405;
  static constexpr Tagged_t kerrors_string = 0x4421;
  static constexpr Tagged_t keval_string = 0x4435;
  static constexpr Tagged_t kEvalError_string = 0x4445;
  static constexpr Tagged_t kexception_string = 0x445d;
  static constexpr Tagged_t kexec_string = 0x4475;
  static constexpr Tagged_t kfalse_string = 0x4485;
  static constexpr Tagged_t kfields_string = 0x4499;
  static constexpr Tagged_t kFinalizationRegistry_string = 0x44ad;
  static constexpr Tagged_t kflags_string = 0x44cd;
  static constexpr Tagged_t kFloat16Array_string = 0x44e1;
  static constexpr Tagged_t kFloat32Array_string = 0x44f9;
  static constexpr Tagged_t kFloat64Array_string = 0x4511;
  static constexpr Tagged_t kfractionalSecondDigits_string = 0x4529;
  static constexpr Tagged_t kfrom_string = 0x454d;
  static constexpr Tagged_t kfunction_native_code_string = 0x455d;
  static constexpr Tagged_t kFunction_prototype_apply_string = 0x4589;
  static constexpr Tagged_t kFunction_prototype_call_string = 0x45ad;
  static constexpr Tagged_t kFunction_string = 0x45d1;
  static constexpr Tagged_t kfunction_string = 0x45e5;
  static constexpr Tagged_t kfunction_to_string = 0x45f9;
  static constexpr Tagged_t kGenerator_string = 0x4619;
  static constexpr Tagged_t kget_space_string = 0x4631;
  static constexpr Tagged_t kget_string = 0x4641;
  static constexpr Tagged_t kgetOffsetNanosecondsFor_string = 0x4651;
  static constexpr Tagged_t kgetOwnPropertyDescriptor_string = 0x4675;
  static constexpr Tagged_t kgetPossibleInstantsFor_string = 0x4699;
  static constexpr Tagged_t kgetPrototypeOf_string = 0x46bd;
  static constexpr Tagged_t kgetTimeZoneTransition_string = 0x46d9;
  static constexpr Tagged_t kglobal_string = 0x46fd;
  static constexpr Tagged_t kglobalThis_string = 0x4711;
  static constexpr Tagged_t kgroups_string = 0x4729;
  static constexpr Tagged_t kgrowable_string = 0x473d;
  static constexpr Tagged_t khas_string = 0x4751;
  static constexpr Tagged_t khasIndices_string = 0x4761;
  static constexpr Tagged_t khour_string = 0x4779;
  static constexpr Tagged_t khours_string = 0x4789;
  static constexpr Tagged_t khoursInDay_string = 0x479d;
  static constexpr Tagged_t kid_string = 0x47b5;
  static constexpr Tagged_t kignoreCase_string = 0x47c5;
  static constexpr Tagged_t killegal_access_string = 0x47dd;
  static constexpr Tagged_t killegal_argument_string = 0x47f9;
  static constexpr Tagged_t kimmutable_string = 0x4815;
  static constexpr Tagged_t kindex_string = 0x482d;
  static constexpr Tagged_t kindices_string = 0x4841;
  static constexpr Tagged_t kInfinity_string = 0x4855;
  static constexpr Tagged_t kinfinity_string = 0x4869;
  static constexpr Tagged_t kinLeapYear_string = 0x487d;
  static constexpr Tagged_t kinput_string = 0x4895;
  static constexpr Tagged_t kinstance_members_initializer_string = 0x48a9;
  static constexpr Tagged_t kInt16Array_string = 0x48d5;
  static constexpr Tagged_t kInt32Array_string = 0x48ed;
  static constexpr Tagged_t kInt8Array_string = 0x4905;
  static constexpr Tagged_t kisExtensible_string = 0x491d;
  static constexpr Tagged_t kiso8601_string = 0x4935;
  static constexpr Tagged_t kisoDay_string = 0x4949;
  static constexpr Tagged_t kisoHour_string = 0x495d;
  static constexpr Tagged_t kisoMicrosecond_string = 0x4971;
  static constexpr Tagged_t kisoMillisecond_string = 0x498d;
  static constexpr Tagged_t kisoMinute_string = 0x49a9;
  static constexpr Tagged_t kisoMonth_string = 0x49c1;
  static constexpr Tagged_t kisoNanosecond_string = 0x49d5;
  static constexpr Tagged_t kisoSecond_string = 0x49f1;
  static constexpr Tagged_t kisoYear_string = 0x4a09;
  static constexpr Tagged_t kIterator_string = 0x4a1d;
  static constexpr Tagged_t kjsMemoryEstimate_string = 0x4a31;
  static constexpr Tagged_t kjsMemoryRange_string = 0x4a4d;
  static constexpr Tagged_t kkeys_string = 0x4a69;
  static constexpr Tagged_t klargestUnit_string = 0x4a79;
  static constexpr Tagged_t klast_chunk_handling_string = 0x4a91;
  static constexpr Tagged_t klastIndex_string = 0x4ab1;
  static constexpr Tagged_t klet_string = 0x4ac9;
  static constexpr Tagged_t kline_string = 0x4ad9;
  static constexpr Tagged_t klinear_string = 0x4ae9;
  static constexpr Tagged_t kLinkError_string = 0x4afd;
  static constexpr Tagged_t klong_string = 0x4b15;
  static constexpr Tagged_t kMap_string = 0x4b25;
  static constexpr Tagged_t kMapIterator_string = 0x4b35;
  static constexpr Tagged_t kmax_byte_length_string = 0x4b4d;
  static constexpr Tagged_t kmedium_string = 0x4b69;
  static constexpr Tagged_t kmergeFields_string = 0x4b7d;
  static constexpr Tagged_t kmessage_string = 0x4b95;
  static constexpr Tagged_t kmeta_string = 0x4ba9;
  static constexpr Tagged_t kmicrosecond_string = 0x4bb9;
  static constexpr Tagged_t kmicroseconds_string = 0x4bd1;
  static constexpr Tagged_t kmillisecond_string = 0x4be9;
  static constexpr Tagged_t kmilliseconds_string = 0x4c01;
  static constexpr Tagged_t kminus_Infinity_string = 0x4c19;
  static constexpr Tagged_t kminute_string = 0x4c31;
  static constexpr Tagged_t kminutes_string = 0x4c45;
  static constexpr Tagged_t kModule_string = 0x4c59;
  static constexpr Tagged_t kmonth_string = 0x4c6d;
  static constexpr Tagged_t kmonthCode_string = 0x4c81;
  static constexpr Tagged_t kmonthDayFromFields_string = 0x4c99;
  static constexpr Tagged_t kmonths_string = 0x4cb9;
  static constexpr Tagged_t kmonthsInYear_string = 0x4ccd;
  static constexpr Tagged_t kmultiline_string = 0x4ce5;
  static constexpr Tagged_t kNaN_string = 0x4cfd;
  static constexpr Tagged_t knanosecond_string = 0x4d0d;
  static constexpr Tagged_t knanoseconds_string = 0x4d25;
  static constexpr Tagged_t knarrow_string = 0x4d3d;
  static constexpr Tagged_t knative_string = 0x4d51;
  static constexpr Tagged_t kNFC_string = 0x4d65;
  static constexpr Tagged_t kNFD_string = 0x4d75;
  static constexpr Tagged_t kNFKC_string = 0x4d85;
  static constexpr Tagged_t kNFKD_string = 0x4d95;
  static constexpr Tagged_t knot_equal_string = 0x4da5;
  static constexpr Tagged_t knull_string = 0x4dbd;
  static constexpr Tagged_t knull_to_string = 0x4dcd;
  static constexpr Tagged_t kNumber_string = 0x4de9;
  static constexpr Tagged_t knumber_string = 0x4dfd;
  static constexpr Tagged_t knumber_to_string = 0x4e11;
  static constexpr Tagged_t kObject_prototype_string = 0x4e2d;
  static constexpr Tagged_t kObject_string = 0x4e49;
  static constexpr Tagged_t kobject_string = 0x4e5d;
  static constexpr Tagged_t kobject_to_string = 0x4e71;
  static constexpr Tagged_t koffset_string = 0x4e8d;
  static constexpr Tagged_t koffsetNanoseconds_string = 0x4ea1;
  static constexpr Tagged_t kok_string = 0x4ec1;
  static constexpr Tagged_t kother_string = 0x4ed1;
  static constexpr Tagged_t koverflow_string = 0x4ee5;
  static constexpr Tagged_t kownKeys_string = 0x4ef9;
  static constexpr Tagged_t kpercent_string = 0x4f0d;
  static constexpr Tagged_t kplainDate_string = 0x4f21;
  static constexpr Tagged_t kplainTime_string = 0x4f39;
  static constexpr Tagged_t kposition_string = 0x4f51;
  static constexpr Tagged_t kpreventExtensions_string = 0x4f65;
  static constexpr Tagged_t kprivate_constructor_string = 0x4f85;
  static constexpr Tagged_t kPromise_string = 0x4f9d;
  static constexpr Tagged_t kpromise_string = 0x4fb1;
  static constexpr Tagged_t kproto_string = 0x4fc5;
  static constexpr Tagged_t kproxy_string = 0x4fdd;
  static constexpr Tagged_t kProxy_string = 0x4ff1;
  static constexpr Tagged_t kquery_colon_string = 0x5005;
  static constexpr Tagged_t kRangeError_string = 0x5015;
  static constexpr Tagged_t kraw_json_string = 0x502d;
  static constexpr Tagged_t kraw_string = 0x5041;
  static constexpr Tagged_t kread_string = 0x5051;
  static constexpr Tagged_t kReferenceError_string = 0x5061;
  static constexpr Tagged_t kReflectGet_string = 0x507d;
  static constexpr Tagged_t kReflectHas_string = 0x5095;
  static constexpr Tagged_t kRegExp_string = 0x50ad;
  static constexpr Tagged_t kregexp_to_string = 0x50c1;
  static constexpr Tagged_t kreject_string = 0x50dd;
  static constexpr Tagged_t krelativeTo_string = 0x50f1;
  static constexpr Tagged_t kresizable_string = 0x5109;
  static constexpr Tagged_t kResizableArrayBuffer_string = 0x5121;
  static constexpr Tagged_t kreturn_string = 0x5141;
  static constexpr Tagged_t krevoke_string = 0x5155;
  static constexpr Tagged_t kroundingIncrement_string = 0x5169;
  static constexpr Tagged_t kroundingMode_string = 0x5189;
  static constexpr Tagged_t kRuntimeError_string = 0x51a1;
  static constexpr Tagged_t kScript_string = 0x51b9;
  static constexpr Tagged_t kscript_string = 0x51cd;
  static constexpr Tagged_t ksecond_string = 0x51e1;
  static constexpr Tagged_t kseconds_string = 0x51f5;
  static constexpr Tagged_t ksentence_string = 0x5209;
  static constexpr Tagged_t kset_space_string = 0x521d;
  static constexpr Tagged_t kSet_string = 0x522d;
  static constexpr Tagged_t kset_string = 0x523d;
  static constexpr Tagged_t kSetIterator_string = 0x524d;
  static constexpr Tagged_t ksetPrototypeOf_string = 0x5265;
  static constexpr Tagged_t kShadowRealm_string = 0x5281;
  static constexpr Tagged_t kSharedArray_string = 0x5299;
  static constexpr Tagged_t kSharedArrayBuffer_string = 0x52b1;
  static constexpr Tagged_t kSharedStruct_string = 0x52d1;
  static constexpr Tagged_t kshort_string = 0x52e9;
  static constexpr Tagged_t ksign_string = 0x52fd;
  static constexpr Tagged_t ksize_string = 0x530d;
  static constexpr Tagged_t ksmallestUnit_string = 0x531d;
  static constexpr Tagged_t ksource_string = 0x5335;
  static constexpr Tagged_t ksourceText_string = 0x5349;
  static constexpr Tagged_t kstack_string = 0x5361;
  static constexpr Tagged_t kstackTraceLimit_string = 0x5375;
  static constexpr Tagged_t kstatic_initializer_string = 0x5391;
  static constexpr Tagged_t ksticky_string = 0x53b1;
  static constexpr Tagged_t kString_string = 0x53c5;
  static constexpr Tagged_t kstring_string = 0x53d9;
  static constexpr Tagged_t kstring_to_string = 0x53ed;
  static constexpr Tagged_t ksuppressed_string = 0x5409;
  static constexpr Tagged_t kSuppressedError_string = 0x5421;
  static constexpr Tagged_t kSuspendError_string = 0x543d;
  static constexpr Tagged_t kSymbol_iterator_string = 0x5455;
  static constexpr Tagged_t kSymbol_match_all_string = 0x5471;
  static constexpr Tagged_t kSymbol_replace_string = 0x548d;
  static constexpr Tagged_t ksymbol_species_string = 0x54a9;
  static constexpr Tagged_t kSymbol_species_string = 0x54c5;
  static constexpr Tagged_t kSymbol_split_string = 0x54e1;
  static constexpr Tagged_t kSymbol_string = 0x54f9;
  static constexpr Tagged_t ksymbol_string = 0x550d;
  static constexpr Tagged_t kSyntaxError_string = 0x5521;
  static constexpr Tagged_t ktarget_string = 0x5539;
  static constexpr Tagged_t kthis_string = 0x554d;
  static constexpr Tagged_t kthrow_string = 0x555d;
  static constexpr Tagged_t ktimed_out_string = 0x5571;
  static constexpr Tagged_t ktimeZone_string = 0x5589;
  static constexpr Tagged_t ktimeZoneId_string = 0x559d;
  static constexpr Tagged_t ktimeZoneName_string = 0x55b5;
  static constexpr Tagged_t ktoJSON_string = 0x55cd;
  static constexpr Tagged_t ktoString_string = 0x55e1;
  static constexpr Tagged_t ktotal_string = 0x55f5;
  static constexpr Tagged_t ktrue_string = 0x5609;
  static constexpr Tagged_t kTypedArrayLength_string = 0x5619;
  static constexpr Tagged_t kTypeError_string = 0x5645;
  static constexpr Tagged_t kUint16Array_string = 0x565d;
  static constexpr Tagged_t kUint32Array_string = 0x5675;
  static constexpr Tagged_t kUint8Array_string = 0x568d;
  static constexpr Tagged_t kUint8ClampedArray_string = 0x56a5;
  static constexpr Tagged_t kundefined_string = 0x56c5;
  static constexpr Tagged_t kundefined_to_string = 0x56dd;
  static constexpr Tagged_t kunicode_string = 0x56fd;
  static constexpr Tagged_t kunicodeSets_string = 0x5711;
  static constexpr Tagged_t kunit_string = 0x5729;
  static constexpr Tagged_t kURIError_string = 0x5739;
  static constexpr Tagged_t kUTC_string = 0x574d;
  static constexpr Tagged_t kWeakMap_string = 0x575d;
  static constexpr Tagged_t kWeakRef_string = 0x5771;
  static constexpr Tagged_t kWeakSet_string = 0x5785;
  static constexpr Tagged_t kWebAssemblyException_string = 0x5799;
  static constexpr Tagged_t kWebAssemblyModule_string = 0x57bd;
  static constexpr Tagged_t kweek_string = 0x57dd;
  static constexpr Tagged_t kweekOfYear_string = 0x57ed;
  static constexpr Tagged_t kweeks_string = 0x5805;
  static constexpr Tagged_t kwith_string = 0x5819;
  static constexpr Tagged_t kword_string = 0x5829;
  static constexpr Tagged_t kwritten_string = 0x5839;
  static constexpr Tagged_t kyear_string = 0x584d;
  static constexpr Tagged_t kyearMonthFromFields_string = 0x585d;
  static constexpr Tagged_t kyearOfWeek_string = 0x587d;
  static constexpr Tagged_t kyears_string = 0x5895;
  static constexpr Tagged_t karray_buffer_wasm_memory_symbol = 0x58a9;
  static constexpr Tagged_t kcall_site_info_symbol = 0x58b9;
  static constexpr Tagged_t kclass_fields_symbol = 0x58c9;
  static constexpr Tagged_t kclass_positions_symbol = 0x58d9;
  static constexpr Tagged_t kerror_end_pos_symbol = 0x58e9;
  static constexpr Tagged_t kerror_message_symbol = 0x58f9;
  static constexpr Tagged_t kerror_script_symbol = 0x5909;
  static constexpr Tagged_t kerror_stack_symbol = 0x5919;
  static constexpr Tagged_t kerror_start_pos_symbol = 0x5929;
  static constexpr Tagged_t kfrozen_symbol = 0x5939;
  static constexpr Tagged_t kinterpreter_trampoline_symbol = 0x5949;
  static constexpr Tagged_t knative_context_index_symbol = 0x5959;
  static constexpr Tagged_t knonextensible_symbol = 0x5969;
  static constexpr Tagged_t kpromise_debug_message_symbol = 0x5979;
  static constexpr Tagged_t kpromise_forwarding_handler_symbol = 0x5989;
  static constexpr Tagged_t kpromise_handled_by_symbol = 0x5999;
  static constexpr Tagged_t kpromise_awaited_by_symbol = 0x59a9;
  static constexpr Tagged_t kregexp_result_names_symbol = 0x59b9;
  static constexpr Tagged_t kregexp_result_regexp_input_symbol = 0x59c9;
  static constexpr Tagged_t kregexp_result_regexp_last_index_symbol = 0x59d9;
  static constexpr Tagged_t ksealed_symbol = 0x59e9;
  static constexpr Tagged_t kshared_struct_map_elements_template_symbol =
      0x59f9;
  static constexpr Tagged_t kshared_struct_map_registry_key_symbol = 0x5a09;
  static constexpr Tagged_t kstrict_function_transition_symbol = 0x5a19;
  static constexpr Tagged_t ktemplate_literal_function_literal_id_symbol =
      0x5a29;
  static constexpr Tagged_t ktemplate_literal_slot_id_symbol = 0x5a39;
  static constexpr Tagged_t kwasm_asm_single_function_symbol = 0x5a49;
  static constexpr Tagged_t kwasm_cross_instance_call_symbol = 0x5a59;
  static constexpr Tagged_t kwasm_exception_tag_symbol = 0x5a69;
  static constexpr Tagged_t kwasm_exception_values_symbol = 0x5a79;
  static constexpr Tagged_t kwasm_uncatchable_symbol = 0x5a89;
  static constexpr Tagged_t kwasm_debug_proxy_cache_symbol = 0x5a99;
  static constexpr Tagged_t kwasm_debug_proxy_names_symbol = 0x5aa9;
  static constexpr Tagged_t kasync_iterator_symbol = 0x5ab9;
  static constexpr Tagged_t kintl_fallback_symbol = 0x5ae9;
  static constexpr Tagged_t kmatch_symbol = 0x5b21;
  static constexpr Tagged_t ksearch_symbol = 0x5b49;
  static constexpr Tagged_t kunscopables_symbol = 0x5b75;
  static constexpr Tagged_t kdispose_symbol = 0x5ba5;
  static constexpr Tagged_t kasync_dispose_symbol = 0x5bd1;
  static constexpr Tagged_t khas_instance_symbol = 0x5c01;
  static constexpr Tagged_t kto_string_tag_symbol = 0x5c31;
  static constexpr Tagged_t kconstructor_string = 0x5ca9;
  static constexpr Tagged_t knext_string = 0x5cc1;
  static constexpr Tagged_t kresolve_string = 0x5cd1;
  static constexpr Tagged_t kthen_string = 0x5ce5;
  static constexpr Tagged_t kvalueOf_string = 0x5cf5;
  static constexpr Tagged_t kiterator_symbol = 0x5d09;
  static constexpr Tagged_t kmatch_all_symbol = 0x5d19;
  static constexpr Tagged_t kreplace_symbol = 0x5d29;
  static constexpr Tagged_t kspecies_symbol = 0x5d39;
  static constexpr Tagged_t ksplit_symbol = 0x5d49;
  static constexpr Tagged_t kto_primitive_symbol = 0x5d59;
  static constexpr Tagged_t kis_concat_spreadable_symbol = 0x5d69;
  static constexpr Tagged_t kEmptySlowElementDictionary = 0x5d79;
  static constexpr Tagged_t kEmptySymbolTable = 0x5d9d;
  static constexpr Tagged_t kUndefinedContextCell = 0x5db9;
  static constexpr Tagged_t kEmptyOrderedHashMap = 0x5dd1;
  static constexpr Tagged_t kEmptyOrderedHashSet = 0x5de5;
  static constexpr Tagged_t kEmptyFeedbackMetadata = 0x5df9;
  static constexpr Tagged_t kGlobalThisBindingScopeInfo = 0x5e05;
  static constexpr Tagged_t kEmptyFunctionScopeInfo = 0x5e25;
  static constexpr Tagged_t kNativeScopeInfo = 0x5e4d;
  static constexpr Tagged_t kShadowRealmScopeInfo = 0x5e65;
  static constexpr Tagged_t kManyClosuresCell = 0x5e7d;
  static constexpr Tagged_t kPreallocatedNumberStringTable = 0x5e8d;
