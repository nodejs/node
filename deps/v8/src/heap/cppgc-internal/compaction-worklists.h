...
#ifndef V8_HEAP_CPPGC_INTERNAL_COMPACTION_WORKLISTS_H_
#define V8_HEAP_CPPGC_INTERNAL_COMPACTION_WORKLISTS_H_
...
#endif  // V8_HEAP_CPPGC_INTERNAL_COMPACTION_WORKLISTS_H_
