...
#ifndef V8_HEAP_CPPGC_INTERNAL_CAGED_HEAP_H_
#define V8_HEAP_CPPGC_INTERNAL_CAGED_HEAP_H_
...
#include "src/heap/cppgc-internal/virtual-memory.h"
...
#endif  // V8_HEAP_CPPGC_INTERNAL_CAGED_HEAP_H_
