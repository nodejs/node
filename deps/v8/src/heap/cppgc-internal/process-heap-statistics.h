...
#ifndef V8_HEAP_CPPGC_INTERNAL_PROCESS_HEAP_STATISTICS_H_
#define V8_HEAP_CPPGC_INTERNAL_PROCESS_HEAP_STATISTICS_H_
...
#endif  // V8_HEAP_CPPGC_INTERNAL_PROCESS_HEAP_STATISTICS_H_
