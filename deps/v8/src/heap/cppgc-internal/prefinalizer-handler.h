...
#ifndef V8_HEAP_CPPGC_INTERNAL_PREFINALIZER_HANDLER_H_
#define V8_HEAP_CPPGC_INTERNAL_PREFINALIZER_HANDLER_H_
...
#endif  // V8_HEAP_CPPGC_INTERNAL_PREFINALIZER_HANDLER_H_
