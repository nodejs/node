...
#ifndef V8_HEAP_CPPGC_INTERNAL_HEAP_STATISTICS_COLLECTOR_H_
#define V8_HEAP_CPPGC_INTERNAL_HEAP_STATISTICS_COLLECTOR_H_
...
#endif  // V8_HEAP_CPPGC_INTERNAL_HEAP_STATISTICS_COLLECTOR_H_
