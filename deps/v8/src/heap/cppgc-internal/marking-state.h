...
#ifndef V8_HEAP_CPPGC_INTERNAL_MARKING_STATE_H_
#define V8_HEAP_CPPGC_INTERNAL_MARKING_STATE_H_
...
#include "src/heap/cppgc-internal/compaction-worklists.h"
...
#endif  // V8_HEAP_CPPGC_INTERNAL_MARKING_STATE_H_
