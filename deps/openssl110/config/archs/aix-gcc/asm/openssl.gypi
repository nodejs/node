{
  'variables': {
    ...
    'openssl_sources_aix-gcc': [
      './config/archs/aix-gcc/asm/crypto/aes/aes-ppc.s',
      './config/archs/aix-gcc/asm/crypto/aes/aesp8-ppc.s',
      ...
      './config/archs/aix-gcc/asm/crypto/poly1305/poly1305-ppcfp.s',
      './config/archs/aix-gcc/asm/crypto/ppccpuid.s',
      './config/archs/aix-gcc/asm/crypto/sha/sha1-ppc.s',
      './config/archs/aix-gcc/asm/crypto/sha/sha256-ppc.s',
      './config/archs/aix-gcc/asm/crypto/sha/sha256p8-ppc.s',
      './config/archs/aix-gcc/asm/crypto/sha/sha512-ppc.s',
