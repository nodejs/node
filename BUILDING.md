...
| macOS            | x64              | >= 13.5                           | Until early 2028[^8]. For notes about compilation see [^4] |
| SmartOS          | x64              | >= 18                             |                                                            |
...
| GNU/Linux        | arm64            | kernel >= 6.18, musl >= 1.2.5 | e.g. Alpine 3.23             |
...
| GNU/Linux        | riscv64          | kernel >= 6.8, glibc >= 2.39  | GCC >= 14 or Clang >= 19[^5] |
| FreeBSD          | x64              | >= 13.2                       |                              |
