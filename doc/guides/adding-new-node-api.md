# Contributing a new API to the Node.js API

The Node.js API is the next-generation ABI-stable API for native modules.
...
* A new API **must** adhere to the Node.js API shape and spirit.
  * **Must** be a C API.
  ...
  * **Must** not change the signature of an existing Node.js API or break
...
* A new API **should** be discussed at the Node.js API team meeting.
* A new API addition **must** be signed off by at least two members of
  the Node.js API team.
