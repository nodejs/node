...
<a id="12.15.0"></a>
## 2020-02-12, Version 12.15.0 'Erbium' (LTS), @targos
...
* [[`67ec97a086`](https://github.com/nodejs/node/commit/67ec97a086)] - **(SEMVER-MINOR)** **assert**: implement `assert.match()` and `assert.doesNotMatch()` (Ruben Bridgewater) [#30929](https://github.com/nodejs/node/pull/30929)
* [[`881ebce0f3`](https://github.com/nodejs/node/commit/881ebce0f3)] - **(SEMVER-MINOR)** **assert**: DRY .throws code (Ruben Bridgewater) [#28263](https://github.com/nodejs/node/pull/28263)
* [[`e938784173`](https://github.com/nodejs/node/commit/e938784173)] - **(SEMVER-MINOR)** **assert**: fix generatedMessage property (Ruben Bridgewater) [#28263](https://github.com/nodejs/node/pull/28263)
* [[`9da54444dd`](https://github.com/nodejs/node/commit/9da54444dd)] - **assert**: use for...of (Soar) [#30983](https://github.com/nodejs/node/pull/30983)
* [[`5bd6947d0e`](https://github.com/nodejs/node/commit/5bd6947d0e)] - **(SEMVER-MINOR)** **assert**: fix line number calculation after V8 upgrade (Michaël Zasso) [#29694](https://github.com/nodejs/node/pull/29694)
* [[`1f68004954`](https://github.com/nodejs/node/commit/1f68004954)] - **assert,util**: stricter type comparison using deep equal comparisons (Ruben Bridgewater) [#30764](https://github.com/nodejs/node/pull/30764)
* [[`c6be79a34e`](https://github.com/nodejs/node/commit/c6be79a34e)] - **async_hooks**: ensure proper handling in runInAsyncScope (Anatoli Papirovski) [#30965](https://github.com/nodejs/node/pull/30965)
* [[`a1555cb276`](https://github.com/nodejs/node/commit/a1555cb276)] - **benchmark**: add more util inspect and format benchmarks (Ruben Bridgewater) [#30767](https://github.com/nodejs/node/pull/30767)
* [[`4ee5665939`](https://github.com/nodejs/node/commit/4ee5665939)] - **benchmark**: use let instead of var in dgram (dnlup) [#31175](https://github.com/nodejs/node/pull/31175)
* [[`b48cfccffa`](https://github.com/nodejs/node/commit/b48cfccffa)] - **benchmark**: add benchmark on async\_hooks enabled http server (legendecas) [#31100](https://github.com/nodejs/node/pull/31100)
* [[`d30911e51b`](https://github.com/nodejs/node/commit/d30911e51b)] - **benchmark**: use let instead of var in crypto (dnlup) [#31135](https://github.com/nodejs/node/pull/31135)
* [[`dc8c955fe9`](https://github.com/nodejs/node/commit/dc8c955fe9)] - **benchmark**: replace var with let/const in cluster benchmark (dnlup) [#31042](https://github.com/nodejs/node/pull/31042)
* [[`d5c0e4d8b1`](https://github.com/nodejs/node/commit/d5c0e4d8b1)] - **benchmark**: include writev in benchmark (Robert Nagy) [#31066](https://github.com/nodejs/node/pull/31066)
* [[`15adbe8d66`](https://github.com/nodejs/node/commit/15adbe8d66)] - **benchmark**: use let instead of var in child\_process (dnlup) [#31043](https://github.com/nodejs/node/pull/31043)
* [[`8c3b8e02f0`](https://github.com/nodejs/node/commit/8c3b8e02f0)] - **benchmark**: add clear connections to secure-pair (Diego Lafuente) [#27971](https://github.com/nodejs/node/pull/27971)
* [[`13337985f7`](https://github.com/nodejs/node/commit/13337985f7)] - **benchmark**: update manywrites back pressure (Robert Nagy) [#30977](https://github.com/nodejs/node/pull/30977)
* [[`47b53676bd`](https://github.com/nodejs/node/commit/47b53676bd)] - **benchmark**: use let/const instead of var in buffers (dnlup) [#30945](https://github.com/nodejs/node/pull/30945)
* [[`ac5de4f4c8`](https://github.com/nodejs/node/commit/ac5de4f4c8)] - **benchmark**: improve `--filter` pattern matching (Matheus Marchini) [#29987](https://github.com/nodejs/node/pull/29987)
* [[`57f29b71b3`](https://github.com/nodejs/node/commit/57f29b71b3)] - **bootstrap**: use different scripts to setup different configurations (Joyee Cheung) [#30862](https://github.com/nodejs/node/pull/30862)
* [[`8252c06165`](https://github.com/nodejs/node/commit/8252c06165)] - **buffer**: release buffers with free callbacks on env exit (Anna Henningsen) [#30551](https://github.com/nodejs/node/pull/30551)
* [[`83f02c0af8`](https://github.com/nodejs/node/commit/83f02c0af8)] - **buffer**: improve .from() error details (Ruben Bridgewater) [#29675](https://github.com/nodejs/node/pull/29675)
* [[`67a2a47484`](https://github.com/nodejs/node/commit/67a2a47484)] - **build**: auto-load ICU data from --with-icu-default-data-dir (Stephen Gallagher) [#30825](https://github.com/nodejs/node/pull/30825)
* [[`e5e60f5599`](https://github.com/nodejs/node/commit/e5e60f5599)] - **build**: remove (almost) unused macros/constants (Benjamin Coe) [#30755](https://github.com/nodejs/node/pull/30755)
* [[`35ce8bbaef`](https://github.com/nodejs/node/commit/35ce8bbaef)] - **build**: do not build mksnapshot and mkcodecache for --shared (Joyee Cheung) [#30647](https://github.com/nodejs/node/pull/30647)
* [[`78c46c5b1a`](https://github.com/nodejs/node/commit/78c46c5b1a)] - **build**: add --without-node-code-cache configure option (Joyee Cheung) [#30647](https://github.com/nodejs/node/pull/30647)
* [[`8ab748e13a`](https://github.com/nodejs/node/commit/8ab748e13a)] - **build**: don't use -latomic on macOS (Ryan Schmidt) [#30099](https://github.com/nodejs/node/pull/30099)
* [[`4cd459c9bd`](https://github.com/nodejs/node/commit/4cd459c9bd)] - **build**: fixes build for some os versions (David Carlier)
* [[`1811b1a742`](https://github.com/nodejs/node/commit/1811b1a742)] - **build**: fix missing x64 arch suffix in binary tar name (legendecas) [#30877](https://github.com/nodejs/node/pull/30877)
* [[`add17b19f4`](https://github.com/nodejs/node/commit/add17b19f4)] - **build**: on Android, use android log library to print stack traces (Giovanni Campagna) [#29388](https://github.com/nodejs/node/pull/29388)
* [[`65e67cb671`](https://github.com/nodejs/node/commit/65e67cb671)] - **build**: fix library version and compile flags on Android (Giovanni Campagna) [#29388](https://github.com/nodejs/node/pull/29388)
* [[`50f6541e10`](https://github.com/nodejs/node/commit/50f6541e10)] - **build**: ease DragonFlyBSD build (David Carlier) [#30201](https://github.com/nodejs/node/pull/30201)
...
* [[`f76f143846`](https://github.com/nodejs/node/commit/f76f143846)] - **cluster**: remove unnecessary bind (Anatoli Papirovski) [#28131](https://github.com/nodejs/node/pull/28131)
* [[`17fc4b093f`](https://github.com/nodejs/node/commit/17fc4b093f)] - **console**: unregister temporary error listener (Robert Nagy) [#30852](https://github.com/nodejs/node/pull/30852)
* [[`e4b3181f2e`](https://github.com/nodejs/node/commit/e4b3181f2e)] - **crypto**: cast oaepLabel to unsigned char\* (Shelley Vohr) [#30917](https://github.com/nodejs/node/pull/30917)
* [[`2e06b854b8`](https://github.com/nodejs/node/commit/2e06b854b8)] - **crypto**: automatically manage memory for ECDSA\_SIG (Tobias Nießen) [#30641](https://github.com/nodejs/node/pull/30641)
...
* [[`02d72838db`](https://github.com/nodejs/node/commit/02d72838db)] - **deps**: V8: cherry-pick 0dfd9ea51241 (Benjamin Coe) [#30713](https://github.com/nodejs/node/pull/30713)
* [[`09e4182a21`](https://github.com/nodejs/node/commit/09e4182a21)] - **deps**: V8: cherry-pick d89f4ef1cd62 (Milad Farazmand) [#31354](https://github.com/nodejs/node/pull/31354)
* [[`678429640c`](https://github.com/nodejs/node/commit/678429640c)] - **deps**: uvwasi: cherry-pick 75b389c (Colin Ihrig) [#31076](https://github.com/nodejs/node/pull/31076)
* [[`a9d9fdbe5c`](https://github.com/nodejs/node/commit/a9d9fdbe5c)] - **deps**: uvwasi: cherry-pick 64e59d5 (Colin Ihrig) [#31076](https://github.com/nodejs/node/pull/31076)
* [[`5d545d064e`](https://github.com/nodejs/node/commit/5d545d064e)] - **deps**: update uvwasi (Anna Henningsen) [#30745](https://github.com/nodejs/node/pull/30745)
* [[`015671dca2`](https://github.com/nodejs/node/commit/015671dca2)] - **deps**: V8: cherry-pick b38dfaf3a633 (Matheus Marchini) [#30870](https://github.com/nodejs/node/pull/30870)
* [[`8c5e951eba`](https://github.com/nodejs/node/commit/8c5e951eba)] - **deps**: V8: cherry-pick cc5016e1b702 (Matheus Marchini) [#30870](https://github.com/nodejs/node/pull/30870)
...
* [[`d905d04df2`](https://github.com/nodejs/node/commit/d905d04df2)] - **deps**: V8: backport a4545db (David Carlier) [#31127](https://github.com/nodejs/node/pull/31127)
* [[`86d1998f02`](https://github.com/nodejs/node/commit/86d1998f02)] - **deps**: V8: cherry-pick d406bfd64653 (Sam Roberts) [#30819](https://github.com/nodejs/node/pull/30819)
* [[`ccf1178331`](https://github.com/nodejs/node/commit/ccf1178331)] - **deps**: V8: cherry-pick d3a1a5b6c491 (Michaël Zasso) [#31005](https://github.com/nodejs/node/pull/31005)
...
* [[`b27b420bc3`](https://github.com/nodejs/node/commit/b27b420bc3)] - **deps**: fix OPENSSLDIR on Windows (Shigeki Ohtsu) [#29456](https://github.com/nodejs/node/pull/29456)
...
* [[`8a16f80453`](https://github.com/nodejs/node/commit/8a16f80453)] - **(SEMVER-MINOR)** **deps**: update V8's postmortem script (Colin Ihrig) [#29694](https://github.com/nodejs/node/pull/29694)
...
* [[`f364b50774`](https://github.com/nodejs/node/commit/f364b50774)] - **(SEMVER-MINOR)** **deps**: V8: cherry-pick 716875d (Myles Borins) [#29694](https://github.com/nodejs/node/pull/29694)
* [[`43c5b91ffd`](https://github.com/nodejs/node/commit/43c5b91ffd)] - **deps**: V8: cherry-pick 35c6d4d (Sam Roberts) [#29585](https://github.com/nodejs/node/pull/29585)
* [[`23271dd50a`](https://github.com/nodejs/node/commit/23271dd50a)] - **deps**: V8: cherry-pick deac757 (Benjamin Coe) [#29626](https://github.com/nodejs/node/pull/29626)
* [[`35ce2f63c1`](https://github.com/nodejs/node/commit/35ce2f63c1)] - **(SEMVER-MINOR)** **deps**: V8: fix linking issue for MSVS (Refael Ackermann) [#28016](https://github.com/nodejs/node/pull/28016)
* [[`c0e829f766`](https://github.com/nodejs/node/commit/c0e829f766)] - **(SEMVER-MINOR)** **deps**: V8: fix BUILDING\_V8\_SHARED issues (Refael Ackermann) [#27375](https://github.com/nodejs/node/pull/27375)
* [[`02b54af39f`](https://github.com/nodejs/node/commit/02b54af39f)] - **(SEMVER-MINOR)** **deps**: V8: add workaround for MSVC optimizer bug (Refael Ackermann) [#28016](https://github.com/nodejs/node/pull/28016)
* [[`367620cc5b`](https://github.com/nodejs/node/commit/367620cc5b)] - **(SEMVER-MINOR)** **deps**: V8: use ATOMIC\_VAR\_INIT instead of std::atomic\_init (Refael Ackermann) [#27375](https://github.com/nodejs/node/pull/27375)
* [[`78b1b5ca91`](https://github.com/nodejs/node/commit/78b1b5ca91)] - **(SEMVER-MINOR)** **deps**: V8: forward declaration of `Rtl\*FunctionTable` (Refael Ackermann) [#27375](https://github.com/nodejs/node/pull/27375)
* [[`2efd0ec96b`](https://github.com/nodejs/node/commit/2efd0ec96b)] - **(SEMVER-MINOR)** **deps**: V8: patch register-arm64.h (Refael Ackermann) [#27375](https://github.com/nodejs/node/pull/27375)
* [[`85041b4c9b`](https://github.com/nodejs/node/commit/85041b4c9b)] - **(SEMVER-MINOR)** **deps**: V8: silence irrelevant warning (Michaël Zasso) [#26685](https://github.com/nodejs/node/pull/26685)
* [[`cdd763d931`](https://github.com/nodejs/node/commit/cdd763d931)] - **(SEMVER-MINOR)** **deps**: V8: un-cherry-pick bd019bd (Refael Ackermann) [#26685](https://github.com/nodejs/node/pull/26685)
* [[`b28a85d0b3`](https://github.com/nodejs/node/commit/b28a85d0b3)] - **(SEMVER-MINOR)** **deps**: V8: fix filename manipulation for Windows (Refael Ackermann) [#28016](https://github.com/nodejs/node/pull/28016)
...
* [[`5c6a6b8b27`](https://github.com/nodejs/node/commit/5c6a6b8b27)] - **(SEMVER-MINOR)** **doc**: make `AssertionError` a link (Ruben Bridgewater) [#28263](https://github.com/nodejs/node/pull/28263)
* [[`6d8a54129d`](https://github.com/nodejs/node/commit/6d8a54129d)] - **(SEMVER-MINOR)** **doc**: update assert.throws() examples (Ruben Bridgewater) [#28263](https://github.com/nodejs/node/pull/28263)
* [[`625ed708a6`](https://github.com/nodejs/node/commit/625ed708a6)] - **doc**: remove extra backtick (Colin Ihrig) [#31186](https://github.com/nodejs/node/pull/31186)
* [[`4bbf584ac8`](https://github.com/nodejs/node/commit/4bbf584ac8)] - **doc**: use code markup/markdown in headers (Ruben Bridgewater) [#31149](https://github.com/nodejs/node/pull/31149)
* [[`42ccf22fb7`](https://github.com/nodejs/node/commit/42ccf22fb7)] - **doc**: add note about fs.close() about undefined behavior (Robert Nagy) [#30966](https://github.com/nodejs/node/pull/30966)
* [[`b1358d3cc0`](https://github.com/nodejs/node/commit/b1358d3cc0)] - **doc**: add code example to inspector.url() method (Juan José Arboleda) [#29496](https://github.com/nodejs/node/pull/29496)
* [[`ec514a6a98`](https://github.com/nodejs/node/commit/ec514a6a98)] - **doc**: deprecate http finished (Robert Nagy) [#28679](https://github.com/nodejs/node/pull/28679)
* [[`f281946b12`](https://github.com/nodejs/node/commit/f281946b12)] - **doc**: update REPL documentation to instantiate the REPL (Ruben Bridgewater) [#30928](https://github.com/nodejs/node/pull/30928)
* [[`39dbc10134`](https://github.com/nodejs/node/commit/39dbc10134)] - **doc**: improve explanation of package.json "type" field (Ronald J Kimball) [#27516](https://github.com/nodejs/node/pull/27516)
* [[`7aa77594af`](https://github.com/nodejs/node/commit/7aa77594af)] - **doc**: clarify role of writable.cork() (Colin Grant) [#30442](https://github.com/nodejs/node/pull/30442)
* [[`25fb34c754`](https://github.com/nodejs/node/commit/25fb34c754)] - **doc**: de-duplicate security release processes (Sam Roberts) [#30996](https://github.com/nodejs/node/pull/30996)
* [[`91e7c14bb6`](https://github.com/nodejs/node/commit/91e7c14bb6)] - **doc**: fix createDiffieHellman generator type (Tobias Nießen) [#31121](https://github.com/nodejs/node/pull/31121)
* [[`cb75f566fd`](https://github.com/nodejs/node/commit/cb75f566fd)] - **doc**: update mode type for mkdir() functions (Colin Ihrig) [#31115](https://github.com/nodejs/node/pull/31115)
* [[`cd310e1184`](https://github.com/nodejs/node/commit/cd310e1184)] - **doc**: update mode type for process.umask() (Colin Ihrig) [#31115](https://github.com/nodejs/node/pull/31115)
* [[`5948ff4872`](https://github.com/nodejs/node/commit/5948ff4872)] - **doc**: update mode type for fs open() functions (Colin Ihrig) [#31115](https://github.com/nodejs/node/pull/31115)
* [[`a5f1434297`](https://github.com/nodejs/node/commit/a5f1434297)] - **doc**: update mode type for fchmod() functions (Colin Ihrig) [#31115](https://github.com/nodejs/node/pull/31115)
* [[`54cbbae66e`](https://github.com/nodejs/node/commit/54cbbae66e)] - **doc**: update parameter type for fsPromises.chmod() (Colin Ihrig) [#31115](https://github.com/nodejs/node/pull/31115)
* [[`6c9bc3cdfa`](https://github.com/nodejs/node/commit/6c9bc3cdfa)] - **doc**: improve dns introduction (Rich Trott) [#31090](https://github.com/nodejs/node/pull/31090)
* [[`671a5b71a3`](https://github.com/nodejs/node/commit/671a5b71a3)] - **doc**: update parameter type for fs.chmod() (Santosh Yadav) [#31085](https://github.com/nodejs/node/pull/31085)
* [[`5db6758a99`](https://github.com/nodejs/node/commit/5db6758a99)] - **doc**: add --inspect-publish-uid man page entry (Colin Ihrig) [#31077](https://github.com/nodejs/node/pull/31077)
* [[`b28b16bf56`](https://github.com/nodejs/node/commit/b28b16bf56)] - **doc**: add --force-context-aware man page entry (Colin Ihrig) [#31077](https://github.com/nodejs/node/pull/31077)
* [[`f08130ea2b`](https://github.com/nodejs/node/commit/f08130ea2b)] - **doc**: add --enable-source-maps man page entry (Colin Ihrig) [#31077](https://github.com/nodejs/node/pull/31077)
* [[`2aab93e4c8`](https://github.com/nodejs/node/commit/2aab93e4c8)] - **doc**: fix anchors and subtitle in BUILDING.md (sutangu) [#30296](https://github.com/nodejs/node/pull/30296)
* [[`5c522dd59a`](https://github.com/nodejs/node/commit/5c522dd59a)] - **doc**: standardize usage of hostname vs. host name (Rich Trott) [#31073](https://github.com/nodejs/node/pull/31073)
* [[`bbb5707699`](https://github.com/nodejs/node/commit/bbb5707699)] - **doc**: add unrepresented flags docs for configure (Pranshu Srivastava) [#28069](https://github.com/nodejs/node/pull/28069)
* [[`1f0a1d5bbb`](https://github.com/nodejs/node/commit/1f0a1d5bbb)] - **doc**: improve doc net:server.listen (dev-313) [#31064](https://github.com/nodejs/node/pull/31064)
* [[`2f7bd150f7`](https://github.com/nodejs/node/commit/2f7bd150f7)] - **doc**: implement minor improvements to BUILDING.md text (Rich Trott) [#31070](https://github.com/nodejs/node/pull/31070)
* [[`ea5be29d99`](https://github.com/nodejs/node/commit/ea5be29d99)] - **doc**: avoid using v8::Persistent in addon docs (Anna Henningsen) [#31018](https://github.com/nodejs/node/pull/31018)
* [[`7822eb1520`](https://github.com/nodejs/node/commit/7822eb1520)] - **doc**: reference worker threads on signal events (legendecas) [#30990](https://github.com/nodejs/node/pull/30990)
* [[`08186b25f7`](https://github.com/nodejs/node/commit/08186b25f7)] - **doc**: update message.url example in http.IncomingMessage (Tadao Iseki) [#30830](https://github.com/nodejs/node/pull/30830)
* [[`5537fae526`](https://github.com/nodejs/node/commit/5537fae526)] - **doc**: explain napi\_run\_script (Tobias Nießen) [#30918](https://github.com/nodejs/node/pull/30918)
* [[`9e5d39c56f`](https://github.com/nodejs/node/commit/9e5d39c56f)] - **doc**: add "Be direct." to the style guide (Rich Trott) [#30935](https://github.com/nodejs/node/pull/30935)
* [[`c554c0e430`](https://github.com/nodejs/node/commit/c554c0e430)] - **doc**: clarify expectations for PR commit messages (Derek Lewis) [#30922](https://github.com/nodejs/node/pull/30922)
* [[`5a8a7a4bb9`](https://github.com/nodejs/node/commit/5a8a7a4bb9)] - **doc**: fix description of N-API exception handlers (Tobias Nießen) [#30893](https://github.com/nodejs/node/pull/30893)
* [[`690deaa3bd`](https://github.com/nodejs/node/commit/690deaa3bd)] - **doc**: improve doc writable streams: 'finish' event (dev-313) [#30889](https://github.com/nodejs/node/pull/30889)
* [[`2f4615c9f3`](https://github.com/nodejs/node/commit/2f4615c9f3)] - **doc**: clarify build support text (Rich Trott) [#30899](https://github.com/nodejs/node/pull/30899)
* [[`169a3d5550`](https://github.com/nodejs/node/commit/169a3d5550)] - **doc**: edit colorMode information (Rich Trott) [#30887](https://github.com/nodejs/node/pull/30887)
* [[`16283b8840`](https://github.com/nodejs/node/commit/16283b8840)] - **doc**: fix argument type of setAAD (Tobias Nießen) [#30863](https://github.com/nodejs/node/pull/30863)
* [[`3ac40b933b`](https://github.com/nodejs/node/commit/3ac40b933b)] - **doc**: clarify Tier 2 implications in BUILDING.md (Rich Trott) [#30866](https://github.com/nodejs/node/pull/30866)
* [[`a8df2e28ac`](https://github.com/nodejs/node/commit/a8df2e28ac)] - **doc**: improve doc Http2Stream: FrameError, Timeout and Trailers (dev-313) [#30373](https://github.com/nodejs/node/pull/30373)
* [[`0f0388c680`](https://github.com/nodejs/node/commit/0f0388c680)] - **doc**: include line/cursor in readline documentation (Jeremy Albright) [#30667](https://github.com/nodejs/node/pull/30667)
* [[`07ba50a8cf`](https://github.com/nodejs/node/commit/07ba50a8cf)] - **doc**: improve napi formatting (Ruben Bridgewater) [#30772](https://github.com/nodejs/node/pull/30772)
* [[`4cb8476bb5`](https://github.com/nodejs/node/commit/4cb8476bb5)] - **doc**: add documentation about node\_mksnapshot and mkcodecache (Joyee Cheung) [#30773](https://github.com/nodejs/node/pull/30773)
* [[`ae65f8c3af`](https://github.com/nodejs/node/commit/ae65f8c3af)] - **doc**: remove imprecise and redundant testing text (Rich Trott) [#30763](https://github.com/nodejs/node/pull/30763)
* [[`4aac4242dd`](https://github.com/nodejs/node/commit/4aac4242dd)] - **doc**: remove usage of "Node" in favor of "Node.js" (Rich Trott) [#30758](https://github.com/nodejs/node/pull/30758)
* [[`4c1f85b395`](https://github.com/nodejs/node/commit/4c1f85b395)] - **doc**: revise addons introduction for brevity and clarity (Rich Trott) [#30756](https://github.com/nodejs/node/pull/30756)
* [[`1c452f0fcb`](https://github.com/nodejs/node/commit/1c452f0fcb)] - **doc**: fix up N-API doc (NickNaso) [#30656](https://github.com/nodejs/node/pull/30656)
* [[`ffad4369bc`](https://github.com/nodejs/node/commit/ffad4369bc)] - **doc**: adds assert doc for strict mode with pointer to strict equality (Shobhit Chittora) [#30486](https://github.com/nodejs/node/pull/30486)
* [[`bc23dfe0ce`](https://github.com/nodejs/node/commit/bc23dfe0ce)] - **doc**: Buffer.toString(): add note about invalid data (Jan-Philip Gehrcke) [#30706](https://github.com/nodejs/node/pull/30706)
* [[`d60da089d5`](https://github.com/nodejs/node/commit/d60da089d5)] - **doc**: clarify text about using 'session' event for compatibility (Rich Trott) [#30746](https://github.com/nodejs/node/pull/30746)
* [[`0a34cf569e`](https://github.com/nodejs/node/commit/0a34cf569e)] - **doc**: fix worker.resourceLimits indentation (Daniel Nalborczyk) [#30663](https://github.com/nodejs/node/pull/30663)
* [[`e1c559ea60`](https://github.com/nodejs/node/commit/e1c559ea60)] - **doc**: fix worker.resourceLimits type (Daniel Nalborczyk) [#30664](https://github.com/nodejs/node/pull/30664)
* [[`f8cd96ad0c`](https://github.com/nodejs/node/commit/f8cd96ad0c)] - **doc**: simplify "is recommended" language in assert documentation (Rich Trott) [#30558](https://github.com/nodejs/node/pull/30558)
* [[`3b4b0de25e`](https://github.com/nodejs/node/commit/3b4b0de25e)] - **doc**: update http.md mention of socket (Jesse O'Connor) [#30155](https://github.com/nodejs/node/pull/30155)
* [[`c6b6e3fcb4`](https://github.com/nodejs/node/commit/c6b6e3fcb4)] - **doc**: clarify required flag for extensionless esm (Lucas Azzola) [#30657](https://github.com/nodejs/node/pull/30657)
* [[`005cad393f`](https://github.com/nodejs/node/commit/005cad393f)] - **doc**: avoid proposal syntax in code example (Alex Zherdev) [#30685](https://github.com/nodejs/node/pull/30685)
* [[`b99eca950d`](https://github.com/nodejs/node/commit/b99eca950d)] - **doc**: esm: improve dual package hazard docs (Geoffrey Booth) [#30345](https://github.com/nodejs/node/pull/30345)
* [[`53b398451b`](https://github.com/nodejs/node/commit/53b398451b)] - **doc**: fix some recent doc nits (vsemozhetbyt) [#30341](https://github.com/nodejs/node/pull/30341)
* [[`6ac1b13192`](https://github.com/nodejs/node/commit/6ac1b13192)] - **doc**: update outdated commonjs compat info (Geoffrey Booth) [#30512](https://github.com/nodejs/node/pull/30512)
* [[`d043692d0b`](https://github.com/nodejs/node/commit/d043692d0b)] - **doc**: update divergent specifier hazard guidance (Geoffrey Booth) [#30051](https://github.com/nodejs/node/pull/30051)
* [[`5679b61585`](https://github.com/nodejs/node/commit/5679b61585)] - **doc**: include --experimental-resolve-self in manpage (Guy Bedford) [#29978](https://github.com/nodejs/node/pull/29978)
* [[`0d431352d2`](https://github.com/nodejs/node/commit/0d431352d2)] - **doc**: update vm.md for link linting (Rich Trott) [#29982](https://github.com/nodejs/node/pull/29982)
* [[`4e8b8bcb76`](https://github.com/nodejs/node/commit/4e8b8bcb76)] - **doc**: make YAML matter consistent in crypto.md (Rich Trott) [#30016](https://github.com/nodejs/node/pull/30016)
* [[`31d38643fe`](https://github.com/nodejs/node/commit/31d38643fe)] - **doc**: fix numbering in require algorithm (Jan Krems) [#30117](https://github.com/nodejs/node/pull/30117)
* [[`55dc0bc656`](https://github.com/nodejs/node/commit/55dc0bc656)] - **doc**: use code markup/markdown in headers in globals documentation (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`7602290b14`](https://github.com/nodejs/node/commit/7602290b14)] - **doc**: use code markup/markdown in headers in deprecations documentation (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`88cdc5155b`](https://github.com/nodejs/node/commit/88cdc5155b)] - **doc**: use code markup/markdown in headers in addons documentation (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`805fb8fce6`](https://github.com/nodejs/node/commit/805fb8fce6)] - **doc**: allow \<code\> in header elements (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`4087825b5f`](https://github.com/nodejs/node/commit/4087825b5f)] - **doc,assert**: use code markup/markdown in headers (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`be5450c8ad`](https://github.com/nodejs/node/commit/be5450c8ad)] - **doc,async_hooks**: use code markup/markdown in headers (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`d68807b3c6`](https://github.com/nodejs/node/commit/d68807b3c6)] - **doc,benchmark**: move benchmark guide to benchmark directory (Rich Trott) [#30781](https://github.com/nodejs/node/pull/30781)
* [[`c470e6e629`](https://github.com/nodejs/node/commit/c470e6e629)] - **doc,buffer**: use code markup/markdown in headers (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`d56fc6accd`](https://github.com/nodejs/node/commit/d56fc6accd)] - **doc,child_process**: use code markup/markdown in headers (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`4abe95550e`](https://github.com/nodejs/node/commit/4abe95550e)] - **doc,cluster**: use code markup/markdown in headers (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`b96c411fd8`](https://github.com/nodejs/node/commit/b96c411fd8)] - **doc,console**: use code markup/markdown in headers (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`886fa78794`](https://github.com/nodejs/node/commit/886fa78794)] - **doc,crypto**: use code markup/markdown in headers (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`1d8b45f89f`](https://github.com/nodejs/node/commit/1d8b45f89f)] - **doc,dgram**: use code markup/markdown in headers (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`6d712ac5b8`](https://github.com/nodejs/node/commit/6d712ac5b8)] - **doc,dns**: use code markup/markdown in headers (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`92dd882e37`](https://github.com/nodejs/node/commit/92dd882e37)] - **doc,domain**: use code markup/markdown in headers (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`bde2625824`](https://github.com/nodejs/node/commit/bde2625824)] - **doc,errors**: use code markup/markdown in headers (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`9cddfe231b`](https://github.com/nodejs/node/commit/9cddfe231b)] - **doc,esm**: use code markup/markdown in headers (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`078cea8ca8`](https://github.com/nodejs/node/commit/078cea8ca8)] - **doc,events**: use code markup/markdown in headers (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`f5e0e20b85`](https://github.com/nodejs/node/commit/f5e0e20b85)] - **doc,fs**: use code markup/markdown in headers (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`015cb26cc5`](https://github.com/nodejs/node/commit/015cb26cc5)] - **doc,http**: use code markup/markdown in headers (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`7d9cce6d75`](https://github.com/nodejs/node/commit/7d9cce6d75)] - **doc,http2**: use code markup/markdown in headers (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`6e45e32b9b`](https://github.com/nodejs/node/commit/6e45e32b9b)] - **doc,https**: use code markup/markdown in headers (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`30ee4ac89a`](https://github.com/nodejs/node/commit/30ee4ac89a)] - **doc,inspector**: use code markup/markdown in headers (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`8be52c448b`](https://github.com/nodejs/node/commit/8be52c448b)] - **doc,lib,src,test**: rename WASI CLI flag (Colin Ihrig) [#30980](https://github.com/nodejs/node/pull/30980)
* [[`7bfaf502a5`](https://github.com/nodejs/node/commit/7bfaf502a5)] - **doc,module**: use code markup/markdown in headers (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`3d9bf149ca`](https://github.com/nodejs/node/commit/3d9bf149ca)] - **doc,n-api**: mark napi\_detach\_arraybuffer as experimental (legendecas) [#30703](https://github.com/nodejs/node/pull/30703)
* [[`ca6d6f3e04`](https://github.com/nodejs/node/commit/ca6d6f3e04)] - **doc,net**: use code markup/markdown in headers (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`fcfcd1d0bf`](https://github.com/nodejs/node/commit/fcfcd1d0bf)] - **doc,os**: use code markup/markdown in headers (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`2fe0f907b2`](https://github.com/nodejs/node/commit/2fe0f907b2)] - **doc,path**: use code markup/markdown in headers (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`90d067c3f0`](https://github.com/nodejs/node/commit/90d067c3f0)] - **doc,perf_hooks**: use code markup/markdown in headers (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`38c6a3faab`](https://github.com/nodejs/node/commit/38c6a3faab)] - **doc,process**: use code markup/markdown in headers (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`7e71ddfcd7`](https://github.com/nodejs/node/commit/7e71ddfcd7)] - **doc,punycode**: use code markup/markdown in headers (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`cf38b43882`](https://github.com/nodejs/node/commit/cf38b43882)] - **doc,querystring**: use code markup/markdown in headers (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`f521a98939`](https://github.com/nodejs/node/commit/f521a98939)] - **doc,readline**: use code markup/markdown in headers (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`ce4545bfba`](https://github.com/nodejs/node/commit/ce4545bfba)] - **doc,repl**: use code markup/markdown in headers (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`920b8d59a2`](https://github.com/nodejs/node/commit/920b8d59a2)] - **doc,stream**: use code markup/markdown in headers (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`37e32431f1`](https://github.com/nodejs/node/commit/37e32431f1)] - **doc,string_decoder**: use code markup/markdown in headers (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`fa6ac14096`](https://github.com/nodejs/node/commit/fa6ac14096)] - **doc,timers**: use code markup/markdown in headers (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`86bcf6c25c`](https://github.com/nodejs/node/commit/86bcf6c25c)] - **doc,tls**: use code markup/markdown in headers (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`9ca825192f`](https://github.com/nodejs/node/commit/9ca825192f)] - **doc,tty**: use code markup/markdown in headers (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`c5853452ad`](https://github.com/nodejs/node/commit/c5853452ad)] - **doc,url**: use code markup/markdown in headers (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`32956444e0`](https://github.com/nodejs/node/commit/32956444e0)] - **doc,util**: use code markup/markdown in headers (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`7d2748a85d`](https://github.com/nodejs/node/commit/7d2748a85d)] - **doc,v8**: use code markup/markdown in headers (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`b6e892bca9`](https://github.com/nodejs/node/commit/b6e892bca9)] - **doc,vm**: use code markup/markdown in headers (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`ee9e8179ab`](https://github.com/nodejs/node/commit/ee9e8179ab)] - **doc,vm,test**: remove \_sandbox\_ from vm documentation (Rich Trott) [#31057](https://github.com/nodejs/node/pull/31057)
* [[`c51153cebb`](https://github.com/nodejs/node/commit/c51153cebb)] - **doc,wasi**: use code markup/markdown in headers (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`36b3e152da`](https://github.com/nodejs/node/commit/36b3e152da)] - **doc,worker**: use code markup/markdown in headers (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`9e43e06b20`](https://github.com/nodejs/node/commit/9e43e06b20)] - **doc,zlib**: use code markup/markdown in headers (Rich Trott) [#31086](https://github.com/nodejs/node/pull/31086)
* [[`1c17f4219d`](https://github.com/nodejs/node/commit/1c17f4219d)] - **errors**: improve ERR\_INVALID\_ARG\_TYPE (Ruben Bridgewater) [#29675](https://github.com/nodejs/node/pull/29675)
* [[`1a0cda1773`](https://github.com/nodejs/node/commit/1a0cda1773)] - **errors**: support prepareSourceMap with source-maps (Benjamin Coe) [#31143](https://github.com/nodejs/node/pull/31143)
* [[`c10ee5d5aa`](https://github.com/nodejs/node/commit/c10ee5d5aa)] - **esm**: better error message for unsupported URL (Thomas) [#31129](https://github.com/nodejs/node/pull/31129)
* [[`b95bb388f6`](https://github.com/nodejs/node/commit/b95bb388f6)] - **esm**: empty ext from pkg type/main doesnt affect format (Bradley Farias) [#31021](https://github.com/nodejs/node/pull/31021)
* [[`0a4cfef7d0`](https://github.com/nodejs/node/commit/0a4cfef7d0)] - **esm**: make specifier flag clearly experimental (Myles Borins) [#30678](https://github.com/nodejs/node/pull/30678)
* [[`924a9a8713`](https://github.com/nodejs/node/commit/924a9a8713)] - **esm**: data URLs should ignore unknown parameters (Bradley Farias) [#30593](https://github.com/nodejs/node/pull/30593)
* [[`549a58eb11`](https://github.com/nodejs/node/commit/549a58eb11)] - **esm**: disable non-js exts outside package scopes (Guy Bedford) [#30501](https://github.com/nodejs/node/pull/30501)
* [[`bd82adb884`](https://github.com/nodejs/node/commit/bd82adb884)] - **esm**: exit the process with an error if loader has an issue (Michaël Zasso) [#30219](https://github.com/nodejs/node/pull/30219)
...
* [[`7ef1386d8e`](https://github.com/nodejs/node/commit/7ef1386d8e)] - **fixup**: update changelog (Myles Borins)
* [[`c3daa3e3f5`](https://github.com/nodejs/node/commit/c3daa3e3f5)] - **fs**: synchronize close with other I/O for streams (Anna Henningsen) [#30837](https://github.com/nodejs/node/pull/30837)
* [[`fb2253e866`](https://github.com/nodejs/node/commit/fb2253e866)] - **fs**: retry unlink operations in rimraf (Colin Ihrig) [#30569](https://github.com/nodejs/node/pull/30569)
* [[`76affb66fd`](https://github.com/nodejs/node/commit/76affb66fd)] - **fs**: only operate on buffers in rimraf (Colin Ihrig) [#30569](https://github.com/nodejs/node/pull/30569)
* [[`17a48f11eb`](https://github.com/nodejs/node/commit/17a48f11eb)] - **fs**: use consistent defaults in sync stat functions (Colin Ihrig) [#31097](https://github.com/nodejs/node/pull/31097)
* [[`91845d8251`](https://github.com/nodejs/node/commit/91845d8251)] - **fs**: remove unnecessary bind (Anatoli Papirovski) [#28131](https://github.com/nodejs/node/pull/28131)
* [[`50afd34237`](https://github.com/nodejs/node/commit/50afd34237)] - **fs**: reduce unnecessary sync rimraf retries (Colin Ihrig) [#30785](https://github.com/nodejs/node/pull/30785)
* [[`4e05bf0cc3`](https://github.com/nodejs/node/commit/4e05bf0cc3)] - **fs**: add synchronous retries to rimraf (Colin Ihrig) [#30785](https://github.com/nodejs/node/pull/30785)
* [[`e3a0c61726`](https://github.com/nodejs/node/commit/e3a0c61726)] - **fs**: fix existsSync for invalid symlink at win32 (Rongjian Zhang) [#30556](https://github.com/nodejs/node/pull/30556)
* [[`0b88bbdeaa`](https://github.com/nodejs/node/commit/0b88bbdeaa)] - **fs**: add ENFILE to rimraf retry logic (Colin Ihrig) [#30644](https://github.com/nodejs/node/pull/30644)
* [[`79e92fb1c1`](https://github.com/nodejs/node/commit/79e92fb1c1)] - **fs**: add retryDelay option to rimraf (Colin Ihrig) [#30644](https://github.com/nodejs/node/pull/30644)
* [[`0a33f17c47`](https://github.com/nodejs/node/commit/0a33f17c47)] - **fs**: remove rimraf's emfileWait option (Colin Ihrig) [#30644](https://github.com/nodejs/node/pull/30644)
* [[`022ecbdc87`](https://github.com/nodejs/node/commit/022ecbdc87)] - **fs**: make rimraf default to 0 retries (Colin Ihrig) [#30644](https://github.com/nodejs/node/pull/30644)
* [[`dfb86f98bc`](https://github.com/nodejs/node/commit/dfb86f98bc)] - **fs**: rename rimraf's maxBusyTries to maxRetries (Colin Ihrig) [#30644](https://github.com/nodejs/node/pull/30644)
...
* [[`725daeb185`](https://github.com/nodejs/node/commit/725daeb185)] - **http**: http\_outgoing rename var to let and const (telenord) [#30284](https://github.com/nodejs/node/pull/30284)
* [[`b840eb77c0`](https://github.com/nodejs/node/commit/b840eb77c0)] - **http**: free listeners on free sockets (Robert Nagy) [#29259](https://github.com/nodejs/node/pull/29259)
* [[`49a9b31615`](https://github.com/nodejs/node/commit/49a9b31615)] - **http**: use for...of in http library code (Trivikram Kamat) [#30958](https://github.com/nodejs/node/pull/30958)
...
* [[`baece55686`](https://github.com/nodejs/node/commit/baece55686)] - **http**: remove unnecessary bind (Anatoli Papirovski) [#28131](https://github.com/nodejs/node/pull/28131)
* [[`f24f352213`](https://github.com/nodejs/node/commit/f24f352213)] - **http**: improve performance caused by primordials (Lucas Recknagel) [#30416](https://github.com/nodejs/node/pull/30416)
...
* [[`54635f5837`](https://github.com/nodejs/node/commit/54635f5837)] - **http**: fix monkey-patching of http\_parser (Jimb Esser) [#30222](https://github.com/nodejs/node/pull/30222)
* [[`f63e440109`](https://github.com/nodejs/node/commit/f63e440109)] - **http2**: make HTTP2ServerResponse more streams compliant (Robert Nagy)
* [[`20a817557e`](https://github.com/nodejs/node/commit/20a817557e)] - **http2**: set default enableConnectProtocol to 0 (Yongsheng Zhang) [#31174](https://github.com/nodejs/node/pull/31174)
...
* [[`dce435db29`](https://github.com/nodejs/node/commit/dce435db29)] - **http2**: remove unnecessary bind from setImmediate (Anatoli Papirovski) [#28131](https://github.com/nodejs/node/pull/28131)
* [[`8d8c05de19`](https://github.com/nodejs/node/commit/8d8c05de19)] - **http2**: forward debug message in debugStreamObj (Denys Otrishko) [#30840](https://github.com/nodejs/node/pull/30840)
* [[`bb77e6e503`](https://github.com/nodejs/node/commit/bb77e6e503)] - **http2**: track nghttp2-allocated memory in heap snapshot (Anna Henningsen) [#30745](https://github.com/nodejs/node/pull/30745)
* [[`284f033034`](https://github.com/nodejs/node/commit/284f033034)] - **http2**: use shared memory tracking implementation (Anna Henningsen) [#30745](https://github.com/nodejs/node/pull/30745)
* [[`f589f4d616`](https://github.com/nodejs/node/commit/f589f4d616)] - **http2**: streamline OnStreamRead streamline memory accounting (Denys Otrishko) [#30351](https://github.com/nodejs/node/pull/30351)
...
* [[`69eaff150e`](https://github.com/nodejs/node/commit/69eaff150e)] - **lib**: move initialization of APIs for changing process state (Anna Henningsen) [#31172](https://github.com/nodejs/node/pull/31172)
* [[`4a1cb3deda`](https://github.com/nodejs/node/commit/4a1cb3deda)] - **lib**: do not catch user errors (Ruben Bridgewater) [#31159](https://github.com/nodejs/node/pull/31159)
* [[`4a7e8606f0`](https://github.com/nodejs/node/commit/4a7e8606f0)] - **lib**: replace var with let/const (kresimirfranin) [#30394](https://github.com/nodejs/node/pull/30394)
* [[`5dd9fb2ef5`](https://github.com/nodejs/node/commit/5dd9fb2ef5)] - **lib**: further simplify assertions in vm/module (Anna Henningsen) [#30815](https://github.com/nodejs/node/pull/30815)
* [[`4198d9ad9a`](https://github.com/nodejs/node/commit/4198d9ad9a)] - **lib**: improve spelling and grammar in comment (David Newman) [#31026](https://github.com/nodejs/node/pull/31026)
* [[`0266d7f7c7`](https://github.com/nodejs/node/commit/0266d7f7c7)] - **lib**: change var to let/const (rene.herrmann) [#30910](https://github.com/nodejs/node/pull/30910)
* [[`1c6e2ec744`](https://github.com/nodejs/node/commit/1c6e2ec744)] - **lib**: refactor NativeModule (Joyee Cheung) [#30856](https://github.com/nodejs/node/pull/30856)
* [[`01ea5badbf`](https://github.com/nodejs/node/commit/01ea5badbf)] - **lib**: replace var with let/const (jens-cappelle) [#30384](https://github.com/nodejs/node/pull/30384)
* [[`248921b58c`](https://github.com/nodejs/node/commit/248921b58c)] - **lib**: delay access to CLI option to pre-execution (Joyee Cheung) [#30778](https://github.com/nodejs/node/pull/30778)
* [[`0dd8605425`](https://github.com/nodejs/node/commit/0dd8605425)] - **lib**: replace Map global by the primordials (Sebastien Ahkrin) [#31155](https://github.com/nodejs/node/pull/31155)
* [[`02ed713314`](https://github.com/nodejs/node/commit/02ed713314)] - **lib**: replace use of Error with primordials (Sebastien Ahkrin) [#31163](https://github.com/nodejs/node/pull/31163)
* [[`e5b7d64f2d`](https://github.com/nodejs/node/commit/e5b7d64f2d)] - **lib**: replace Set global by the primordials (Sebastien Ahkrin) [#31154](https://github.com/nodejs/node/pull/31154)
* [[`869cd531e9`](https://github.com/nodejs/node/commit/869cd531e9)] - **lib**: replace WeakSet global by the primordials (Sebastien Ahkrin) [#31157](https://github.com/nodejs/node/pull/31157)
* [[`90196b89dd`](https://github.com/nodejs/node/commit/90196b89dd)] - **lib**: replace WeakMap global by the primordials (Sebastien Ahkrin) [#31158](https://github.com/nodejs/node/pull/31158)
* [[`b1550a63b8`](https://github.com/nodejs/node/commit/b1550a63b8)] - **lib**: replace Set.prototype with SetPrototype primordial (Sebastien Ahkrin) [#31161](https://github.com/nodejs/node/pull/31161)
* [[`f33147bf4d`](https://github.com/nodejs/node/commit/f33147bf4d)] - **lib**: replace Symbol.species by SymbolSpecies (Sebastien Ahkrin) [#30950](https://github.com/nodejs/node/pull/30950)
* [[`581e83755a`](https://github.com/nodejs/node/commit/581e83755a)] - **lib**: replace Symbol.hasInstance by SymbolHasInstance (Sebastien Ahkrin) [#30948](https://github.com/nodejs/node/pull/30948)
* [[`5cfcf6f9d6`](https://github.com/nodejs/node/commit/5cfcf6f9d6)] - **lib**: replace Symbol.asyncIterator by SymbolAsyncIterator (Sebastien Ahkrin) [#30947](https://github.com/nodejs/node/pull/30947)
* [[`31227e6ecd`](https://github.com/nodejs/node/commit/31227e6ecd)] - **lib**: enforce use of Promise from primordials (Michaël Zasso) [#30936](https://github.com/nodejs/node/pull/30936)
* [[`b00fcafc9d`](https://github.com/nodejs/node/commit/b00fcafc9d)] - **lib**: add TypedArray constructors to primordials (Sebastien Ahkrin) [#30740](https://github.com/nodejs/node/pull/30740)
* [[`7c3ac42ddb`](https://github.com/nodejs/node/commit/7c3ac42ddb)] - **lib**: replace Symbol.toPrimitive to SymbolToPrimitive primordials (Sebastien Ahkrin) [#30905](https://github.com/nodejs/node/pull/30905)
* [[`d1702f5866`](https://github.com/nodejs/node/commit/d1702f5866)] - **lib**: update Symbol.toStringTag by SymbolToStringTag primordial (Sebastien Ahkrin) [#30908](https://github.com/nodejs/node/pull/30908)
* [[`d4ea392a62`](https://github.com/nodejs/node/commit/d4ea392a62)] - **lib**: enforce use of BigInt from primordials (Michaël Zasso) [#30882](https://github.com/nodejs/node/pull/30882)
* [[`22df5dc956`](https://github.com/nodejs/node/commit/22df5dc956)] - **lib**: replace Symbol.iterator by SymbolIterator (Sebastien Ahkrin) [#30859](https://github.com/nodejs/node/pull/30859)
* [[`54aa3b92df`](https://github.com/nodejs/node/commit/54aa3b92df)] - **lib**: replace every Symbol.for by SymbolFor primordials (Sebastien Ahkrin) [#30857](https://github.com/nodejs/node/pull/30857)
* [[`c6535c0f1d`](https://github.com/nodejs/node/commit/c6535c0f1d)] - **lib**: replace Symbol global by the primordials Symbol (Sebastien Ahkrin) [#30737](https://github.com/nodejs/node/pull/30737)
* [[`d4d61721d3`](https://github.com/nodejs/node/commit/d4d61721d3)] - **lib**: enforce use of primordial Number (Sebastien Ahkrin) [#30700](https://github.com/nodejs/node/pull/30700)
* [[`5de272cceb`](https://github.com/nodejs/node/commit/5de272cceb)] - **lib**: use static Number properties from primordials (Michaël Zasso) [#30686](https://github.com/nodejs/node/pull/30686)
* [[`2e81795ab7`](https://github.com/nodejs/node/commit/2e81795ab7)] - **lib**: enforce use of Boolean from primordials (Michaël Zasso) [#30698](https://github.com/nodejs/node/pull/30698)
* [[`61bb7b918c`](https://github.com/nodejs/node/commit/61bb7b918c)] - **lib**: replace Date.now function by primordial DateNow (Tchoupinax) [#30689](https://github.com/nodejs/node/pull/30689)
* [[`67de74424f`](https://github.com/nodejs/node/commit/67de74424f)] - **lib**: replace ArrayBuffer.isView by primordial ArrayBuffer (Vincent Dhennin) [#30692](https://github.com/nodejs/node/pull/30692)
* [[`79dd591223`](https://github.com/nodejs/node/commit/79dd591223)] - **lib**: enforce use of Array from primordials (Michaël Zasso) [#30635](https://github.com/nodejs/node/pull/30635)
* [[`ac7bebad27`](https://github.com/nodejs/node/commit/ac7bebad27)] - **lib**: flatten access to primordials (Michaël Zasso) [#30610](https://github.com/nodejs/node/pull/30610)
* [[`9b730ad28a`](https://github.com/nodejs/node/commit/9b730ad28a)] - **lib**: use strict equality comparison (Donggeon Lim) [#30898](https://github.com/nodejs/node/pull/30898)
* [[`15d48f9fa7`](https://github.com/nodejs/node/commit/15d48f9fa7)] - **lib**: add parent to ERR\_UNKNOWN\_FILE\_EXTENSION (qualitymanifest) [#30728](https://github.com/nodejs/node/pull/30728)
* [[`b743f2c343`](https://github.com/nodejs/node/commit/b743f2c343)] - **(SEMVER-MINOR)** **lib**: no need to strip BOM or shebang for scripts (Refael Ackermann) [#27375](https://github.com/nodejs/node/pull/27375)
* [[`6c34ad6c66`](https://github.com/nodejs/node/commit/6c34ad6c66)] - **(SEMVER-MINOR)** **lib**: rework logic of stripping BOM+Shebang from commonjs (Gus Caplan) [#27768](https://github.com/nodejs/node/pull/27768)
...
* [[`db5ec52ea0`](https://github.com/nodejs/node/commit/db5ec52ea0)] - **module**: fix check exports issue in cjs module loading (Guy Bedford) [#31427](https://github.com/nodejs/node/pull/31427)
* [[`616a4ee93a`](https://github.com/nodejs/node/commit/616a4ee93a)] - **(SEMVER-MINOR)** **module**: unflag conditional exports (Guy Bedford) [#31001](https://github.com/nodejs/node/pull/31001)
...
* [[`2a2ae8ec94`](https://github.com/nodejs/node/commit/2a2ae8ec94)] - **module**: fixup lint and test regressions (Guy Bedford) [#30802](https://github.com/nodejs/node/pull/30802)
* [[`9696e9edad`](https://github.com/nodejs/node/commit/9696e9edad)] - **module**: fix specifier resolution algorithm (Rongjian Zhang) [#30574](https://github.com/nodejs/node/pull/30574)
* [[`3d0e33eb94`](https://github.com/nodejs/node/commit/3d0e33eb94)] - **module**: unflag resolve self (Guy Bedford) [#31002](https://github.com/nodejs/node/pull/31002)
* [[`801ea120b6`](https://github.com/nodejs/node/commit/801ea120b6)] - **module**: self resolve bug fix and esm ordering (Guy Bedford) [#31009](https://github.com/nodejs/node/pull/31009)
* [[`5b4db8e570`](https://github.com/nodejs/node/commit/5b4db8e570)] - **module**: conditional exports import condition (Guy Bedford) [#30799](https://github.com/nodejs/node/pull/30799)
* [[`69ec9bea62`](https://github.com/nodejs/node/commit/69ec9bea62)] - **module**: ignore resolution failures for inspect-brk (Maël Nison) [#30336](https://github.com/nodejs/node/pull/30336)
* [[`f0850a310a`](https://github.com/nodejs/node/commit/f0850a310a)] - **module**: add warnings for experimental flags (Rongjian Zhang) [#30617](https://github.com/nodejs/node/pull/30617)
* [[`7e1f0500e2`](https://github.com/nodejs/node/commit/7e1f0500e2)] - **module**: conditional exports with flagged conditions (Guy Bedford) [#29978](https://github.com/nodejs/node/pull/29978)
* [[`c7adb00b93`](https://github.com/nodejs/node/commit/c7adb00b93)] - **module**: refactor modules bootstrap (Bradley Farias) [#29937](https://github.com/nodejs/node/pull/29937)
...
* [[`ea3d4e8b6e`](https://github.com/nodejs/node/commit/ea3d4e8b6e)] - **(SEMVER-MINOR)** **n-api**: implement napi\_is\_detached\_arraybuffer (Denys Otrishko) [#30613](https://github.com/nodejs/node/pull/30613)
* [[`b69f2ddea3`](https://github.com/nodejs/node/commit/b69f2ddea3)] - **n-api**: keep napi\_env alive while it has finalizers (Anna Henningsen) [#31140](https://github.com/nodejs/node/pull/31140)
...
* [[`0638b78ef1`](https://github.com/nodejs/node/commit/0638b78ef1)] - **net**: remove duplicate \_undestroy (Robert Nagy) [#30833](https://github.com/nodejs/node/pull/30833)
...
* [[`59e2975413`](https://github.com/nodejs/node/commit/59e2975413)] - **perf_hooks**: use for...of (Trivikram Kamat) [#31049](https://github.com/nodejs/node/pull/31049)
...
* [[`01bb87650b`](https://github.com/nodejs/node/commit/01bb87650b)] - **perf_hooks**: remove unnecessary bind (Anatoli Papirovski) [#28131](https://github.com/nodejs/node/pull/28131)
* [[`732780fa03`](https://github.com/nodejs/node/commit/732780fa03)] - **process**: refs --unhandled-rejections documentation in warning message (Antoine du HAMEL) [#30564](https://github.com/nodejs/node/pull/30564)
* [[`9ce788e357`](https://github.com/nodejs/node/commit/9ce788e357)] - **process**: fix promise catching (Rongjian Zhang) [#30957](https://github.com/nodejs/node/pull/30957)
...
* [[`12a1191727`](https://github.com/nodejs/node/commit/12a1191727)] - **readline**: eagerly load string\_decoder (Ruben Bridgewater) [#30807](https://github.com/nodejs/node/pull/30807)
* [[`d4b41f6de4`](https://github.com/nodejs/node/commit/d4b41f6de4)] - **repl**: use better uncaught exceptions indicator (Ruben Bridgewater) [#29676](https://github.com/nodejs/node/pull/29676)
* [[`521458a6c2`](https://github.com/nodejs/node/commit/521458a6c2)] - **repl**: fix autocomplete when useGlobal is false (Michaël Zasso) [#30883](https://github.com/nodejs/node/pull/30883)
* [[`d7972b7b63`](https://github.com/nodejs/node/commit/d7972b7b63)] - **repl**: fix referrer for dynamic import (Corey Farrell) [#30609](https://github.com/nodejs/node/pull/30609)
...
* [[`6f5ced67a8`](https://github.com/nodejs/node/commit/6f5ced67a8)] - **src**: accept single argument in getProxyDetails (Ruben Bridgewater) [#30858](https://github.com/nodejs/node/pull/30858)
* [[`4c1d172c6f`](https://github.com/nodejs/node/commit/4c1d172c6f)] - **src**: mark ArrayBuffers with free callbacks as untransferable (Anna Henningsen) [#30475](https://github.com/nodejs/node/pull/30475)
* [[`cc3e427334`](https://github.com/nodejs/node/commit/cc3e427334)] - **src**: prevent hard coding stack trace limit (legendecas) [#30752](https://github.com/nodejs/node/pull/30752)
* [[`ace3e70ef1`](https://github.com/nodejs/node/commit/ace3e70ef1)] - **src**: unregister Isolate with platform before disposing (Anna Henningsen) [#30909](https://github.com/nodejs/node/pull/30909)
* [[`1148724bf5`](https://github.com/nodejs/node/commit/1148724bf5)] - **src**: free preopen memory in WASI::New() (Colin Ihrig) [#30809](https://github.com/nodejs/node/pull/30809)
* [[`808a4566e8`](https://github.com/nodejs/node/commit/808a4566e8)] - **src**: use checked allocations in WASI::New() (Colin Ihrig) [#30809](https://github.com/nodejs/node/pull/30809)
* [[`6bc2ce2bc2`](https://github.com/nodejs/node/commit/6bc2ce2bc2)] - ***Revert*** "**src**: update v8abbr.h for V8 7.7" (Matheus Marchini) [#30870](https://github.com/nodejs/node/pull/30870)
* [[`7858d65cfe`](https://github.com/nodejs/node/commit/7858d65cfe)] - **src**: suppress warning in src/node\_env\_var.cc (Harshitha KP) [#31136](https://github.com/nodejs/node/pull/31136)
* [[`cb350975ac`](https://github.com/nodejs/node/commit/cb350975ac)] - **src**: enable stack trace printing for V8 check failures (Anna Henningsen) [#31079](https://github.com/nodejs/node/pull/31079)
* [[`82fbedcb27`](https://github.com/nodejs/node/commit/82fbedcb27)] - **src**: port --bash-completion to C++ (Joyee Cheung) [#25901](https://github.com/nodejs/node/pull/25901)
* [[`3c63af27c2`](https://github.com/nodejs/node/commit/3c63af27c2)] - **src**: list used functions on headers (Juan José Arboleda) [#30827](https://github.com/nodejs/node/pull/30827)
* [[`d04891f4f2`](https://github.com/nodejs/node/commit/d04891f4f2)] - **src**: fix compiler warning in env.cc (Anna Henningsen) [#31020](https://github.com/nodejs/node/pull/31020)
* [[`6f61407a24`](https://github.com/nodejs/node/commit/6f61407a24)] - **src**: make debug\_options getters public (Shelley Vohr) [#30494](https://github.com/nodejs/node/pull/30494)
* [[`1743738417`](https://github.com/nodejs/node/commit/1743738417)] - **src**: fix the false isatty() issue on IBMi (Xu Meng) [#30829](https://github.com/nodejs/node/pull/30829)
* [[`2ae27278a6`](https://github.com/nodejs/node/commit/2ae27278a6)] - **src**: improve checked uv loop close output (Anna Henningsen) [#30814](https://github.com/nodejs/node/pull/30814)
* [[`b1c226456b`](https://github.com/nodejs/node/commit/b1c226456b)] - **src**: port memory-tracking allocator from QUIC repo (Anna Henningsen) [#30745](https://github.com/nodejs/node/pull/30745)
* [[`a5a09ac538`](https://github.com/nodejs/node/commit/a5a09ac538)] - **src**: don't use deprecated OpenSSL APIs (Rosen Penev) [#30812](https://github.com/nodejs/node/pull/30812)
* [[`85067c1201`](https://github.com/nodejs/node/commit/85067c1201)] - **src**: delete redundant method in node\_dir.h (gengjiawen) [#30747](https://github.com/nodejs/node/pull/30747)
* [[`9b608e307e`](https://github.com/nodejs/node/commit/9b608e307e)] - **src**: remove redundant cast in node\_dir.cc (gengjiawen) [#30747](https://github.com/nodejs/node/pull/30747)
* [[`08ac9b6875`](https://github.com/nodejs/node/commit/08ac9b6875)] - **src**: improve node\_crypto.cc memory allocation (Priyanka Kore) [#30751](https://github.com/nodejs/node/pull/30751)
* [[`cf19ec0c23`](https://github.com/nodejs/node/commit/cf19ec0c23)] - **src**: fix node\_dir.cc memory allocation (Priyanka Kore) [#30750](https://github.com/nodejs/node/pull/30750)
* [[`3f1ca18071`](https://github.com/nodejs/node/commit/3f1ca18071)] - **src**: change header file in node\_stat\_watcher.cc (Reza Fatahi) [#29976](https://github.com/nodejs/node/pull/29976)
* [[`6e33991c7e`](https://github.com/nodejs/node/commit/6e33991c7e)] - **src**: clean up node\_file.h (Anna Henningsen) [#30530](https://github.com/nodejs/node/pull/30530)
* [[`c8e30c1d38`](https://github.com/nodejs/node/commit/c8e30c1d38)] - **src**: fix -Wsign-compare warnings (Colin Ihrig) [#30565](https://github.com/nodejs/node/pull/30565)
* [[`ef9dd607ab`](https://github.com/nodejs/node/commit/ef9dd607ab)] - **src**: use uv\_async\_t for WeakRefs (Anna Henningsen) [#30616](https://github.com/nodejs/node/pull/30616)
...
* [[`69dac4b9b9`](https://github.com/nodejs/node/commit/69dac4b9b9)] - **src**: do not use `std::function` for `OnScopeLeave` (Anna Henningsen) [#30134](https://github.com/nodejs/node/pull/30134)
* [[`f080239586`](https://github.com/nodejs/node/commit/f080239586)] - **src**: remove AsyncScope and AsyncCallbackScope (Anna Henningsen) [#30236](https://github.com/nodejs/node/pull/30236)
* [[`f70d5187fd`](https://github.com/nodejs/node/commit/f70d5187fd)] - **src**: use callback scope for main script (Anna Henningsen) [#30236](https://github.com/nodejs/node/pull/30236)
* [[`32e5c3937f`](https://github.com/nodejs/node/commit/32e5c3937f)] - **src**: fix crash with SyntheticModule#setExport (Michaël Zasso) [#30062](https://github.com/nodejs/node/pull/30062)
* [[`17e0bf4510`](https://github.com/nodejs/node/commit/17e0bf4510)] - **src**: implement v8 host weakref hooks (Gus Caplan) [#29874](https://github.com/nodejs/node/pull/29874)
* [[`5e232f5de9`](https://github.com/nodejs/node/commit/5e232f5de9)] - **src**: make large\_pages node.cc include conditional (Denys Otrishko) [#31078](https://github.com/nodejs/node/pull/31078)
* [[`fcbd2d245a`](https://github.com/nodejs/node/commit/fcbd2d245a)] - **src**: make --use-largepages a runtime option (Gabriel Schulhof) [#30954](https://github.com/nodejs/node/pull/30954)
* [[`56225439c4`](https://github.com/nodejs/node/commit/56225439c4)] - **src,test**: use v8::Global instead of v8::Persistent (Anna Henningsen) [#31018](https://github.com/nodejs/node/pull/31018)
* [[`5edfd50584`](https://github.com/nodejs/node/commit/5edfd50584)] - **stream**: group all properties using defineProperties (antsmartian) [#31144](https://github.com/nodejs/node/pull/31144)
* [[`a83c976a2b`](https://github.com/nodejs/node/commit/a83c976a2b)] - **stream**: reset flowing state if no 'readable' or 'data' listeners (Robert Nagy) [#31036](https://github.com/nodejs/node/pull/31036)
* [[`a0f5207389`](https://github.com/nodejs/node/commit/a0f5207389)] - **stream**: simplify isBuf (Robert Nagy) [#31067](https://github.com/nodejs/node/pull/31067)
* [[`f6acf9a7b5`](https://github.com/nodejs/node/commit/f6acf9a7b5)] - **stream**: use for...of (Trivikram Kamat) [#30960](https://github.com/nodejs/node/pull/30960)
* [[`8cd8cd7413`](https://github.com/nodejs/node/commit/8cd8cd7413)] - **stream**: do not chunk strings and Buffer in Readable.from (Matteo Collina) [#30912](https://github.com/nodejs/node/pull/30912)
...
* [[`536d088850`](https://github.com/nodejs/node/commit/536d088850)] - **stream**: use more accurate end-of-stream writable and readable detection (Stewart X Addison) [#29409](https://github.com/nodejs/node/pull/29409)
...
* [[`18cd0028d8`](https://github.com/nodejs/node/commit/18cd0028d8)] - **test**: change buffer offset to accommodate V8 BackingStore (Thang Tran) [#31171](https://github.com/nodejs/node/pull/31171)
* [[`1d45ba3342`](https://github.com/nodejs/node/commit/1d45ba3342)] - **test**: get lib/wasi.js coverage to 100% (Colin Ihrig) [#31039](https://github.com/nodejs/node/pull/31039)
* [[`b6c815c18c`](https://github.com/nodejs/node/commit/b6c815c18c)] - **test**: cover vm with negative tests (Andrew Kuzmenko) [#31028](https://github.com/nodejs/node/pull/31028)
* [[`e4e086a058`](https://github.com/nodejs/node/commit/e4e086a058)] - **test**: remove obsolete WASI test (Colin Ihrig) [#30980](https://github.com/nodejs/node/pull/30980)
* [[`d676c6c5a9`](https://github.com/nodejs/node/commit/d676c6c5a9)] - **test**: simplify test-wasi-start-validation.js (Colin Ihrig) [#30972](https://github.com/nodejs/node/pull/30972)
* [[`299d518b48`](https://github.com/nodejs/node/commit/299d518b48)] - **test**: improve WASI start() coverage (Colin Ihrig) [#30972](https://github.com/nodejs/node/pull/30972)
* [[`12e9bad4c6`](https://github.com/nodejs/node/commit/12e9bad4c6)] - **test**: add missing test flags (Colin Ihrig) [#30971](https://github.com/nodejs/node/pull/30971)
* [[`713932522c`](https://github.com/nodejs/node/commit/713932522c)] - **test**: add test for validation for wasi.start() argument (Rich Trott) [#30919](https://github.com/nodejs/node/pull/30919)
* [[`5b78bf2025`](https://github.com/nodejs/node/commit/5b78bf2025)] - **test**: work around ENOTEMPTY when cleaning tmp dir (Ben Noordhuis) [#30849](https://github.com/nodejs/node/pull/30849)
* [[`bf9a824c0a`](https://github.com/nodejs/node/commit/bf9a824c0a)] - **test**: wait for stream close before writing to file (Anna Henningsen) [#30836](https://github.com/nodejs/node/pull/30836)
* [[`b6688efb9c`](https://github.com/nodejs/node/commit/b6688efb9c)] - **test**: use fs rimraf to refresh tmpdir (Colin Ihrig) [#30569](https://github.com/nodejs/node/pull/30569)
* [[`bb8b11f54a`](https://github.com/nodejs/node/commit/bb8b11f54a)] - **test**: improve WASI options validation (Rich Trott) [#30800](https://github.com/nodejs/node/pull/30800)
* [[`2c27df2e14`](https://github.com/nodejs/node/commit/2c27df2e14)] - **test**: run more assert tests (Ruben Bridgewater) [#30764](https://github.com/nodejs/node/pull/30764)
* [[`8d0217b1d1`](https://github.com/nodejs/node/commit/8d0217b1d1)] - **test**: improve wasi test coverage (Rich Trott) [#30770](https://github.com/nodejs/node/pull/30770)
* [[`11473ccaa4`](https://github.com/nodejs/node/commit/11473ccaa4)] - **test**: simplify tmpdir import in wasi tests (Rich Trott) [#30770](https://github.com/nodejs/node/pull/30770)
* [[`ee40a0039c`](https://github.com/nodejs/node/commit/ee40a0039c)] - **test**: use arrow functions in addons tests (garygsc) [#30131](https://github.com/nodejs/node/pull/30131)
* [[`4fd4a734e7`](https://github.com/nodejs/node/commit/4fd4a734e7)] - ***Revert*** "**test**: update postmortem metadata test for V8 7.7" (Matheus Marchini) [#30870](https://github.com/nodejs/node/pull/30870)
* [[`ccf9038ef4`](https://github.com/nodejs/node/commit/ccf9038ef4)] - **test**: check that --insecure-http-parser works (Sam Roberts) [#31253](https://github.com/nodejs/node/pull/31253)
* [[`402261709d`](https://github.com/nodejs/node/commit/402261709d)] - **test**: use spread object (Fran Herrero) [#30423](https://github.com/nodejs/node/pull/30423)
* [[`9ed7d2ed45`](https://github.com/nodejs/node/commit/9ed7d2ed45)] - **test**: log errors in test-http2-propagate-session-destroy-code (Denys Otrishko) [#31072](https://github.com/nodejs/node/pull/31072)
* [[`9c9138fd83`](https://github.com/nodejs/node/commit/9c9138fd83)] - **test**: skip the unsupported test cases for IBM i (Xu Meng) [#30819](https://github.com/nodejs/node/pull/30819)
* [[`3c16855a21`](https://github.com/nodejs/node/commit/3c16855a21)] - **test**: unflake async hooks statwatcher test (Denys Otrishko) [#30362](https://github.com/nodejs/node/pull/30362)
* [[`734b550d05`](https://github.com/nodejs/node/commit/734b550d05)] - **test**: fix common.enoughTestMem (Rich Trott) [#31035](https://github.com/nodejs/node/pull/31035)
* [[`73701b2564`](https://github.com/nodejs/node/commit/73701b2564)] - **test**: fix long lines (Colin Ihrig) [#31014](https://github.com/nodejs/node/pull/31014)
* [[`2a2fe8a358`](https://github.com/nodejs/node/commit/2a2fe8a358)] - **test**: fix flaky test-http2-client-upload (Gerhard Stoebich) [#29889](https://github.com/nodejs/node/pull/29889)
* [[`e6907f05a1`](https://github.com/nodejs/node/commit/e6907f05a1)] - **test**: improve test coverage in child\_process (Juan José Arboleda) [#26282](https://github.com/nodejs/node/pull/26282)
* [[`5cb1744147`](https://github.com/nodejs/node/commit/5cb1744147)] - **test**: improve dns lookup coverage (Kirill Ponomarev) [#30777](https://github.com/nodejs/node/pull/30777)
* [[`4651871804`](https://github.com/nodejs/node/commit/4651871804)] - **test**: avoid leftover report file (Gerhard Stoebich) [#30925](https://github.com/nodejs/node/pull/30925)
* [[`88085f0919`](https://github.com/nodejs/node/commit/88085f0919)] - **test**: improve assertion error message in test-debug-usage (Rich Trott) [#30913](https://github.com/nodejs/node/pull/30913)
* [[`2155f56669`](https://github.com/nodejs/node/commit/2155f56669)] - **test**: disable colorMode in test-console-group (Rich Trott) [#30886](https://github.com/nodejs/node/pull/30886)
* [[`cd740a29d0`](https://github.com/nodejs/node/commit/cd740a29d0)] - **test**: assert: fix deepStrictEqual comparing a real array and fake array (Jordan Harband) [#30743](https://github.com/nodejs/node/pull/30743)
* [[`be97f71a1f`](https://github.com/nodejs/node/commit/be97f71a1f)] - **test**: refactor test-accessor-properties (himself65) [#29943](https://github.com/nodejs/node/pull/29943)
* [[`e1eb6a6025`](https://github.com/nodejs/node/commit/e1eb6a6025)] - **test**: scale keepalive timeouts for slow machines (Ben Noordhuis) [#30834](https://github.com/nodejs/node/pull/30834)
* [[`dc1bc155e1`](https://github.com/nodejs/node/commit/dc1bc155e1)] - **test**: mark tests as flaky (João Reis) [#30848](https://github.com/nodejs/node/pull/30848)
* [[`39d770cc6e`](https://github.com/nodejs/node/commit/39d770cc6e)] - **test**: mark addons/openssl-bindings/test flaky on arm (Richard Lau) [#30838](https://github.com/nodejs/node/pull/30838)
* [[`1fa7347ab9`](https://github.com/nodejs/node/commit/1fa7347ab9)] - **test**: remove common.busyLoop() (Colin Ihrig) [#30787](https://github.com/nodejs/node/pull/30787)
* [[`f6356fe50b`](https://github.com/nodejs/node/commit/f6356fe50b)] - **test**: use callback arguments in getconnections test (Rich Trott) [#30775](https://github.com/nodejs/node/pull/30775)
* [[`c2ee0a8ecb`](https://github.com/nodejs/node/commit/c2ee0a8ecb)] - **test**: remove duplicate entries from root.status (Richard Lau) [#30769](https://github.com/nodejs/node/pull/30769)
* [[`193a02027c`](https://github.com/nodejs/node/commit/193a02027c)] - **test**: increase debugging information in subprocess test (Rich Trott) [#30761](https://github.com/nodejs/node/pull/30761)
...
* [[`ad4af04dce`](https://github.com/nodejs/node/commit/ad4af04dce)] - **test,module**: add test for exports cjs loader check (Rich Trott) [#31427](https://github.com/nodejs/node/pull/31427)
...
* [[`7d5ab8be31`](https://github.com/nodejs/node/commit/7d5ab8be31)] - **tls**: introduce ERR\_TLS\_INVALID\_CONTEXT (Rich Trott) [#30718](https://github.com/nodejs/node/pull/30718)
...
* [[`bedc6e2066`](https://github.com/nodejs/node/commit/bedc6e2066)] - **tools**: allow the travis commit message job to fail (Ruben Bridgewater) [#31116](https://github.com/nodejs/node/pull/31116)
* [[`b714e94786`](https://github.com/nodejs/node/commit/b714e94786)] - **tools**: fix Raspbian armv7 build (Andrey Hohutkin) [#31041](https://github.com/nodejs/node/pull/31041)
* [[`9d2e8c5727`](https://github.com/nodejs/node/commit/9d2e8c5727)] - **tools**: update ESLint to 6.8.0 (Colin Ihrig) [#31044](https://github.com/nodejs/node/pull/31044)
* [[`47067ce07d`](https://github.com/nodejs/node/commit/47067ce07d)] - **tools**: enable Markdown linter's usage information (Derek Lewis) [#30216](https://github.com/nodejs/node/pull/30216)
* [[`174e4350d1`](https://github.com/nodejs/node/commit/174e4350d1)] - **tools**: update link to google styleguide for cpplint (Daniel Bevenius) [#30876](https://github.com/nodejs/node/pull/30876)
* [[`7558d8ba5a`](https://github.com/nodejs/node/commit/7558d8ba5a)] - **tools**: use CC instead of CXX when pointing to gcc (Milad Farazmand) [#30817](https://github.com/nodejs/node/pull/30817)
* [[`eb8f19abc2`](https://github.com/nodejs/node/commit/eb8f19abc2)] - **tools**: update remark-preset-lint-node to 1.11.0 (Rich Trott) [#30789](https://github.com/nodejs/node/pull/30789)
* [[`54140a8ab3`](https://github.com/nodejs/node/commit/54140a8ab3)] - **tools**: update ESLint to 6.7.2 (Rich Trott) [#30762](https://github.com/nodejs/node/pull/30762)
* [[`dbb4e2ab1f`](https://github.com/nodejs/node/commit/dbb4e2ab1f)] - **tools**: update remark-preset-lint-node to 1.10.1 (Rich Trott) [#29982](https://github.com/nodejs/node/pull/29982)
* [[`1b8f841d10`](https://github.com/nodejs/node/commit/1b8f841d10)] - **tools**: update remark-preset-lint-node to 1.10.0 (Rich Trott) [#29594](https://github.com/nodejs/node/pull/29594)
* [[`6531e8b69e`](https://github.com/nodejs/node/commit/6531e8b69e)] - **tools**: apply more stringent blank-line linting for markdown files (Rich Trott) [#29447](https://github.com/nodejs/node/pull/29447)
* [[`6ae7d3028a`](https://github.com/nodejs/node/commit/6ae7d3028a)] - **(SEMVER-MINOR)** **tools**: patch V8 to run on older XCode versions (Ujjwal Sharma) [#29694](https://github.com/nodejs/node/pull/29694)
* [[`6a17aecd31`](https://github.com/nodejs/node/commit/6a17aecd31)] - **(SEMVER-MINOR)** **tools**: update V8 gypfiles (Michaël Zasso) [#29694](https://github.com/nodejs/node/pull/29694)
...
* [[`fc0febebc9`](https://github.com/nodejs/node/commit/fc0febebc9)] - **util**: improve prototype inspection using `inspect()` and `showHidden` (Ruben Bridgewater) [#31113](https://github.com/nodejs/node/pull/31113)
* [[`cc19d08748`](https://github.com/nodejs/node/commit/cc19d08748)] - **util**: add (typed) array length to the default output (Ruben Bridgewater) [#31027](https://github.com/nodejs/node/pull/31027)
* [[`3b9360da11`](https://github.com/nodejs/node/commit/3b9360da11)] - **util**: refactor inspect code for constistency (Ruben Bridgewater) [#30225](https://github.com/nodejs/node/pull/30225)
* [[`b0e3aec7ca`](https://github.com/nodejs/node/commit/b0e3aec7ca)] - **(SEMVER-MINOR)** **util**: inspect (user defined) prototype properties (Ruben Bridgewater) [#30768](https://github.com/nodejs/node/pull/30768)
* [[`40a724c1c2`](https://github.com/nodejs/node/commit/40a724c1c2)] - **(SEMVER-MINOR)** **util**: fix built-in detection (Ruben Bridgewater) [#30768](https://github.com/nodejs/node/pull/30768)
* [[`bbf39bcfec`](https://github.com/nodejs/node/commit/bbf39bcfec)] - **util**: never trigger any proxy traps using `format()` (Ruben Bridgewater) [#30767](https://github.com/nodejs/node/pull/30767)
* [[`a309ee11ca`](https://github.com/nodejs/node/commit/a309ee11ca)] - **util**: improve performance inspecting proxies (Ruben Bridgewater) [#30767](https://github.com/nodejs/node/pull/30767)
* [[`a1ce77670e`](https://github.com/nodejs/node/commit/a1ce77670e)] - **util**: fix .format() not always calling toString when it should be (Ruben Bridgewater) [#30343](https://github.com/nodejs/node/pull/30343)
...
* [[`ff47915e5b`](https://github.com/nodejs/node/commit/ff47915e5b)] - **wasi**: refactor destructuring object on constructor (himself65) [#31185](https://github.com/nodejs/node/pull/31185)
* [[`80d7b6e1c5`](https://github.com/nodejs/node/commit/80d7b6e1c5)] - **wasi**: fix serdes bugs from snapshot1 migration (Colin Ihrig) [#31122](https://github.com/nodejs/node/pull/31122)
* [[`e815655ca3`](https://github.com/nodejs/node/commit/e815655ca3)] - **wasi**: throw on failed uvwasi\_init() (Colin Ihrig) [#31076](https://github.com/nodejs/node/pull/31076)
* [[`5d2ae05131`](https://github.com/nodejs/node/commit/5d2ae05131)] - **wasi**: require CLI flag to require() wasi module (Colin Ihrig) [#30963](https://github.com/nodejs/node/pull/30963)
* [[`2bb364aa53`](https://github.com/nodejs/node/commit/2bb364aa53)] - **wasi**: use memory-tracking allocator (Anna Henningsen) [#30745](https://github.com/nodejs/node/pull/30745)
...
* [[`61da6571fe`](https://github.com/nodejs/node/commit/61da6571fe)] - **zlib**: use for...of (Trivikram Kamat) [#31051](https://github.com/nodejs/node/pull/31051)
* [[`84070863f2`](https://github.com/nodejs/node/commit/84070863f2)] - **zlib**: allow writes after readable 'end' to finish (Anna Henningsen) [#31082](https://github.com/nodejs/node/pull/31082)
