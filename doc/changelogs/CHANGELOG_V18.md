...
* \[[`7552de6806`](https://github.com/nodejs/node/commit/7552de6806)] - **module**: fix the leak in SourceTextModule and ContextifyScript (Joyee Cheung) [#48510](https://github.com/nodejs/node/pull/48510)
...
* \[[`f0e8ff90eb`](https://github.com/nodejs/node/commit/f0e8ff90eb)] - **test**: use an array for WPT globalThis initialization scripts (Joyee Cheung) [#46425](https://github.com/nodejs/node/pull/46425)
...
* \[[`339b52f3bc`](https://github.com/nodejs/node/commit/339b52f3bc)] - **src**: make util.h self-contained (Joyee Cheung) [#46817](https://github.com/nodejs/node/pull/46817)
