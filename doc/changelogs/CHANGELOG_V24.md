...
## 2026-07-22, Version 24.19.0 'Krypton' (LTS), @aduh95

### Notable Changes

* \[[`afd262f710`](https://github.com/nodejs/node/commit/afd262f710)] - **(SEMVER-MINOR)** **buffer**: implement blob.textStream() (Matthew Aitken) [#64036](https://github.com/nodejs/node/pull/64036)
* \[[`89ceffa260`](https://github.com/nodejs/node/commit/89ceffa260)] - **(SEMVER-MINOR)** **deps**: update OpenSSL build config to support compression (Tim Perry) [#62217](https://github.com/nodejs/node/pull/62217)
* \[[`4bc1a093e5`](https://github.com/nodejs/node/commit/4bc1a093e5)] - **(SEMVER-MINOR)** **doc**: update `blockList` stability status to release candidate (alphaleadership) [#63050](https://github.com/nodejs/node/pull/63050)
* \[[`b8f7e6d080`](https://github.com/nodejs/node/commit/b8f7e6d080)] - **doc**: mark `stream.compose` stable (Matteo Collina) [#62562](https://github.com/nodejs/node/pull/62562)
* \[[`bac5f170de`](https://github.com/nodejs/node/commit/bac5f170de)] - **(SEMVER-MINOR)** **esm**: add `--experimental-import-text` flag (Efe) [#62300](https://github.com/nodejs/node/pull/62300)
* \[[`00522e6960`](https://github.com/nodejs/node/commit/00522e6960)] - **(SEMVER-MINOR)** **fs**: support caller-supplied `readFile()` buffers (Matteo Collina) [#63634](https://github.com/nodejs/node/pull/63634)
* \[[`cf5e1b5ad3`](https://github.com/nodejs/node/commit/cf5e1b5ad3)] - **(SEMVER-MINOR)** **http**: add httpValidation option to configure header value validation (RajeshKumar11) [#61597](https://github.com/nodejs/node/pull/61597)
* \[[`443a43cdde`](https://github.com/nodejs/node/commit/443a43cdde)] - **(SEMVER-MINOR)** **net**: support `TCP_KEEPINTVL` and `TCP_KEEPCNT` in setKeepAlive (Guy Bedford) [#63825](https://github.com/nodejs/node/pull/63825)
* \[[`70ebe66a96`](https://github.com/nodejs/node/commit/70ebe66a96)] - **(SEMVER-MINOR)** **perf\_hooks**: sample delay per event loop iteration (Pablo Erhard) [#62935](https://github.com/nodejs/node/pull/62935)
* \[[`a446480fdd`](https://github.com/nodejs/node/commit/a446480fdd)] - **(SEMVER-MINOR)** **src**: allow empty `--experimental-config-file` (Marco Ippolito) [#61610](https://github.com/nodejs/node/pull/61610)
* \[[`1492bc52f1`](https://github.com/nodejs/node/commit/1492bc52f1)] - **(SEMVER-MINOR)** **stream**: expose `ReadableStreamTee` (Matteo Collina) [#64195](https://github.com/nodejs/node/pull/64195)
* \[[`e3c0fd74b8`](https://github.com/nodejs/node/commit/e3c0fd74b8)] - **(SEMVER-MINOR)** **tls**: report negotiated TLS groups (Filip Skokan) [#64119](https://github.com/nodejs/node/pull/64119)
* \[[`a31378a449`](https://github.com/nodejs/node/commit/a31378a449)] - **(SEMVER-MINOR)** **tls**: add `certificateCompression` option (Tim Perry) [#62217](https://github.com/nodejs/node/pull/62217)

### Commits

* \[[`f79c0ef318`](https://github.com/nodejs/node/commit/f79c0ef318)] - **benchmark**: trim down the argon2 sets (Filip Skokan) [#64218](https://github.com/nodejs/node/pull/64218)
* \[[`dfefe0355d`](https://github.com/nodejs/node/commit/dfefe0355d)] - **benchmark**: add child\_process async path baselines (Yagiz Nizipli) [#63929](https://github.com/nodejs/node/pull/63929)
* \[[`885fd5be0f`](https://github.com/nodejs/node/commit/885fd5be0f)] - **buffer**: remove unreachable overflow check in atob (haramjeong) [#60161](https://github.com/nodejs/node/pull/60161)
* \[[`6a57c8c999`](https://github.com/nodejs/node/commit/6a57c8c999)] - **buffer**: add fast api for isUtf8 and isAscii (Gürgün Dayıoğlu) [#64169](https://github.com/nodejs/node/pull/64169)
* \[[`afd262f710`](https://github.com/nodejs/node/commit/afd262f710)] - **(SEMVER-MINOR)** **buffer**: implement blob.textStream() (Matthew Aitken) [#64036](https://github.com/nodejs/node/pull/64036)
* \[[`f0b3a1cb0b`](https://github.com/nodejs/node/commit/f0b3a1cb0b)] - **build**: remove redundant intermediate node\_aix\_shared (Chengzhong Wu) [#63747](https://github.com/nodejs/node/pull/63747)
* \[[`ef88b5304b`](https://github.com/nodejs/node/commit/ef88b5304b)] - **build**: build codecache and snapshot with libnode (Chengzhong Wu) [#63626](https://github.com/nodejs/node/pull/63626)
* \[[`c84011b6b5`](https://github.com/nodejs/node/commit/c84011b6b5)] - **build**: support setting an emulator from configure script (Ivan Trubach) [#53899](https://github.com/nodejs/node/pull/53899)
* \[[`efb9193da5`](https://github.com/nodejs/node/commit/efb9193da5)] - **build**: remove duplicated node\_use\_sqlite and node\_use\_ffi conditions (Chengzhong Wu) [#63629](https://github.com/nodejs/node/pull/63629)
* \[[`d0a574856b`](https://github.com/nodejs/node/commit/d0a574856b)] - **build**: add manually-dispatched stress-test workflow (Joyee Cheung) [#64118](https://github.com/nodejs/node/pull/64118)
* \[[`8826c3e36d`](https://github.com/nodejs/node/commit/8826c3e36d)] - **build**: suppress compiler warnings for histogram (Richard Lau) [#63980](https://github.com/nodejs/node/pull/63980)
* \[[`73295d5f43`](https://github.com/nodejs/node/commit/73295d5f43)] - **build,win**: fix VS2022 arm64 PGO build (Stefan Stojanovic) [#63413](https://github.com/nodejs/node/pull/63413)
* \[[`76bf86f2a2`](https://github.com/nodejs/node/commit/76bf86f2a2)] - **child\_process**: fix permission model propagation via NODE\_OPTIONS (Matteo Collina) [#63972](https://github.com/nodejs/node/pull/63972)
* \[[`b9f6ea79a2`](https://github.com/nodejs/node/commit/b9f6ea79a2)] - **child\_process**: pass spawn options to the binding positionally (Yagiz Nizipli) [#63930](https://github.com/nodejs/node/pull/63930)
* \[[`b351fa5eee`](https://github.com/nodejs/node/commit/b351fa5eee)] - **child\_process**: serialize advanced IPC messages natively (Yagiz Nizipli) [#63933](https://github.com/nodejs/node/pull/63933)
* \[[`81bfbb2c30`](https://github.com/nodejs/node/commit/81bfbb2c30)] - **crypto**: reject small-order EdDSA points during verify (Filip Skokan) [#64026](https://github.com/nodejs/node/pull/64026)
* \[[`e3e371973e`](https://github.com/nodejs/node/commit/e3e371973e)] - **crypto**: support non-byte WebCrypto lengths and cSHAKE (Filip Skokan) [#63988](https://github.com/nodejs/node/pull/63988)
* \[[`cedc8f4ce3`](https://github.com/nodejs/node/commit/cedc8f4ce3)] - **crypto**: share WebCrypto method and usage helpers (Filip Skokan) [#63975](https://github.com/nodejs/node/pull/63975)
* \[[`b88f7b4a97`](https://github.com/nodejs/node/commit/b88f7b4a97)] - **crypto**: refactor keyObject.toCryptoKey() and SubtleCrypto.getPublicKey() (Filip Skokan) [#63622](https://github.com/nodejs/node/pull/63622)
* \[[`4ce77bbf0c`](https://github.com/nodejs/node/commit/4ce77bbf0c)] - **crypto**: coerce -0 to +0 before native calls (Filip Skokan) [#63556](https://github.com/nodejs/node/pull/63556)
* \[[`eaeb9b60be`](https://github.com/nodejs/node/commit/eaeb9b60be)] - **crypto**: reject invalid raw key imports (Filip Skokan) [#63134](https://github.com/nodejs/node/pull/63134)
* \[[`898e70fa20`](https://github.com/nodejs/node/commit/898e70fa20)] - **crypto**: improve accuracy of SubtleCrypto.supports (Filip Skokan) [#63104](https://github.com/nodejs/node/pull/63104)
* \[[`2f690d774f`](https://github.com/nodejs/node/commit/2f690d774f)] - **crypto**: fix large DH generator validation (Tobias Nießen) [#64092](https://github.com/nodejs/node/pull/64092)
* \[[`8e769b1ff1`](https://github.com/nodejs/node/commit/8e769b1ff1)] - **crypto**: use EVP\_MAC for HMAC on OpenSSL >=3 (Filip Skokan) [#63942](https://github.com/nodejs/node/pull/63942)
* \[[`622f4e1a6d`](https://github.com/nodejs/node/commit/622f4e1a6d)] - **crypto**: make webcrypto aliasKeyFormat directional (Filip Skokan) [#63910](https://github.com/nodejs/node/pull/63910)
* \[[`521e6c13bf`](https://github.com/nodejs/node/commit/521e6c13bf)] - **crypto**: fix unhandled error in Hash.\_transform (Haram Jeong) [#63261](https://github.com/nodejs/node/pull/63261)
* \[[`15ca68c6cb`](https://github.com/nodejs/node/commit/15ca68c6cb)] - **crypto**: handle cipher context allocation failures (Tian Teng) [#63542](https://github.com/nodejs/node/pull/63542)
* \[[`12986ba26e`](https://github.com/nodejs/node/commit/12986ba26e)] - **crypto**: deduplicate X509 subject matching logic (Tobias Nießen) [#63644](https://github.com/nodejs/node/pull/63644)
* \[[`400c54dc6b`](https://github.com/nodejs/node/commit/400c54dc6b)] - **crypto**: fix warnings in test\_node\_crypto.cc (Maya Lekova) [#63490](https://github.com/nodejs/node/pull/63490)
* \[[`7607ad4e61`](https://github.com/nodejs/node/commit/7607ad4e61)] - **crypto**: optimize normalizeAlgorithm dispatch hot path (Filip Skokan) [#62756](https://github.com/nodejs/node/pull/62756)
* \[[`41eb9f34d6`](https://github.com/nodejs/node/commit/41eb9f34d6)] - **crypto,tls**: do not ignore BN\_get\_word error (Tobias Nießen) [#63895](https://github.com/nodejs/node/pull/63895)
* \[[`4f4245dc8f`](https://github.com/nodejs/node/commit/4f4245dc8f)] - **debugger**: add --max-hit option to probe mode (Joyee Cheung) [#63704](https://github.com/nodejs/node/pull/63704)
* \[[`cb467410c1`](https://github.com/nodejs/node/commit/cb467410c1)] - **debugger**: add more logs to probe mode (Joyee Cheung) [#63663](https://github.com/nodejs/node/pull/63663)
* \[[`61aca1f49b`](https://github.com/nodejs/node/commit/61aca1f49b)] - **debugger**: surface inspector failures in probe mode (Joyee Cheung) [#63437](https://github.com/nodejs/node/pull/63437)
* \[[`857f7c0e64`](https://github.com/nodejs/node/commit/857f7c0e64)] - **debugger**: disambiguate probe location binding (Joyee Cheung) [#63286](https://github.com/nodejs/node/pull/63286)
* \[[`0440ddd85a`](https://github.com/nodejs/node/commit/0440ddd85a)] - **debugger**: lazily wait for initial break output (Trivikram Kamat) [#63969](https://github.com/nodejs/node/pull/63969)
* \[[`16c511c05a`](https://github.com/nodejs/node/commit/16c511c05a)] - **debugger**: defer probe pause handling until startup (Trivikram Kamat) [#63608](https://github.com/nodejs/node/pull/63608)
* \[[`a42aa0a351`](https://github.com/nodejs/node/commit/a42aa0a351)] - **debugger**: await initialization after run and restart (Trivikram Kamat) [#63607](https://github.com/nodejs/node/pull/63607)
* \[[`f6074a323a`](https://github.com/nodejs/node/commit/f6074a323a)] - **debugger,test**: deflake resume failure test and add debug logs (Joyee Cheung) [#63524](https://github.com/nodejs/node/pull/63524)
* \[[`38e03dfeb9`](https://github.com/nodejs/node/commit/38e03dfeb9)] - **deps**: V8: backport bef0d9c1bc90 (Joyee Cheung) [#62132](https://github.com/nodejs/node/pull/62132)
* \[[`f67161c905`](https://github.com/nodejs/node/commit/f67161c905)] - **deps**: V8: cherry-pick 64b36b441179 (Dan Carney) [#61712](https://github.com/nodejs/node/pull/61712)
* \[[`7599d2da6b`](https://github.com/nodejs/node/commit/7599d2da6b)] - **deps**: update googletest to 8b53336594cc52213c6c2c7a0b29194fa896d039 (Node.js GitHub Bot) [#64181](https://github.com/nodejs/node/pull/64181)
* \[[`60a3720217`](https://github.com/nodejs/node/commit/60a3720217)] - **deps**: update sqlite to 3.53.3 (Node.js GitHub Bot) [#64180](https://github.com/nodejs/node/pull/64180)
* \[[`1078da9827`](https://github.com/nodejs/node/commit/1078da9827)] - **deps**: c-ares: cherry-pick 8ba37af8e3fb (René) [#64110](https://github.com/nodejs/node/pull/64110)
* \[[`3b0aca3028`](https://github.com/nodejs/node/commit/3b0aca3028)] - **deps**: update googletest to 0b1e895ba4226c2fda5ee0178c9b5b1195a741aa (Node.js GitHub Bot) [#64039](https://github.com/nodejs/node/pull/64039)
* \[[`76ee60649b`](https://github.com/nodejs/node/commit/76ee60649b)] - **deps**: update acorn to 8.17.0 (Node.js GitHub Bot) [#63901](https://github.com/nodejs/node/pull/63901)
* \[[`89ceffa260`](https://github.com/nodejs/node/commit/89ceffa260)] - **(SEMVER-MINOR)** **deps**: update OpenSSL build config to support compression (Tim Perry) [#62217](https://github.com/nodejs/node/pull/62217)
* \[[`ae097c6999`](https://github.com/nodejs/node/commit/ae097c6999)] - **deps**: upgrade npm to 11.17.0 (npm team) [#63857](https://github.com/nodejs/node/pull/63857)
* \[[`22b4005708`](https://github.com/nodejs/node/commit/22b4005708)] - **deps**: add ngtcp2\_fmt.c to build configuration (ngtcp2.gyp) (沈鸿飞) [#63821](https://github.com/nodejs/node/pull/63821)
* \[[`4f36fd1a08`](https://github.com/nodejs/node/commit/4f36fd1a08)] - **deps**: update googletest to 7140cd416cecd7462a8aae488024abeee55598e4 (Node.js GitHub Bot) [#63775](https://github.com/nodejs/node/pull/63775)
* \[[`2e2b9ed09a`](https://github.com/nodejs/node/commit/2e2b9ed09a)] - **deps**: update sqlite to 3.53.2 (Node.js GitHub Bot) [#63774](https://github.com/nodejs/node/pull/63774)
* \[[`adc3d3ce8e`](https://github.com/nodejs/node/commit/adc3d3ce8e)] - **deps**: update zlib to 1.3.2.1-motley-3246f1b (Node.js GitHub Bot) [#63773](https://github.com/nodejs/node/pull/63773)
* \[[`353a2c0ff2`](https://github.com/nodejs/node/commit/353a2c0ff2)] - **deps**: update amaro to 1.1.10 (Node.js GitHub Bot) [#63670](https://github.com/nodejs/node/pull/63670)
* \[[`aced087ad6`](https://github.com/nodejs/node/commit/aced087ad6)] - **deps**: update googletest to 8736d2cd5c1dcba41170ed2fddca14021d4916c3 (Node.js GitHub Bot) [#63669](https://github.com/nodejs/node/pull/63669)
* \[[`571058fca1`](https://github.com/nodejs/node/commit/571058fca1)] - **dgram**: add synchronous Socket connectSync() (Guy Bedford) [#63932](https://github.com/nodejs/node/pull/63932)
* \[[`f8c967cd83`](https://github.com/nodejs/node/commit/f8c967cd83)] - **dgram**: add synchronous Socket.prototype.bindSync() (Guy Bedford) [#63838](https://github.com/nodejs/node/pull/63838)
* \[[`ec02d3f3eb`](https://github.com/nodejs/node/commit/ec02d3f3eb)] - **dgram**: skip dns.lookup() for literal IP addresses (Ruben Bridgewater) [#64133](https://github.com/nodejs/node/pull/64133)
* \[[`020029216a`](https://github.com/nodejs/node/commit/020029216a)] - **dns**: coerce -0 to +0 in lookup and resolver inputs (Filip Skokan) [#63556](https://github.com/nodejs/node/pull/63556)
* \[[`732e80b23b`](https://github.com/nodejs/node/commit/732e80b23b)] - **doc**: improve `fs.StatFs` properties descriptions (aymanxdev) [#62578](https://github.com/nodejs/node/pull/62578)
* \[[`8b56dffdc8`](https://github.com/nodejs/node/commit/8b56dffdc8)] - **doc**: fix inconsistencies in CJS code snippets (Antoine du Hamel) [#63199](https://github.com/nodejs/node/pull/63199)
* \[[`6db6944c61`](https://github.com/nodejs/node/commit/6db6944c61)] - **doc**: remove typo comma from man page (Vas Sudanagunta) [#63080](https://github.com/nodejs/node/pull/63080)
* \[[`a23e0926c6`](https://github.com/nodejs/node/commit/a23e0926c6)] - **doc**: update Http2SecureServer.on("timeout") default value (YuSheng Chen) [#64187](https://github.com/nodejs/node/pull/64187)
* \[[`f072603344`](https://github.com/nodejs/node/commit/f072603344)] - **doc**: add note on visibility of CI failures to new contributor guide (Stewart X Addison) [#64256](https://github.com/nodejs/node/pull/64256)
* \[[`f67e2e769d`](https://github.com/nodejs/node/commit/f67e2e769d)] - **doc**: clarify HTTP/1.1 response ordering (Matteo Collina) [#64213](https://github.com/nodejs/node/pull/64213)
* \[[`0776aaa788`](https://github.com/nodejs/node/commit/0776aaa788)] - **doc**: recommend node-stress-single-test for flaky tests (Trivikram Kamat) [#64223](https://github.com/nodejs/node/pull/64223)
* \[[`e49a577806`](https://github.com/nodejs/node/commit/e49a577806)] - **doc**: fix typo in examples (Vas Sudanagunta) [#64184](https://github.com/nodejs/node/pull/64184)
* \[[`64942999bd`](https://github.com/nodejs/node/commit/64942999bd)] - **doc**: clarify defense-in-depth issues (Matteo Collina) [#64215](https://github.com/nodejs/node/pull/64215)
* \[[`5bc303db88`](https://github.com/nodejs/node/commit/5bc303db88)] - **doc**: add guide and answers to FAQs for first-time contributors (Joyee Cheung) [#63685](https://github.com/nodejs/node/pull/63685)
* \[[`9238b34df0`](https://github.com/nodejs/node/commit/9238b34df0)] - **doc**: update `Http2Server.close` & `Http2SecureServer.close` (YuSheng Chen) [#63298](https://github.com/nodejs/node/pull/63298)
* \[[`70064f7804`](https://github.com/nodejs/node/commit/70064f7804)] - **doc**: update list of people in `SECURITY.md` (Richard Lau) [#64152](https://github.com/nodejs/node/pull/64152)
* \[[`c40b6156cb`](https://github.com/nodejs/node/commit/c40b6156cb)] - **doc**: add missing option to man page (Richard Lau) [#64156](https://github.com/nodejs/node/pull/64156)
* \[[`1e793f167f`](https://github.com/nodejs/node/commit/1e793f167f)] - **doc**: fix callback example import in fs docs (Kamal Rawal) [#63912](https://github.com/nodejs/node/pull/63912)
* \[[`7fad2004b0`](https://github.com/nodejs/node/commit/7fad2004b0)] - **doc**: fix keepAliveTimeout default in http.createServer options (Jahanzaib iqbal) [#63974](https://github.com/nodejs/node/pull/63974)
* \[[`289c648178`](https://github.com/nodejs/node/commit/289c648178)] - **doc**: add sxa GPG key (ed25519) (Stewart X Addison) [#64193](https://github.com/nodejs/node/pull/64193)
* \[[`a6bd0ddf9e`](https://github.com/nodejs/node/commit/a6bd0ddf9e)] - **doc**: add aduh95 to last security release steward (Antoine du Hamel) [#63981](https://github.com/nodejs/node/pull/63981)
* \[[`50d0728715`](https://github.com/nodejs/node/commit/50d0728715)] - **doc**: fix typo in util.md (Daijiro Wachi) [#63961](https://github.com/nodejs/node/pull/63961)
* \[[`d73c8321e1`](https://github.com/nodejs/node/commit/d73c8321e1)] - **doc**: clarify callback exceptions (Matteo Collina) [#63939](https://github.com/nodejs/node/pull/63939)
* \[[`6723b1e799`](https://github.com/nodejs/node/commit/6723b1e799)] - **doc**: fix incorrect test runner mock examples (Kimaswa Emmanuel Yusufu) [#63656](https://github.com/nodejs/node/pull/63656)
* \[[`b7b5706850`](https://github.com/nodejs/node/commit/b7b5706850)] - **doc**: fix typo in cli.md (Daijiro Wachi) [#63883](https://github.com/nodejs/node/pull/63883)
* \[[`9bbb9f9fd8`](https://github.com/nodejs/node/commit/9bbb9f9fd8)] - **doc**: fix typo in vm.md (Daijiro Wachi) [#63881](https://github.com/nodejs/node/pull/63881)
* \[[`388421eb5d`](https://github.com/nodejs/node/commit/388421eb5d)] - **doc**: fix typo in packages.md (Daijiro Wachi) [#63882](https://github.com/nodejs/node/pull/63882)
* \[[`d79d016a0e`](https://github.com/nodejs/node/commit/d79d016a0e)] - **doc**: fix a/an article typos in module, util, and dns (Daijiro Wachi) [#63766](https://github.com/nodejs/node/pull/63766)
* \[[`7a391578e3`](https://github.com/nodejs/node/commit/7a391578e3)] - **doc**: update npm supported versions link (hojeong park) [#63672](https://github.com/nodejs/node/pull/63672)
* \[[`683de5de16`](https://github.com/nodejs/node/commit/683de5de16)] - **doc**: fix AES-OCB IV length in SubtleCrypto.supports example (Anshika Jain) [#63717](https://github.com/nodejs/node/pull/63717)
* \[[`556d15093c`](https://github.com/nodejs/node/commit/556d15093c)] - **doc**: add webstreams to args for `pipeline` from `stream/promises` (David Sanders) [#63628](https://github.com/nodejs/node/pull/63628)
* \[[`be256f4ab7`](https://github.com/nodejs/node/commit/be256f4ab7)] - **doc**: fix "used to sent" → "used to send" in http2 (Daijiro Wachi) [#63700](https://github.com/nodejs/node/pull/63700)
* \[[`2a710736ca`](https://github.com/nodejs/node/commit/2a710736ca)] - **doc**: clarify tty raw mode applies to input processing only (Muhammad Zeeshan) [#63438](https://github.com/nodejs/node/pull/63438)
* \[[`28f789da00`](https://github.com/nodejs/node/commit/28f789da00)] - **doc**: add worker\_threads history entries (Bob Put) [#63545](https://github.com/nodejs/node/pull/63545)
* \[[`4bc1a093e5`](https://github.com/nodejs/node/commit/4bc1a093e5)] - **(SEMVER-MINOR)** **doc**: update `blockList` stability status to release candidate (alphaleadership) [#63050](https://github.com/nodejs/node/pull/63050)
* \[[`5715f25bcf`](https://github.com/nodejs/node/commit/5715f25bcf)] - **doc**: move hyperlinks outside of text blocks (Aviv Keller) [#63493](https://github.com/nodejs/node/pull/63493)
* \[[`b8f7e6d080`](https://github.com/nodejs/node/commit/b8f7e6d080)] - **doc**: mark stream.compose stable (Matteo Collina) [#62562](https://github.com/nodejs/node/pull/62562)
* \[[`8490456509`](https://github.com/nodejs/node/commit/8490456509)] - **doc,crypto**: mark argon2 and encap/decap as stable (Filip Skokan) [#63924](https://github.com/nodejs/node/pull/63924)
* \[[`5d2dc844d2`](https://github.com/nodejs/node/commit/5d2dc844d2)] - **doc,lib**: align WebCrypto names with spec (Filip Skokan) [#63518](https://github.com/nodejs/node/pull/63518)
* \[[`bac5f170de`](https://github.com/nodejs/node/commit/bac5f170de)] - **(SEMVER-MINOR)** **esm**: add `--experimental-import-text` flag (Efe) [#62300](https://github.com/nodejs/node/pull/62300)
* \[[`9ad3013e2e`](https://github.com/nodejs/node/commit/9ad3013e2e)] - **events**: improve `addAbortListener` perf by caching options object (Raz Luvaton) [#52367](https://github.com/nodejs/node/pull/52367)
* \[[`c6601786c4`](https://github.com/nodejs/node/commit/c6601786c4)] - **fs**: do not treat EPERM as ENOTEMPTY on Windows (Kirill Saied) [#63709](https://github.com/nodejs/node/pull/63709)
* \[[`00522e6960`](https://github.com/nodejs/node/commit/00522e6960)] - **(SEMVER-MINOR)** **fs**: support caller-supplied readFile() buffers (Matteo Collina) [#63634](https://github.com/nodejs/node/pull/63634)
* \[[`f9b161bc05`](https://github.com/nodejs/node/commit/f9b161bc05)] - **fs**: prevent spurious recursive watch events on prefix siblings (Marco) [#63095](https://github.com/nodejs/node/pull/63095)
* \[[`b4037ae2fd`](https://github.com/nodejs/node/commit/b4037ae2fd)] - **fs**: ignore deleted dirs in recursive watch scan (Trivikram Kamat) [#63686](https://github.com/nodejs/node/pull/63686)
* \[[`a7bdf3d748`](https://github.com/nodejs/node/commit/a7bdf3d748)] - **fs**: coerce -0 to +0 in mode flags and watch intervals (Filip Skokan) [#63556](https://github.com/nodejs/node/pull/63556)
* \[[`58e08bbaee`](https://github.com/nodejs/node/commit/58e08bbaee)] - **gyp**: update deps gypfiles (Nad Alaba) [#63117](https://github.com/nodejs/node/pull/63117)
* \[[`4943ea5e0c`](https://github.com/nodejs/node/commit/4943ea5e0c)] - **http**: document and validate options.path when it's in absolute-form (Joyee Cheung) [#64108](https://github.com/nodejs/node/pull/64108)
* \[[`cf5e1b5ad3`](https://github.com/nodejs/node/commit/cf5e1b5ad3)] - **(SEMVER-MINOR)** **http**: add httpValidation option to configure header value validation (RajeshKumar11) [#61597](https://github.com/nodejs/node/pull/61597)
* \[[`a5fd145b2f`](https://github.com/nodejs/node/commit/a5fd145b2f)] - **http**: fix drain event with cork/uncork (David Evans) [#64038](https://github.com/nodejs/node/pull/64038)
* \[[`a764d89c37`](https://github.com/nodejs/node/commit/a764d89c37)] - **http2**: retain header memory in session accounting (Matteo Collina) [#63752](https://github.com/nodejs/node/pull/63752)
* \[[`e541150edf`](https://github.com/nodejs/node/commit/e541150edf)] - **inspector**: fix crash when writing to closed inspector socket (ympark2011) [#64209](https://github.com/nodejs/node/pull/64209)
* \[[`afb8cdc045`](https://github.com/nodejs/node/commit/afb8cdc045)] - **inspector**: fix inspector.close() documented behavior (Chengzhong Wu) [#63837](https://github.com/nodejs/node/pull/63837)
* \[[`b496823f84`](https://github.com/nodejs/node/commit/b496823f84)] - **lib**: fix missing lazyDOMException import (Filip Skokan) [#64033](https://github.com/nodejs/node/pull/64033)
* \[[`79d9886155`](https://github.com/nodejs/node/commit/79d9886155)] - **lib**: reject string "0" in validatePort when allowZero is false (Daijiro Wachi) [#64174](https://github.com/nodejs/node/pull/64174)
* \[[`e62b075ea8`](https://github.com/nodejs/node/commit/e62b075ea8)] - **lib**: use `__proto__: null` when calling `ObjectDefineProperty` (Antoine du Hamel) [#64239](https://github.com/nodejs/node/pull/64239)
* \[[`ed86fe7622`](https://github.com/nodejs/node/commit/ed86fe7622)] - **lib**: lazily initialize kEvents and kHandlers maps (Guilherme Araújo) [#63702](https://github.com/nodejs/node/pull/63702)
* \[[`24c8908dd3`](https://github.com/nodejs/node/commit/24c8908dd3)] - **lib**: improve control abstraction coverage in frozen intrinsics (Renegade334) [#63698](https://github.com/nodejs/node/pull/63698)
* \[[`1e33e80246`](https://github.com/nodejs/node/commit/1e33e80246)] - **lib**: add Iterator global to primordials (Renegade334) [#63698](https://github.com/nodejs/node/pull/63698)
* \[[`e87143f85f`](https://github.com/nodejs/node/commit/e87143f85f)] - **lib**: make `Navigator#language` getter throw on invalid `this` (Mohamed Sayed) [#63601](https://github.com/nodejs/node/pull/63601)
* \[[`638e07c13c`](https://github.com/nodejs/node/commit/638e07c13c)] - **lib**: optimize webidl conversion options (Filip Skokan) [#62756](https://github.com/nodejs/node/pull/62756)
* \[[`757950a79c`](https://github.com/nodejs/node/commit/757950a79c)] - **meta**: bump actions/checkout from 6.0.2 to 6.0.3 (dependabot\[bot]) [#63726](https://github.com/nodejs/node/pull/63726)
* \[[`6d13e91bec`](https://github.com/nodejs/node/commit/6d13e91bec)] - **meta**: bump actions/upload-artifact from 7.0.0 to 7.0.1 (dependabot\[bot]) [#62850](https://github.com/nodejs/node/pull/62850)
* \[[`a595d80fd8`](https://github.com/nodejs/node/commit/a595d80fd8)] - **meta**: fix linter warning in `stale.yml` (Antoine du Hamel) [#64281](https://github.com/nodejs/node/pull/64281)
* \[[`72a7394d04`](https://github.com/nodejs/node/commit/72a7394d04)] - **meta**: bump actions/cache from 5.0.5 to 6.1.0 (dependabot\[bot]) [#64248](https://github.com/nodejs/node/pull/64248)
* \[[`2bc0c92043`](https://github.com/nodejs/node/commit/2bc0c92043)] - **meta**: bump github/codeql-action/autobuild from 4.36.1 to 4.36.2 (dependabot\[bot]) [#64247](https://github.com/nodejs/node/pull/64247)
* \[[`39ff59a981`](https://github.com/nodejs/node/commit/39ff59a981)] - **meta**: bump github/codeql-action/analyze from 4.36.1 to 4.36.2 (dependabot\[bot]) [#64246](https://github.com/nodejs/node/pull/64246)
* \[[`9a8af939b6`](https://github.com/nodejs/node/commit/9a8af939b6)] - **meta**: bump codecov/codecov-action from 6.0.1 to 7.0.0 (dependabot\[bot]) [#64244](https://github.com/nodejs/node/pull/64244)
* \[[`8a8428038c`](https://github.com/nodejs/node/commit/8a8428038c)] - **meta**: bump rtCamp/action-slack-notify from 2.3.3 to 2.4.0 (dependabot\[bot]) [#64243](https://github.com/nodejs/node/pull/64243)
* \[[`cd9d5ac979`](https://github.com/nodejs/node/commit/cd9d5ac979)] - **meta**: bump github/codeql-action/init from 4.36.1 to 4.36.2 (dependabot\[bot]) [#64242](https://github.com/nodejs/node/pull/64242)
* \[[`d7fde73fe2`](https://github.com/nodejs/node/commit/d7fde73fe2)] - **meta**: bump github/codeql-action/upload-sarif from 4.36.1 to 4.36.2 (dependabot\[bot]) [#64240](https://github.com/nodejs/node/pull/64240)
* \[[`3401dde801`](https://github.com/nodejs/node/commit/3401dde801)] - **meta**: clarify V8 flags are outside threat model (Matteo Collina) [#64224](https://github.com/nodejs/node/pull/64224)
* \[[`1457aa1f1a`](https://github.com/nodejs/node/commit/1457aa1f1a)] - **meta**: move one or more collaborators to emeritus (Node.js GitHub Bot) [#64057](https://github.com/nodejs/node/pull/64057)
* \[[`924daf0417`](https://github.com/nodejs/node/commit/924daf0417)] - **meta**: update status of past strategic initiatives (Joyee Cheung) [#63480](https://github.com/nodejs/node/pull/63480)
* \[[`1f3c82feef`](https://github.com/nodejs/node/commit/1f3c82feef)] - **meta**: speed up stale bot (Aviv Keller) [#64075](https://github.com/nodejs/node/pull/64075)
* \[[`48a766cee2`](https://github.com/nodejs/node/commit/48a766cee2)] - **meta**: bump github/codeql-action from 4.35.3 to 4.36.1 (dependabot\[bot]) [#63724](https://github.com/nodejs/node/pull/63724)
* \[[`273315f181`](https://github.com/nodejs/node/commit/273315f181)] - **meta**: bump actions/cache from 5.0.4 to 5.0.5 (dependabot\[bot]) [#62847](https://github.com/nodejs/node/pull/62847)
* \[[`e7c645710d`](https://github.com/nodejs/node/commit/e7c645710d)] - **meta**: bump codecov/codecov-action from 6.0.0 to 6.0.1 (dependabot\[bot]) [#63725](https://github.com/nodejs/node/pull/63725)
* \[[`92ac12076b`](https://github.com/nodejs/node/commit/92ac12076b)] - **meta**: bump actions/stale from 10.2.0 to 10.3.0 (dependabot\[bot]) [#63728](https://github.com/nodejs/node/pull/63728)
* \[[`8be2b1e43a`](https://github.com/nodejs/node/commit/8be2b1e43a)] - **meta**: bump step-security/harden-runner from 2.19.0 to 2.19.4 (dependabot\[bot]) [#63727](https://github.com/nodejs/node/pull/63727)
* \[[`6bf6251be2`](https://github.com/nodejs/node/commit/6bf6251be2)] - **module**: enable import support for addons by default (Chengzhong Wu) [#64221](https://github.com/nodejs/node/pull/64221)
* \[[`98ce551fc0`](https://github.com/nodejs/node/commit/98ce551fc0)] - **module**: use file: URL as sourceURL for type-stripped CommonJS (Joyee Cheung) [#63705](https://github.com/nodejs/node/pull/63705)
* \[[`0725b90fad`](https://github.com/nodejs/node/commit/0725b90fad)] - **net**: early TCP binding via synchronous net.BoundSocket (Guy Bedford) [#63951](https://github.com/nodejs/node/pull/63951)
* \[[`443a43cdde`](https://github.com/nodejs/node/commit/443a43cdde)] - **(SEMVER-MINOR)** **net**: support TCP\_KEEPINTVL and TCP\_KEEPCNT in setKeepAlive (Guy Bedford) [#63825](https://github.com/nodejs/node/pull/63825)
* \[[`e69f82c897`](https://github.com/nodejs/node/commit/e69f82c897)] - **net**: coerce -0 to +0 in BlockList prefixes (Filip Skokan) [#63556](https://github.com/nodejs/node/pull/63556)
* \[[`70ebe66a96`](https://github.com/nodejs/node/commit/70ebe66a96)] - **(SEMVER-MINOR)** **perf\_hooks**: sample delay per event loop iteration (Pablo Erhard) [#62935](https://github.com/nodejs/node/pull/62935)
* \[[`deeeaacf8d`](https://github.com/nodejs/node/commit/deeeaacf8d)] - **perf\_hooks**: add NODE\_PERFORMANCE\_GC\_MINOR\_MARK\_SWEEP constant (Attila Szegedi) [#63877](https://github.com/nodejs/node/pull/63877)
* \[[`cc08f2a97c`](https://github.com/nodejs/node/commit/cc08f2a97c)] - **process**: fix finalization cleanup ref tracking (Trivikram Kamat) [#64087](https://github.com/nodejs/node/pull/64087)
* \[[`6fb5bb5126`](https://github.com/nodejs/node/commit/6fb5bb5126)] - **quic**: fix broken listEndpoints export, test callbacks & nghttp3 include (Tim Perry) [#63874](https://github.com/nodejs/node/pull/63874)
* \[[`1d62b24a82`](https://github.com/nodejs/node/commit/1d62b24a82)] - **sqlite**: do not leave database open after failed open (Yagiz Nizipli) [#63854](https://github.com/nodejs/node/pull/63854)
* \[[`b28fe96d6b`](https://github.com/nodejs/node/commit/b28fe96d6b)] - **sqlite**: fix stack-use-after-scope with function callback (ndossche) [#63640](https://github.com/nodejs/node/pull/63640)
* \[[`a446480fdd`](https://github.com/nodejs/node/commit/a446480fdd)] - **(SEMVER-MINOR)** **src**: allow empty --experimental-config-file (Marco Ippolito) [#61610](https://github.com/nodejs/node/pull/61610)
* \[[`4b70bcfc86`](https://github.com/nodejs/node/commit/4b70bcfc86)] - **src**: add test flag to config file (Marco Ippolito) [#60798](https://github.com/nodejs/node/pull/60798)
* \[[`f07d76613e`](https://github.com/nodejs/node/commit/f07d76613e)] - **src**: rename config file testRunner to test (Marco Ippolito) [#60798](https://github.com/nodejs/node/pull/60798)
* \[[`b459d10632`](https://github.com/nodejs/node/commit/b459d10632)] - **src**: do not enable wasm trap handler if there's not enough vmem (Joyee Cheung) [#62132](https://github.com/nodejs/node/pull/62132)
* \[[`d38c790ac3`](https://github.com/nodejs/node/commit/d38c790ac3)] - **src**: fix escaping of single quotes in task runner (Antoine du Hamel) [#64089](https://github.com/nodejs/node/pull/64089)
* \[[`19c0eff0ea`](https://github.com/nodejs/node/commit/19c0eff0ea)] - **src**: abstract tracing agent for both legacy and perfetto (Chengzhong Wu) [#64053](https://github.com/nodejs/node/pull/64053)
* \[[`fa710c2dd6`](https://github.com/nodejs/node/commit/fa710c2dd6)] - **src**: avoid redundant call to `std::get_if<>()` (Tobias Nießen) [#64094](https://github.com/nodejs/node/pull/64094)
* \[[`f9cabf87d2`](https://github.com/nodejs/node/commit/f9cabf87d2)] - **src**: omit unconvertible names in cjs\_lexer::Parse (Yagiz Nizipli) [#63943](https://github.com/nodejs/node/pull/63943)
* \[[`6387105874`](https://github.com/nodejs/node/commit/6387105874)] - **src**: guard OpenSSL compression header include (Filip Skokan) [#64009](https://github.com/nodejs/node/pull/64009)
* \[[`f29949e1c6`](https://github.com/nodejs/node/commit/f29949e1c6)] - **src**: handle empty MaybeLocal in cjs\_lexer::Parse (Yagiz Nizipli) [#63885](https://github.com/nodejs/node/pull/63885)
* \[[`53df1584ab`](https://github.com/nodejs/node/commit/53df1584ab)] - **src**: do not track weak `BaseObject`s as childrens of `Realm`s (Anna Henningsen) [#63842](https://github.com/nodejs/node/pull/63842)
* \[[`747aa0c262`](https://github.com/nodejs/node/commit/747aa0c262)] - **src**: allow tracking children in `MemoryTracker` with weak edges (Anna Henningsen) [#63842](https://github.com/nodejs/node/pull/63842)
* \[[`e75d973efd`](https://github.com/nodejs/node/commit/e75d973efd)] - **src**: use C++14 deprecated attribute for `NODE_DEPRECATED` (Anna Henningsen) [#63755](https://github.com/nodejs/node/pull/63755)
* \[[`e9659f5280`](https://github.com/nodejs/node/commit/e9659f5280)] - **src**: add cleanup hooks to `node::ObjectWrap` (Anna Henningsen) [#63642](https://github.com/nodejs/node/pull/63642)
* \[[`2f4e596fa0`](https://github.com/nodejs/node/commit/2f4e596fa0)] - **src**: fix edge case when deflateInit2() fails with Z\_VERSION\_ERROR (Nora Dossche) [#63476](https://github.com/nodejs/node/pull/63476)
* \[[`b81f1b10b5`](https://github.com/nodejs/node/commit/b81f1b10b5)] - **src**: add Latin1 fast path in StringBytes::Encode utf8 (Mert Can Altin) [#63385](https://github.com/nodejs/node/pull/63385)
* \[[`0ba5cc467a`](https://github.com/nodejs/node/commit/0ba5cc467a)] - **src**: fix crash when reading length on Storage.prototype (Mohamed Sayed) [#63529](https://github.com/nodejs/node/pull/63529)
* \[[`0d24deade5`](https://github.com/nodejs/node/commit/0d24deade5)] - **stream**: cut per-chunk overhead in WHATWG streams (Matteo Collina) [#64252](https://github.com/nodejs/node/pull/64252)
* \[[`70e9390c86`](https://github.com/nodejs/node/commit/70e9390c86)] - **stream**: reduce allocations on WHATWG streams hot paths (Matteo Collina) [#63876](https://github.com/nodejs/node/pull/63876)
* \[[`b9ae1d0ecb`](https://github.com/nodejs/node/commit/b9ae1d0ecb)] - **stream**: optimize pipeTo promise handling (Matteo Collina) [#63572](https://github.com/nodejs/node/pull/63572)
* \[[`5caf5e657e`](https://github.com/nodejs/node/commit/5caf5e657e)] - **stream**: preserve half-open duplexes in async iteration (Efe) [#64275](https://github.com/nodejs/node/pull/64275)
* \[[`1492bc52f1`](https://github.com/nodejs/node/commit/1492bc52f1)] - **(SEMVER-MINOR)** **stream**: expose ReadableStreamTee (Matteo Collina) [#64195](https://github.com/nodejs/node/pull/64195)
* \[[`492d7182d5`](https://github.com/nodejs/node/commit/492d7182d5)] - **stream**: proxy first own method in Readable.wrap() (Daijiro Wachi) [#64048](https://github.com/nodejs/node/pull/64048)
* \[[`6ba4e880cc`](https://github.com/nodejs/node/commit/6ba4e880cc)] - **stream**: fix Writable.toWeb() desiredSize for non-object-mode (Matteo Collina) [#62986](https://github.com/nodejs/node/pull/62986)
* \[[`af215a8637`](https://github.com/nodejs/node/commit/af215a8637)] - **stream**: fix Utf8Stream stall after full write of multi-byte data (Daijiro Wachi) [#63964](https://github.com/nodejs/node/pull/63964)
* \[[`1bac08661a`](https://github.com/nodejs/node/commit/1bac08661a)] - **stream**: only pass the expected number of parameters to callbacks (Antoine du Hamel) [#63909](https://github.com/nodejs/node/pull/63909)
* \[[`e55eeafd4f`](https://github.com/nodejs/node/commit/e55eeafd4f)] - **stream**: fix dropped first chunk in Utf8Stream buffer mode (Daijiro Wachi) [#63833](https://github.com/nodejs/node/pull/63833)
* \[[`97590e8680`](https://github.com/nodejs/node/commit/97590e8680)] - **stream**: check done before backpressure in stream reader (Daijiro Wachi) [#63699](https://github.com/nodejs/node/pull/63699)
* \[[`5a356ac784`](https://github.com/nodejs/node/commit/5a356ac784)] - **test**: update WPT for WebCryptoAPI to 03a1476844 (Node.js GitHub Bot) [#63900](https://github.com/nodejs/node/pull/63900)
* \[[`8aa5c840a8`](https://github.com/nodejs/node/commit/8aa5c840a8)] - **test**: deflake test-debugger-probe-timeout (Joyee Cheung) [#63547](https://github.com/nodejs/node/pull/63547)
* \[[`0f08fc2c58`](https://github.com/nodejs/node/commit/0f08fc2c58)] - **test**: make blob desiredSize assertion robust (Trivikram Kamat) [#64106](https://github.com/nodejs/node/pull/64106)
* \[[`4a0ff0e5c7`](https://github.com/nodejs/node/commit/4a0ff0e5c7)] - **test**: update WPT for urlpattern to 11a459a2b1 (Node.js GitHub Bot) [#64037](https://github.com/nodejs/node/pull/64037)
* \[[`8c8ff866d5`](https://github.com/nodejs/node/commit/8c8ff866d5)] - **test**: improve lcov reporter snapshot diagnostics (Trivikram Kamat) [#64049](https://github.com/nodejs/node/pull/64049)
* \[[`c76dd4a4a5`](https://github.com/nodejs/node/commit/c76dd4a4a5)] - **test**: keep finalization close fixture ref alive (Trivikram Kamat) [#64085](https://github.com/nodejs/node/pull/64085)
* \[[`562b09855d`](https://github.com/nodejs/node/commit/562b09855d)] - **test**: fix typo from overriden to overridden (parkhojeong) [#63403](https://github.com/nodejs/node/pull/63403)
* \[[`227033df94`](https://github.com/nodejs/node/commit/227033df94)] - **test**: mark hr-time WPT flaky on macos15-x64 (Trivikram Kamat) [#64054](https://github.com/nodejs/node/pull/64054)
* \[[`1be32f377f`](https://github.com/nodejs/node/commit/1be32f377f)] - **test**: use one-off agent in http consumed timeout test (Trivikram Kamat) [#64052](https://github.com/nodejs/node/pull/64052)
* \[[`2ccc4c6a86`](https://github.com/nodejs/node/commit/2ccc4c6a86)] - **test**: fix flaky test-runner coverage threshold test (Trivikram Kamat) [#64051](https://github.com/nodejs/node/pull/64051)
* \[[`6f345594ed`](https://github.com/nodejs/node/commit/6f345594ed)] - **test**: tolerate duplicate watch change events (Trivikram Kamat) [#63937](https://github.com/nodejs/node/pull/63937)
* \[[`d2dc033e1b`](https://github.com/nodejs/node/commit/d2dc033e1b)] - **test**: mark test-debugger-run-after-quit-restart as flaky on macOS (Matteo Collina) [#64006](https://github.com/nodejs/node/pull/64006)
* \[[`6f3e3429b9`](https://github.com/nodejs/node/commit/6f3e3429b9)] - **test**: update WPT for url to d4598eba09 (Node.js GitHub Bot) [#63899](https://github.com/nodejs/node/pull/63899)
* \[[`b8d3f5efa3`](https://github.com/nodejs/node/commit/b8d3f5efa3)] - **test**: update WPT for urlpattern to 23aac92784 (Node.js GitHub Bot) [#63898](https://github.com/nodejs/node/pull/63898)
* \[[`41e78113c3`](https://github.com/nodejs/node/commit/41e78113c3)] - **test**: add tests for 3 methods in utils (Daijiro Wachi) [#63765](https://github.com/nodejs/node/pull/63765)
* \[[`d86c1d9f94`](https://github.com/nodejs/node/commit/d86c1d9f94)] - **test**: mark SEA tests flaky on linux arm debug (Trivikram Kamat) [#63743](https://github.com/nodejs/node/pull/63743)
* \[[`b4e941c4c3`](https://github.com/nodejs/node/commit/b4e941c4c3)] - **test**: validate ERR\_INVALID\_THIS for scheduler methods (Daijiro Wachi) [#63764](https://github.com/nodejs/node/pull/63764)
* \[[`2b50ee30bb`](https://github.com/nodejs/node/commit/2b50ee30bb)] - **test**: add coverage outside SEA (Daijiro Wachi) [#63744](https://github.com/nodejs/node/pull/63744)
* \[[`9386db5442`](https://github.com/nodejs/node/commit/9386db5442)] - **test**: update WPT for urlpattern to 2f28df545c (Node.js GitHub Bot) [#63771](https://github.com/nodejs/node/pull/63771)
* \[[`4a2303a525`](https://github.com/nodejs/node/commit/4a2303a525)] - **test**: make Brotli 16GB test wait for backpressure (Trivikram Kamat) [#63389](https://github.com/nodejs/node/pull/63389)
* \[[`a6b5163169`](https://github.com/nodejs/node/commit/a6b5163169)] - **test**: add regression test for using `ObjectWrap` in worker (Mohamed Akram) [#63642](https://github.com/nodejs/node/pull/63642)
* \[[`85487ceaf6`](https://github.com/nodejs/node/commit/85487ceaf6)] - **test**: accept SIGILL aborts in async-hooks tests (Trivikram Kamat) [#63687](https://github.com/nodejs/node/pull/63687)
* \[[`9c417fd2e0`](https://github.com/nodejs/node/commit/9c417fd2e0)] - **test**: add more test cases for pathToFileURL (Rafael Gonzaga) [#63293](https://github.com/nodejs/node/pull/63293)
* \[[`f9f192a125`](https://github.com/nodejs/node/commit/f9f192a125)] - **test**: update test426-fixtures to 2965987bf4c96afa400c9356c8e620cb340aaee (Node.js GitHub Bot) [#63668](https://github.com/nodejs/node/pull/63668)
* \[[`fc2c6c9999`](https://github.com/nodejs/node/commit/fc2c6c9999)] - **test**: cover webcrypto prototype pollution systematically (Filip Skokan) [#63520](https://github.com/nodejs/node/pull/63520)
* \[[`d6b2834aaa`](https://github.com/nodejs/node/commit/d6b2834aaa)] - **test,debugger**: add test for type stripping in debugger probe mode (Joyee Cheung) [#63748](https://github.com/nodejs/node/pull/63748)
* \[[`494d8e0192`](https://github.com/nodejs/node/commit/494d8e0192)] - **test\_runner**: avoid recompiling coverage globs for every file (sangwook) [#63675](https://github.com/nodejs/node/pull/63675)
* \[[`c048b3afc7`](https://github.com/nodejs/node/commit/c048b3afc7)] - **test\_runner**: cache `shouldSkipFileCoverage` result per URL (sangwook) [#63675](https://github.com/nodejs/node/pull/63675)
* \[[`7f3f9de083`](https://github.com/nodejs/node/commit/7f3f9de083)] - **test\_runner**: ignore erased TS lines in coverage (Matteo Collina) [#63510](https://github.com/nodejs/node/pull/63510)
* \[[`3ae5f8c1d2`](https://github.com/nodejs/node/commit/3ae5f8c1d2)] - **test\_runner**: fix suite diagnostic chanel end (Moshe Atlow) [#63533](https://github.com/nodejs/node/pull/63533)
* \[[`1cdef79adc`](https://github.com/nodejs/node/commit/1cdef79adc)] - **test\_runner**: add parentId to test events with testId (Moshe Atlow) [#63435](https://github.com/nodejs/node/pull/63435)
* \[[`b2f155e10c`](https://github.com/nodejs/node/commit/b2f155e10c)] - **test\_runner**: fix hooks test context (Moshe Atlow) [#63285](https://github.com/nodejs/node/pull/63285)
* \[[`872910a065`](https://github.com/nodejs/node/commit/872910a065)] - **test\_runner**: add tags option and tag-name filter (Chemi Atlow) [#63221](https://github.com/nodejs/node/pull/63221)
* \[[`a0cab5aee4`](https://github.com/nodejs/node/commit/a0cab5aee4)] - **test\_runner**: add `getTestContext()` (Moshe Atlow) [#62501](https://github.com/nodejs/node/pull/62501)
* \[[`439694dbdc`](https://github.com/nodejs/node/commit/439694dbdc)] - **test\_runner**: filter execArgv fallback for child tests (Trivikram Kamat) [#64056](https://github.com/nodejs/node/pull/64056)
* \[[`610db93fba`](https://github.com/nodejs/node/commit/610db93fba)] - **test\_runner**: improve coverage failure diagnostics (Trivikram Kamat) [#64050](https://github.com/nodejs/node/pull/64050)
* \[[`0cd81ec86a`](https://github.com/nodejs/node/commit/0cd81ec86a)] - **test\_runner**: add timestamp to JUnit reporter testsuites (sangwook) [#64029](https://github.com/nodejs/node/pull/64029)
* \[[`d24afc262b`](https://github.com/nodejs/node/commit/d24afc262b)] - **test\_runner**: remove unused shuffleArrayWithSeed (Daijiro Wachi) [#63847](https://github.com/nodejs/node/pull/63847)
* \[[`ebd2b91326`](https://github.com/nodejs/node/commit/ebd2b91326)] - **test\_runner**: fix watch cwd with isolation none (Trivikram Kamat) [#63690](https://github.com/nodejs/node/pull/63690)
* \[[`88c1699651`](https://github.com/nodejs/node/commit/88c1699651)] - **timers**: reuse Timeout objects in setStreamTimeout (Matteo Collina) [#64254](https://github.com/nodejs/node/pull/64254)
* \[[`e3c0fd74b8`](https://github.com/nodejs/node/commit/e3c0fd74b8)] - **(SEMVER-MINOR)** **tls**: report negotiated TLS groups (Filip Skokan) [#64119](https://github.com/nodejs/node/pull/64119)
* \[[`6f75a89a89`](https://github.com/nodejs/node/commit/6f75a89a89)] - **tls**: handle large RSA exponents in X.509 cert (Tobias Nießen) [#64093](https://github.com/nodejs/node/pull/64093)
* \[[`a31378a449`](https://github.com/nodejs/node/commit/a31378a449)] - **(SEMVER-MINOR)** **tls**: add certificateCompression option (Tim Perry) [#62217](https://github.com/nodejs/node/pull/62217)
* \[[`cf039e2650`](https://github.com/nodejs/node/commit/cf039e2650)] - **tls**: route event listener exceptions through error handlers (Antoine du Hamel) [#63822](https://github.com/nodejs/node/pull/63822)
* \[[`dff51131ea`](https://github.com/nodejs/node/commit/dff51131ea)] - **tools**: bump the eslint group in /tools/eslint with 8 updates (dependabot\[bot]) [#64249](https://github.com/nodejs/node/pull/64249)
* \[[`a7a3174797`](https://github.com/nodejs/node/commit/a7a3174797)] - **tools**: update c-ares updater script (Antoine du Hamel) [#64194](https://github.com/nodejs/node/pull/64194)
* \[[`e5ad190e02`](https://github.com/nodejs/node/commit/e5ad190e02)] - **tools**: validate version number in release proposal commit message lint (Antoine du Hamel) [#64070](https://github.com/nodejs/node/pull/64070)
* \[[`62a7ff09f0`](https://github.com/nodejs/node/commit/62a7ff09f0)] - **tools**: update sccache to v0.16.0 (Michaël Zasso) [#63078](https://github.com/nodejs/node/pull/63078)
* \[[`5c9e1b5eac`](https://github.com/nodejs/node/commit/5c9e1b5eac)] - **tools**: bump js-yaml from 4.1.1 to 4.2.0 in /tools/lint-md (dependabot\[bot]) [#63948](https://github.com/nodejs/node/pull/63948)
* \[[`7278e4d6ab`](https://github.com/nodejs/node/commit/7278e4d6ab)] - **tools**: bump js-yaml from 4.1.1 to 4.2.0 in /tools/eslint (dependabot\[bot]) [#63947](https://github.com/nodejs/node/pull/63947)
* \[[`02cbcc3baa`](https://github.com/nodejs/node/commit/02cbcc3baa)] - **tools**: update the llhttp updater script (Antoine du Hamel) [#63819](https://github.com/nodejs/node/pull/63819)
* \[[`b82d8cd923`](https://github.com/nodejs/node/commit/b82d8cd923)] - **tools**: align Bash snippets in GHA with `lint-sh` conventions (Antoine du Hamel) [#63829](https://github.com/nodejs/node/pull/63829)
* \[[`0f5467360b`](https://github.com/nodejs/node/commit/0f5467360b)] - **tools**: bump the eslint group in /tools/eslint with 7 updates (dependabot\[bot]) [#63730](https://github.com/nodejs/node/pull/63730)
* \[[`1692fdbb4c`](https://github.com/nodejs/node/commit/1692fdbb4c)] - **tools**: fix zlib updater script (Antoine du Hamel) [#63707](https://github.com/nodejs/node/pull/63707)
* \[[`fb4d8db0fa`](https://github.com/nodejs/node/commit/fb4d8db0fa)] - **typings**: add typing for crypto (Filip Skokan) [#64122](https://github.com/nodejs/node/pull/64122)
* \[[`898c4a81ee`](https://github.com/nodejs/node/commit/898c4a81ee)] - **url**: fix URLSearchParams(null) to prudce null= per spec (Marco) [#63782](https://github.com/nodejs/node/pull/63782)
* \[[`9ce79b28b0`](https://github.com/nodejs/node/commit/9ce79b28b0)] - **util**: fix OOM in inspect color stack formatting (Ijtihed Kilani) [#64022](https://github.com/nodejs/node/pull/64022)
* \[[`7e85198d14`](https://github.com/nodejs/node/commit/7e85198d14)] - **util**: fix scientific notation formatting (Daijiro Wachi) [#63823](https://github.com/nodejs/node/pull/63823)
* \[[`4e8db7fc92`](https://github.com/nodejs/node/commit/4e8db7fc92)] - **util**: fix -0 formatting when numericSeparator is enabled (Daijiro Wachi) [#63815](https://github.com/nodejs/node/pull/63815)
* \[[`991956e819`](https://github.com/nodejs/node/commit/991956e819)] - **util**: remove style caches from styleText slow path (Guilherme Araújo) [#63706](https://github.com/nodejs/node/pull/63706)
* \[[`066120125e`](https://github.com/nodejs/node/commit/066120125e)] - **watch**: print name of changed file that triggers restart (Marco) [#63781](https://github.com/nodejs/node/pull/63781)
* \[[`28f380d588`](https://github.com/nodejs/node/commit/28f380d588)] - **watch**: cancel pending restart on shutdown (Trivikram Kamat) [#63383](https://github.com/nodejs/node/pull/63383)
* \[[`8170bbcb63`](https://github.com/nodejs/node/commit/8170bbcb63)] - **zlib**: validate flush king for all streams (Ic3b3rg) [#63746](https://github.com/nodejs/node/pull/63746)
* \[[`00ae7a61f6`](https://github.com/nodejs/node/commit/00ae7a61f6)] - **zlib**: validate flush kind for brotli streams (Ic3b3rg) [#63746](https://github.com/nodejs/node/pull/63746)
* \[[`ccbe0819cf`](https://github.com/nodejs/node/commit/ccbe0819cf)] - **zlib**: expose rejectGarbageAfterEnd option (Filip Skokan) [#64023](https://github.com/nodejs/node/pull/64023)
* \[[`a58a224797`](https://github.com/nodejs/node/commit/a58a224797)] - **zlib**: reject trailing gzip members in web streams (Filip Skokan) [#64023](https://github.com/nodejs/node/pull/64023)
* \[[`be4b3fe966`](https://github.com/nodejs/node/commit/be4b3fe966)] - **zlib**: coerce -0 to +0 for crc32 seeds (Filip Skokan) [#63556](https://github.com/nodejs/node/pull/63556)
