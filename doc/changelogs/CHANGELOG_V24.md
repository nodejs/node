...
* \[[`619f6bb698`](https://github.com/nodejs/node/commit/619f6bb698)] - **(SEMVER-MINOR)** **http**: add optimizeEmptyRequests server option (Rafael Gonzaga) [#59778](https://github.com/nodejs/node/pull/59778)
* \[[`b9277a0ab7`](https://github.com/nodejs/node/commit/b9277a0ab7)] - **(SEMVER-MINOR)** **src**: add watch config namespace (Marco Ippolito) [#60178](https://github.com/nodejs/node/pull/60178)
* \[[`986b4df1cc`](https://github.com/nodejs/node/commit/986b4df1cc)] - **(SEMVER-MINOR)** **src**: add an option to make compile cache portable (Aditi) [#58797](https://github.com/nodejs/node/pull/58797)
* \[[`879e4c0073`](https://github.com/nodejs/node/commit/879e4c0073)] - **(SEMVER-MINOR)** **v8**: add cpu profile (theanarkh) [#59807](https://github.com/nodejs/node/pull/59807)

### Commits

* \[[`a330b57ad8`](https://github.com/nodejs/node/commit/a330b57ad8)] - **benchmark**: improve cpu.sh for safety and usability (Nam Yooseong) [#60162](https://github.com/nodejs/node/pull/60162)
* \[[`5e374e9870`](https://github.com/nodejs/node/commit/5e374e9870)] - **benchmark**: add benchmark for leaf source text modules (Joyee Cheung) [#60205](https://github.com/nodejs/node/pull/60205)
* \[[`2448de6c0c`](https://github.com/nodejs/node/commit/2448de6c0c)] - **benchmark**: add vm.SourceTextModule benchmark (Joyee Cheung) [#59396](https://github.com/nodejs/node/pull/59396)
* \[[`2fc1abf7f8`](https://github.com/nodejs/node/commit/2fc1abf7f8)] - **benchmark**: use non-deprecated WriteUtf8V2 method (Michaël Zasso) [#60173](https://github.com/nodejs/node/pull/60173)
* \[[`13e192982f`](https://github.com/nodejs/node/commit/13e192982f)] - **build**: ibmi follow aix visibility (SRAVANI GUNDEPALLI) [#60360](https://github.com/nodejs/node/pull/60360)
* \[[`0087d9a7ae`](https://github.com/nodejs/node/commit/0087d9a7ae)] - **build**: use call command when calling python configure (Jacob Nichols) [#60098](https://github.com/nodejs/node/pull/60098)
* \[[`176959785a`](https://github.com/nodejs/node/commit/176959785a)] - **build**: build v8 with -fvisibility=hidden -fvisibility-inlines-hidden (Joyee Cheung) [#56290](https://github.com/nodejs/node/pull/56290)
* \[[`77189c195f`](https://github.com/nodejs/node/commit/77189c195f)] - **build**: remove V8\_COMPRESS\_POINTERS\_IN\_ISOLATE\_CAGE defs (Joyee Cheung) [#60296](https://github.com/nodejs/node/pull/60296)
* \[[`1be854f257`](https://github.com/nodejs/node/commit/1be854f257)] - **build, src**: fix include paths for vtune files (Rahul) [#59999](https://github.com/nodejs/node/pull/59999)
* \[[`64540121fb`](https://github.com/nodejs/node/commit/64540121fb)] - **crypto**: update root certificates to NSS 3.116 (Node.js GitHub Bot) [#59956](https://github.com/nodejs/node/pull/59956)
* \[[`dd9a117f9a`](https://github.com/nodejs/node/commit/dd9a117f9a)] - **deps**: update corepack to 0.34.2 (Node.js GitHub Bot) [#60550](https://github.com/nodejs/node/pull/60550)
* \[[`1af45bf0ae`](https://github.com/nodejs/node/commit/1af45bf0ae)] - **deps**: update simdjson to 4.0.7 (Node.js GitHub Bot) [#59883](https://github.com/nodejs/node/pull/59883)
* \[[`ce265a2712`](https://github.com/nodejs/node/commit/ce265a2712)] - **deps**: update corepack to 0.34.1 (Node.js GitHub Bot) [#60314](https://github.com/nodejs/node/pull/60314)
* \[[`f61511650f`](https://github.com/nodejs/node/commit/f61511650f)] - **deps**: update inspector\_protocol to af7f5a8173fdbc29f0835ec94395932e328b (Node.js GitHub Bot) [#60312](https://github.com/nodejs/node/pull/60312)
* \[[`ebe3befe78`](https://github.com/nodejs/node/commit/ebe3befe78)] - **deps**: update googletest to 279f847 (Node.js GitHub Bot) [#60219](https://github.com/nodejs/node/pull/60219)
* \[[`40c984df38`](https://github.com/nodejs/node/commit/40c984df38)] - **deps**: upgrade npm to 11.6.2 (npm team) [#60168](https://github.com/nodejs/node/pull/60168)
* \[[`6181e9df11`](https://github.com/nodejs/node/commit/6181e9df11)] - **doc**: mention more codemods in `deprecations.md` (Augustin Mauroy) [#60243](https://github.com/nodejs/node/pull/60243)
* \[[`83a725291a`](https://github.com/nodejs/node/commit/83a725291a)] - **doc**: add missing CAA type to dns.resolveAny() & dnsPromises.resolveAny() (Jimmy Leung) [#58899](https://github.com/nodejs/node/pull/58899)
* \[[`fbc8b7bfaa`](https://github.com/nodejs/node/commit/fbc8b7bfaa)] - **doc**: use `any` for `worker_threads.Worker` 'error' event argument `err` (Jonas Geiler) [#60300](https://github.com/nodejs/node/pull/60300)
* \[[`3a64383b8a`](https://github.com/nodejs/node/commit/3a64383b8a)] - **doc**: update decorator documentation to reflect actual policy (Muhammad Salman Aziz) [#60288](https://github.com/nodejs/node/pull/60288)
* \[[`5262707c9c`](https://github.com/nodejs/node/commit/5262707c9c)] - **doc**: document wildcard supported by tools/test.py (Joyee Cheung) [#60265](https://github.com/nodejs/node/pull/60265)
* \[[`51adaaa491`](https://github.com/nodejs/node/commit/51adaaa491)] - **doc**: add --heap-snapshot-on-oom to useful v8 flag (jakecastelli) [#60260](https://github.com/nodejs/node/pull/60260)
* \[[`51fb64d2f3`](https://github.com/nodejs/node/commit/51fb64d2f3)] - **doc**: fix `blob.bytes()` heading level (XTY) [#60252](https://github.com/nodejs/node/pull/60252)
* \[[`472e11d071`](https://github.com/nodejs/node/commit/472e11d071)] - **doc**: fix not working code example in vm docs (Artur Gawlik) [#60224](https://github.com/nodejs/node/pull/60224)
* \[[`9446832905`](https://github.com/nodejs/node/commit/9446832905)] - **doc**: improve code snippet alternative of url.parse() using WHATWG URL (Steven) [#60209](https://github.com/nodejs/node/pull/60209)
* \[[`987a023c70`](https://github.com/nodejs/node/commit/987a023c70)] - **doc**: `createSQLTagStore` -> `createTagStore` (Aviv Keller) [#60182](https://github.com/nodejs/node/pull/60182)
* \[[`6643c82512`](https://github.com/nodejs/node/commit/6643c82512)] - **doc**: use markdown when branch-diff major release (Rafael Gonzaga) [#60179](https://github.com/nodejs/node/pull/60179)
* \[[`16e5db3e38`](https://github.com/nodejs/node/commit/16e5db3e38)] - **doc**: update teams in collaborator-guide.md and add links (Bart Louwers) [#60065](https://github.com/nodejs/node/pull/60065)
* \[[`3176940893`](https://github.com/nodejs/node/commit/3176940893)] - **doc**: disambiguate top-level `worker_threads` module exports (René) [#59890](https://github.com/nodejs/node/pull/59890)
...
* \[[`efbfc6c368`](https://github.com/nodejs/node/commit/efbfc6c368)] - **doc, module**: change async customization hooks to experimental (Gerhard Stöbich) [#60302](https://github.com/nodejs/node/pull/60302)
* \[[`b1f74c7058`](https://github.com/nodejs/node/commit/b1f74c7058)] - **http**: lazy allocate cookies array (Robert Nagy) [#59734](https://github.com/nodejs/node/pull/59734)
* \[[`619f6bb698`](https://github.com/nodejs/node/commit/619f6bb698)] - **(SEMVER-MINOR)** **http**: add optimizeEmptyRequests server option (Rafael Gonzaga) [#59778](https://github.com/nodejs/node/pull/59778)
* \[[`157e1f1399`](https://github.com/nodejs/node/commit/157e1f1399)] - **http**: fix http client leaky with double response (theanarkh) [#60062](https://github.com/nodejs/node/pull/60062)
* \[[`cc2d9fdfcf`](https://github.com/nodejs/node/commit/cc2d9fdfcf)] - **http2**: rename variable to additionalPseudoHeaders (Tobias Nießen) [#60208](https://github.com/nodejs/node/pull/60208)
* \[[`5009021a07`](https://github.com/nodejs/node/commit/5009021a07)] - **http2**: do not crash on mismatched ping buffer length (René) [#60135](https://github.com/nodejs/node/pull/60135)
* \[[`93c5776b0e`](https://github.com/nodejs/node/commit/93c5776b0e)] - **inspector**: add network payload buffer size limits (Chengzhong Wu) [#60236](https://github.com/nodejs/node/pull/60236)
* \[[`00072128df`](https://github.com/nodejs/node/commit/00072128df)] - **inspector**: support handshake response for websocket inspection (Shima Ryuhei) [#60225](https://github.com/nodejs/node/pull/60225)
* \[[`365aed4133`](https://github.com/nodejs/node/commit/365aed4133)] - **lib**: fix typo in createBlobReaderStream (SeokHun) [#60132](https://github.com/nodejs/node/pull/60132)
* \[[`0c130d057d`](https://github.com/nodejs/node/commit/0c130d057d)] - **lib**: fix constructor in \_errnoException stack tree (SeokHun) [#60156](https://github.com/nodejs/node/pull/60156)
* \[[`caafda2a6a`](https://github.com/nodejs/node/commit/caafda2a6a)] - **lib**: fix typo in QuicSessionStats (SeokHun) [#60155](https://github.com/nodejs/node/pull/60155)
* \[[`3ef07506c0`](https://github.com/nodejs/node/commit/3ef07506c0)] - **lib**: remove redundant destroyHook checks (Gürgün Dayıoğlu) [#60120](https://github.com/nodejs/node/pull/60120)
* \[[`49046c5dcb`](https://github.com/nodejs/node/commit/49046c5dcb)] - **meta**: move one or more collaborators to emeritus (Node.js GitHub Bot) [#60325](https://github.com/nodejs/node/pull/60325)
* \[[`b66f0f766d`](https://github.com/nodejs/node/commit/b66f0f766d)] - **meta**: loop userland-migrations in deprecations (Chengzhong Wu) [#60299](https://github.com/nodejs/node/pull/60299)
* \[[`67bfe86173`](https://github.com/nodejs/node/commit/67bfe86173)] - **module**: refactor and clarify async loader hook customizations (Joyee Cheung) [#60278](https://github.com/nodejs/node/pull/60278)
* \[[`d6a982be9b`](https://github.com/nodejs/node/commit/d6a982be9b)] - **module**: handle null source from async loader hooks in sync hooks (Joyee Cheung) [#59929](https://github.com/nodejs/node/pull/59929)
* \[[`31a1c953af`](https://github.com/nodejs/node/commit/31a1c953af)] - **module**: fix directory option in the enableCompileCache() API (Joyee Cheung) [#59931](https://github.com/nodejs/node/pull/59931)
* \[[`88a7df7e7e`](https://github.com/nodejs/node/commit/88a7df7e7e)] - **msi**: fix WiX warnings (Stefan Stojanovic) [#60251](https://github.com/nodejs/node/pull/60251)
* \[[`076115d238`](https://github.com/nodejs/node/commit/076115d238)] - **src**: fix timing of snapshot serialize callback (Joyee Cheung) [#60434](https://github.com/nodejs/node/pull/60434)
* \[[`b8fd0df55d`](https://github.com/nodejs/node/commit/b8fd0df55d)] - **src**: add COUNT\_GENERIC\_USAGE utility for tests (Joyee Cheung) [#60434](https://github.com/nodejs/node/pull/60434)
* \[[`534f249a01`](https://github.com/nodejs/node/commit/534f249a01)] - **src**: conditionally disable source phase imports by default (Shelley Vohr) [#60364](https://github.com/nodejs/node/pull/60364)
* \[[`b9277a0ab7`](https://github.com/nodejs/node/commit/b9277a0ab7)] - **(SEMVER-MINOR)** **src**: add watch config namespace (Marco Ippolito) [#60178](https://github.com/nodejs/node/pull/60178)
* \[[`4390889010`](https://github.com/nodejs/node/commit/4390889010)] - **src**: use cached primordials\_string (Sohyeon Kim) [#60255](https://github.com/nodejs/node/pull/60255)
* \[[`41cc57ebd8`](https://github.com/nodejs/node/commit/41cc57ebd8)] - **src**: replace Environment::GetCurrent with args.GetIsolate (Sohyeon Kim) [#60256](https://github.com/nodejs/node/pull/60256)
* \[[`ec53d9f0a3`](https://github.com/nodejs/node/commit/ec53d9f0a3)] - **src**: initial enablement of IsolateGroups (James M Snell) [#60254](https://github.com/nodejs/node/pull/60254)
* \[[`c95d974538`](https://github.com/nodejs/node/commit/c95d974538)] - **src**: use `Utf8Value` and `TwoByteValue` instead of V8 helpers (Anna Henningsen) [#60244](https://github.com/nodejs/node/pull/60244)
* \[[`73fe9d22e2`](https://github.com/nodejs/node/commit/73fe9d22e2)] - **src**: add a default branch for module phase (Chengzhong Wu) [#60261](https://github.com/nodejs/node/pull/60261)
* \[[`f3359104c7`](https://github.com/nodejs/node/commit/f3359104c7)] - **src**: make additional cleanups in node locks impl (James M Snell) [#60061](https://github.com/nodejs/node/pull/60061)
* \[[`4b7d83652b`](https://github.com/nodejs/node/commit/4b7d83652b)] - **src**: update locks to use DictionaryTemplate (James M Snell) [#60061](https://github.com/nodejs/node/pull/60061)
* \[[`986b4df1cc`](https://github.com/nodejs/node/commit/986b4df1cc)] - **(SEMVER-MINOR)** **src**: add an option to make compile cache portable (Aditi) [#58797](https://github.com/nodejs/node/pull/58797)
* \[[`3ce93dd9f0`](https://github.com/nodejs/node/commit/3ce93dd9f0)] - **test**: increase debugger waitFor timeout on macOS (Chengzhong Wu) [#60367](https://github.com/nodejs/node/pull/60367)
* \[[`388a16336e`](https://github.com/nodejs/node/commit/388a16336e)] - **test**: put helper in test-runner-output into common (Joyee Cheung) [#60330](https://github.com/nodejs/node/pull/60330)
* \[[`1790f50094`](https://github.com/nodejs/node/commit/1790f50094)] - **test**: fix small compile warning in test\_network\_requests\_buffer.cc (xiaocainiao633) [#60281](https://github.com/nodejs/node/pull/60281)
* \[[`f37230347f`](https://github.com/nodejs/node/commit/f37230347f)] - **test**: split test-runner-watch-mode-kill-signal (Joyee Cheung) [#60298](https://github.com/nodejs/node/pull/60298)
* \[[`931b80f3ea`](https://github.com/nodejs/node/commit/931b80f3ea)] - **test**: fix incorrect calculation in test-perf-hooks.js (Joyee Cheung) [#60271](https://github.com/nodejs/node/pull/60271)
* \[[`8c497a6a85`](https://github.com/nodejs/node/commit/8c497a6a85)] - **test**: parallelize test-without-async-context-frame correctly (Joyee Cheung) [#60273](https://github.com/nodejs/node/pull/60273)
* \[[`ee2512ffcf`](https://github.com/nodejs/node/commit/ee2512ffcf)] - **test**: skip sea tests on x64 macOS (Joyee Cheung) [#60250](https://github.com/nodejs/node/pull/60250)
* \[[`00866b4fa9`](https://github.com/nodejs/node/commit/00866b4fa9)] - **test**: move sea tests into test/sea (Joyee Cheung) [#60250](https://github.com/nodejs/node/pull/60250)
* \[[`bc3ed497d0`](https://github.com/nodejs/node/commit/bc3ed497d0)] - _**Revert**_ "**test**: ensure message event fires in worker message port test" (Luigi Pinca) [#60126](https://github.com/nodejs/node/pull/60126)
* \[[`d80ec0d26a`](https://github.com/nodejs/node/commit/d80ec0d26a)] - **test**: skip tests that cause timeouts on IBM i (SRAVANI GUNDEPALLI) [#60148](https://github.com/nodejs/node/pull/60148)
* \[[`c88ea78985`](https://github.com/nodejs/node/commit/c88ea78985)] - **test**: deflake test-fs-promises-watch-iterator (Luigi Pinca) [#60060](https://github.com/nodejs/node/pull/60060)
* \[[`4821ff8560`](https://github.com/nodejs/node/commit/4821ff8560)] - **test**: prepare junit file attribute normalization (sangwook) [#59432](https://github.com/nodejs/node/pull/59432)
...
* \[[`15a406d066`](https://github.com/nodejs/node/commit/15a406d066)] - **test,crypto**: fix conditional SHA3-\* skip on BoringSSL (Filip Skokan) [#60379](https://github.com/nodejs/node/pull/60379)
* \[[`b15badb589`](https://github.com/nodejs/node/commit/b15badb589)] - **test,crypto**: sha3 algorithms aren't supported with BoringSSL (Shelley Vohr) [#60374](https://github.com/nodejs/node/pull/60374)
* \[[`f0f0291cdc`](https://github.com/nodejs/node/commit/f0f0291cdc)] - **test,doc**: skip --max-old-space-size-percentage on 32-bit platforms (Asaf Federman) [#60144](https://github.com/nodejs/node/pull/60144)
* \[[`b674be4b7e`](https://github.com/nodejs/node/commit/b674be4b7e)] - **test\_runner**: use module.registerHooks in module mocks (Joyee Cheung) [#60326](https://github.com/nodejs/node/pull/60326)
* \[[`3ddd7b4fe1`](https://github.com/nodejs/node/commit/3ddd7b4fe1)] - **test\_runner**: fix suite timeout (Moshe Atlow) [#59853](https://github.com/nodejs/node/pull/59853)
* \[[`25c33fdd47`](https://github.com/nodejs/node/commit/25c33fdd47)] - **test\_runner**: add junit file attribute support (sangwook) [#59432](https://github.com/nodejs/node/pull/59432)
* \[[`e25758cdf7`](https://github.com/nodejs/node/commit/e25758cdf7)] - **tools**: update gyp-next to 0.20.5 (Node.js GitHub Bot) [#60313](https://github.com/nodejs/node/pull/60313)
* \[[`abdeb18fd1`](https://github.com/nodejs/node/commit/abdeb18fd1)] - **tools**: limit inspector protocol PR title length (Chengzhong Wu) [#60324](https://github.com/nodejs/node/pull/60324)
* \[[`5f83d4dcae`](https://github.com/nodejs/node/commit/5f83d4dcae)] - **tools**: fix inspector\_protocol updater (Chengzhong Wu) [#60277](https://github.com/nodejs/node/pull/60277)
* \[[`7bdfee8bb3`](https://github.com/nodejs/node/commit/7bdfee8bb3)] - **tools**: optimize wildcard execution in tools/test.py (Joyee Cheung) [#60266](https://github.com/nodejs/node/pull/60266)
* \[[`f419ba781b`](https://github.com/nodejs/node/commit/f419ba781b)] - **tools**: add inspector\_protocol updater (Chengzhong Wu) [#60245](https://github.com/nodejs/node/pull/60245)
* \[[`ef4026fa9e`](https://github.com/nodejs/node/commit/ef4026fa9e)] - **tools**: use cooldown property correctly (Rafael Gonzaga) [#60134](https://github.com/nodejs/node/pull/60134)
* \[[`33d97b3c43`](https://github.com/nodejs/node/commit/33d97b3c43)] - **typings**: add missing properties and method in Worker (Woohyun Sung) [#60257](https://github.com/nodejs/node/pull/60257)
* \[[`58385da7ea`](https://github.com/nodejs/node/commit/58385da7ea)] - **typings**: add missing properties in HTTPParser (Woohyun Sung) [#60257](https://github.com/nodejs/node/pull/60257)
* \[[`83bd17c1e9`](https://github.com/nodejs/node/commit/83bd17c1e9)] - **typings**: delete undefined property in ConfigBinding (Woohyun Sung) [#60257](https://github.com/nodejs/node/pull/60257)
* \[[`cfc45d1d7a`](https://github.com/nodejs/node/commit/cfc45d1d7a)] - **typings**: add buffer internalBinding typing (방진혁) [#60163](https://github.com/nodejs/node/pull/60163)
* \[[`63d52420db`](https://github.com/nodejs/node/commit/63d52420db)] - **util**: use more defensive code when inspecting error objects (Antoine du Hamel) [#60139](https://github.com/nodejs/node/pull/60139)
* \[[`c220da0bdd`](https://github.com/nodejs/node/commit/c220da0bdd)] - **util**: mark special properties when inspecting them (Ruben Bridgewater) [#60131](https://github.com/nodejs/node/pull/60131)
* \[[`879e4c0073`](https://github.com/nodejs/node/commit/879e4c0073)] - **(SEMVER-MINOR)** **v8**: add cpu profile (theanarkh) [#59807](https://github.com/nodejs/node/pull/59807)
* \[[`742eebc83d`](https://github.com/nodejs/node/commit/742eebc83d)] - **vm**: make vm.Module.evaluate() conditionally synchronous (Joyee Cheung) [#60205](https://github.com/nodejs/node/pull/60205)
* \[[`0f89192f7e`](https://github.com/nodejs/node/commit/0f89192f7e)] - **win**: upgrade Visual Studio workload from 2019 to 2022 (Jiawen Geng) [#60318](https://github.com/nodejs/node/pull/60318)
