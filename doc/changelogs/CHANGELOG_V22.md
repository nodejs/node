...
## 2025-04-15, Version 22.15.0 'Jod' (LTS), @RafaelGSS

### Notable Changes

* \[[`b91a8fd010`](https://github.com/nodejs/node/commit/b91a8fd010)] - **(SEMVER-MINOR)** **assert**: implement partial error comparison (Ruben Bridgewater) [#57370](https://github.com/nodejs/node/pull/57370)
* \[[`bc6fbdc709`](https://github.com/nodejs/node/commit/bc6fbdc709)] - **(SEMVER-MINOR)** **assert**: improve partialDeepStrictEqual (Ruben Bridgewater) [#57370](https://github.com/nodejs/node/pull/57370)
* \[[`314b74c204`](https://github.com/nodejs/node/commit/314b74c204)] - **(SEMVER-MINOR)** **assert,util**: improve performance (Ruben Bridgewater) [#57370](https://github.com/nodejs/node/pull/57370)
* \[[`2dfc7e0c60`](https://github.com/nodejs/node/commit/2dfc7e0c60)] - **(SEMVER-MINOR)** **benchmark**: adjust assert runtimes (Ruben Bridgewater) [#57370](https://github.com/nodejs/node/pull/57370)
* \[[`09443a70f1`](https://github.com/nodejs/node/commit/09443a70f1)] - **(SEMVER-MINOR)** **benchmark**: skip running some assert benchmarks by default (Ruben Bridgewater) [#57370](https://github.com/nodejs/node/pull/57370)
* \[[`2c974b8c9d`](https://github.com/nodejs/node/commit/2c974b8c9d)] - **(SEMVER-MINOR)** **benchmark**: add assert partialDeepStrictEqual benchmark (Ruben Bridgewater) [#57370](https://github.com/nodejs/node/pull/57370)
* \[[`84ac1dbfd9`](https://github.com/nodejs/node/commit/84ac1dbfd9)] - **(SEMVER-MINOR)** **cli**: allow --cpu-prof\* in NODE\_OPTIONS (Carlos Espa) [#57018](https://github.com/nodejs/node/pull/57018)
* \[[`35bb364e38`](https://github.com/nodejs/node/commit/35bb364e38)] - **crypto**: update root certificates to NSS 3.108 (Node.js GitHub Bot) [#57381](https://github.com/nodejs/node/pull/57381)
* \[[`5d5c3af029`](https://github.com/nodejs/node/commit/5d5c3af029)] - **(SEMVER-MINOR)** **crypto**: support --use-system-ca on Windows (Joyee Cheung) [#56833](https://github.com/nodejs/node/pull/56833)
...
* \[[`b3c53acb3a`](https://github.com/nodejs/node/commit/b3c53acb3a)] - **deps**: update timezone to 2025a (Node.js GitHub Bot) [#56876](https://github.com/nodejs/node/pull/56876)
* \[[`30605c49dd`](https://github.com/nodejs/node/commit/30605c49dd)] - **(SEMVER-MINOR)** **deps**: update ada to v3.0.1 (Yagiz Nizipli) [#56452](https://github.com/nodejs/node/pull/56452)
* \[[`eeba54df6b`](https://github.com/nodejs/node/commit/eeba54df6b)] - **(SEMVER-MINOR)** **deps,tools**: add zstd 1.5.6 (Jan Martin) [#52100](https://github.com/nodejs/node/pull/52100)
* \[[`1150546ff7`](https://github.com/nodejs/node/commit/1150546ff7)] - **(SEMVER-MINOR)** **dns**: add TLSA record query and parsing (Rithvik Vibhu) [#52983](https://github.com/nodejs/node/pull/52983)
* \[[`98733c3fa5`](https://github.com/nodejs/node/commit/98733c3fa5)] - **doc**: add @geeksilva97 to collaborators (Edy Silva) [#57241](https://github.com/nodejs/node/pull/57241)
...
* \[[`119615a482`](https://github.com/nodejs/node/commit/119615a482)] - **(SEMVER-MINOR)** **process**: add execve (Paolo Insogna) [#56496](https://github.com/nodejs/node/pull/56496)
* \[[`a2bb6471e5`](https://github.com/nodejs/node/commit/a2bb6471e5)] - **(SEMVER-MINOR)** **process**: add threadCpuUsage (Paolo Insogna) [#56467](https://github.com/nodejs/node/pull/56467)
* \[[`0c5ec1782a`](https://github.com/nodejs/node/commit/0c5ec1782a)] - **(SEMVER-MINOR)** **sqlite**: add StatementSync.prototype.columns() (Colin Ihrig) [#57490](https://github.com/nodejs/node/pull/57490)
* \[[`f67ddb989f`](https://github.com/nodejs/node/commit/f67ddb989f)] - **(SEMVER-MINOR)** **sqlite**: allow returning `ArrayBufferView`s from user-defined functions (René) [#56790](https://github.com/nodejs/node/pull/56790)
* \[[`d52f5e702e`](https://github.com/nodejs/node/commit/d52f5e702e)] - **src**: set signal inspector io thread name (RafaelGSS) [#56416](https://github.com/nodejs/node/pull/56416)
* \[[`e786e8eb7c`](https://github.com/nodejs/node/commit/e786e8eb7c)] - **src**: set thread name for main thread and v8 worker (RafaelGSS) [#56416](https://github.com/nodejs/node/pull/56416)
* \[[`4adf96fd13`](https://github.com/nodejs/node/commit/4adf96fd13)] - **src**: set worker thread name using worker.name (RafaelGSS) [#56416](https://github.com/nodejs/node/pull/56416)
* \[[`be6918da13`](https://github.com/nodejs/node/commit/be6918da13)] - **src**: use a default thread name for inspector (RafaelGSS) [#56416](https://github.com/nodejs/node/pull/56416)
* \[[`95bf60f13f`](https://github.com/nodejs/node/commit/95bf60f13f)] - **(SEMVER-MINOR)** **test**: add WPT for URLPattern (Yagiz Nizipli) [#56452](https://github.com/nodejs/node/pull/56452)
* \[[`f09fc91b72`](https://github.com/nodejs/node/commit/f09fc91b72)] - **(SEMVER-MINOR)** **tls**: implement tls.getCACertificates() (Joyee Cheung) [#57107](https://github.com/nodejs/node/pull/57107)
* \[[`fd9b56b620`](https://github.com/nodejs/node/commit/fd9b56b620)] - **(SEMVER-MINOR)** **url**: add URLPattern implementation (Yagiz Nizipli) [#56452](https://github.com/nodejs/node/pull/56452)
* \[[`f69417937e`](https://github.com/nodejs/node/commit/f69417937e)] - **(SEMVER-MINOR)** **util**: expose diff function used by the assertion errors (Giovanni Bucci) [#57462](https://github.com/nodejs/node/pull/57462)
* \[[`7905ead170`](https://github.com/nodejs/node/commit/7905ead170)] - **(SEMVER-MINOR)** **v8**: add v8.getCppHeapStatistics() method (Aditi) [#57146](https://github.com/nodejs/node/pull/57146)
* \[[`dcd9c72fe5`](https://github.com/nodejs/node/commit/dcd9c72fe5)] - **(SEMVER-MINOR)** **zlib**: add zstd support (Jan Martin) [#52100](https://github.com/nodejs/node/pull/52100)

### Commits

* \[[`7bb03b4d02`](https://github.com/nodejs/node/commit/7bb03b4d02)] - **assert**: improve partialDeepStrictEqual performance (Ruben Bridgewater) [#57509](https://github.com/nodejs/node/pull/57509)
* \[[`b91a8fd010`](https://github.com/nodejs/node/commit/b91a8fd010)] - **(SEMVER-MINOR)** **assert**: implement partial error comparison (Ruben Bridgewater) [#57370](https://github.com/nodejs/node/pull/57370)
* \[[`bc6fbdc709`](https://github.com/nodejs/node/commit/bc6fbdc709)] - **(SEMVER-MINOR)** **assert**: improve partialDeepStrictEqual (Ruben Bridgewater) [#57370](https://github.com/nodejs/node/pull/57370)
* \[[`d46015fa84`](https://github.com/nodejs/node/commit/d46015fa84)] - **assert**: improve myers diff performance (Giovanni Bucci) [#57279](https://github.com/nodejs/node/pull/57279)
* \[[`314b74c204`](https://github.com/nodejs/node/commit/314b74c204)] - **(SEMVER-MINOR)** **assert,util**: improve performance (Ruben Bridgewater) [#57370](https://github.com/nodejs/node/pull/57370)
* \[[`2dfc7e0c60`](https://github.com/nodejs/node/commit/2dfc7e0c60)] - **(SEMVER-MINOR)** **benchmark**: adjust assert runtimes (Ruben Bridgewater) [#57370](https://github.com/nodejs/node/pull/57370)
* \[[`09443a70f1`](https://github.com/nodejs/node/commit/09443a70f1)] - **(SEMVER-MINOR)** **benchmark**: skip running some assert benchmarks by default (Ruben Bridgewater) [#57370](https://github.com/nodejs/node/pull/57370)
* \[[`2c974b8c9d`](https://github.com/nodejs/node/commit/2c974b8c9d)] - **(SEMVER-MINOR)** **benchmark**: add assert partialDeepStrictEqual benchmark (Ruben Bridgewater) [#57370](https://github.com/nodejs/node/pull/57370)
* \[[`41e8fcdc9c`](https://github.com/nodejs/node/commit/41e8fcdc9c)] - **benchmark**: add a warmup on bench-openSync (Elves Vieira) [#57051](https://github.com/nodejs/node/pull/57051)
* \[[`19d8d18f4d`](https://github.com/nodejs/node/commit/19d8d18f4d)] - **benchmark**: add simple parse and test benchmarks for URLPattern (James M Snell) [#56882](https://github.com/nodejs/node/pull/56882)
* \[[`ed49f1fe38`](https://github.com/nodejs/node/commit/ed49f1fe38)] - **build**: fix update-wpt workflow (Jonas) [#57468](https://github.com/nodejs/node/pull/57468)
* \[[`bfc7577348`](https://github.com/nodejs/node/commit/bfc7577348)] - **build**: fix compatibility with V8's `depot_tools` (Richard Lau) [#57330](https://github.com/nodejs/node/pull/57330)
* \[[`ff02af04ec`](https://github.com/nodejs/node/commit/ff02af04ec)] - **build**: print 'Formatting Markdown...' for long task markdown formatting (1ilsang) [#57108](https://github.com/nodejs/node/pull/57108)
* \[[`89dff29958`](https://github.com/nodejs/node/commit/89dff29958)] - **build**: fix GN build failure (Cheng) [#57013](https://github.com/nodejs/node/pull/57013)
* \[[`40a285896f`](https://github.com/nodejs/node/commit/40a285896f)] - **build**: fix GN build of uv (Cheng) [#56955](https://github.com/nodejs/node/pull/56955)
* \[[`d462561f4a`](https://github.com/nodejs/node/commit/d462561f4a)] - **build**: gyp exclude libm linking on macOS (deepak1556) [#56901](https://github.com/nodejs/node/pull/56901)
* \[[`8e094787fc`](https://github.com/nodejs/node/commit/8e094787fc)] - **build**: remove explicit linker call to libm on macOS (deepak1556) [#56901](https://github.com/nodejs/node/pull/56901)
* \[[`72f43b3120`](https://github.com/nodejs/node/commit/72f43b3120)] - **build**: link with Security.framework in GN build (Cheng) [#56895](https://github.com/nodejs/node/pull/56895)
* \[[`26a3405ca9`](https://github.com/nodejs/node/commit/26a3405ca9)] - **build**: do not put commands in sources variables (Cheng) [#56885](https://github.com/nodejs/node/pull/56885)
...
* \[[`4e8a5441b9`](https://github.com/nodejs/node/commit/4e8a5441b9)] - **build,win**: disable node pch with ccache (Stefan Stojanovic) [#57224](https://github.com/nodejs/node/pull/57224)
* \[[`24dd10b22d`](https://github.com/nodejs/node/commit/24dd10b22d)] - **build,win**: enable ccache (Stefan Stojanovic) [#56847](https://github.com/nodejs/node/pull/56847)
* \[[`eeb60686e8`](https://github.com/nodejs/node/commit/eeb60686e8)] - **cli**: clarify --cpu-prof-name allowed values (Eugenio Ceschia) [#57433](https://github.com/nodejs/node/pull/57433)
* \[[`84ac1dbfd9`](https://github.com/nodejs/node/commit/84ac1dbfd9)] - **(SEMVER-MINOR)** **cli**: allow --cpu-prof\* in NODE\_OPTIONS (Carlos Espa) [#57018](https://github.com/nodejs/node/pull/57018)
* \[[`f74e053be6`](https://github.com/nodejs/node/commit/f74e053be6)] - **crypto**: ensure expected JWK alg in SubtleCrypto.importKey RSA imports (Filip Skokan) [#57450](https://github.com/nodejs/node/pull/57450)
* \[[`35bb364e38`](https://github.com/nodejs/node/commit/35bb364e38)] - **crypto**: update root certificates to NSS 3.108 (Node.js GitHub Bot) [#57381](https://github.com/nodejs/node/pull/57381)
* \[[`131978f0d0`](https://github.com/nodejs/node/commit/131978f0d0)] - **crypto**: add support for intermediate certs in --use-system-ca (Tim Jacomb) [#57164](https://github.com/nodejs/node/pull/57164)
* \[[`5b8bf99a16`](https://github.com/nodejs/node/commit/5b8bf99a16)] - **crypto**: support --use-system-ca on non-Windows and non-macOS (Joyee Cheung) [#57009](https://github.com/nodejs/node/pull/57009)
* \[[`75088aabc9`](https://github.com/nodejs/node/commit/75088aabc9)] - **crypto**: fix missing OPENSSL\_NO\_ENGINE guard (Shelley Vohr) [#57012](https://github.com/nodejs/node/pull/57012)
* \[[`b060f3f9c0`](https://github.com/nodejs/node/commit/b060f3f9c0)] - **crypto**: cleanup root certificates and skip PEM deserialization (Joyee Cheung) [#56999](https://github.com/nodejs/node/pull/56999)
* \[[`5d5c3af029`](https://github.com/nodejs/node/commit/5d5c3af029)] - **(SEMVER-MINOR)** **crypto**: support --use-system-ca on Windows (Joyee Cheung) [#56833](https://github.com/nodejs/node/pull/56833)
* \[[`d8258aba6b`](https://github.com/nodejs/node/commit/d8258aba6b)] - **crypto**: fix X509\* leak in --use-system-ca (Joyee Cheung) [#56832](https://github.com/nodejs/node/pull/56832)
...
* \[[`94647bbdb2`](https://github.com/nodejs/node/commit/94647bbdb2)] - **(SEMVER-MINOR)** **crypto**: added support for reading certificates from macOS system store (Tim Jacomb) [#56599](https://github.com/nodejs/node/pull/56599)
* \[[`c4bf109888`](https://github.com/nodejs/node/commit/c4bf109888)] - **debugger**: fix behavior of plain object exec in debugger repl (Dario Piotrowicz) [#57498](https://github.com/nodejs/node/pull/57498)
* \[[`acffb1e9eb`](https://github.com/nodejs/node/commit/acffb1e9eb)] - **deps**: update undici to 6.21.2 (Matteo Collina) [#57442](https://github.com/nodejs/node/pull/57442)
* \[[`40ac5f1030`](https://github.com/nodejs/node/commit/40ac5f1030)] - **deps**: V8: cherry-pick c172ffc5bf54 (Choongwoo Han) [#57437](https://github.com/nodejs/node/pull/57437)
* \[[`2cd6f58391`](https://github.com/nodejs/node/commit/2cd6f58391)] - **deps**: update ada to v3.2.1 (Yagiz Nizipli) [#57429](https://github.com/nodejs/node/pull/57429)
* \[[`183711c49f`](https://github.com/nodejs/node/commit/183711c49f)] - **deps**: update googletest to 0bdccf4 (Node.js GitHub Bot) [#57380](https://github.com/nodejs/node/pull/57380)
* \[[`d68b8e1327`](https://github.com/nodejs/node/commit/d68b8e1327)] - **deps**: update acorn to 8.14.1 (Node.js GitHub Bot) [#57382](https://github.com/nodejs/node/pull/57382)
* \[[`b27929d87e`](https://github.com/nodejs/node/commit/b27929d87e)] - **deps**: update amaro to 0.4.1 (marco-ippolito) [#57121](https://github.com/nodejs/node/pull/57121)
* \[[`3998781f52`](https://github.com/nodejs/node/commit/3998781f52)] - **deps**: update amaro to 0.3.2 (marco-ippolito) [#56916](https://github.com/nodejs/node/pull/56916)
* \[[`b94c7bfc0a`](https://github.com/nodejs/node/commit/b94c7bfc0a)] - **deps**: update amaro to 0.3.1 (Node.js GitHub Bot) [#56785](https://github.com/nodejs/node/pull/56785)
* \[[`63d021af37`](https://github.com/nodejs/node/commit/63d021af37)] - **deps**: update simdjson to 3.12.2 (Node.js GitHub Bot) [#57084](https://github.com/nodejs/node/pull/57084)
* \[[`4937b068f7`](https://github.com/nodejs/node/commit/4937b068f7)] - **deps**: update archs files for openssl-3.0.16 (Node.js GitHub Bot) [#57335](https://github.com/nodejs/node/pull/57335)
* \[[`7265b98eb5`](https://github.com/nodejs/node/commit/7265b98eb5)] - **deps**: upgrade openssl sources to quictls/openssl-3.0.16 (Node.js GitHub Bot) [#57335](https://github.com/nodejs/node/pull/57335)
* \[[`3b1f26487d`](https://github.com/nodejs/node/commit/3b1f26487d)] - **deps**: update corepack to 0.32.0 (Node.js GitHub Bot) [#57265](https://github.com/nodejs/node/pull/57265)
* \[[`595a994397`](https://github.com/nodejs/node/commit/595a994397)] - **deps**: update gyp file for ngtcp2 1.11.0 (Richard Lau) [#57225](https://github.com/nodejs/node/pull/57225)
* \[[`0da17bca15`](https://github.com/nodejs/node/commit/0da17bca15)] - **deps**: update ada to 3.1.3 (Node.js GitHub Bot) [#57222](https://github.com/nodejs/node/pull/57222)
* \[[`c0398d66b5`](https://github.com/nodejs/node/commit/c0398d66b5)] - **deps**: update cjs-module-lexer to 2.1.0 (Node.js GitHub Bot) [#57180](https://github.com/nodejs/node/pull/57180)
* \[[`01fc28c74b`](https://github.com/nodejs/node/commit/01fc28c74b)] - **deps**: update ngtcp2 to 1.11.0 (Node.js GitHub Bot) [#57179](https://github.com/nodejs/node/pull/57179)
* \[[`331827152e`](https://github.com/nodejs/node/commit/331827152e)] - **deps**: update sqlite to 3.49.1 (Node.js GitHub Bot) [#57178](https://github.com/nodejs/node/pull/57178)
* \[[`13e5d36874`](https://github.com/nodejs/node/commit/13e5d36874)] - **deps**: update ada to 3.1.0 (Node.js GitHub Bot) [#57083](https://github.com/nodejs/node/pull/57083)
* \[[`af84bba2f6`](https://github.com/nodejs/node/commit/af84bba2f6)] - **deps**: update zlib to 1.3.0.1-motley-788cb3c (Node.js GitHub Bot) [#56655](https://github.com/nodejs/node/pull/56655)
* \[[`1d8e7ad569`](https://github.com/nodejs/node/commit/1d8e7ad569)] - **deps**: update sqlite to 3.49.0 (Node.js GitHub Bot) [#56654](https://github.com/nodejs/node/pull/56654)
* \[[`325252144c`](https://github.com/nodejs/node/commit/325252144c)] - **deps**: V8: cherry-pick 9ab40592f697 (Levi Zim) [#56781](https://github.com/nodejs/node/pull/56781)
* \[[`123e777269`](https://github.com/nodejs/node/commit/123e777269)] - **deps**: update cjs-module-lexer to 2.0.0 (Michael Dawson) [#56855](https://github.com/nodejs/node/pull/56855)
* \[[`b3c53acb3a`](https://github.com/nodejs/node/commit/b3c53acb3a)] - **deps**: update timezone to 2025a (Node.js GitHub Bot) [#56876](https://github.com/nodejs/node/pull/56876)
* \[[`3e792c2248`](https://github.com/nodejs/node/commit/3e792c2248)] - **deps**: update simdjson to 3.12.0 (Node.js GitHub Bot) [#56874](https://github.com/nodejs/node/pull/56874)
* \[[`1bfeb37e8f`](https://github.com/nodejs/node/commit/1bfeb37e8f)] - **deps**: update googletest to e235eb3 (Node.js GitHub Bot) [#56873](https://github.com/nodejs/node/pull/56873)
* \[[`30605c49dd`](https://github.com/nodejs/node/commit/30605c49dd)] - **(SEMVER-MINOR)** **deps**: update ada to v3.0.1 (Yagiz Nizipli) [#56452](https://github.com/nodejs/node/pull/56452)
...
* \[[`eeba54df6b`](https://github.com/nodejs/node/commit/eeba54df6b)] - **(SEMVER-MINOR)** **deps,tools**: add zstd 1.5.6 (Jan Martin) [#52100](https://github.com/nodejs/node/pull/52100)
* \[[`f806e9a04e`](https://github.com/nodejs/node/commit/f806e9a04e)] - **dns**: remove redundant code using common variable (Deokjin Kim) [#57386](https://github.com/nodejs/node/pull/57386)
* \[[`1150546ff7`](https://github.com/nodejs/node/commit/1150546ff7)] - **(SEMVER-MINOR)** **dns**: add TLSA record query and parsing (Rithvik Vibhu) [#52983](https://github.com/nodejs/node/pull/52983)
* \[[`adc70630cc`](https://github.com/nodejs/node/commit/adc70630cc)] - **doc**: add gurgunday as triager (Gürgün Dayıoğlu) [#57594](https://github.com/nodejs/node/pull/57594)
* \[[`0ad3694990`](https://github.com/nodejs/node/commit/0ad3694990)] - **doc**: clarify behaviour of node-api adjust function (Michael Dawson) [#57463](https://github.com/nodejs/node/pull/57463)
* \[[`d39bc58984`](https://github.com/nodejs/node/commit/d39bc58984)] - **doc**: remove Corepack documentation (Antoine du Hamel) [#57635](https://github.com/nodejs/node/pull/57635)
* \[[`88075e21f6`](https://github.com/nodejs/node/commit/88075e21f6)] - **doc**: remove mention of `--require` not supporting ES modules (Huáng Jùnliàng) [#57620](https://github.com/nodejs/node/pull/57620)
* \[[`12d3981c97`](https://github.com/nodejs/node/commit/12d3981c97)] - **doc**: mention reports should align with Node.js CoC (Rafael Gonzaga) [#57607](https://github.com/nodejs/node/pull/57607)
* \[[`51d0255847`](https://github.com/nodejs/node/commit/51d0255847)] - **doc**: add section stating that very stale PRs should be closed (Dario Piotrowicz) [#57541](https://github.com/nodejs/node/pull/57541)
* \[[`7fcb8529dd`](https://github.com/nodejs/node/commit/7fcb8529dd)] - **doc**: add bjohansebas as triager (Sebastian Beltran) [#57564](https://github.com/nodejs/node/pull/57564)
* \[[`e7beae9761`](https://github.com/nodejs/node/commit/e7beae9761)] - **doc**: update support channels (Claudio W.) [#57538](https://github.com/nodejs/node/pull/57538)
* \[[`4f6278e772`](https://github.com/nodejs/node/commit/4f6278e772)] - **doc**: remove cryptoStream API reference (Jonas) [#57579](https://github.com/nodejs/node/pull/57579)
* \[[`22b893e6a2`](https://github.com/nodejs/node/commit/22b893e6a2)] - **doc**: module resolution pseudocode corrections (Marcel Laverdet) [#57080](https://github.com/nodejs/node/pull/57080)
* \[[`10f861dd3b`](https://github.com/nodejs/node/commit/10f861dd3b)] - **doc**: add history entry for DEP0190 in `child_process.md` (Antoine du Hamel) [#57544](https://github.com/nodejs/node/pull/57544)
* \[[`2fc13f7205`](https://github.com/nodejs/node/commit/2fc13f7205)] - **doc**: remove deprecated pattern in `child_process.md` (Antoine du Hamel) [#57568](https://github.com/nodejs/node/pull/57568)
* \[[`d4670932fa`](https://github.com/nodejs/node/commit/d4670932fa)] - **doc**: mark multiple experimental APIS as stable (James M Snell) [#57510](https://github.com/nodejs/node/pull/57510)
* \[[`f8661337e7`](https://github.com/nodejs/node/commit/f8661337e7)] - **doc**: remove mertcanaltin from Triagers (Mert Can Altin) [#57531](https://github.com/nodejs/node/pull/57531)
* \[[`5611fe1b82`](https://github.com/nodejs/node/commit/5611fe1b82)] - **doc**: recommend watching the collaborators repo in the onboarding doc (Darshan Sen) [#57527](https://github.com/nodejs/node/pull/57527)
* \[[`828691876b`](https://github.com/nodejs/node/commit/828691876b)] - **doc**: remove mention of visa fees from onboarding doc (Darshan Sen) [#57526](https://github.com/nodejs/node/pull/57526)
* \[[`e058bb30ec`](https://github.com/nodejs/node/commit/e058bb30ec)] - **doc**: deprecate passing `args` to `spawn` and `execFile` (Antoine du Hamel) [#57389](https://github.com/nodejs/node/pull/57389)
* \[[`548a19923a`](https://github.com/nodejs/node/commit/548a19923a)] - **doc**: remove some inconsistencies in `deprecations.md` (Antoine du Hamel) [#57512](https://github.com/nodejs/node/pull/57512)
* \[[`534cce7181`](https://github.com/nodejs/node/commit/534cce7181)] - **doc**: run license-builder (github-actions\[bot]) [#57511](https://github.com/nodejs/node/pull/57511)
* \[[`eb2dd98cc5`](https://github.com/nodejs/node/commit/eb2dd98cc5)] - **doc**: add new writing-docs contributing md (Dario Piotrowicz) [#57502](https://github.com/nodejs/node/pull/57502)
* \[[`e4793c7893`](https://github.com/nodejs/node/commit/e4793c7893)] - **doc**: add node.js streams references to Web Streams doc (Dario Piotrowicz) [#57393](https://github.com/nodejs/node/pull/57393)
* \[[`0a6e78d5b3`](https://github.com/nodejs/node/commit/0a6e78d5b3)] - **doc**: prefer to sign commits under nodejs repository (Rafael Gonzaga) [#57311](https://github.com/nodejs/node/pull/57311)
* \[[`291fb48dbd`](https://github.com/nodejs/node/commit/291fb48dbd)] - **doc**: fixed the incorrect splitting of multiple words (letianpailove) [#57454](https://github.com/nodejs/node/pull/57454)
* \[[`ea5e805101`](https://github.com/nodejs/node/commit/ea5e805101)] - **doc**: add review guidelines for collaborator nominations (Antoine du Hamel) [#57449](https://github.com/nodejs/node/pull/57449)
* \[[`30e4b52edf`](https://github.com/nodejs/node/commit/30e4b52edf)] - **doc**: fix typo in `url.md` (Allon Murienik) [#57467](https://github.com/nodejs/node/pull/57467)
* \[[`2cea0cd0af`](https://github.com/nodejs/node/commit/2cea0cd0af)] - **doc**: add history info for --use-system-ca (Darshan Sen) [#57432](https://github.com/nodejs/node/pull/57432)
* \[[`3ab4a3a0e2`](https://github.com/nodejs/node/commit/3ab4a3a0e2)] - **doc**: remove typo YAML snippet from tls.getCACertificates doc (Darshan Sen) [#57459](https://github.com/nodejs/node/pull/57459)
* \[[`39e40cedce`](https://github.com/nodejs/node/commit/39e40cedce)] - **doc**: fix typo in sqlite.md (Tobias Nießen) [#57473](https://github.com/nodejs/node/pull/57473)
* \[[`96e3d8a33d`](https://github.com/nodejs/node/commit/96e3d8a33d)] - **doc**: explicit mention arbitrary code execution as a vuln (Rafael Gonzaga) [#57426](https://github.com/nodejs/node/pull/57426)
* \[[`44072ccbb1`](https://github.com/nodejs/node/commit/44072ccbb1)] - **doc**: update maintaining-openssl.md for openssl (Richard Lau) [#57413](https://github.com/nodejs/node/pull/57413)
* \[[`10722bc20e`](https://github.com/nodejs/node/commit/10722bc20e)] - **doc**: add missing `deprecated` badges in `fs.md` (Yukihiro Hasegawa) [#57384](https://github.com/nodejs/node/pull/57384)
* \[[`3fd633c3d0`](https://github.com/nodejs/node/commit/3fd633c3d0)] - **doc**: fix small typo in `process.md` (Felix Rieseberg) [#57333](https://github.com/nodejs/node/pull/57333)
* \[[`5c36222565`](https://github.com/nodejs/node/commit/5c36222565)] - **doc**: add note about sync nodejs-private branches (Rafael Gonzaga) [#57404](https://github.com/nodejs/node/pull/57404)
* \[[`78e48828e3`](https://github.com/nodejs/node/commit/78e48828e3)] - **doc**: update Xcode version used for arm64 and pkg (Michaël Zasso) [#57104](https://github.com/nodejs/node/pull/57104)
* \[[`221ddf2a3d`](https://github.com/nodejs/node/commit/221ddf2a3d)] - **doc**: improve type stripping documentation (Marco Ippolito) [#56916](https://github.com/nodejs/node/pull/56916)
* \[[`b009c27907`](https://github.com/nodejs/node/commit/b009c27907)] - **doc**: specificy support for erasable ts syntax (Marco Ippolito) [#56916](https://github.com/nodejs/node/pull/56916)
* \[[`a22158537d`](https://github.com/nodejs/node/commit/a22158537d)] - **doc**: make first parameter optional in `util.getCallSites` (Deokjin Kim) [#57387](https://github.com/nodejs/node/pull/57387)
* \[[`72504d2e5e`](https://github.com/nodejs/node/commit/72504d2e5e)] - **doc**: fix usage of module.registerSync in comment (Timo Kössler) [#57328](https://github.com/nodejs/node/pull/57328)
* \[[`6c4bbccf31`](https://github.com/nodejs/node/commit/6c4bbccf31)] - **doc**: add Darshan back as voting TSC member (Michael Dawson) [#57402](https://github.com/nodejs/node/pull/57402)
* \[[`2d1de340e7`](https://github.com/nodejs/node/commit/2d1de340e7)] - **doc**: revise webcrypto.md types, interfaces, and added versions (Filip Skokan) [#57376](https://github.com/nodejs/node/pull/57376)
* \[[`4b8c465535`](https://github.com/nodejs/node/commit/4b8c465535)] - **doc**: add info on how project manages social media (Michael Dawson) [#57318](https://github.com/nodejs/node/pull/57318)
* \[[`049857f264`](https://github.com/nodejs/node/commit/049857f264)] - **doc**: revise `tsconfig.json` note (Steven) [#57353](https://github.com/nodejs/node/pull/57353)
* \[[`969d69e1cb`](https://github.com/nodejs/node/commit/969d69e1cb)] - **doc**: use more clear name in getSystemErrorMessage's example (ikuma-t) [#57310](https://github.com/nodejs/node/pull/57310)
* \[[`c03dd4d76a`](https://github.com/nodejs/node/commit/c03dd4d76a)] - **doc**: recommend setting `noEmit: true` in `tsconfig.json` (Steven) [#57320](https://github.com/nodejs/node/pull/57320)
* \[[`1323ba013f`](https://github.com/nodejs/node/commit/1323ba013f)] - **doc**: ping nodejs/tsc for each security pull request (Rafael Gonzaga) [#57309](https://github.com/nodejs/node/pull/57309)
* \[[`559963cbd7`](https://github.com/nodejs/node/commit/559963cbd7)] - **doc**: fix Windows ccache section position (Stefan Stojanovic) [#57326](https://github.com/nodejs/node/pull/57326)
* \[[`5ceb46e6f4`](https://github.com/nodejs/node/commit/5ceb46e6f4)] - **doc**: update node-api version matrix (Chengzhong Wu) [#57287](https://github.com/nodejs/node/pull/57287)
* \[[`26fcf03b49`](https://github.com/nodejs/node/commit/26fcf03b49)] - **doc**: recommend `erasableSyntaxOnly` in ts docs (Rob Palmer) [#57271](https://github.com/nodejs/node/pull/57271)
* \[[`7929a823bc`](https://github.com/nodejs/node/commit/7929a823bc)] - **doc**: clarify `path.isAbsolute` is not path traversal mitigation (Eric Fortis) [#57073](https://github.com/nodejs/node/pull/57073)
* \[[`f049579b51`](https://github.com/nodejs/node/commit/f049579b51)] - **doc**: fix rendering of DEP0174 description (David Sanders) [#56835](https://github.com/nodejs/node/pull/56835)
* \[[`4f15f7ae38`](https://github.com/nodejs/node/commit/4f15f7ae38)] - **doc**: add 1ilsang to triage team (1ilsang) [#57183](https://github.com/nodejs/node/pull/57183)
* \[[`98733c3fa5`](https://github.com/nodejs/node/commit/98733c3fa5)] - **doc**: add @geeksilva97 to collaborators (Edy Silva) [#57241](https://github.com/nodejs/node/pull/57241)
* \[[`08dbd7f939`](https://github.com/nodejs/node/commit/08dbd7f939)] - **doc**: add missing assert return types (Colin Ihrig) [#57219](https://github.com/nodejs/node/pull/57219)
* \[[`acf1aca667`](https://github.com/nodejs/node/commit/acf1aca667)] - **doc**: add streamResetBurst and streamResetRate (Sujal Raj) [#57195](https://github.com/nodejs/node/pull/57195)
* \[[`07ea57a6ad`](https://github.com/nodejs/node/commit/07ea57a6ad)] - **doc**: add esm examples to node:util (Alfredo González) [#56793](https://github.com/nodejs/node/pull/56793)
* \[[`f2d3a8ca87`](https://github.com/nodejs/node/commit/f2d3a8ca87)] - **doc**: update options to filehandle.appendFile() (Hasegawa-Yukihiro) [#56972](https://github.com/nodejs/node/pull/56972)
* \[[`277caa64a2`](https://github.com/nodejs/node/commit/277caa64a2)] - **doc**: add additional caveat for fs.watch (Michael Dawson) [#57150](https://github.com/nodejs/node/pull/57150)
* \[[`e501b34082`](https://github.com/nodejs/node/commit/e501b34082)] - **doc**: fix typo in Windows building instructions (Tim Jacomb) [#57158](https://github.com/nodejs/node/pull/57158)
* \[[`54b4f38f7a`](https://github.com/nodejs/node/commit/54b4f38f7a)] - **doc**: fix web.libera.chat link in pull-requests.md (Samuel Bronson) [#57076](https://github.com/nodejs/node/pull/57076)
* \[[`ccf6cf76c2`](https://github.com/nodejs/node/commit/ccf6cf76c2)] - **doc**: remove buffered flag from performance hooks examples (Pavel Romanov) [#52607](https://github.com/nodejs/node/pull/52607)
* \[[`4b8c62dcb3`](https://github.com/nodejs/node/commit/4b8c62dcb3)] - **doc**: fix 'introduced\_in' version in typescript module (1ilsang) [#57109](https://github.com/nodejs/node/pull/57109)
* \[[`96c313e5d6`](https://github.com/nodejs/node/commit/96c313e5d6)] - **doc**: fix link and history of `SourceMap` sections (Antoine du Hamel) [#57098](https://github.com/nodejs/node/pull/57098)
* \[[`848dd7bd1e`](https://github.com/nodejs/node/commit/848dd7bd1e)] - **doc**: add `module namespace object` links (Dario Piotrowicz) [#57093](https://github.com/nodejs/node/pull/57093)
* \[[`e78a22dcc2`](https://github.com/nodejs/node/commit/e78a22dcc2)] - **doc**: disambiguate pseudo-code statement (Dario Piotrowicz) [#57092](https://github.com/nodejs/node/pull/57092)
* \[[`8e8b0a0169`](https://github.com/nodejs/node/commit/8e8b0a0169)] - **doc**: update clang-cl on Windows building guide (Joyee Cheung) [#57087](https://github.com/nodejs/node/pull/57087)
* \[[`c76f436c80`](https://github.com/nodejs/node/commit/c76f436c80)] - **doc**: fix wrong articles used to address modules (Dario Piotrowicz) [#57090](https://github.com/nodejs/node/pull/57090)
* \[[`4dea5a3eb4`](https://github.com/nodejs/node/commit/4dea5a3eb4)] - **doc**: `modules.md`: fix `distance` definition (Alexander “weej” Jones) [#57046](https://github.com/nodejs/node/pull/57046)
* \[[`ced7d6be0d`](https://github.com/nodejs/node/commit/ced7d6be0d)] - **doc**: fix wrong verb form (Dario Piotrowicz) [#57091](https://github.com/nodejs/node/pull/57091)
* \[[`9897e8e579`](https://github.com/nodejs/node/commit/9897e8e579)] - **doc**: fix transpiler loader hooks documentation (Joyee Cheung) [#57037](https://github.com/nodejs/node/pull/57037)
* \[[`d01fde9c61`](https://github.com/nodejs/node/commit/d01fde9c61)] - **doc**: add a note about `require('../common')` in testing documentation (Aditi) [#56953](https://github.com/nodejs/node/pull/56953)
* \[[`3f489a647c`](https://github.com/nodejs/node/commit/3f489a647c)] - **doc**: recommend writing tests in new files and including comments (Joyee Cheung) [#57028](https://github.com/nodejs/node/pull/57028)
* \[[`68086ed2fe`](https://github.com/nodejs/node/commit/68086ed2fe)] - **doc**: improve documentation on argument validation (Aditi) [#56954](https://github.com/nodejs/node/pull/56954)
* \[[`70f23e11a9`](https://github.com/nodejs/node/commit/70f23e11a9)] - **doc**: buffer: fix typo on `Buffer.copyBytesFrom(` `offset` option (tpoisseau) [#57015](https://github.com/nodejs/node/pull/57015)
* \[[`1bc8b06196`](https://github.com/nodejs/node/commit/1bc8b06196)] - **doc**: update cleanup to trust on vuln db automation (Rafael Gonzaga) [#57004](https://github.com/nodejs/node/pull/57004)
* \[[`2ec05070cb`](https://github.com/nodejs/node/commit/2ec05070cb)] - **doc**: move stability index after history section for consistency (Antoine du Hamel) [#56997](https://github.com/nodejs/node/pull/56997)
* \[[`b3a0779a4f`](https://github.com/nodejs/node/commit/b3a0779a4f)] - **doc**: add `signal` to `filehandle.writeFile()` options (Yukihiro Hasegawa) [#56804](https://github.com/nodejs/node/pull/56804)
* \[[`63d820f6ce`](https://github.com/nodejs/node/commit/63d820f6ce)] - **doc**: run license-builder (github-actions\[bot]) [#56985](https://github.com/nodejs/node/pull/56985)
* \[[`dc9d75a633`](https://github.com/nodejs/node/commit/dc9d75a633)] - **doc**: update history of stream.Readable.toWeb() (Jimmy Leung) [#56928](https://github.com/nodejs/node/pull/56928)
* \[[`f20ff8dffc`](https://github.com/nodejs/node/commit/f20ff8dffc)] - **doc**: make MDN links to global classes more consistent (Antoine du Hamel) [#56924](https://github.com/nodejs/node/pull/56924)
* \[[`b9b50ddf67`](https://github.com/nodejs/node/commit/b9b50ddf67)] - **doc**: make MDN links to global classes more consistent in `assert.md` (Antoine du Hamel) [#56920](https://github.com/nodejs/node/pull/56920)
* \[[`0e1a5e811b`](https://github.com/nodejs/node/commit/0e1a5e811b)] - **doc**: make MDN links to global classes more consistent (Antoine du Hamel) [#56923](https://github.com/nodejs/node/pull/56923)
* \[[`38d16b9ecf`](https://github.com/nodejs/node/commit/38d16b9ecf)] - **doc**: make MDN links to global classes more consistent in `util.md` (Antoine du Hamel) [#56922](https://github.com/nodejs/node/pull/56922)
* \[[`b145947a68`](https://github.com/nodejs/node/commit/b145947a68)] - **doc**: make MDN links to global classes more consistent in `buffer.md` (Antoine du Hamel) [#56921](https://github.com/nodejs/node/pull/56921)
* \[[`3e6ea5b0ea`](https://github.com/nodejs/node/commit/3e6ea5b0ea)] - **doc**: update post sec release process (Rafael Gonzaga) [#56907](https://github.com/nodejs/node/pull/56907)
* \[[`df7752901d`](https://github.com/nodejs/node/commit/df7752901d)] - **doc**: update websocket link to avoid linking to self (Chengzhong Wu) [#56897](https://github.com/nodejs/node/pull/56897)
* \[[`ea6804624f`](https://github.com/nodejs/node/commit/ea6804624f)] - **doc**: mark `--env-file-if-exists` flag as experimental (Juan José) [#56893](https://github.com/nodejs/node/pull/56893)
...
* \[[`4ef7922e4c`](https://github.com/nodejs/node/commit/4ef7922e4c)] - **fs**: apply exclude function to root path (Rich Trott) [#57420](https://github.com/nodejs/node/pull/57420)
* \[[`e96f83fc6c`](https://github.com/nodejs/node/commit/e96f83fc6c)] - **fs**: handle UV\_ENOTDIR in `fs.statSync` with `throwIfNoEntry` provided (Juan José Arboleda) [#56996](https://github.com/nodejs/node/pull/56996)
* \[[`cd771b6f2d`](https://github.com/nodejs/node/commit/cd771b6f2d)] - **fs**: make `FileHandle.readableWebStream` always create byte streams (Ian Kerins) [#55461](https://github.com/nodejs/node/pull/55461)
* \[[`6040858266`](https://github.com/nodejs/node/commit/6040858266)] - **http**: coerce content-length to number (Marco Ippolito) [#57458](https://github.com/nodejs/node/pull/57458)
...
* \[[`6fbbf068a5`](https://github.com/nodejs/node/commit/6fbbf068a5)] - **inspector**: convert event params to protocol without json (Chengzhong Wu) [#57027](https://github.com/nodejs/node/pull/57027)
* \[[`56fd810529`](https://github.com/nodejs/node/commit/56fd810529)] - **inspector**: skip promise hook in the inspector async hook (Joyee Cheung) [#57148](https://github.com/nodejs/node/pull/57148)
* \[[`2ed0d27218`](https://github.com/nodejs/node/commit/2ed0d27218)] - **inspector**: add Network.Initiator in inspector protocol (Chengzhong Wu) [#56805](https://github.com/nodejs/node/pull/56805)
...
* \[[`00eaf3d3a7`](https://github.com/nodejs/node/commit/00eaf3d3a7)] - **lib**: add warning when binding inspector to public IP (Demian Parkhomenko) [#55736](https://github.com/nodejs/node/pull/55736)
* \[[`aa588990e6`](https://github.com/nodejs/node/commit/aa588990e6)] - **lib**: limit split function calls to prevent excessive array length (Gürgün Dayıoğlu) [#57501](https://github.com/nodejs/node/pull/57501)
* \[[`c6efcd038b`](https://github.com/nodejs/node/commit/c6efcd038b)] - **lib**: make getCallSites sourceMap option truly optional (James M Snell) [#57388](https://github.com/nodejs/node/pull/57388)
* \[[`80d12338fb`](https://github.com/nodejs/node/commit/80d12338fb)] - **lib**: optimize priority queue (Gürgün Dayıoğlu) [#57100](https://github.com/nodejs/node/pull/57100)
* \[[`8deb5630a1`](https://github.com/nodejs/node/commit/8deb5630a1)] - **lib**: fixup incorrect argument order in assertEncoding (James M Snell) [#57177](https://github.com/nodejs/node/pull/57177)
* \[[`16715da88d`](https://github.com/nodejs/node/commit/16715da88d)] - **meta**: add some clarification to the nomination process (James M Snell) [#57503](https://github.com/nodejs/node/pull/57503)
* \[[`a15e96bf65`](https://github.com/nodejs/node/commit/a15e96bf65)] - **meta**: remove collaborator self-nomination (Rich Trott) [#57537](https://github.com/nodejs/node/pull/57537)
* \[[`49f2ac6b5c`](https://github.com/nodejs/node/commit/49f2ac6b5c)] - **meta**: edit collaborator nomination process (Antoine du Hamel) [#57483](https://github.com/nodejs/node/pull/57483)
* \[[`1ca8271c2a`](https://github.com/nodejs/node/commit/1ca8271c2a)] - **meta**: move ovflowd to emeritus (Claudio W.) [#57443](https://github.com/nodejs/node/pull/57443)
* \[[`7cf5d20fe1`](https://github.com/nodejs/node/commit/7cf5d20fe1)] - **meta**: bump codecov/codecov-action from 5.3.1 to 5.4.0 (dependabot\[bot]) [#57257](https://github.com/nodejs/node/pull/57257)
* \[[`e59ea04b12`](https://github.com/nodejs/node/commit/e59ea04b12)] - **meta**: bump github/codeql-action from 3.28.8 to 3.28.10 (dependabot\[bot]) [#57254](https://github.com/nodejs/node/pull/57254)
* \[[`06070c2e1b`](https://github.com/nodejs/node/commit/06070c2e1b)] - **meta**: bump ossf/scorecard-action from 2.4.0 to 2.4.1 (dependabot\[bot]) [#57253](https://github.com/nodejs/node/pull/57253)
* \[[`9490cd7335`](https://github.com/nodejs/node/commit/9490cd7335)] - **meta**: set nodejs/config as codeowner (Marco Ippolito) [#57237](https://github.com/nodejs/node/pull/57237)
* \[[`89edf9e107`](https://github.com/nodejs/node/commit/89edf9e107)] - **meta**: move RaisinTen back to collaborators, triagers and SEA champion (Darshan Sen) [#57292](https://github.com/nodejs/node/pull/57292)
* \[[`4a0ce79d15`](https://github.com/nodejs/node/commit/4a0ce79d15)] - **meta**: bump actions/download-artifact from 4.1.8 to 4.1.9 (dependabot\[bot]) [#57260](https://github.com/nodejs/node/pull/57260)
* \[[`bc863c7033`](https://github.com/nodejs/node/commit/bc863c7033)] - **meta**: bump peter-evans/create-pull-request from 7.0.6 to 7.0.7 (dependabot\[bot]) [#57259](https://github.com/nodejs/node/pull/57259)
* \[[`54c6632ed3`](https://github.com/nodejs/node/commit/54c6632ed3)] - **meta**: bump step-security/harden-runner from 2.10.4 to 2.11.0 (dependabot\[bot]) [#57258](https://github.com/nodejs/node/pull/57258)
* \[[`bec15631dc`](https://github.com/nodejs/node/commit/bec15631dc)] - **meta**: bump actions/cache from 4.2.0 to 4.2.2 (dependabot\[bot]) [#57256](https://github.com/nodejs/node/pull/57256)
* \[[`4c042be817`](https://github.com/nodejs/node/commit/4c042be817)] - **meta**: bump actions/upload-artifact from 4.6.0 to 4.6.1 (dependabot\[bot]) [#57255](https://github.com/nodejs/node/pull/57255)
* \[[`a941b12612`](https://github.com/nodejs/node/commit/a941b12612)] - **meta**: bump `actions/setup-python` from 5.3.0 to 5.4.0 (dependabot\[bot]) [#56867](https://github.com/nodejs/node/pull/56867)
* \[[`327749e39e`](https://github.com/nodejs/node/commit/327749e39e)] - **meta**: bump `peter-evans/create-pull-request` from 7.0.5 to 7.0.6 (dependabot\[bot]) [#56866](https://github.com/nodejs/node/pull/56866)
* \[[`fb1513f377`](https://github.com/nodejs/node/commit/fb1513f377)] - **meta**: bump `mozilla-actions/sccache-action` from 0.0.6 to 0.0.7 (dependabot\[bot]) [#56865](https://github.com/nodejs/node/pull/56865)
* \[[`143c7a58fc`](https://github.com/nodejs/node/commit/143c7a58fc)] - **meta**: bump `codecov/codecov-action` from 5.0.7 to 5.3.1 (dependabot\[bot]) [#56864](https://github.com/nodejs/node/pull/56864)
* \[[`32702ef536`](https://github.com/nodejs/node/commit/32702ef536)] - **meta**: bump `step-security/harden-runner` from 2.10.2 to 2.10.4 (dependabot\[bot]) [#56863](https://github.com/nodejs/node/pull/56863)
* \[[`3c8bd538d8`](https://github.com/nodejs/node/commit/3c8bd538d8)] - **meta**: bump `actions/cache` from 4.1.2 to 4.2.0 (dependabot\[bot]) [#56862](https://github.com/nodejs/node/pull/56862)
* \[[`5ad0ab5b57`](https://github.com/nodejs/node/commit/5ad0ab5b57)] - **meta**: bump `actions/stale` from 9.0.0 to 9.1.0 (dependabot\[bot]) [#56860](https://github.com/nodejs/node/pull/56860)
* \[[`268dbb38a5`](https://github.com/nodejs/node/commit/268dbb38a5)] - **meta**: bump `github/codeql-action` from 3.27.5 to 3.28.8 (dependabot\[bot]) [#56859](https://github.com/nodejs/node/pull/56859)
* \[[`4b613e1b9a`](https://github.com/nodejs/node/commit/4b613e1b9a)] - **meta**: add CODEOWNERS for SQLite (Colin Ihrig) [#57147](https://github.com/nodejs/node/pull/57147)
* \[[`e5cb7fc513`](https://github.com/nodejs/node/commit/e5cb7fc513)] - **meta**: update last name for jkrems (Jan Martin) [#57006](https://github.com/nodejs/node/pull/57006)
* \[[`bf5ea4f5ed`](https://github.com/nodejs/node/commit/bf5ea4f5ed)] - **meta**: bump `actions/upload-artifact` from 4.4.3 to 4.6.0 (dependabot\[bot]) [#56861](https://github.com/nodejs/node/pull/56861)
* \[[`ef4c90bfdd`](https://github.com/nodejs/node/commit/ef4c90bfdd)] - **meta**: bump `actions/setup-node` from 4.1.0 to 4.2.0 (dependabot\[bot]) [#56868](https://github.com/nodejs/node/pull/56868)
* \[[`e963142abe`](https://github.com/nodejs/node/commit/e963142abe)] - **meta**: move one or more collaborators to emeritus (Node.js GitHub Bot) [#56889](https://github.com/nodejs/node/pull/56889)
...
* \[[`889f8a0c35`](https://github.com/nodejs/node/commit/889f8a0c35)] - **module**: handle cached linked async jobs in require(esm) (Joyee Cheung) [#57187](https://github.com/nodejs/node/pull/57187)
* \[[`26be8db459`](https://github.com/nodejs/node/commit/26be8db459)] - **module**: add dynamic file-specific ESM warnings (Mert Can Altin) [#56628](https://github.com/nodejs/node/pull/56628)
* \[[`f67ef52eb1`](https://github.com/nodejs/node/commit/f67ef52eb1)] - **module**: improve error message from asynchronicity in require(esm) (Joyee Cheung) [#57126](https://github.com/nodejs/node/pull/57126)
* \[[`4f36fb9e29`](https://github.com/nodejs/node/commit/4f36fb9e29)] - **module**: allow omitting context in synchronous next hooks (Joyee Cheung) [#57056](https://github.com/nodejs/node/pull/57056)
* \[[`208293a460`](https://github.com/nodejs/node/commit/208293a460)] - **module**: fix require.resolve() crash on non-string paths (Aditi) [#56942](https://github.com/nodejs/node/pull/56942)
...
* \[[`6b93ba723b`](https://github.com/nodejs/node/commit/6b93ba723b)] - **(SEMVER-MINOR)** **module**: use synchronous hooks for preparsing in import(cjs) (Joyee Cheung) [#55698](https://github.com/nodejs/node/pull/55698)
* \[[`b2e44a8079`](https://github.com/nodejs/node/commit/b2e44a8079)] - **(SEMVER-MINOR)** **module**: implement module.registerHooks() (Joyee Cheung) [#55698](https://github.com/nodejs/node/pull/55698)
* \[[`7aca254808`](https://github.com/nodejs/node/commit/7aca254808)] - **net**: validate non-string host for socket.connect (Daeyeon Jeong) [#57198](https://github.com/nodejs/node/pull/57198)
* \[[`66b990c813`](https://github.com/nodejs/node/commit/66b990c813)] - **net**: replace brand checks with identity checks (Yagiz Nizipli) [#57341](https://github.com/nodejs/node/pull/57341)
* \[[`472732dbc6`](https://github.com/nodejs/node/commit/472732dbc6)] - **net**: emit an error when custom lookup resolves to a non-string address (Edy Silva) [#57192](https://github.com/nodejs/node/pull/57192)
* \[[`119615a482`](https://github.com/nodejs/node/commit/119615a482)] - **(SEMVER-MINOR)** **process**: add execve (Paolo Insogna) [#56496](https://github.com/nodejs/node/pull/56496)
* \[[`a2bb6471e5`](https://github.com/nodejs/node/commit/a2bb6471e5)] - **(SEMVER-MINOR)** **process**: add threadCpuUsage (Paolo Insogna) [#56467](https://github.com/nodejs/node/pull/56467)
* \[[`c79fedaa26`](https://github.com/nodejs/node/commit/c79fedaa26)] - **readline**: add support for `Symbol.dispose` (Antoine du Hamel) [#57276](https://github.com/nodejs/node/pull/57276)
...
* \[[`3110e64e85`](https://github.com/nodejs/node/commit/3110e64e85)] - **sea**: suppress builtin warning with disableExperimentalSEAWarning option (koooge) [#57086](https://github.com/nodejs/node/pull/57086)
* \[[`e693396e5c`](https://github.com/nodejs/node/commit/e693396e5c)] - **sqlite**: add support for unknown named parameters (Colin Ihrig) [#57552](https://github.com/nodejs/node/pull/57552)
* \[[`7d7856a712`](https://github.com/nodejs/node/commit/7d7856a712)] - **sqlite**: add DatabaseSync.prototype.isOpen (Colin Ihrig) [#57522](https://github.com/nodejs/node/pull/57522)
* \[[`47bcc6e238`](https://github.com/nodejs/node/commit/47bcc6e238)] - **sqlite**: add DatabaseSync.prototype\[Symbol.dispose]\() (Colin Ihrig) [#57506](https://github.com/nodejs/node/pull/57506)
* \[[`0c5ec1782a`](https://github.com/nodejs/node/commit/0c5ec1782a)] - **(SEMVER-MINOR)** **sqlite**: add StatementSync.prototype.columns() (Colin Ihrig) [#57490](https://github.com/nodejs/node/pull/57490)
* \[[`0c11ac4c8d`](https://github.com/nodejs/node/commit/0c11ac4c8d)] - **sqlite**: reset statement immediately in run() (Colin Ihrig) [#57350](https://github.com/nodejs/node/pull/57350)
* \[[`3228b0a397`](https://github.com/nodejs/node/commit/3228b0a397)] - **sqlite**: restore changes from #55373 (Colin Ihrig) [#56908](https://github.com/nodejs/node/pull/56908)
* \[[`f67ddb989f`](https://github.com/nodejs/node/commit/f67ddb989f)] - **(SEMVER-MINOR)** **sqlite**: allow returning `ArrayBufferView`s from user-defined functions (René) [#56790](https://github.com/nodejs/node/pull/56790)
...
* \[[`7b41d49ab3`](https://github.com/nodejs/node/commit/7b41d49ab3)] - **src**: cache urlpattern properties (JonasBa) [#57465](https://github.com/nodejs/node/pull/57465)
* \[[`4aa03c86f4`](https://github.com/nodejs/node/commit/4aa03c86f4)] - **src**: define urlpattern components using a macro (JonasBa) [#57452](https://github.com/nodejs/node/pull/57452)
* \[[`1688a2b722`](https://github.com/nodejs/node/commit/1688a2b722)] - **src**: cleanup aliased\_buffer.h (Mohammed Keyvanzadeh) [#57395](https://github.com/nodejs/node/pull/57395)
* \[[`9785644a34`](https://github.com/nodejs/node/commit/9785644a34)] - **src**: remove obsolete NoArrayBufferZeroFillScope (James M Snell) [#56913](https://github.com/nodejs/node/pull/56913)
* \[[`d52f5e702e`](https://github.com/nodejs/node/commit/d52f5e702e)] - **src**: set signal inspector io thread name (RafaelGSS) [#56416](https://github.com/nodejs/node/pull/56416)
* \[[`e786e8eb7c`](https://github.com/nodejs/node/commit/e786e8eb7c)] - **src**: set thread name for main thread and v8 worker (RafaelGSS) [#56416](https://github.com/nodejs/node/pull/56416)
* \[[`4adf96fd13`](https://github.com/nodejs/node/commit/4adf96fd13)] - **src**: set worker thread name using worker.name (RafaelGSS) [#56416](https://github.com/nodejs/node/pull/56416)
* \[[`be6918da13`](https://github.com/nodejs/node/commit/be6918da13)] - **src**: use a default thread name for inspector (RafaelGSS) [#56416](https://github.com/nodejs/node/pull/56416)
* \[[`1ca67e3ae6`](https://github.com/nodejs/node/commit/1ca67e3ae6)] - **src**: do not pass nullptr to std::string ctor (Charles Kerr) [#57354](https://github.com/nodejs/node/pull/57354)
* \[[`de142d4810`](https://github.com/nodejs/node/commit/de142d4810)] - **src**: fix process exit listeners not receiving unsettled tla codes (Dario Piotrowicz) [#56872](https://github.com/nodejs/node/pull/56872)
* \[[`f49b715457`](https://github.com/nodejs/node/commit/f49b715457)] - **src**: refactor SubtleCrypto algorithm and length validations (Filip Skokan) [#57319](https://github.com/nodejs/node/pull/57319)
* \[[`243272bd6b`](https://github.com/nodejs/node/commit/243272bd6b)] - **src**: allow embedder customization of OOMErrorHandler (Shelley Vohr) [#57325](https://github.com/nodejs/node/pull/57325)
* \[[`a9bf386f58`](https://github.com/nodejs/node/commit/a9bf386f58)] - **src**: use Maybe\<void> in ProcessEmitWarningSync (Daeyeon Jeong) [#57250](https://github.com/nodejs/node/pull/57250)
* \[[`b4fe8475d7`](https://github.com/nodejs/node/commit/b4fe8475d7)] - **src**: make even more improvements to error handling (James M Snell) [#57264](https://github.com/nodejs/node/pull/57264)
* \[[`26adcd2a5d`](https://github.com/nodejs/node/commit/26adcd2a5d)] - **src**: use cached `emit` v8::String (Daeyeon Jeong) [#57249](https://github.com/nodejs/node/pull/57249)
* \[[`6b204aaf52`](https://github.com/nodejs/node/commit/6b204aaf52)] - **src**: refactor SubtleCrypto algorithm and length validations (Filip Skokan) [#57273](https://github.com/nodejs/node/pull/57273)
* \[[`b759ab839b`](https://github.com/nodejs/node/commit/b759ab839b)] - **src**: make more error handling improvements (James M Snell) [#57262](https://github.com/nodejs/node/pull/57262)
* \[[`63316febe5`](https://github.com/nodejs/node/commit/63316febe5)] - **src**: fix typo in comment (Antoine du Hamel) [#57291](https://github.com/nodejs/node/pull/57291)
* \[[`52b06d41f1`](https://github.com/nodejs/node/commit/52b06d41f1)] - **src**: improve error handling in `node_messaging.cc` (James M Snell) [#57211](https://github.com/nodejs/node/pull/57211)
* \[[`874de25454`](https://github.com/nodejs/node/commit/874de25454)] - **src**: improve error handling in `tty_wrap.cc` (James M Snell) [#57211](https://github.com/nodejs/node/pull/57211)
* \[[`8dbcd22606`](https://github.com/nodejs/node/commit/8dbcd22606)] - **src**: improve error handling in `tcp_wrap.cc` (James M Snell) [#57211](https://github.com/nodejs/node/pull/57211)
* \[[`46e86c70b6`](https://github.com/nodejs/node/commit/46e86c70b6)] - **src**: fix ThrowInvalidURL call in PathToFileURL (Daniel M Brasil) [#57141](https://github.com/nodejs/node/pull/57141)
* \[[`6e7f9aebfa`](https://github.com/nodejs/node/commit/6e7f9aebfa)] - **src**: improve error handling in buffer and dotenv (James M Snell) [#57189](https://github.com/nodejs/node/pull/57189)
* \[[`f99b6263d1`](https://github.com/nodejs/node/commit/f99b6263d1)] - **src**: improve error handling in module\_wrap (James M Snell) [#57188](https://github.com/nodejs/node/pull/57188)
* \[[`4dbf1fd7da`](https://github.com/nodejs/node/commit/4dbf1fd7da)] - **src**: improve error handling in spawn\_sync (James M Snell) [#57185](https://github.com/nodejs/node/pull/57185)
* \[[`ca510d191d`](https://github.com/nodejs/node/commit/ca510d191d)] - **src**: detect whether the string is one byte representation or not (theweipeng) [#56147](https://github.com/nodejs/node/pull/56147)
* \[[`9bc30db633`](https://github.com/nodejs/node/commit/9bc30db633)] - **src**: fix crash when lazy getter is invoked in a vm context (Chengzhong Wu) [#57168](https://github.com/nodejs/node/pull/57168)
* \[[`c512a7846d`](https://github.com/nodejs/node/commit/c512a7846d)] - **src**: do not format single string argument for THROW\_ERR\_\* (Joyee Cheung) [#57126](https://github.com/nodejs/node/pull/57126)
* \[[`bda0ce87cb`](https://github.com/nodejs/node/commit/bda0ce87cb)] - **src**: move instead of copy shared pointer in node\_blob (Michaël Zasso) [#57120](https://github.com/nodejs/node/pull/57120)
* \[[`86e10e9d58`](https://github.com/nodejs/node/commit/86e10e9d58)] - **src**: replace NewFromUtf8 with OneByteString where appropriate (James M Snell) [#57096](https://github.com/nodejs/node/pull/57096)
* \[[`847162b796`](https://github.com/nodejs/node/commit/847162b796)] - **src**: port `defineLazyProperties` to native code (Antoine du Hamel) [#57081](https://github.com/nodejs/node/pull/57081)
* \[[`2a3b572f91`](https://github.com/nodejs/node/commit/2a3b572f91)] - **src**: improve error handling in node\_blob (James M Snell) [#57078](https://github.com/nodejs/node/pull/57078)
* \[[`38797a8d61`](https://github.com/nodejs/node/commit/38797a8d61)] - **src**: fix accessing empty string (Cheng) [#57014](https://github.com/nodejs/node/pull/57014)
* \[[`b2c3d8d88d`](https://github.com/nodejs/node/commit/b2c3d8d88d)] - **src**: lock the isolate properly in IsolateData destructor (Joyee Cheung) [#57031](https://github.com/nodejs/node/pull/57031)
* \[[`0db112b80e`](https://github.com/nodejs/node/commit/0db112b80e)] - **src**: add self-assigment memcpy checks (Burkov Egor) [#56986](https://github.com/nodejs/node/pull/56986)
* \[[`e04125b5e9`](https://github.com/nodejs/node/commit/e04125b5e9)] - **src**: improve node::Dotenv trimming (Dario Piotrowicz) [#56983](https://github.com/nodejs/node/pull/56983)
* \[[`a65722ff1f`](https://github.com/nodejs/node/commit/a65722ff1f)] - **src**: improve error handling in string\_bytes/decoder (James M Snell) [#56978](https://github.com/nodejs/node/pull/56978)
* \[[`05de504600`](https://github.com/nodejs/node/commit/05de504600)] - **src**: improve error handling in process\_wrap (James M Snell) [#56977](https://github.com/nodejs/node/pull/56977)
* \[[`4ab0a6da8a`](https://github.com/nodejs/node/commit/4ab0a6da8a)] - **src**: use `args.This()` in zlib (Michaël Zasso) [#56988](https://github.com/nodejs/node/pull/56988)
* \[[`8ae1f7f78b`](https://github.com/nodejs/node/commit/8ae1f7f78b)] - **src**: replace `SplitString` with built-in (Yagiz Nizipli) [#54990](https://github.com/nodejs/node/pull/54990)
* \[[`f852ac4b0c`](https://github.com/nodejs/node/commit/f852ac4b0c)] - **src**: add nullptr handling for `NativeKeyObject` (Burkov Egor) [#56900](https://github.com/nodejs/node/pull/56900)
* \[[`83ae926407`](https://github.com/nodejs/node/commit/83ae926407)] - **src**: disallow copy/move fns/constructors (Yagiz Nizipli) [#56811](https://github.com/nodejs/node/pull/56811)
* \[[`017ad970fa`](https://github.com/nodejs/node/commit/017ad970fa)] - **src**: add a hard dependency v8\_inspector\_headers (Chengzhong Wu) [#56805](https://github.com/nodejs/node/pull/56805)
* \[[`f97c06325c`](https://github.com/nodejs/node/commit/f97c06325c)] - **src**: improve error handling in encoding\_binding.cc (James M Snell) [#56915](https://github.com/nodejs/node/pull/56915)
* \[[`0a42b3450d`](https://github.com/nodejs/node/commit/0a42b3450d)] - **src**: improve error handling in permission.cc (James M Snell) [#56904](https://github.com/nodejs/node/pull/56904)
* \[[`df74ec67de`](https://github.com/nodejs/node/commit/df74ec67de)] - **src**: improve error handling in node\_sqlite (James M Snell) [#56891](https://github.com/nodejs/node/pull/56891)
* \[[`e52dd034cc`](https://github.com/nodejs/node/commit/e52dd034cc)] - **src**: improve error handling in node\_os by removing ToLocalChecked (James M Snell) [#56888](https://github.com/nodejs/node/pull/56888)
* \[[`b25f795c42`](https://github.com/nodejs/node/commit/b25f795c42)] - **src**: improve error handling in node\_url (James M Snell) [#56886](https://github.com/nodejs/node/pull/56886)
* \[[`97e9aeafc8`](https://github.com/nodejs/node/commit/97e9aeafc8)] - **src**: add memory retainer traits for external types (Chengzhong Wu) [#56881](https://github.com/nodejs/node/pull/56881)
* \[[`1150d000cf`](https://github.com/nodejs/node/commit/1150d000cf)] - **src**: prevent URLPattern property accessors from crashing on invalid this (James M Snell) [#56877](https://github.com/nodejs/node/pull/56877)
* \[[`d0d923faeb`](https://github.com/nodejs/node/commit/d0d923faeb)] - **src**: make multiple improvements to node\_url\_pattern (James M Snell) [#56871](https://github.com/nodejs/node/pull/56871)
...
* \[[`5d133851f8`](https://github.com/nodejs/node/commit/5d133851f8)] - **src,test**: expand test coverage for urlpattern and fix error (James M Snell) [#56878](https://github.com/nodejs/node/pull/56878)
* \[[`16ed868255`](https://github.com/nodejs/node/commit/16ed868255)] - **stream**: fix sizeAlgorithm validation in WritableStream (Daeyeon Jeong) [#57280](https://github.com/nodejs/node/pull/57280)
* \[[`be1f27e50b`](https://github.com/nodejs/node/commit/be1f27e50b)] - **test**: update WPT for urlpattern to 6ceca69d26 (Node.js GitHub Bot) [#57486](https://github.com/nodejs/node/pull/57486)
* \[[`3f064bf65e`](https://github.com/nodejs/node/commit/3f064bf65e)] - **test**: add more number cases for buffer.indexOf (Meghan Denny) [#57200](https://github.com/nodejs/node/pull/57200)
* \[[`fca3430a58`](https://github.com/nodejs/node/commit/fca3430a58)] - **test**: update parallel/test-tls-dhe for OpenSSL 3.5 (Richard Lau) [#57477](https://github.com/nodejs/node/pull/57477)
* \[[`8847f01dc2`](https://github.com/nodejs/node/commit/8847f01dc2)] - **test**: skip uv-thread-name on IBM i (Abdirahim Musse) [#57299](https://github.com/nodejs/node/pull/57299)
* \[[`92daab9e3f`](https://github.com/nodejs/node/commit/92daab9e3f)] - **test**: module syntax should throw (Marco Ippolito) [#57121](https://github.com/nodejs/node/pull/57121)
* \[[`ba3cff49ed`](https://github.com/nodejs/node/commit/ba3cff49ed)] - **test**: update snapshots for amaro v0.3.2 (Marco Ippolito) [#56916](https://github.com/nodejs/node/pull/56916)
* \[[`d343b8e0db`](https://github.com/nodejs/node/commit/d343b8e0db)] - **test**: test runner run plan (Pietro Marchini) [#57304](https://github.com/nodejs/node/pull/57304)
* \[[`ef64a13ed6`](https://github.com/nodejs/node/commit/ef64a13ed6)] - **test**: update WPT for urlpattern to 3b6b19853a (Node.js GitHub Bot) [#57377](https://github.com/nodejs/node/pull/57377)
* \[[`199a9260f5`](https://github.com/nodejs/node/commit/199a9260f5)] - **test**: update WPT for WebCryptoAPI to edd42c005c (Node.js GitHub Bot) [#57365](https://github.com/nodejs/node/pull/57365)
* \[[`2446eee624`](https://github.com/nodejs/node/commit/2446eee624)] - **test**: simplify test-tls-connect-abort-controller.js (Yagiz Nizipli) [#57338](https://github.com/nodejs/node/pull/57338)
* \[[`61e705b7bc`](https://github.com/nodejs/node/commit/61e705b7bc)] - **test**: use `assert.match` in `test-esm-import-meta` (Antoine du Hamel) [#57290](https://github.com/nodejs/node/pull/57290)
* \[[`6eef77dca4`](https://github.com/nodejs/node/commit/6eef77dca4)] - **test**: update compression wpt (Yagiz Nizipli) [#56960](https://github.com/nodejs/node/pull/56960)
* \[[`bbe6f343d8`](https://github.com/nodejs/node/commit/bbe6f343d8)] - _**Revert**_ "**test**: temporary remove resource check from fs read-write" (Rafael Gonzaga) [#56906](https://github.com/nodejs/node/pull/56906)
* \[[`662989e51c`](https://github.com/nodejs/node/commit/662989e51c)] - **test**: more common.mustNotCall in net, tls (Meghan Denny) [#57246](https://github.com/nodejs/node/pull/57246)
* \[[`1b4b837f75`](https://github.com/nodejs/node/commit/1b4b837f75)] - **test**: swap assert.strictEqual() parameters (Luigi Pinca) [#57217](https://github.com/nodejs/node/pull/57217)
* \[[`af367b6c60`](https://github.com/nodejs/node/commit/af367b6c60)] - **test**: assert write return values in buffer-bigint64 (Meghan Denny) [#57212](https://github.com/nodejs/node/pull/57212)
* \[[`7618406aad`](https://github.com/nodejs/node/commit/7618406aad)] - **test**: allow embedder running async context frame test (Shelley Vohr) [#57193](https://github.com/nodejs/node/pull/57193)
* \[[`4a30f44ea8`](https://github.com/nodejs/node/commit/4a30f44ea8)] - **test**: resolve race condition in test-net-write-fully-async-\* (Matteo Collina) [#57022](https://github.com/nodejs/node/pull/57022)
* \[[`6bbe2fa84a`](https://github.com/nodejs/node/commit/6bbe2fa84a)] - **test**: add doAppendAndCancel test (Hasegawa-Yukihiro) [#56972](https://github.com/nodejs/node/pull/56972)
* \[[`dbabf77f2c`](https://github.com/nodejs/node/commit/dbabf77f2c)] - **test**: fix test-without-async-context-frame.mjs in debug mode (Joyee Cheung) [#57034](https://github.com/nodejs/node/pull/57034)
* \[[`ff202edf7f`](https://github.com/nodejs/node/commit/ff202edf7f)] - **test**: make eval snapshot comparison more flexible (Shelley Vohr) [#57020](https://github.com/nodejs/node/pull/57020)
* \[[`4c22520716`](https://github.com/nodejs/node/commit/4c22520716)] - **test**: simplify test-http2-client-promisify-connect-error (Luigi Pinca) [#57144](https://github.com/nodejs/node/pull/57144)
* \[[`5addbf2dae`](https://github.com/nodejs/node/commit/5addbf2dae)] - **test**: improve error output of test-http2-client-promisify-connect-error (Antoine du Hamel) [#57135](https://github.com/nodejs/node/pull/57135)
* \[[`9ab8587fc8`](https://github.com/nodejs/node/commit/9ab8587fc8)] - **test**: add case for unrecognised fields within pjson "exports" (Jacob Smith) [#57026](https://github.com/nodejs/node/pull/57026)
* \[[`1d78cf8ad9`](https://github.com/nodejs/node/commit/1d78cf8ad9)] - **test**: remove unnecessary assert requiring from tests (Dario Piotrowicz) [#57008](https://github.com/nodejs/node/pull/57008)
* \[[`1d94c73b62`](https://github.com/nodejs/node/commit/1d94c73b62)] - **test**: update WPT for urlpattern to ef6d83d789 (Node.js GitHub Bot) [#56984](https://github.com/nodejs/node/pull/56984)
* \[[`99963ab16e`](https://github.com/nodejs/node/commit/99963ab16e)] - **test**: reduce flakiness on test-net-write-fully-async-buffer (Yagiz Nizipli) [#56971](https://github.com/nodejs/node/pull/56971)
* \[[`e5e029e587`](https://github.com/nodejs/node/commit/e5e029e587)] - **test**: remove flakiness on macOS test (Yagiz Nizipli) [#56971](https://github.com/nodejs/node/pull/56971)
* \[[`2c49183f0d`](https://github.com/nodejs/node/commit/2c49183f0d)] - **test**: improve timeout duration for debugger events (Yagiz Nizipli) [#56970](https://github.com/nodejs/node/pull/56970)
* \[[`4b820941fc`](https://github.com/nodejs/node/commit/4b820941fc)] - **test**: remove unnecessary syscall to cpuinfo (Yagiz Nizipli) [#56968](https://github.com/nodejs/node/pull/56968)
* \[[`e08f5a123d`](https://github.com/nodejs/node/commit/e08f5a123d)] - **test**: update webstorage wpt (Yagiz Nizipli) [#56963](https://github.com/nodejs/node/pull/56963)
* \[[`460cb0eb16`](https://github.com/nodejs/node/commit/460cb0eb16)] - **test**: execute shell directly for refresh() (Yagiz Nizipli) [#55051](https://github.com/nodejs/node/pull/55051)
* \[[`0ce10580bd`](https://github.com/nodejs/node/commit/0ce10580bd)] - **test**: automatically sync wpt urlpattern tests (Jonas) [#56949](https://github.com/nodejs/node/pull/56949)
* \[[`470801696a`](https://github.com/nodejs/node/commit/470801696a)] - **test**: change jenkins reporter (Carlos Espa) [#56808](https://github.com/nodejs/node/pull/56808)
* \[[`9d99d462ec`](https://github.com/nodejs/node/commit/9d99d462ec)] - **test**: fix race condition in test-child-process-bad-stdio (Colin Ihrig) [#56845](https://github.com/nodejs/node/pull/56845)
* \[[`95bf60f13f`](https://github.com/nodejs/node/commit/95bf60f13f)] - **(SEMVER-MINOR)** **test**: add WPT for URLPattern (Yagiz Nizipli) [#56452](https://github.com/nodejs/node/pull/56452)
...
* \[[`eceb2d99e2`](https://github.com/nodejs/node/commit/eceb2d99e2)] - **test,crypto**: make tests work for BoringSSL (Shelley Vohr) [#57021](https://github.com/nodejs/node/pull/57021)
* \[[`b3a1cee8ec`](https://github.com/nodejs/node/commit/b3a1cee8ec)] - **test\_runner**: refactor testPlan counter increse (Pietro Marchini) [#56765](https://github.com/nodejs/node/pull/56765)
* \[[`5cea5f209c`](https://github.com/nodejs/node/commit/5cea5f209c)] - **test\_runner**: print formatted errors on summary (Pietro Marchini) [#56911](https://github.com/nodejs/node/pull/56911)
* \[[`57a1c19ad1`](https://github.com/nodejs/node/commit/57a1c19ad1)] - **test\_runner**: allow special characters in snapshot keys (Carlos Espa) [#57017](https://github.com/nodejs/node/pull/57017)
* \[[`3340df6dc1`](https://github.com/nodejs/node/commit/3340df6dc1)] - **timers**: optimize timer functions with improved argument handling (Gürgün Dayıoğlu) [#57072](https://github.com/nodejs/node/pull/57072)
* \[[`acd905281b`](https://github.com/nodejs/node/commit/acd905281b)] - **timers**: remove unnecessary allocation of \_onTimeout (Gürgün Dayıoğlu) [#57497](https://github.com/nodejs/node/pull/57497)
* \[[`a262adad9c`](https://github.com/nodejs/node/commit/a262adad9c)] - **timers**: remove unused parameter from insertGuarded (Gürgün Dayıoğlu) [#57251](https://github.com/nodejs/node/pull/57251)
* \[[`1a7f63dbca`](https://github.com/nodejs/node/commit/1a7f63dbca)] - **timers**: simplify the compareTimersLists function (Gürgün Dayıoğlu) [#57110](https://github.com/nodejs/node/pull/57110)
* \[[`1f3febca1f`](https://github.com/nodejs/node/commit/1f3febca1f)] - **tls**: remove unnecessary type check on normalize (Yagiz Nizipli) [#57336](https://github.com/nodejs/node/pull/57336)
* \[[`f09fc91b72`](https://github.com/nodejs/node/commit/f09fc91b72)] - **(SEMVER-MINOR)** **tls**: implement tls.getCACertificates() (Joyee Cheung) [#57107](https://github.com/nodejs/node/pull/57107)
* \[[`097f2778ae`](https://github.com/nodejs/node/commit/097f2778ae)] - **tools**: fix WPT update cron string (Antoine du Hamel) [#57665](https://github.com/nodejs/node/pull/57665)
* \[[`6b7421e01d`](https://github.com/nodejs/node/commit/6b7421e01d)] - **tools**: remove stalled label on unstalled issues and PRs (Rich Trott) [#57630](https://github.com/nodejs/node/pull/57630)
* \[[`2dd6d8122c`](https://github.com/nodejs/node/commit/2dd6d8122c)] - **tools**: update sccache to support GH cache changes (Michaël Zasso) [#57573](https://github.com/nodejs/node/pull/57573)
* \[[`486d083c56`](https://github.com/nodejs/node/commit/486d083c56)] - **tools**: bump @babel/helpers from 7.26.9 to 7.26.10 in /tools/eslint (dependabot\[bot]) [#57444](https://github.com/nodejs/node/pull/57444)
* \[[`68eb1da953`](https://github.com/nodejs/node/commit/68eb1da953)] - **tools**: extract target abseil to abseil.gyp (Chengzhong Wu) [#57289](https://github.com/nodejs/node/pull/57289)
* \[[`9d2de381d8`](https://github.com/nodejs/node/commit/9d2de381d8)] - **tools**: add config subspace (Marco Ippolito) [#57239](https://github.com/nodejs/node/pull/57239)
* \[[`138cd541b1`](https://github.com/nodejs/node/commit/138cd541b1)] - **tools**: import rather than require ESLint plugins (Michaël Zasso) [#57315](https://github.com/nodejs/node/pull/57315)
* \[[`7e099f5d04`](https://github.com/nodejs/node/commit/7e099f5d04)] - **tools**: switch back to official OpenSSL (Richard Lau) [#57301](https://github.com/nodejs/node/pull/57301)
* \[[`6fe106edcc`](https://github.com/nodejs/node/commit/6fe106edcc)] - **tools**: revert to use @stylistic/eslint-plugin-js v3 (Joyee Cheung) [#57314](https://github.com/nodejs/node/pull/57314)
* \[[`0974d4e444`](https://github.com/nodejs/node/commit/0974d4e444)] - **tools**: add more details about rolling inspector\_protocol (Chengzhong Wu) [#57167](https://github.com/nodejs/node/pull/57167)
* \[[`db4b0d487c`](https://github.com/nodejs/node/commit/db4b0d487c)] - **tools**: bump the eslint group in /tools/eslint with 5 updates (dependabot\[bot]) [#57261](https://github.com/nodejs/node/pull/57261)
* \[[`c694acc864`](https://github.com/nodejs/node/commit/c694acc864)] - **tools**: remove deps/zlib/GN-scraper.py (Chengzhong Wu) [#57238](https://github.com/nodejs/node/pull/57238)
* \[[`c55e262dce`](https://github.com/nodejs/node/commit/c55e262dce)] - **tools**: run Linux tests on GitHub arm64 runners as well (Dennis Ameling) [#57162](https://github.com/nodejs/node/pull/57162)
* \[[`b7e4807f54`](https://github.com/nodejs/node/commit/b7e4807f54)] - **tools**: consolidate 'introduced\_in' check for docs (1ilsang) [#57109](https://github.com/nodejs/node/pull/57109)
* \[[`4a0f328c57`](https://github.com/nodejs/node/commit/4a0f328c57)] - **tools**: do not run major-release workflow on forks (Rich Trott) [#57064](https://github.com/nodejs/node/pull/57064)
* \[[`a6718ecc24`](https://github.com/nodejs/node/commit/a6718ecc24)] - **tools**: fix release URL computation in update-root-certs.mjs (Joyee Cheung) [#56843](https://github.com/nodejs/node/pull/56843)
* \[[`2db2508a8d`](https://github.com/nodejs/node/commit/2db2508a8d)] - **tools**: add support for `import source` syntax in linter (Antoine du Hamel) [#56992](https://github.com/nodejs/node/pull/56992)
* \[[`80eb78bba5`](https://github.com/nodejs/node/commit/80eb78bba5)] - **tools**: bump eslint version (dependabot\[bot]) [#56869](https://github.com/nodejs/node/pull/56869)
* \[[`3941d68bd9`](https://github.com/nodejs/node/commit/3941d68bd9)] - **tools**: remove test-asan/ubsan workflows (Michaël Zasso) [#56823](https://github.com/nodejs/node/pull/56823)
...
* \[[`c03648becb`](https://github.com/nodejs/node/commit/c03648becb)] - **typings**: fix `ImportModuleDynamicallyCallback` return type (Chengzhong Wu) [#57160](https://github.com/nodejs/node/pull/57160)
* \[[`936af489a0`](https://github.com/nodejs/node/commit/936af489a0)] - **url**: fix constructor error message for URLPattern (jakecastelli) [#57482](https://github.com/nodejs/node/pull/57482)
* \[[`11c577a4a7`](https://github.com/nodejs/node/commit/11c577a4a7)] - **url**: improve urlpattern regexp performance (Yagiz Nizipli) [#57136](https://github.com/nodejs/node/pull/57136)
* \[[`fd9b56b620`](https://github.com/nodejs/node/commit/fd9b56b620)] - **(SEMVER-MINOR)** **url**: add URLPattern implementation (Yagiz Nizipli) [#56452](https://github.com/nodejs/node/pull/56452)
* \[[`4b8d6d0e31`](https://github.com/nodejs/node/commit/4b8d6d0e31)] - **util**: avoid run debug when enabled is false (fengmk2) [#57494](https://github.com/nodejs/node/pull/57494)
* \[[`f69417937e`](https://github.com/nodejs/node/commit/f69417937e)] - **(SEMVER-MINOR)** **util**: expose diff function used by the assertion errors (Giovanni Bucci) [#57462](https://github.com/nodejs/node/pull/57462)
...
* \[[`7905ead170`](https://github.com/nodejs/node/commit/7905ead170)] - **(SEMVER-MINOR)** **v8**: add v8.getCppHeapStatistics() method (Aditi) [#57146](https://github.com/nodejs/node/pull/57146)
* \[[`fe992ef332`](https://github.com/nodejs/node/commit/fe992ef332)] - **win,build**: add option to enable Control Flow Guard (Hüseyin Açacak) [#56605](https://github.com/nodejs/node/pull/56605)
* \[[`460f4f3bc8`](https://github.com/nodejs/node/commit/460f4f3bc8)] - **win,test**: disable test case failing with ClangCL (Stefan Stojanovic) [#57397](https://github.com/nodejs/node/pull/57397)
* \[[`7f11aea942`](https://github.com/nodejs/node/commit/7f11aea942)] - **zlib**: use modern class syntax for zstd classes (Yagiz Nizipli) [#56965](https://github.com/nodejs/node/pull/56965)
* \[[`19a6444c12`](https://github.com/nodejs/node/commit/19a6444c12)] - **zlib**: make all zstd functions experimental (Yagiz Nizipli) [#56964](https://github.com/nodejs/node/pull/56964)
* \[[`dcd9c72fe5`](https://github.com/nodejs/node/commit/dcd9c72fe5)] - **(SEMVER-MINOR)** **zlib**: add zstd support (Jan Martin) [#52100](https://github.com/nodejs/node/pull/52100)
