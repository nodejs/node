...
* \[[`4239d07aad`](https://github.com/nodejs/node/commit/4239d07aad)] - **(SEMVER-MINOR)** **async\_hooks**: add trackPromises option to createHook() (Joyee Cheung) [#61415](https://github.com/nodejs/node/pull/61415)
* \[[`aacafaee77`](https://github.com/nodejs/node/commit/aacafaee77)] - **(SEMVER-MINOR)** **buffer**: increase Buffer.poolSize default to 64 KiB (Matteo Collina) [#63597](https://github.com/nodejs/node/pull/63597)
* \[[`02e2b017e2`](https://github.com/nodejs/node/commit/02e2b017e2)] - **(SEMVER-MINOR)** **cli**: add --max-heap-size option (tannal) [#58708](https://github.com/nodejs/node/pull/58708)
* \[[`cc0d64f9c2`](https://github.com/nodejs/node/commit/cc0d64f9c2)] - **(SEMVER-MINOR)** **console**: allow per-stream `inspectOptions` option (Anna Henningsen) [#60082](https://github.com/nodejs/node/pull/60082)
* \[[`c2822f848e`](https://github.com/nodejs/node/commit/c2822f848e)] - **crypto**: update root certificates to NSS 3.123.1 (Node.js GitHub Bot) [#63527](https://github.com/nodejs/node/pull/63527)
* \[[`b0a8d04556`](https://github.com/nodejs/node/commit/b0a8d04556)] - **(SEMVER-MINOR)** **debugger**: add edit-free runtime expression probes to `node inspect` (Joyee Cheung) [#62713](https://github.com/nodejs/node/pull/62713)
* \[[`2ebefe02f4`](https://github.com/nodejs/node/commit/2ebefe02f4)] - **(SEMVER-MINOR)** **fs**: add signal option to fs.stat() (Mert Can Altin) [#57775](https://github.com/nodejs/node/pull/57775)
* \[[`e77dd8d425`](https://github.com/nodejs/node/commit/e77dd8d425)] - **(SEMVER-MINOR)** **fs**: expose frsize field in statfs (Jinho Jang) [#62277](https://github.com/nodejs/node/pull/62277)
* \[[`a8cb80f5e2`](https://github.com/nodejs/node/commit/a8cb80f5e2)] - **(SEMVER-MINOR)** **fs**: add `throwIfNoEntry` option for fs.stat and fs.promises.stat (Juan José) [#61178](https://github.com/nodejs/node/pull/61178)
* \[[`ffbf579a9c`](https://github.com/nodejs/node/commit/ffbf579a9c)] - **(SEMVER-MINOR)** **fs**: add ignore option to fs.watch (Matteo Collina) [#61433](https://github.com/nodejs/node/pull/61433)
* \[[`9313db841e`](https://github.com/nodejs/node/commit/9313db841e)] - **(SEMVER-MINOR)** **http**: add writeInformation to send arbitrary 1xx status codes (Tim Perry) [#63155](https://github.com/nodejs/node/pull/63155)
* \[[`d95374b6fe`](https://github.com/nodejs/node/commit/d95374b6fe)] - **(SEMVER-MINOR)** **http**: add req.signal to IncomingMessage (Akshat) [#62541](https://github.com/nodejs/node/pull/62541)
* \[[`6384766d1d`](https://github.com/nodejs/node/commit/6384766d1d)] - **(SEMVER-MINOR)** **lib**: remove util.getCallSite (Rafael Gonzaga) [#59980](https://github.com/nodejs/node/pull/59980)
* \[[`3017a5402f`](https://github.com/nodejs/node/commit/3017a5402f)] - **(SEMVER-MINOR)** **net**: add `setTOS` and `getTOS` to `Socket` (Amol Yadav) [#61503](https://github.com/nodejs/node/pull/61503)
* \[[`700df39d93`](https://github.com/nodejs/node/commit/700df39d93)] - **(SEMVER-MINOR)** **node-api**: support SharedArrayBuffer in napi\_create\_dataview (Kevin Eady) [#60473](https://github.com/nodejs/node/pull/60473)
* \[[`864a2f1d90`](https://github.com/nodejs/node/commit/864a2f1d90)] - **(SEMVER-MINOR)** **node-api**: add napi\_create\_object\_with\_properties (Miguel Marcondes Filho) [#59953](https://github.com/nodejs/node/pull/59953)
* \[[`8b07e57adf`](https://github.com/nodejs/node/commit/8b07e57adf)] - **(SEMVER-MINOR)** **perf\_hooks**: move non-standard performance properties to perf\_hooks (Chengzhong Wu) [#60370](https://github.com/nodejs/node/pull/60370)
* \[[`b68524efec`](https://github.com/nodejs/node/commit/b68524efec)] - **(SEMVER-MINOR)** **sqlite**: add sqlite prepare options args (Guilherme Araújo) [#61311](https://github.com/nodejs/node/pull/61311)
* \[[`a899991ba7`](https://github.com/nodejs/node/commit/a899991ba7)] - **(SEMVER-MINOR)** **sqlite**: create authorization api (Guilherme Araújo) [#59928](https://github.com/nodejs/node/pull/59928)
* \[[`50b8968596`](https://github.com/nodejs/node/commit/50b8968596)] - **(CVE-2026-21712)** **src**: handle url crash on different url formats (RafaelGSS) [nodejs-private/node-private#816](https://github.com/nodejs-private/node-private/pull/816)
* \[[`71e857ff7f`](https://github.com/nodejs/node/commit/71e857ff7f)] - **(SEMVER-MINOR)** **src,permission**: add --allow-inspector ability (Rafael Gonzaga) [#59711](https://github.com/nodejs/node/pull/59711)
* \[[`d71a464807`](https://github.com/nodejs/node/commit/d71a464807)] - **(SEMVER-MINOR)** **stream**: add bytes() method to stream/consumers (wantaek) [#60426](https://github.com/nodejs/node/pull/60426)
* \[[`097a23f79b`](https://github.com/nodejs/node/commit/097a23f79b)] - **(SEMVER-MINOR)** **stream**: do not pass `readable.compose()` output via `Readable.from()` (René) [#60907](https://github.com/nodejs/node/pull/60907)
* \[[`0142183b6b`](https://github.com/nodejs/node/commit/0142183b6b)] - **(SEMVER-MINOR)** **test\_runner**: align mock timeout api (sangwook) [#62820](https://github.com/nodejs/node/pull/62820)

### Commits

* \[[`ff01087bc1`](https://github.com/nodejs/node/commit/ff01087bc1)] - **assert,util**: fix stale nested cycle memo entries (Ruben Bridgewater) [#62509](https://github.com/nodejs/node/pull/62509)
* \[[`4239d07aad`](https://github.com/nodejs/node/commit/4239d07aad)] - **(SEMVER-MINOR)** **async\_hooks**: add trackPromises option to createHook() (Joyee Cheung) [#61415](https://github.com/nodejs/node/pull/61415)
* \[[`6e5732e257`](https://github.com/nodejs/node/commit/6e5732e257)] - **benchmark**: fix destructuring in dgram/single-buffer (Ali Hassan) [#62084](https://github.com/nodejs/node/pull/62084)
* \[[`403645707a`](https://github.com/nodejs/node/commit/403645707a)] - **benchmark**: add startup benchmark for ESM entrypoint (Joyee Cheung) [#61769](https://github.com/nodejs/node/pull/61769)
* \[[`c858f470ce`](https://github.com/nodejs/node/commit/c858f470ce)] - **benchmark**: add streaming TextDecoder benchmark (Сковорода Никита Андреевич) [#61549](https://github.com/nodejs/node/pull/61549)
* \[[`aacafaee77`](https://github.com/nodejs/node/commit/aacafaee77)] - **(SEMVER-MINOR)** **buffer**: increase Buffer.poolSize default to 64 KiB (Matteo Collina) [#63597](https://github.com/nodejs/node/pull/63597)
* \[[`bc588a7c7a`](https://github.com/nodejs/node/commit/bc588a7c7a)] - **buffer**: optimize buffer.concat performance (Mert Can Altin) [#61721](https://github.com/nodejs/node/pull/61721)
* \[[`d09e75aff9`](https://github.com/nodejs/node/commit/d09e75aff9)] - **build**: def `NODE_USE_NODE_CODE_CACHE` only used in node\_mksnapshot (Chengzhong Wu) [#63588](https://github.com/nodejs/node/pull/63588)
* \[[`e8529a2466`](https://github.com/nodejs/node/commit/e8529a2466)] - **build**: track PDL files as inputs in inspector GN build (Robo) [#62888](https://github.com/nodejs/node/pull/62888)
* \[[`5028d563d5`](https://github.com/nodejs/node/commit/5028d563d5)] - **build**: remove redundant -fuse-linker-plugin from GCC LTO flags (Daniel Lando) [#62667](https://github.com/nodejs/node/pull/62667)
* \[[`30219199cb`](https://github.com/nodejs/node/commit/30219199cb)] - **build**: support empty libname flags in `configure.py` (Antoine du Hamel) [#62477](https://github.com/nodejs/node/pull/62477)
* \[[`2e8543ea37`](https://github.com/nodejs/node/commit/2e8543ea37)] - **build**: fix timezone-update path references (Chengzhong Wu) [#62280](https://github.com/nodejs/node/pull/62280)
* \[[`54f7483f39`](https://github.com/nodejs/node/commit/54f7483f39)] - **build**: use path-ignore in GHA coverage-windows.yml (Chengzhong Wu) [#61811](https://github.com/nodejs/node/pull/61811)
* \[[`f1faf37828`](https://github.com/nodejs/node/commit/f1faf37828)] - **build**: generate\_config\_gypi.py generates valid JSON (Shelley Vohr) [#61791](https://github.com/nodejs/node/pull/61791)
* \[[`209da8a06a`](https://github.com/nodejs/node/commit/209da8a06a)] - **build**: build with v8 gdbjit support on supported platform (Joyee Cheung) [#61010](https://github.com/nodejs/node/pull/61010)
* \[[`50209555bd`](https://github.com/nodejs/node/commit/50209555bd)] - **build**: add --debug-symbols to build with -g without enabling DCHECKs (Joyee Cheung) [#61100](https://github.com/nodejs/node/pull/61100)
* \[[`9a2265b380`](https://github.com/nodejs/node/commit/9a2265b380)] - **build**: aix: deoptimize implementation-visitor.cc with --shared (Stewart X Addison) [#61550](https://github.com/nodejs/node/pull/61550)
* \[[`b4dada92c9`](https://github.com/nodejs/node/commit/b4dada92c9)] - **build**: expose libplatform symbols in shared libnode (Joyee Cheung) [#61144](https://github.com/nodejs/node/pull/61144)
* \[[`8f93873afd`](https://github.com/nodejs/node/commit/8f93873afd)] - **build**: ibmi follow aix visibility (SRAVANI GUNDEPALLI) [#60360](https://github.com/nodejs/node/pull/60360)
* \[[`df3148560b`](https://github.com/nodejs/node/commit/df3148560b)] - **build**: build v8 with -fvisibility=hidden -fvisibility-inlines-hidden (Joyee Cheung) [#56290](https://github.com/nodejs/node/pull/56290)
* \[[`0e2e4e0f22`](https://github.com/nodejs/node/commit/0e2e4e0f22)] - **child\_process**: add tracing channel for spawn (Marco) [#61836](https://github.com/nodejs/node/pull/61836)
* \[[`02e2b017e2`](https://github.com/nodejs/node/commit/02e2b017e2)] - **(SEMVER-MINOR)** **cli**: add --max-heap-size option (tannal) [#58708](https://github.com/nodejs/node/pull/58708)
* \[[`cc0d64f9c2`](https://github.com/nodejs/node/commit/cc0d64f9c2)] - **(SEMVER-MINOR)** **console**: allow per-stream `inspectOptions` option (Anna Henningsen) [#60082](https://github.com/nodejs/node/pull/60082)
* \[[`c2822f848e`](https://github.com/nodejs/node/commit/c2822f848e)] - **crypto**: update root certificates to NSS 3.123.1 (Node.js GitHub Bot) [#63527](https://github.com/nodejs/node/pull/63527)
* \[[`9f48487ee0`](https://github.com/nodejs/node/commit/9f48487ee0)] - **crypto**: coerce -0 keylen to +0 in pbkdf2 and scrypt (Jordan Harband) [#63531](https://github.com/nodejs/node/pull/63531)
* \[[`34a36469b6`](https://github.com/nodejs/node/commit/34a36469b6)] - **crypto**: improve system certificate enumeration logic on macOS (Robo) [#62576](https://github.com/nodejs/node/pull/62576)
* \[[`8d8b5f5340`](https://github.com/nodejs/node/commit/8d8b5f5340)] - **crypto**: fix unsigned conversion of 4-byte RSA publicExponent (DeepView Autofix) [#62839](https://github.com/nodejs/node/pull/62839)
* \[[`53ae62cbe8`](https://github.com/nodejs/node/commit/53ae62cbe8)] - **crypto**: add crypto::GetSSLCtx API for addon access to OpenSSL contexts (Tim Perry) [#62254](https://github.com/nodejs/node/pull/62254)
* \[[`266456e0d0`](https://github.com/nodejs/node/commit/266456e0d0)] - **crypto**: read algorithm name property only once in normalizeAlgorithm (Filip Skokan) [#62170](https://github.com/nodejs/node/pull/62170)
* \[[`a673bfbae8`](https://github.com/nodejs/node/commit/a673bfbae8)] - **debugger**: add --help to `node inspect` and improve docs (Joyee Cheung) [#63201](https://github.com/nodejs/node/pull/63201)
* \[[`3747f10878`](https://github.com/nodejs/node/commit/3747f10878)] - **debugger**: move ProbeInspectorSession and helpers to separate files (Joyee Cheung) [#63013](https://github.com/nodejs/node/pull/63013)
* \[[`b0a8d04556`](https://github.com/nodejs/node/commit/b0a8d04556)] - **(SEMVER-MINOR)** **debugger**: add edit-free runtime expression probes to `node inspect` (Joyee Cheung) [#62713](https://github.com/nodejs/node/pull/62713)
* \[[`1e8a8b9675`](https://github.com/nodejs/node/commit/1e8a8b9675)] - **deps**: SQLite: cherry-pick b869ed6b067d623cb1383549f2a18aa35508385d (Junsu Han) [#63525](https://github.com/nodejs/node/pull/63525)
* \[[`85237a31c1`](https://github.com/nodejs/node/commit/85237a31c1)] - **deps**: update sqlite to 3.53.1 (Node.js GitHub Bot) [#63217](https://github.com/nodejs/node/pull/63217)
* \[[`5346cc9129`](https://github.com/nodejs/node/commit/5346cc9129)] - **deps**: update simdjson to 4.6.4 (Node.js GitHub Bot) [#62811](https://github.com/nodejs/node/pull/62811)
* \[[`5aaa7ba2fc`](https://github.com/nodejs/node/commit/5aaa7ba2fc)] - **deps**: cherry-pick libuv/libuv\@a43e543 (Ali Hassan) [#63222](https://github.com/nodejs/node/pull/63222)
* \[[`0e3a4eb893`](https://github.com/nodejs/node/commit/0e3a4eb893)] - **deps**: update corepack to 0.35.0 (Node.js GitHub Bot) [#63375](https://github.com/nodejs/node/pull/63375)
* \[[`23370a1a9c`](https://github.com/nodejs/node/commit/23370a1a9c)] - **deps**: update amaro to 1.1.9 (Node.js GitHub Bot) [#63090](https://github.com/nodejs/node/pull/63090)
* \[[`0d2111e255`](https://github.com/nodejs/node/commit/0d2111e255)] - **deps**: update corepack to 0.34.7 (Node.js GitHub Bot) [#62810](https://github.com/nodejs/node/pull/62810)
* \[[`037ae2a929`](https://github.com/nodejs/node/commit/037ae2a929)] - **deps**: cherry-pick libuv/libuv\@439a54b (skooch) [#62881](https://github.com/nodejs/node/pull/62881)
* \[[`bc4d8a151f`](https://github.com/nodejs/node/commit/bc4d8a151f)] - **deps**: update sqlite to 3.53.0 (Node.js GitHub Bot) [#62699](https://github.com/nodejs/node/pull/62699)
* \[[`b3684e645a`](https://github.com/nodejs/node/commit/b3684e645a)] - **deps**: update nbytes to 0.1.4 (Node.js GitHub Bot) [#62698](https://github.com/nodejs/node/pull/62698)
* \[[`e33b12ab77`](https://github.com/nodejs/node/commit/e33b12ab77)] - **deps**: update minimatch to 10.2.5 (Node.js GitHub Bot) [#62594](https://github.com/nodejs/node/pull/62594)
* \[[`057ea64aaf`](https://github.com/nodejs/node/commit/057ea64aaf)] - **deps**: update googletest to d72f9c8aea6817cdf1ca0ac10887f328de7f3da2 (Node.js GitHub Bot) [#62593](https://github.com/nodejs/node/pull/62593)
* \[[`ee50353ca9`](https://github.com/nodejs/node/commit/ee50353ca9)] - **deps**: update simdjson to 4.6.1 (Node.js GitHub Bot) [#62592](https://github.com/nodejs/node/pull/62592)
* \[[`8edd06eae9`](https://github.com/nodejs/node/commit/8edd06eae9)] - **deps**: libuv: cherry-pick aabb7651de (Santiago Gimeno) [#62561](https://github.com/nodejs/node/pull/62561)
* \[[`83b594acfa`](https://github.com/nodejs/node/commit/83b594acfa)] - **deps**: update icu to 78.3 (Node.js GitHub Bot) [#62324](https://github.com/nodejs/node/pull/62324)
* \[[`7fe2c32a4f`](https://github.com/nodejs/node/commit/7fe2c32a4f)] - **deps**: update libuv to 1.52.1 (Node.js GitHub Bot) [#61829](https://github.com/nodejs/node/pull/61829)
* \[[`0587ede067`](https://github.com/nodejs/node/commit/0587ede067)] - **deps**: V8: cherry-pick cf1bce40a5ef (Richard Lau) [#62449](https://github.com/nodejs/node/pull/62449)
* \[[`6781132f4f`](https://github.com/nodejs/node/commit/6781132f4f)] - **deps**: update googletest to 5a9c3f9e8d9b90bbbe8feb32902146cb8f7c1757 (Node.js GitHub Bot) [#61731](https://github.com/nodejs/node/pull/61731)
* \[[`c9bc0fca64`](https://github.com/nodejs/node/commit/c9bc0fca64)] - **deps**: update googletest to 56efe3983185e3f37e43415d1afa97e3860f187f (Node.js GitHub Bot) [#61605](https://github.com/nodejs/node/pull/61605)
* \[[`eed058e929`](https://github.com/nodejs/node/commit/eed058e929)] - **deps**: update inspector\_protocol to 1b1bcbbe060e8c8cd8704f00f78978c50991 (Node.js GitHub Bot) [#60705](https://github.com/nodejs/node/pull/60705)
* \[[`12665d3a54`](https://github.com/nodejs/node/commit/12665d3a54)] - **deps**: V8: cherry-pick 2abc61361dd4 (Richard Lau) [#60177](https://github.com/nodejs/node/pull/60177)
* \[[`f267eb307d`](https://github.com/nodejs/node/commit/f267eb307d)] - **deps**: update inspector\_protocol to af7f5a8173fdbc29f0835ec94395932e328b (Node.js GitHub Bot) [#60312](https://github.com/nodejs/node/pull/60312)
* \[[`eb03a824d9`](https://github.com/nodejs/node/commit/eb03a824d9)] - **deps**: V8: cherry-pick f93055fbd5aa (Olivier Flückiger) [#60105](https://github.com/nodejs/node/pull/60105)
* \[[`ab072328cb`](https://github.com/nodejs/node/commit/ab072328cb)] - **dns**: fix Windows SRV ECONNREFUSED by adjusting c-ares fallback detection (notvivek12) [#61453](https://github.com/nodejs/node/pull/61453)
* \[[`c008048f4c`](https://github.com/nodejs/node/commit/c008048f4c)] - **doc**: remove duplicated sentences in large-pull-requests.md (Joyee Cheung) [#63650](https://github.com/nodejs/node/pull/63650)
* \[[`5e31a8b7f6`](https://github.com/nodejs/node/commit/5e31a8b7f6)] - **doc**: update `git node land` instructions for security releases (Antoine du Hamel) [#63586](https://github.com/nodejs/node/pull/63586)
* \[[`c0a73f35a7`](https://github.com/nodejs/node/commit/c0a73f35a7)] - **doc**: drop --experimental from --permission (Rafael Gonzaga) [#63583](https://github.com/nodejs/node/pull/63583)
* \[[`fae81544ee`](https://github.com/nodejs/node/commit/fae81544ee)] - **doc**: explicitly ask for reproducible in JS (Rafael Gonzaga) [#63479](https://github.com/nodejs/node/pull/63479)
* \[[`3db33589a3`](https://github.com/nodejs/node/commit/3db33589a3)] - **doc**: fix URL postMessage example in worker\_threads (Kit Dallege) [#62203](https://github.com/nodejs/node/pull/62203)
* \[[`333b06c147`](https://github.com/nodejs/node/commit/333b06c147)] - **doc**: clarify `filter` option of `sqlite.database.applyChangeset` (Antoine du Hamel) [#63515](https://github.com/nodejs/node/pull/63515)
* \[[`6a175977f4`](https://github.com/nodejs/node/commit/6a175977f4)] - **doc**: fix double spaces in ERR\_TLS\_INVALID\_PROTOCOL\_METHOD (Daijiro Wachi) [#63511](https://github.com/nodejs/node/pull/63511)
* \[[`d764a825b6`](https://github.com/nodejs/node/commit/d764a825b6)] - **doc**: fix double space in modules.md (Daijiro Wachi) [#63512](https://github.com/nodejs/node/pull/63512)
* \[[`7783427603`](https://github.com/nodejs/node/commit/7783427603)] - **doc**: fix "options" to "option" in tls.createServer (Daijiro Wachi) [#63453](https://github.com/nodejs/node/pull/63453)
* \[[`60b2681339`](https://github.com/nodejs/node/commit/60b2681339)] - **doc**: remove unsupported template type from v8.md (René) [#63410](https://github.com/nodejs/node/pull/63410)
* \[[`707d58e7d6`](https://github.com/nodejs/node/commit/707d58e7d6)] - **doc**: remove the bi-monthly contributor spotlight section (Claudio Wunder) [#62734](https://github.com/nodejs/node/pull/62734)
* \[[`1ba81e6220`](https://github.com/nodejs/node/commit/1ba81e6220)] - **doc**: update http2's `push` and `trailers` events with `rawHeaders` param (YuSheng Chen) [#63259](https://github.com/nodejs/node/pull/63259)
* \[[`e9b063208e`](https://github.com/nodejs/node/commit/e9b063208e)] - **doc**: remove inactive members from Triagers list (Antoine du Hamel) [#63329](https://github.com/nodejs/node/pull/63329)
* \[[`5ca80fd16c`](https://github.com/nodejs/node/commit/5ca80fd16c)] - **doc**: recommend explicitly Tier 1 or 2 for production applications (Mike McCready) [#63187](https://github.com/nodejs/node/pull/63187)
* \[[`d9a31c28e1`](https://github.com/nodejs/node/commit/d9a31c28e1)] - **doc**: add large pull requests contributing guide (Matteo Collina) [#62829](https://github.com/nodejs/node/pull/62829)
* \[[`a76017add3`](https://github.com/nodejs/node/commit/a76017add3)] - **doc**: clarify SEA platform support excludes darwin-x64 (MJSHANG) [#63181](https://github.com/nodejs/node/pull/63181)
* \[[`3af9699576`](https://github.com/nodejs/node/commit/3af9699576)] - **doc**: update release steps when post-release fails (Rafael Gonzaga) [#63131](https://github.com/nodejs/node/pull/63131)
* \[[`1b4f4871c8`](https://github.com/nodejs/node/commit/1b4f4871c8)] - **doc**: remove list of versions in `BUILDING.md` (Antoine du Hamel) [#63113](https://github.com/nodejs/node/pull/63113)
* \[[`90d852ba64`](https://github.com/nodejs/node/commit/90d852ba64)] - **doc**: fix the TypeScript Execute (tsx) project link (David Thornton) [#63093](https://github.com/nodejs/node/pull/63093)
* \[[`fac9b19a51`](https://github.com/nodejs/node/commit/fac9b19a51)] - **doc**: correct diagnostics\_channel built-in channel names (Bryan English) [#62995](https://github.com/nodejs/node/pull/62995)
* \[[`614d6cbcac`](https://github.com/nodejs/node/commit/614d6cbcac)] - **doc**: use mjs/cjs blocks for callbackify null reason example (Daijiro Wachi) [#62884](https://github.com/nodejs/node/pull/62884)
* \[[`966eda7541`](https://github.com/nodejs/node/commit/966eda7541)] - **doc**: correct typo in PR contribution instructions (Mike McCready) [#62738](https://github.com/nodejs/node/pull/62738)
* \[[`b7d35d8ef7`](https://github.com/nodejs/node/commit/b7d35d8ef7)] - **doc**: fix duplicate word "of of" in postMessageToThread (Daijiro Wachi) [#62917](https://github.com/nodejs/node/pull/62917)
* \[[`3a4167e292`](https://github.com/nodejs/node/commit/3a4167e292)] - **doc**: fix duplicate word "for for" in compile cache (Daijiro Wachi) [#62917](https://github.com/nodejs/node/pull/62917)
* \[[`33c00eb437`](https://github.com/nodejs/node/commit/33c00eb437)] - **doc**: fix typo in dns.lookup options description (Daijiro Wachi) [#62882](https://github.com/nodejs/node/pull/62882)
* \[[`11c1de3cee`](https://github.com/nodejs/node/commit/11c1de3cee)] - **doc**: clarify diffieHellman.generateKeys recomputes same key (Kit Dallege) [#62205](https://github.com/nodejs/node/pull/62205)
* \[[`7dc1af3e6b`](https://github.com/nodejs/node/commit/7dc1af3e6b)] - **doc**: remove Ayase-252 and meixg from triagger team (Antoine du Hamel) [#62841](https://github.com/nodejs/node/pull/62841)
* \[[`98a4612e70`](https://github.com/nodejs/node/commit/98a4612e70)] - **doc**: clarify dns.lookup() callback signature when all is true (eungi) [#62800](https://github.com/nodejs/node/pull/62800)
* \[[`acec5c8525`](https://github.com/nodejs/node/commit/acec5c8525)] - **doc**: add experimental modules lifetime policy (Paolo Insogna) [#62753](https://github.com/nodejs/node/pull/62753)
* \[[`4395f0733f`](https://github.com/nodejs/node/commit/4395f0733f)] - **doc**: clarify process.\_debugProcess() in Permission Model (Fahad Khan) [#62537](https://github.com/nodejs/node/pull/62537)
* \[[`9529a270c6`](https://github.com/nodejs/node/commit/9529a270c6)] - **doc**: fix typo in devcontainer guide (Rohan Santhosh Kumar) [#62687](https://github.com/nodejs/node/pull/62687)
* \[[`ee617c1789`](https://github.com/nodejs/node/commit/ee617c1789)] - **doc**: clarify Backport-PR-URL metadata added automatically (Mike McCready) [#62668](https://github.com/nodejs/node/pull/62668)
* \[[`e096f66505`](https://github.com/nodejs/node/commit/e096f66505)] - **doc**: update WPT test runner README.md (Filip Skokan) [#62680](https://github.com/nodejs/node/pull/62680)
* \[[`0de9f7f0ce`](https://github.com/nodejs/node/commit/0de9f7f0ce)] - **doc**: fix spelling in release announcement guidance (Rohan Santhosh Kumar) [#62663](https://github.com/nodejs/node/pull/62663)
* \[[`adca0b806c`](https://github.com/nodejs/node/commit/adca0b806c)] - **doc**: update bug bounty program (Rafael Gonzaga) [#62590](https://github.com/nodejs/node/pull/62590)
* \[[`99a81a3cc2`](https://github.com/nodejs/node/commit/99a81a3cc2)] - **doc**: document TransformStream transformer.cancel option (Tom Pereira) [#62566](https://github.com/nodejs/node/pull/62566)
* \[[`98f3ace627`](https://github.com/nodejs/node/commit/98f3ace627)] - **doc**: remove spawn with shell example from bat/cmd section (Kit Dallege) [#62243](https://github.com/nodejs/node/pull/62243)
* \[[`34e146b875`](https://github.com/nodejs/node/commit/34e146b875)] - **doc**: fix typo in --disable-wasm-trap-handler description (Dmytro Semchuk) [#61820](https://github.com/nodejs/node/pull/61820)
* \[[`7a166b1e70`](https://github.com/nodejs/node/commit/7a166b1e70)] - **doc**: clarify that features cannot be both experimental and deprecated (Antoine du Hamel) [#62456](https://github.com/nodejs/node/pull/62456)
* \[[`bd3542b9bd`](https://github.com/nodejs/node/commit/bd3542b9bd)] - **doc**: enhance clarification about the main field (Mowafak Almahaini) [#62302](https://github.com/nodejs/node/pull/62302)
* \[[`286d7e9267`](https://github.com/nodejs/node/commit/286d7e9267)] - **doc**: minor typo fix (Jeff Matson) [#62358](https://github.com/nodejs/node/pull/62358)
* \[[`646f11d258`](https://github.com/nodejs/node/commit/646f11d258)] - **doc**: test and test-only targets do not run linter (Xavier Stouder) [#62120](https://github.com/nodejs/node/pull/62120)
* \[[`e5800ccbfb`](https://github.com/nodejs/node/commit/e5800ccbfb)] - **doc**: clarify that any truthy value of `shell` is part of DEP0190 (Antoine du Hamel) [#62249](https://github.com/nodejs/node/pull/62249)
* \[[`720024e268`](https://github.com/nodejs/node/commit/720024e268)] - **doc**: remove outdated Chrome 66 and ndb references from debugger (Kit Dallege) [#62202](https://github.com/nodejs/node/pull/62202)
* \[[`0924a038f9`](https://github.com/nodejs/node/commit/0924a038f9)] - **doc**: copyedit `addons.md` (Antoine du Hamel) [#62071](https://github.com/nodejs/node/pull/62071)
* \[[`341aa7a21e`](https://github.com/nodejs/node/commit/341aa7a21e)] - **doc**: expand SECURITY.md with non-vulnerability examples (Rafael Gonzaga) [#61972](https://github.com/nodejs/node/pull/61972)
* \[[`e4c6ac352c`](https://github.com/nodejs/node/commit/e4c6ac352c)] - **doc**: separate in-types and out-types in SQLite conversion docs (René) [#62034](https://github.com/nodejs/node/pull/62034)
* \[[`9798f76f9a`](https://github.com/nodejs/node/commit/9798f76f9a)] - **doc**: update DEP0040 (punycode) to application type deprecation (Mike McCready) [#61916](https://github.com/nodejs/node/pull/61916)
* \[[`e1c76757b7`](https://github.com/nodejs/node/commit/e1c76757b7)] - **doc**: add esm and cjs examples to node:vm (Alfredo González) [#61498](https://github.com/nodejs/node/pull/61498)
* \[[`111c6cf3f0`](https://github.com/nodejs/node/commit/111c6cf3f0)] - **doc**: clarify build environment is trusted in threat model (Matteo Collina) [#61865](https://github.com/nodejs/node/pull/61865)
* \[[`99e5b00f60`](https://github.com/nodejs/node/commit/99e5b00f60)] - **doc**: clean up Windows code snippet in `child_process.md` (reillylm) [#61422](https://github.com/nodejs/node/pull/61422)
* \[[`86c72a05b4`](https://github.com/nodejs/node/commit/86c72a05b4)] - **doc**: clarify EventEmitter error handling in threat model (Matteo Collina) [#61701](https://github.com/nodejs/node/pull/61701)
* \[[`96b47690d5`](https://github.com/nodejs/node/commit/96b47690d5)] - **doc**: fix --inspect security warning section (Tim Perry) [#61675](https://github.com/nodejs/node/pull/61675)
* \[[`6ef6d1f9a0`](https://github.com/nodejs/node/commit/6ef6d1f9a0)] - **doc**: fix grammatical error in README.md (ayj8201) [#61653](https://github.com/nodejs/node/pull/61653)
* \[[`ffad1e83d2`](https://github.com/nodejs/node/commit/ffad1e83d2)] - **doc**: update `server.dropMaxConnection` link (YuSheng Chen) [#61584](https://github.com/nodejs/node/pull/61584)
* \[[`4e4ffeac47`](https://github.com/nodejs/node/commit/4e4ffeac47)] - **doc**: clean up writing-and-running-benchmarks.md (Hardanish Singh) [#61345](https://github.com/nodejs/node/pull/61345)
* \[[`8fde6481fc`](https://github.com/nodejs/node/commit/8fde6481fc)] - **doc**: add --heap-snapshot-on-oom to useful v8 flag (jakecastelli) [#60260](https://github.com/nodejs/node/pull/60260)
* \[[`8c36a34b21`](https://github.com/nodejs/node/commit/8c36a34b21)] - **doc**: add sxa GPG key (ed25519) (Stewart X Addison) [#64193](https://github.com/nodejs/node/pull/64193)
* \[[`dfeb267fc9`](https://github.com/nodejs/node/commit/dfeb267fc9)] - **doc,sqlite**: document entryPoint argument for loadExtension (Edy Silva) [#63152](https://github.com/nodejs/node/pull/63152)
* \[[`e47534104e`](https://github.com/nodejs/node/commit/e47534104e)] - **doc,test**: clarify --eval syntax for leading '-' scripts (kovan) [#62244](https://github.com/nodejs/node/pull/62244)
* \[[`8d15bb09c7`](https://github.com/nodejs/node/commit/8d15bb09c7)] - **errors**: handle V8 warnings in DisallowJavascriptExecutionScope (Divyanshu Sharma) [#63491](https://github.com/nodejs/node/pull/63491)
* \[[`c54a9177f3`](https://github.com/nodejs/node/commit/c54a9177f3)] - **events**: avoid cloning listeners array on every emit (Gürgün Dayıoğlu) [#62261](https://github.com/nodejs/node/pull/62261)
* \[[`ffa9b9818e`](https://github.com/nodejs/node/commit/ffa9b9818e)] - **fs**: make `Date` properties on `Stats` enumerable (LiviaMedeiros) [#63328](https://github.com/nodejs/node/pull/63328)
* \[[`cd8dc6d4bf`](https://github.com/nodejs/node/commit/cd8dc6d4bf)] - **fs**: validate position argument before length === 0 early return (Edy Silva) [#62674](https://github.com/nodejs/node/pull/62674)
* \[[`2ebefe02f4`](https://github.com/nodejs/node/commit/2ebefe02f4)] - **(SEMVER-MINOR)** **fs**: add signal option to fs.stat() (Mert Can Altin) [#57775](https://github.com/nodejs/node/pull/57775)
* \[[`e77dd8d425`](https://github.com/nodejs/node/commit/e77dd8d425)] - **(SEMVER-MINOR)** **fs**: expose frsize field in statfs (Jinho Jang) [#62277](https://github.com/nodejs/node/pull/62277)
* \[[`a8cb80f5e2`](https://github.com/nodejs/node/commit/a8cb80f5e2)] - **(SEMVER-MINOR)** **fs**: add `throwIfNoEntry` option for fs.stat and fs.promises.stat (Juan José) [#61178](https://github.com/nodejs/node/pull/61178)
* \[[`ffbf579a9c`](https://github.com/nodejs/node/commit/ffbf579a9c)] - **(SEMVER-MINOR)** **fs**: add ignore option to fs.watch (Matteo Collina) [#61433](https://github.com/nodejs/node/pull/61433)
* \[[`9313db841e`](https://github.com/nodejs/node/commit/9313db841e)] - **(SEMVER-MINOR)** **http**: add writeInformation to send arbitrary 1xx status codes (Tim Perry) [#63155](https://github.com/nodejs/node/pull/63155)
* \[[`13fe725f6f`](https://github.com/nodejs/node/commit/13fe725f6f)] - **http**: emit 'drain' on OutgoingMessage only after buffers drain (Robert Nagy) [#62936](https://github.com/nodejs/node/pull/62936)
* \[[`ea619d4d9b`](https://github.com/nodejs/node/commit/ea619d4d9b)] - **http**: fix leaked error listener on sync HTTP req create + destroy (Tim Perry) [#62872](https://github.com/nodejs/node/pull/62872)
* \[[`3fac8fd9d4`](https://github.com/nodejs/node/commit/3fac8fd9d4)] - **http**: fix no\_proxy leading-dot suffix matching (Daijiro Wachi) [#62333](https://github.com/nodejs/node/pull/62333)
* \[[`3933b68336`](https://github.com/nodejs/node/commit/3933b68336)] - **http**: cleanup pipeline queue (Robert Nagy) [#62534](https://github.com/nodejs/node/pull/62534)
* \[[`d95374b6fe`](https://github.com/nodejs/node/commit/d95374b6fe)] - **(SEMVER-MINOR)** **http**: add req.signal to IncomingMessage (Akshat) [#62541](https://github.com/nodejs/node/pull/62541)
* \[[`dde0531c54`](https://github.com/nodejs/node/commit/dde0531c54)] - **http**: fix use-after-free when freeParser is called during llhttp\_execute (Gerhard Stöbich) [#62095](https://github.com/nodejs/node/pull/62095)
* \[[`823350d3fa`](https://github.com/nodejs/node/commit/823350d3fa)] - **http**: validate ClientRequest path on set (Matteo Collina) [#62030](https://github.com/nodejs/node/pull/62030)
* \[[`bb6fa79f0c`](https://github.com/nodejs/node/commit/bb6fa79f0c)] - **http**: validate headers in writeEarlyHints (Richard Clarke) [#61897](https://github.com/nodejs/node/pull/61897)
* \[[`dc25e8792b`](https://github.com/nodejs/node/commit/dc25e8792b)] - **http**: remove redundant keepAliveTimeoutBuffer assignment (Efe) [#61743](https://github.com/nodejs/node/pull/61743)
* \[[`21fb8bc57d`](https://github.com/nodejs/node/commit/21fb8bc57d)] - **http**: attach error handler to socket synchronously in onSocket (RajeshKumar11) [#61770](https://github.com/nodejs/node/pull/61770)
* \[[`bbc36d78b4`](https://github.com/nodejs/node/commit/bbc36d78b4)] - **http**: implement slab allocation for HTTP header parsing (Mert Can Altin) [#61375](https://github.com/nodejs/node/pull/61375)
* \[[`0e48f238cd`](https://github.com/nodejs/node/commit/0e48f238cd)] - **http2**: emit session close before stream close (Matteo Collina) [#63414](https://github.com/nodejs/node/pull/63414)
* \[[`60145c3c97`](https://github.com/nodejs/node/commit/60145c3c97)] - **http2**: validate non-link headers in writeEarlyHints (Matteo Collina) [#62017](https://github.com/nodejs/node/pull/62017)
* \[[`0c9ec2327c`](https://github.com/nodejs/node/commit/0c9ec2327c)] - **http2**: expose writable stream state on compat response (T) [#63003](https://github.com/nodejs/node/pull/63003)
* \[[`400c7fb56c`](https://github.com/nodejs/node/commit/400c7fb56c)] - **inspector**: fix absolute URLs in network http (bugyaluwang) [#62955](https://github.com/nodejs/node/pull/62955)
* \[[`6661730cd5`](https://github.com/nodejs/node/commit/6661730cd5)] - **inspector**: unwrap internal/debugger/inspect imports (René) [#61974](https://github.com/nodejs/node/pull/61974)
* \[[`e0216a1680`](https://github.com/nodejs/node/commit/e0216a1680)] - **inspector**: fix crash when receiving non json message (Shima Ryuhei) [#60388](https://github.com/nodejs/node/pull/60388)
* \[[`16d0302437`](https://github.com/nodejs/node/commit/16d0302437)] - **lib**: define `kEnumerableProperty` atomically (Antoine du Hamel) [#63609](https://github.com/nodejs/node/pull/63609)
* \[[`67a27d6123`](https://github.com/nodejs/node/commit/67a27d6123)] - **lib**: fix typos in esm loader comments (RonGamzu) [#63465](https://github.com/nodejs/node/pull/63465)
* \[[`aede0eb578`](https://github.com/nodejs/node/commit/aede0eb578)] - **lib**: fixes validator message (Daijiro Wachi) [#62823](https://github.com/nodejs/node/pull/62823)
* \[[`90cae53633`](https://github.com/nodejs/node/commit/90cae53633)] - **lib**: narrow ReadableStreamBYOBRequest.view return type to Uint8Array (RoomWithOutRoof) [#63017](https://github.com/nodejs/node/pull/63017)
* \[[`7c0397c2da`](https://github.com/nodejs/node/commit/7c0397c2da)] - **lib**: avoid quadratic shift() in startup snapshot callback (Daijiro Wachi) [#62914](https://github.com/nodejs/node/pull/62914)
* \[[`06363e7756`](https://github.com/nodejs/node/commit/06363e7756)] - **lib**: harden kKeyOps lookup with null prototype (Filip Skokan) [#62877](https://github.com/nodejs/node/pull/62877)
* \[[`122d833ab3`](https://github.com/nodejs/node/commit/122d833ab3)] - **lib**: use js-only implementation of `isDataView()` (René) [#62780](https://github.com/nodejs/node/pull/62780)
* \[[`e1f2fece6e`](https://github.com/nodejs/node/commit/e1f2fece6e)] - **lib**: fix sequence argument handling in Blob constructor (Ms2ger) [#62179](https://github.com/nodejs/node/pull/62179)
* \[[`5015509fac`](https://github.com/nodejs/node/commit/5015509fac)] - **lib**: make SubtleCrypto.supports enumerable (Filip Skokan) [#62307](https://github.com/nodejs/node/pull/62307)
* \[[`144f1714f4`](https://github.com/nodejs/node/commit/144f1714f4)] - **lib**: improve argument handling in Blob constructor (Ms2ger) [#61980](https://github.com/nodejs/node/pull/61980)
* \[[`6109708007`](https://github.com/nodejs/node/commit/6109708007)] - **lib**: recycle queues (Robert Nagy) [#61461](https://github.com/nodejs/node/pull/61461)
* \[[`6384766d1d`](https://github.com/nodejs/node/commit/6384766d1d)] - **(SEMVER-MINOR)** **lib**: remove util.getCallSite (Rafael Gonzaga) [#59980](https://github.com/nodejs/node/pull/59980)
* \[[`0b66dbe892`](https://github.com/nodejs/node/commit/0b66dbe892)] - **meta**: flip mcollina emails in .mailmap (Matteo Collina) [#63621](https://github.com/nodejs/node/pull/63621)
* \[[`b5c9e2c321`](https://github.com/nodejs/node/commit/b5c9e2c321)] - **meta**: label "source maps" PRs (Chengzhong Wu) [#63591](https://github.com/nodejs/node/pull/63591)
* \[[`64e70d530b`](https://github.com/nodejs/node/commit/64e70d530b)] - **meta**: add `vfs` subsystem label (René) [#62331](https://github.com/nodejs/node/pull/62331)
* \[[`9a9b680e19`](https://github.com/nodejs/node/commit/9a9b680e19)] - **meta**: skip scheduled workflows on forks (Jamie Magee) [#63565](https://github.com/nodejs/node/pull/63565)
* \[[`3fc9dc7d6f`](https://github.com/nodejs/node/commit/3fc9dc7d6f)] - **meta**: add additional gitignore entries (James M Snell) [#63267](https://github.com/nodejs/node/pull/63267)
* \[[`29540b02d5`](https://github.com/nodejs/node/commit/29540b02d5)] - **meta**: move one or more collaborators to emeritus (Node.js GitHub Bot) [#63402](https://github.com/nodejs/node/pull/63402)
* \[[`91cc89c2fa`](https://github.com/nodejs/node/commit/91cc89c2fa)] - **meta**: move one or more collaborators to emeritus (Node.js GitHub Bot) [#63235](https://github.com/nodejs/node/pull/63235)
* \[[`f5ed147537`](https://github.com/nodejs/node/commit/f5ed147537)] - **meta**: ignore AI assistants files (Matteo Collina) [#62612](https://github.com/nodejs/node/pull/62612)
* \[[`7d41d91a2b`](https://github.com/nodejs/node/commit/7d41d91a2b)] - **meta**: bump actions/download-artifact from 8.0.0 to 8.0.1 (dependabot\[bot]) [#62549](https://github.com/nodejs/node/pull/62549)
* \[[`9709dff62e`](https://github.com/nodejs/node/commit/9709dff62e)] - **meta**: bump github/codeql-action from 4.35.1 to 4.35.3 (dependabot\[bot]) [#63074](https://github.com/nodejs/node/pull/63074)
* \[[`25df45b8f4`](https://github.com/nodejs/node/commit/25df45b8f4)] - **meta**: bump Mozilla-Actions/sccache-action from 0.0.9 to 0.0.10 (dependabot\[bot]) [#63073](https://github.com/nodejs/node/pull/63073)
* \[[`5db12902a3`](https://github.com/nodejs/node/commit/5db12902a3)] - **meta**: add automation policy (Chengzhong Wu) [#62871](https://github.com/nodejs/node/pull/62871)
* \[[`a1ed7093c6`](https://github.com/nodejs/node/commit/a1ed7093c6)] - **meta**: move VoltrexKeyva to emeritus (Matteo Collina) [#62895](https://github.com/nodejs/node/pull/62895)
* \[[`8379761044`](https://github.com/nodejs/node/commit/8379761044)] - **meta**: bump peter-evans/create-pull-request from 8.1.0 to 8.1.1 (dependabot\[bot]) [#62845](https://github.com/nodejs/node/pull/62845)
* \[[`bad2050c81`](https://github.com/nodejs/node/commit/bad2050c81)] - **meta**: bump step-security/harden-runner from 2.16.1 to 2.19.0 (dependabot\[bot]) [#62844](https://github.com/nodejs/node/pull/62844)
* \[[`7e1c500569`](https://github.com/nodejs/node/commit/7e1c500569)] - **meta**: bump actions/setup-node from 6.3.0 to 6.4.0 (dependabot\[bot]) [#62842](https://github.com/nodejs/node/pull/62842)
* \[[`6aef87c737`](https://github.com/nodejs/node/commit/6aef87c737)] - **meta**: broaden stale bot (Aviv Keller) [#62658](https://github.com/nodejs/node/pull/62658)
* \[[`0556b64d0a`](https://github.com/nodejs/node/commit/0556b64d0a)] - **meta**: add QUIC to CODEOWNERS (Tim Perry) [#62652](https://github.com/nodejs/node/pull/62652)
* \[[`c96f1a5f2e`](https://github.com/nodejs/node/commit/c96f1a5f2e)] - **meta**: move Michael to emeritus (Michael Dawson) [#62536](https://github.com/nodejs/node/pull/62536)
* \[[`ea6fd18e03`](https://github.com/nodejs/node/commit/ea6fd18e03)] - **meta**: populate apt list for slim runner in update-openssl workflow (René) [#62628](https://github.com/nodejs/node/pull/62628)
* \[[`73e117dddf`](https://github.com/nodejs/node/commit/73e117dddf)] - **meta**: bump step-security/harden-runner from 2.15.0 to 2.16.1 (dependabot\[bot]) [#62550](https://github.com/nodejs/node/pull/62550)
* \[[`62a7fe6c1f`](https://github.com/nodejs/node/commit/62a7fe6c1f)] - **meta**: bump actions/setup-node from 6.2.0 to 6.3.0 (dependabot\[bot]) [#62548](https://github.com/nodejs/node/pull/62548)
* \[[`ec4c7410e7`](https://github.com/nodejs/node/commit/ec4c7410e7)] - **meta**: bump github/codeql-action from 4.32.4 to 4.35.1 (dependabot\[bot]) [#62547](https://github.com/nodejs/node/pull/62547)
* \[[`6cea66614b`](https://github.com/nodejs/node/commit/6cea66614b)] - **meta**: bump codecov/codecov-action from 5.5.2 to 6.0.0 (dependabot\[bot]) [#62545](https://github.com/nodejs/node/pull/62545)
* \[[`a72dd0c7df`](https://github.com/nodejs/node/commit/a72dd0c7df)] - **meta**: bump actions/cache from 5.0.3 to 5.0.4 (dependabot\[bot]) [#62543](https://github.com/nodejs/node/pull/62543)
* \[[`7aae63c239`](https://github.com/nodejs/node/commit/7aae63c239)] - **meta**: require DCO signoff in commit message guidelines (James M Snell) [#62510](https://github.com/nodejs/node/pull/62510)
* \[[`aa4486be61`](https://github.com/nodejs/node/commit/aa4486be61)] - **meta**: expand memory leak DoS criteria to all DoS (Joyee Cheung) [#62505](https://github.com/nodejs/node/pull/62505)
* \[[`ced3493483`](https://github.com/nodejs/node/commit/ced3493483)] - **meta**: bump actions/download-artifact from 7.0.0 to 8.0.0 (dependabot\[bot]) [#62063](https://github.com/nodejs/node/pull/62063)
* \[[`6549786184`](https://github.com/nodejs/node/commit/6549786184)] - **meta**: bump actions/upload-artifact from 6.0.0 to 7.0.0 (dependabot\[bot]) [#62062](https://github.com/nodejs/node/pull/62062)
* \[[`96db002424`](https://github.com/nodejs/node/commit/96db002424)] - **meta**: bump step-security/harden-runner from 2.14.2 to 2.15.0 (dependabot\[bot]) [#62064](https://github.com/nodejs/node/pull/62064)
* \[[`67a008000f`](https://github.com/nodejs/node/commit/67a008000f)] - **meta**: bump github/codeql-action from 4.32.0 to 4.32.4 (dependabot\[bot]) [#61911](https://github.com/nodejs/node/pull/61911)
* \[[`04dc1b9f8f`](https://github.com/nodejs/node/commit/04dc1b9f8f)] - **meta**: bump step-security/harden-runner from 2.14.1 to 2.14.2 (dependabot\[bot]) [#61909](https://github.com/nodejs/node/pull/61909)
* \[[`42a8624166`](https://github.com/nodejs/node/commit/42a8624166)] - **meta**: bump actions/stale from 10.1.1 to 10.2.0 (dependabot\[bot]) [#61908](https://github.com/nodejs/node/pull/61908)
* \[[`83a37adfc9`](https://github.com/nodejs/node/commit/83a37adfc9)] - **meta**: bump github/codeql-action from 4.31.9 to 4.32.0 (dependabot\[bot]) [#61622](https://github.com/nodejs/node/pull/61622)
* \[[`3181ce26cc`](https://github.com/nodejs/node/commit/3181ce26cc)] - **meta**: bump step-security/harden-runner from 2.14.0 to 2.14.1 (dependabot\[bot]) [#61621](https://github.com/nodejs/node/pull/61621)
* \[[`bae080a316`](https://github.com/nodejs/node/commit/bae080a316)] - **meta**: bump actions/setup-python from 6.1.0 to 6.2.0 (dependabot\[bot]) [#61627](https://github.com/nodejs/node/pull/61627)
* \[[`b6b33a3dc7`](https://github.com/nodejs/node/commit/b6b33a3dc7)] - **meta**: bump actions/setup-node from 6.1.0 to 6.2.0 (dependabot\[bot]) [#61625](https://github.com/nodejs/node/pull/61625)
* \[[`dc5dd5837e`](https://github.com/nodejs/node/commit/dc5dd5837e)] - **meta**: bump actions/cache from 5.0.1 to 5.0.3 (dependabot\[bot]) [#61624](https://github.com/nodejs/node/pull/61624)
* \[[`37feb77b85`](https://github.com/nodejs/node/commit/37feb77b85)] - **meta**: bump peter-evans/create-pull-request from 8.0.0 to 8.1.0 (dependabot\[bot]) [#61623](https://github.com/nodejs/node/pull/61623)
* \[[`052992d050`](https://github.com/nodejs/node/commit/052992d050)] - **meta**: bump actions/stale from 10.1.0 to 10.1.1 (dependabot\[bot]) [#61620](https://github.com/nodejs/node/pull/61620)
* \[[`e78e03b490`](https://github.com/nodejs/node/commit/e78e03b490)] - **meta**: bump actions/checkout from 6.0.1 to 6.0.2 (dependabot\[bot]) [#61619](https://github.com/nodejs/node/pull/61619)
* \[[`fc7298d6fc`](https://github.com/nodejs/node/commit/fc7298d6fc)] - **meta**: bump actions/download-artifact from 6.0.0 to 7.0.0 (dependabot\[bot]) [#61242](https://github.com/nodejs/node/pull/61242)
* \[[`b57faeef2d`](https://github.com/nodejs/node/commit/b57faeef2d)] - **meta**: bump actions/checkout from 6.0.0 to 6.0.1 (dependabot\[bot]) [#61239](https://github.com/nodejs/node/pull/61239)
* \[[`58e3c6be2b`](https://github.com/nodejs/node/commit/58e3c6be2b)] - **meta**: bump actions/upload-artifact from 5.0.0 to 6.0.0 (dependabot\[bot]) [#61238](https://github.com/nodejs/node/pull/61238)
* \[[`012cfd0268`](https://github.com/nodejs/node/commit/012cfd0268)] - **meta**: bump actions/checkout from 5.0.1 to 6.0.0 (dependabot\[bot]) [#60925](https://github.com/nodejs/node/pull/60925)
* \[[`9baa5ae954`](https://github.com/nodejs/node/commit/9baa5ae954)] - **meta**: bump actions/checkout from 5.0.0 to 5.0.1 (dependabot\[bot]) [#60767](https://github.com/nodejs/node/pull/60767)
* \[[`2581ca3404`](https://github.com/nodejs/node/commit/2581ca3404)] - **module**: remove duplicated checks from `_resolveFilename` (Antoine du Hamel) [#62729](https://github.com/nodejs/node/pull/62729)
* \[[`f568923233`](https://github.com/nodejs/node/commit/f568923233)] - **module**: fix coverage of mocked CJS modules imported from ESM (Marco) [#62133](https://github.com/nodejs/node/pull/62133)
* \[[`a2639adc75`](https://github.com/nodejs/node/commit/a2639adc75)] - **module,win**: fix long subpath import (Stefan Stojanovic) [#62101](https://github.com/nodejs/node/pull/62101)
* \[[`3017a5402f`](https://github.com/nodejs/node/commit/3017a5402f)] - **(SEMVER-MINOR)** **net**: add `setTOS` and `getTOS` to `Socket` (Amol Yadav) [#61503](https://github.com/nodejs/node/pull/61503)
* \[[`fb89be2a13`](https://github.com/nodejs/node/commit/fb89be2a13)] - **net**: defer synchronous destroy calls in internalConnect (RajeshKumar11) [#61658](https://github.com/nodejs/node/pull/61658)
* \[[`e9b83d8bf5`](https://github.com/nodejs/node/commit/e9b83d8bf5)] - **node-api**: update libuv ABI stability note (Chengzhong Wu) [#62789](https://github.com/nodejs/node/pull/62789)
* \[[`f7a9361dd4`](https://github.com/nodejs/node/commit/f7a9361dd4)] - **node-api**: add napi\_create\_external\_sharedarraybuffer (Ben Noordhuis) [#62623](https://github.com/nodejs/node/pull/62623)
* \[[`09d671aa0e`](https://github.com/nodejs/node/commit/09d671aa0e)] - **node-api**: execute tsfn finalizer after queue drains when aborted (Kevin Eady) [#61956](https://github.com/nodejs/node/pull/61956)
* \[[`e4c00c2b21`](https://github.com/nodejs/node/commit/e4c00c2b21)] - **node-api**: fix data race and use-after-free in napi\_threadsafe\_function (Mika Fischer) [#55877](https://github.com/nodejs/node/pull/55877)
* \[[`700df39d93`](https://github.com/nodejs/node/commit/700df39d93)] - **(SEMVER-MINOR)** **node-api**: support SharedArrayBuffer in napi\_create\_dataview (Kevin Eady) [#60473](https://github.com/nodejs/node/pull/60473)
* \[[`864a2f1d90`](https://github.com/nodejs/node/commit/864a2f1d90)] - **(SEMVER-MINOR)** **node-api**: add napi\_create\_object\_with\_properties (Miguel Marcondes Filho) [#59953](https://github.com/nodejs/node/pull/59953)
* \[[`8b07e57adf`](https://github.com/nodejs/node/commit/8b07e57adf)] - **(SEMVER-MINOR)** **perf\_hooks**: move non-standard performance properties to perf\_hooks (Chengzhong Wu) [#60370](https://github.com/nodejs/node/pull/60370)
* \[[`af00ddc415`](https://github.com/nodejs/node/commit/af00ddc415)] - **perf\_hooks**: fix histogram fast call signatures (Renegade334) [#59600](https://github.com/nodejs/node/pull/59600)
* \[[`e2d5c43ba7`](https://github.com/nodejs/node/commit/e2d5c43ba7)] - **process**: handle rejections only when needed (Gürgün Dayıoğlu) [#62919](https://github.com/nodejs/node/pull/62919)
* \[[`e8a6a3805f`](https://github.com/nodejs/node/commit/e8a6a3805f)] - **process**: optimize asyncHandledRejections by using FixedQueue (Gürgün Dayıoğlu) [#60854](https://github.com/nodejs/node/pull/60854)
* \[[`fbecadb4bd`](https://github.com/nodejs/node/commit/fbecadb4bd)] - **process**: do not truncate long strings in `--print` (Mohamed Akram) [#61497](https://github.com/nodejs/node/pull/61497)
* \[[`5ecef374f7`](https://github.com/nodejs/node/commit/5ecef374f7)] - **repl**: keep reference count for `process.on('newListener')` (Anna Henningsen) [#61895](https://github.com/nodejs/node/pull/61895)
* \[[`758b4d2ffb`](https://github.com/nodejs/node/commit/758b4d2ffb)] - **sqlite**: keep source database alive during backup (Matteo Collina) [#62673](https://github.com/nodejs/node/pull/62673)
* \[[`43791a1279`](https://github.com/nodejs/node/commit/43791a1279)] - **sqlite**: enable Percentile extension (Jurj Andrei George) [#61295](https://github.com/nodejs/node/pull/61295)
* \[[`e264ec1f3c`](https://github.com/nodejs/node/commit/e264ec1f3c)] - **sqlite**: avoid extra copy for large text binds (Ali Hassan) [#61580](https://github.com/nodejs/node/pull/61580)
* \[[`06ce00539b`](https://github.com/nodejs/node/commit/06ce00539b)] - **sqlite**: reserve vectors space (Guilherme Araújo) [#61540](https://github.com/nodejs/node/pull/61540)
* \[[`b68524efec`](https://github.com/nodejs/node/commit/b68524efec)] - **(SEMVER-MINOR)** **sqlite**: add sqlite prepare options args (Guilherme Araújo) [#61311](https://github.com/nodejs/node/pull/61311)
* \[[`a899991ba7`](https://github.com/nodejs/node/commit/a899991ba7)] - **(SEMVER-MINOR)** **sqlite**: create authorization api (Guilherme Araújo) [#59928](https://github.com/nodejs/node/pull/59928)
* \[[`c2b0d04b41`](https://github.com/nodejs/node/commit/c2b0d04b41)] - **src**: improve token return value check (James M Snell) [#63483](https://github.com/nodejs/node/pull/63483)
* \[[`fa7d69f309`](https://github.com/nodejs/node/commit/fa7d69f309)] - **src**: expose `node::RegisterContext` to make a node managed context (Chengzhong Wu) [#62322](https://github.com/nodejs/node/pull/62322)
* \[[`93918083c0`](https://github.com/nodejs/node/commit/93918083c0)] - **src**: fix crash in GetErrorSource() for invalid using syntax (semimikoh) [#62770](https://github.com/nodejs/node/pull/62770)
* \[[`13a285807f`](https://github.com/nodejs/node/commit/13a285807f)] - **src**: simplify `TCPWrap::Connect` signature (Anna Henningsen) [#62929](https://github.com/nodejs/node/pull/62929)
* \[[`11d3bdd546`](https://github.com/nodejs/node/commit/11d3bdd546)] - **src**: use DCHECK in AsyncWrap::MakeCallback instead emiting a warning (Gerhard Stöbich) [#62795](https://github.com/nodejs/node/pull/62795)
* \[[`d548e2def3`](https://github.com/nodejs/node/commit/d548e2def3)] - **src**: fix MaybeStackBuffer char\_traits deprecation warning (om-ghante) [#62507](https://github.com/nodejs/node/pull/62507)
* \[[`6c0583c468`](https://github.com/nodejs/node/commit/6c0583c468)] - **src**: use context-free V8 message column getters (René) [#62778](https://github.com/nodejs/node/pull/62778)
* \[[`ffcb68eeb7`](https://github.com/nodejs/node/commit/ffcb68eeb7)] - **src**: coerce `spawnSync` args to string once (Antoine du Hamel) [#62633](https://github.com/nodejs/node/pull/62633)
* \[[`4c805f0824`](https://github.com/nodejs/node/commit/4c805f0824)] - **src**: convert context\_frame field in AsyncWrap to internal field (Anna Henningsen) [#62103](https://github.com/nodejs/node/pull/62103)
* \[[`336e60cdc8`](https://github.com/nodejs/node/commit/336e60cdc8)] - **src**: make AsyncWrap subclass internal field counts explicit (Anna Henningsen) [#62103](https://github.com/nodejs/node/pull/62103)
* \[[`ab55ae149c`](https://github.com/nodejs/node/commit/ab55ae149c)] - **src**: improve EC JWK import performance (Filip Skokan) [#62396](https://github.com/nodejs/node/pull/62396)
* \[[`9641fa2bdf`](https://github.com/nodejs/node/commit/9641fa2bdf)] - **src**: handle null backing store in ArrayBufferViewContents::Read (Mert Can Altin) [#62343](https://github.com/nodejs/node/pull/62343)
* \[[`29abcd1f5b`](https://github.com/nodejs/node/commit/29abcd1f5b)] - **src**: expose async context frame debugging helper to JS (Anna Henningsen) [#62103](https://github.com/nodejs/node/pull/62103)
* \[[`d99d114106`](https://github.com/nodejs/node/commit/d99d114106)] - **src**: release context frame in AsyncWrap::EmitDestroy (Gerhard Stöbich) [#61995](https://github.com/nodejs/node/pull/61995)
* \[[`4adf0116a7`](https://github.com/nodejs/node/commit/4adf0116a7)] - **src**: use validate\_ascii\_with\_errors instead of validate\_ascii (Сковорода Никита Андреевич) [#61122](https://github.com/nodejs/node/pull/61122)
* \[[`d893a8ded0`](https://github.com/nodejs/node/commit/d893a8ded0)] - **src**: use bool literals in TraceEnvVarOptions (Tobias Nießen) [#61425](https://github.com/nodejs/node/pull/61425)
* \[[`a29247b129`](https://github.com/nodejs/node/commit/a29247b129)] - **src**: release memory for zstd contexts in `Close()` (Anna Henningsen) [#61717](https://github.com/nodejs/node/pull/61717)
* \[[`517da522a8`](https://github.com/nodejs/node/commit/517da522a8)] - **src**: add more checks and clarify docs for external references (Joyee Cheung) [#61719](https://github.com/nodejs/node/pull/61719)
* \[[`50b8968596`](https://github.com/nodejs/node/commit/50b8968596)] - **(CVE-2026-21712)** **src**: handle url crash on different url formats (RafaelGSS) [nodejs-private/node-private#816](https://github.com/nodejs-private/node-private/pull/816)
* \[[`d82d1072cf`](https://github.com/nodejs/node/commit/d82d1072cf)] - **src**: elide heap allocation in structured clone implementation (Anna Henningsen) [#61703](https://github.com/nodejs/node/pull/61703)
* \[[`fd5dcf309d`](https://github.com/nodejs/node/commit/fd5dcf309d)] - **src**: use `Utf8Value` and `TwoByteValue` instead of V8 helpers (Anna Henningsen) [#60244](https://github.com/nodejs/node/pull/60244)
* \[[`71e857ff7f`](https://github.com/nodejs/node/commit/71e857ff7f)] - **(SEMVER-MINOR)** **src,permission**: add --allow-inspector ability (Rafael Gonzaga) [#59711](https://github.com/nodejs/node/pull/59711)
* \[[`c980105ab6`](https://github.com/nodejs/node/commit/c980105ab6)] - **src,sqlite**: only pass `xFilter` when user provided a callback (Antoine du Hamel) [#63516](https://github.com/nodejs/node/pull/63516)
* \[[`79a5ed3a9a`](https://github.com/nodejs/node/commit/79a5ed3a9a)] - **src,sqlite**: remove dead code (Edy Silva) [#63204](https://github.com/nodejs/node/pull/63204)
* \[[`d4fc3f568a`](https://github.com/nodejs/node/commit/d4fc3f568a)] - **stream**: use data listener for compose forwarding (Trivikram Kamat) [#63593](https://github.com/nodejs/node/pull/63593)
* \[[`b06bd877ad`](https://github.com/nodejs/node/commit/b06bd877ad)] - **stream**: remove unnecessary check (Antoine du Hamel) [#63030](https://github.com/nodejs/node/pull/63030)
* \[[`f50b07e9c4`](https://github.com/nodejs/node/commit/f50b07e9c4)] - **stream**: simplify `setPromiseHandled` utility (Antoine du Hamel) [#63032](https://github.com/nodejs/node/pull/63032)
* \[[`0ab4b9b2e0`](https://github.com/nodejs/node/commit/0ab4b9b2e0)] - **stream**: ensuring cross-destruction in \_duplexify to prevent leaks (Daijiro Wachi) [#62824](https://github.com/nodejs/node/pull/62824)
* \[[`0badebd253`](https://github.com/nodejs/node/commit/0badebd253)] - **stream**: fix nested compose error propagation (Matteo Collina) [#62556](https://github.com/nodejs/node/pull/62556)
* \[[`229f363996`](https://github.com/nodejs/node/commit/229f363996)] - **stream**: simplify `createPromiseCallback` (Antoine du Hamel) [#62650](https://github.com/nodejs/node/pull/62650)
* \[[`fbda3b12ce`](https://github.com/nodejs/node/commit/fbda3b12ce)] - **stream**: fix writev unhandled rejection in fromWeb (sangwook) [#62297](https://github.com/nodejs/node/pull/62297)
* \[[`6ad176efba`](https://github.com/nodejs/node/commit/6ad176efba)] - **stream**: refactor duplexify to be less suceptible to prototype pollution (Antoine du Hamel) [#62559](https://github.com/nodejs/node/pull/62559)
* \[[`cb19bf05fc`](https://github.com/nodejs/node/commit/cb19bf05fc)] - **stream**: replace bind with arrow function for onwrite callback (Ali Hassan) [#62087](https://github.com/nodejs/node/pull/62087)
* \[[`dc75c189f8`](https://github.com/nodejs/node/commit/dc75c189f8)] - **stream**: optimize webstreams pipeTo (Mattias Buelens) [#62079](https://github.com/nodejs/node/pull/62079)
* \[[`f3ecb461fa`](https://github.com/nodejs/node/commit/f3ecb461fa)] - **stream**: fix TransformStream race on cancel with pending write (Marco) [#62040](https://github.com/nodejs/node/pull/62040)
* \[[`c12d9f084f`](https://github.com/nodejs/node/commit/c12d9f084f)] - **stream**: fix pipeTo to defer writes per WHATWG spec (Matteo Collina) [#61800](https://github.com/nodejs/node/pull/61800)
* \[[`51ebd31b24`](https://github.com/nodejs/node/commit/51ebd31b24)] - **stream**: add fast paths for webstreams read and pipeTo (Matteo Collina) [#61807](https://github.com/nodejs/node/pull/61807)
* \[[`d71a464807`](https://github.com/nodejs/node/commit/d71a464807)] - **(SEMVER-MINOR)** **stream**: add bytes() method to stream/consumers (wantaek) [#60426](https://github.com/nodejs/node/pull/60426)
* \[[`097a23f79b`](https://github.com/nodejs/node/commit/097a23f79b)] - **(SEMVER-MINOR)** **stream**: do not pass `readable.compose()` output via `Readable.from()` (René) [#60907](https://github.com/nodejs/node/pull/60907)
* \[[`845f5ab5ec`](https://github.com/nodejs/node/commit/845f5ab5ec)] - **test**: shorten path in net pipe connect errors (Matteo Collina) [#63405](https://github.com/nodejs/node/pull/63405)
* \[[`127a4ee919`](https://github.com/nodejs/node/commit/127a4ee919)] - **test**: update test426-fixtures to 9b9e225b5a63139e9a95cdd1bf874a8f0b9d131 (Node.js GitHub Bot) [#63373](https://github.com/nodejs/node/pull/63373)
* \[[`9ff43d753f`](https://github.com/nodejs/node/commit/9ff43d753f)] - **test**: deflake async-hooks statwatcher test (Trivikram Kamat) [#63396](https://github.com/nodejs/node/pull/63396)
* \[[`1495072317`](https://github.com/nodejs/node/commit/1495072317)] - **test**: wait for ok before initial break after restart (Yuya Inoue) [#62807](https://github.com/nodejs/node/pull/62807)
* \[[`34855a4bb8`](https://github.com/nodejs/node/commit/34855a4bb8)] - **test**: disable Maglev in near-heap-limit worker test (Trivikram Kamat) [#63398](https://github.com/nodejs/node/pull/63398)
* \[[`97e1e2dedd`](https://github.com/nodejs/node/commit/97e1e2dedd)] - **test**: relax test-memory-usage arrayBuffers check (inoway46) [#63244](https://github.com/nodejs/node/pull/63244)
* \[[`841a27f75e`](https://github.com/nodejs/node/commit/841a27f75e)] - **test**: reduce flakiness of `different-registry-per-thread` (Antoine du Hamel) [#63244](https://github.com/nodejs/node/pull/63244)
* \[[`70895bd8b6`](https://github.com/nodejs/node/commit/70895bd8b6)] - **test**: fix flaky test-watch-mode-inspect timeout (Matteo Collina) [#63361](https://github.com/nodejs/node/pull/63361)
* \[[`6e4f446a95`](https://github.com/nodejs/node/commit/6e4f446a95)] - **test**: avoid flaky restart sync in debugger exceptions test (Yuya Inoue) [#62055](https://github.com/nodejs/node/pull/62055)
* \[[`15c4125bb6`](https://github.com/nodejs/node/commit/15c4125bb6)] - **test**: avoid initial-break wait in restart-message (inoway46) [#62060](https://github.com/nodejs/node/pull/62060)
* \[[`8d112be333`](https://github.com/nodejs/node/commit/8d112be333)] - **test**: export isRiscv64 from common module (Jamie Magee) [#62609](https://github.com/nodejs/node/pull/62609)
* \[[`f149860bac`](https://github.com/nodejs/node/commit/f149860bac)] - **test**: normalize known inspector crash as completion (Joyee Cheung) [#62851](https://github.com/nodejs/node/pull/62851)
* \[[`ed3229d731`](https://github.com/nodejs/node/commit/ed3229d731)] - **test**: mark test-snapshot-reproducible flaky (Filip Skokan) [#62808](https://github.com/nodejs/node/pull/62808)
* \[[`5f2303ba51`](https://github.com/nodejs/node/commit/5f2303ba51)] - **test**: check contextify contextual store behavior in strict mode (René) [#62571](https://github.com/nodejs/node/pull/62571)
* \[[`bd1808f741`](https://github.com/nodejs/node/commit/bd1808f741)] - **test**: ensure WPT report is in out/wpt (Filip Skokan) [#62637](https://github.com/nodejs/node/pull/62637)
* \[[`810d0961bf`](https://github.com/nodejs/node/commit/810d0961bf)] - **test**: improve WPT runner summary (Filip Skokan) [#62636](https://github.com/nodejs/node/pull/62636)
* \[[`79574d4229`](https://github.com/nodejs/node/commit/79574d4229)] - **test**: capture negative utimes mtime at call time (Yuya Inoue) [#62490](https://github.com/nodejs/node/pull/62490)
* \[[`da56aa52ac`](https://github.com/nodejs/node/commit/da56aa52ac)] - **test**: allow skipping individual WPT subtests (Filip Skokan) [#62517](https://github.com/nodejs/node/pull/62517)
* \[[`798ac9131d`](https://github.com/nodejs/node/commit/798ac9131d)] - **test**: use on-disk fixture for test-npm-install (Joyee Cheung) [#62584](https://github.com/nodejs/node/pull/62584)
* \[[`a9ffd1eb0d`](https://github.com/nodejs/node/commit/a9ffd1eb0d)] - **test**: fix test-buffer-zero-fill-cli to be effective (Сковорода Никита Андреевич) [#60623](https://github.com/nodejs/node/pull/60623)
* \[[`c3804757be`](https://github.com/nodejs/node/commit/c3804757be)] - **test**: wait for reattach before initial break on restart (Yuya Inoue) [#62471](https://github.com/nodejs/node/pull/62471)
* \[[`8d55023bbe`](https://github.com/nodejs/node/commit/8d55023bbe)] - **test**: disable flaky WPT Blob test on AIX (James M Snell) [#62470](https://github.com/nodejs/node/pull/62470)
* \[[`e756fb7d7b`](https://github.com/nodejs/node/commit/e756fb7d7b)] - **test**: avoid flaky run wait in debugger restart test (Yuya Inoue) [#62112](https://github.com/nodejs/node/pull/62112)
* \[[`071b92f1c8`](https://github.com/nodejs/node/commit/071b92f1c8)] - **test**: improve WPT report runner (Filip Skokan) [#62107](https://github.com/nodejs/node/pull/62107)
* \[[`88dffb2028`](https://github.com/nodejs/node/commit/88dffb2028)] - **test**: fix skipping behavior for `test-runner-run-files-undefined` (Antoine du Hamel) [#62026](https://github.com/nodejs/node/pull/62026)
* \[[`ff239169fd`](https://github.com/nodejs/node/commit/ff239169fd)] - **test**: remove unnecessary `process.exit` calls from test files (Antoine du Hamel) [#62020](https://github.com/nodejs/node/pull/62020)
* \[[`b61411212b`](https://github.com/nodejs/node/commit/b61411212b)] - **test**: avoid flaky debugger restart waits (Yuya Inoue) [#61773](https://github.com/nodejs/node/pull/61773)
* \[[`6caf426836`](https://github.com/nodejs/node/commit/6caf426836)] - **test**: check stability block position in API markdown (René) [#58590](https://github.com/nodejs/node/pull/58590)
* \[[`6e8c130387`](https://github.com/nodejs/node/commit/6e8c130387)] - **test**: update FileAPI tests from WPT (Ms2ger) [#61750](https://github.com/nodejs/node/pull/61750)
* \[[`2d4aef22fb`](https://github.com/nodejs/node/commit/2d4aef22fb)] - **test**: print stack immediately avoiding GC interleaving (Chengzhong Wu) [#61699](https://github.com/nodejs/node/pull/61699)
* \[[`762106bde1`](https://github.com/nodejs/node/commit/762106bde1)] - **test**: remove duplicate wpt tests (Filip Skokan) [#61617](https://github.com/nodejs/node/pull/61617)
* \[[`99cdcc3ca1`](https://github.com/nodejs/node/commit/99cdcc3ca1)] - **test**: ensure assertions are reachable in `test/internet` (Antoine du Hamel) [#60513](https://github.com/nodejs/node/pull/60513)
* \[[`bea1cbcbf4`](https://github.com/nodejs/node/commit/bea1cbcbf4)] - **test**: deflake test-perf-hooks-timerify-histogram-sync (Joyee Cheung) [#60639](https://github.com/nodejs/node/pull/60639)
* \[[`0a1a3367d3`](https://github.com/nodejs/node/commit/0a1a3367d3)] - **test**: ensure assertions are reached on more tests (Antoine du Hamel) [#60500](https://github.com/nodejs/node/pull/60500)
* \[[`c62e1ef4e2`](https://github.com/nodejs/node/commit/c62e1ef4e2)] - **test**: split test-perf-hooks-timerify (Joyee Cheung) [#60568](https://github.com/nodejs/node/pull/60568)
* \[[`42e1c80470`](https://github.com/nodejs/node/commit/42e1c80470)] - **test**: ensure assertions are reachable in more folders (Antoine du Hamel) [#60411](https://github.com/nodejs/node/pull/60411)
* \[[`f05e1fd38f`](https://github.com/nodejs/node/commit/f05e1fd38f)] - **test**: ensure assertions are reachable in `test/addons` (Antoine du Hamel) [#60142](https://github.com/nodejs/node/pull/60142)
* \[[`c6ef7af9a2`](https://github.com/nodejs/node/commit/c6ef7af9a2)] - **test**: ensure assertions are reachable in `test/client-proxy` (Antoine du Hamel) [#60175](https://github.com/nodejs/node/pull/60175)
* \[[`faf2140cec`](https://github.com/nodejs/node/commit/faf2140cec)] - **test**: mark `test-runner-run-watch` flaky on macOS (Richard Lau) [#60115](https://github.com/nodejs/node/pull/60115)
* \[[`b9b58487ae`](https://github.com/nodejs/node/commit/b9b58487ae)] - **test\_runner**: dont buffer unordered events in process isolation mode (Moshe Atlow) [#63432](https://github.com/nodejs/node/pull/63432)
* \[[`0142183b6b`](https://github.com/nodejs/node/commit/0142183b6b)] - **(SEMVER-MINOR)** **test\_runner**: align mock timeout api (sangwook) [#62820](https://github.com/nodejs/node/pull/62820)
* \[[`e91c3335e4`](https://github.com/nodejs/node/commit/e91c3335e4)] - **test\_runner**: make it compatible with fake timers (Matteo Collina) [#59272](https://github.com/nodejs/node/pull/59272)
* \[[`086328fb6f`](https://github.com/nodejs/node/commit/086328fb6f)] - **test\_runner**: run afterEach on runtime skip (Igor Shevelenkov) [#61525](https://github.com/nodejs/node/pull/61525)
* \[[`6011e248c8`](https://github.com/nodejs/node/commit/6011e248c8)] - **test\_runner**: replace native methods with primordials (Ayoub Mabrouk) [#61219](https://github.com/nodejs/node/pull/61219)
* \[[`d2056414fd`](https://github.com/nodejs/node/commit/d2056414fd)] - **test\_runner**: fix test enqueue when test file has syntax error (Edy Silva) [#61573](https://github.com/nodejs/node/pull/61573)
* \[[`e44ab50af5`](https://github.com/nodejs/node/commit/e44ab50af5)] - **test\_runner**: fix memory leaks in runner (Abhishek Kv. Savani) [#60860](https://github.com/nodejs/node/pull/60860)
* \[[`84dfdc9e3e`](https://github.com/nodejs/node/commit/84dfdc9e3e)] - **test\_runner**: fix coverage report when a directory is named file (Heath Dutton🕴️) [#61169](https://github.com/nodejs/node/pull/61169)
* \[[`8dd5dce097`](https://github.com/nodejs/node/commit/8dd5dce097)] - **test\_runner**: print info when test restarts (Xavier Stouder) [#61160](https://github.com/nodejs/node/pull/61160)
* \[[`73d0351efd`](https://github.com/nodejs/node/commit/73d0351efd)] - **test\_runner**: nix dead reporter code (Vas Sudanagunta) [#59700](https://github.com/nodejs/node/pull/59700)
* \[[`1d9aae7930`](https://github.com/nodejs/node/commit/1d9aae7930)] - **test\_runner**: fix lazy `test.assert` accessor (René) [#61097](https://github.com/nodejs/node/pull/61097)
* \[[`1150e5d371`](https://github.com/nodejs/node/commit/1150e5d371)] - **test\_runner**: use module.registerHooks in module mocks (Joyee Cheung) [#60326](https://github.com/nodejs/node/pull/60326)
* \[[`96ed4d3ae3`](https://github.com/nodejs/node/commit/96ed4d3ae3)] - **tools**: skip commit-lint on backport pull requests (Marco) [#63378](https://github.com/nodejs/node/pull/63378)
* \[[`b520e4f15f`](https://github.com/nodejs/node/commit/b520e4f15f)] - **tools**: fix skip of `test-internet` on forks (Antoine du Hamel) [#63492](https://github.com/nodejs/node/pull/63492)
* \[[`90b34fce6f`](https://github.com/nodejs/node/commit/90b34fce6f)] - **tools**: update gyp-next to 0.22.2 (Node.js GitHub Bot) [#63374](https://github.com/nodejs/node/pull/63374)
* \[[`6736038813`](https://github.com/nodejs/node/commit/6736038813)] - **tools**: fix test426 updater (Antoine du Hamel) [#63271](https://github.com/nodejs/node/pull/63271)
* \[[`92d842bf09`](https://github.com/nodejs/node/commit/92d842bf09)] - **tools**: use different branch for tool updates on staging branches (Antoine du Hamel) [#63110](https://github.com/nodejs/node/pull/63110)
* \[[`7b2cc33c23`](https://github.com/nodejs/node/commit/7b2cc33c23)] - **tools**: add a check for clean git tree after tests (Antoine du Hamel) [#62661](https://github.com/nodejs/node/pull/62661)
* \[[`9546ec9044`](https://github.com/nodejs/node/commit/9546ec9044)] - **tools**: use LTS Node.js in notify-on-push workflow (Nenad Spasenic) [#63084](https://github.com/nodejs/node/pull/63084)
* \[[`baf980b431`](https://github.com/nodejs/node/commit/baf980b431)] - **tools**: update gr2m/create-or-update-pull-request-action to v1.10.1 (Mike McCready) [#63065](https://github.com/nodejs/node/pull/63065)
* \[[`bdc1d30265`](https://github.com/nodejs/node/commit/bdc1d30265)] - **tools**: simplify `update-undici.sh` (Antoine du Hamel) [#63044](https://github.com/nodejs/node/pull/63044)
* \[[`bbb61572c5`](https://github.com/nodejs/node/commit/bbb61572c5)] - **tools**: do not run `test-linux` on unrelated tools changes (Antoine du Hamel) [#63037](https://github.com/nodejs/node/pull/63037)
* \[[`e7f9d6e617`](https://github.com/nodejs/node/commit/e7f9d6e617)] - **tools**: update gyp-next to 0.22.1 (Node.js GitHub Bot) [#62961](https://github.com/nodejs/node/pull/62961)
* \[[`2aba346869`](https://github.com/nodejs/node/commit/2aba346869)] - **tools**: fix commit linter for semver-major release proposals (Antoine du Hamel) [#62993](https://github.com/nodejs/node/pull/62993)
* \[[`1114fb50db`](https://github.com/nodejs/node/commit/1114fb50db)] - **tools**: consolidate and simplify .editorconfig deps section (Daijiro Wachi) [#62887](https://github.com/nodejs/node/pull/62887)
* \[[`41f619e973`](https://github.com/nodejs/node/commit/41f619e973)] - **tools**: set bot as author of tools-deps-update PRs (Antoine du Hamel) [#62856](https://github.com/nodejs/node/pull/62856)
* \[[`bdbec2121d`](https://github.com/nodejs/node/commit/bdbec2121d)] - **tools**: bump brace-expansion in /tools/clang-format (dependabot\[bot]) [#62467](https://github.com/nodejs/node/pull/62467)
* \[[`f9e4e80f7e`](https://github.com/nodejs/node/commit/f9e4e80f7e)] - **tools**: exclude @node-core/doc-kit from dependabot cooldown (Levi Zim) [#62775](https://github.com/nodejs/node/pull/62775)
* \[[`29c148e195`](https://github.com/nodejs/node/commit/29c148e195)] - **tools**: re-enable undici WPTs in daily wpt.fyi job (Filip Skokan) [#62677](https://github.com/nodejs/node/pull/62677)
* \[[`5766f30669`](https://github.com/nodejs/node/commit/5766f30669)] - **tools**: update gyp-next to 0.22.0 (Node.js GitHub Bot) [#62697](https://github.com/nodejs/node/pull/62697)
* \[[`67bc93fdf5`](https://github.com/nodejs/node/commit/67bc93fdf5)] - **tools**: improve backport review script (Antoine du Hamel) [#62573](https://github.com/nodejs/node/pull/62573)
* \[[`0dbb6d9bdc`](https://github.com/nodejs/node/commit/0dbb6d9bdc)] - **tools**: improve output for unexpected passes in WTP tests (Antoine du Hamel) [#62587](https://github.com/nodejs/node/pull/62587)
* \[[`56f759f9b6`](https://github.com/nodejs/node/commit/56f759f9b6)] - **tools**: revert OpenSSL update workflow to ubuntu-latest (Richard Lau) [#62627](https://github.com/nodejs/node/pull/62627)
* \[[`4f862b69ea`](https://github.com/nodejs/node/commit/4f862b69ea)] - **tools**: allow triagers to queue a PR for CI until it's reviewed (Antoine du Hamel) [#62524](https://github.com/nodejs/node/pull/62524)
* \[[`2a2bc4b9fb`](https://github.com/nodejs/node/commit/2a2bc4b9fb)] - **tools**: do not run `commit-lint` on release proposals (Antoine du Hamel) [#62523](https://github.com/nodejs/node/pull/62523)
* \[[`1fae81adea`](https://github.com/nodejs/node/commit/1fae81adea)] - **tools**: adopt the `--check-for-duplicates` NCU flag (Antoine du Hamel) [#62478](https://github.com/nodejs/node/pull/62478)
* \[[`a61ef4503d`](https://github.com/nodejs/node/commit/a61ef4503d)] - **tools**: bump flatted from 3.3.3 to 3.4.1 in /tools/eslint (dependabot\[bot]) [#62255](https://github.com/nodejs/node/pull/62255)
* \[[`eb776a3104`](https://github.com/nodejs/node/commit/eb776a3104)] - **tools**: validate all commits that are pushed to `main` (Antoine du Hamel) [#62246](https://github.com/nodejs/node/pull/62246)
* \[[`97af27f44c`](https://github.com/nodejs/node/commit/97af27f44c)] - **tools**: revert timezone update GHA workflow to ubuntu-latest (Richard Lau) [#62140](https://github.com/nodejs/node/pull/62140)
* \[[`186cab005a`](https://github.com/nodejs/node/commit/186cab005a)] - **tools**: improve error handling in test426 update script (Rich Trott) [#62121](https://github.com/nodejs/node/pull/62121)
* \[[`c0c7e9411f`](https://github.com/nodejs/node/commit/c0c7e9411f)] - **tools**: fix daily wpt workflow nighly release version lookup (Filip Skokan) [#62076](https://github.com/nodejs/node/pull/62076)
* \[[`d050e80458`](https://github.com/nodejs/node/commit/d050e80458)] - **tools**: fix example in release proposal linter (Richard Lau) [#62074](https://github.com/nodejs/node/pull/62074)
* \[[`d3c2e59872`](https://github.com/nodejs/node/commit/d3c2e59872)] - **tools**: bump minimatch from 3.1.3 to 3.1.5 in /tools/clang-format (dependabot\[bot]) [#62013](https://github.com/nodejs/node/pull/62013)
* \[[`70ecf77ca7`](https://github.com/nodejs/node/commit/70ecf77ca7)] - **tools**: bump minimatch from 3.1.2 to 3.1.3 in `/tools/clang-format` (dependabot\[bot]) [#61977](https://github.com/nodejs/node/pull/61977)
* \[[`b7946ce042`](https://github.com/nodejs/node/commit/b7946ce042)] - **tools**: bump minimatch from 3.1.2 to 3.1.3 in /tools/eslint (dependabot\[bot]) [#61976](https://github.com/nodejs/node/pull/61976)
* \[[`82467b9a2e`](https://github.com/nodejs/node/commit/82467b9a2e)] - **tools**: roll back to x86 runner on `scorecard.yml` (Antoine du Hamel) [#61944](https://github.com/nodejs/node/pull/61944)
* \[[`f13705856b`](https://github.com/nodejs/node/commit/f13705856b)] - **tools**: do not checkout repo in `auto-start-ci.yml` (Antoine du Hamel) [#61874](https://github.com/nodejs/node/pull/61874)
* \[[`1965fe9544`](https://github.com/nodejs/node/commit/1965fe9544)] - **tools**: automate updates for test/fixtures/test426 (Rich Trott) [#60978](https://github.com/nodejs/node/pull/60978)
* \[[`2168c92b7e`](https://github.com/nodejs/node/commit/2168c92b7e)] - **tools**: bump unist-util-visit in /tools/doc in the doc group (dependabot\[bot]) [#61646](https://github.com/nodejs/node/pull/61646)
* \[[`3daf22ecf4`](https://github.com/nodejs/node/commit/3daf22ecf4)] - **tools**: fix small inconsistencies in JSON doc output (Antoine du Hamel) [#61757](https://github.com/nodejs/node/pull/61757)
* \[[`abd31da2c1`](https://github.com/nodejs/node/commit/abd31da2c1)] - **tools**: add LIEF to license builder (Chengzhong Wu) [#61523](https://github.com/nodejs/node/pull/61523)
* \[[`bd3dd6f455`](https://github.com/nodejs/node/commit/bd3dd6f455)] - **tools**: limit inspector protocol PR title length (Chengzhong Wu) [#60324](https://github.com/nodejs/node/pull/60324)
* \[[`95650707e0`](https://github.com/nodejs/node/commit/95650707e0)] - **tools**: fix inspector\_protocol updater (Chengzhong Wu) [#60277](https://github.com/nodejs/node/pull/60277)
* \[[`5029486dd2`](https://github.com/nodejs/node/commit/5029486dd2)] - **tools**: add inspector\_protocol updater (Chengzhong Wu) [#60245](https://github.com/nodejs/node/pull/60245)
* \[[`a37a7402f7`](https://github.com/nodejs/node/commit/a37a7402f7)] - **typings**: rationalise TypedArray types (René) [#62174](https://github.com/nodejs/node/pull/62174)
* \[[`382f539dc8`](https://github.com/nodejs/node/commit/382f539dc8)] - **url**: optimize URLSearchParams set/delete duplicate handling (Gürgün Dayıoğlu) [#62266](https://github.com/nodejs/node/pull/62266)
* \[[`e55331b510`](https://github.com/nodejs/node/commit/e55331b510)] - **util**: add fast path to stripVTControlCharacters (Hiroki Osame) [#61833](https://github.com/nodejs/node/pull/61833)
* \[[`5c98b1670a`](https://github.com/nodejs/node/commit/5c98b1670a)] - **worker**: eliminate race condition in process.cwd() (giulioAZ) [#61664](https://github.com/nodejs/node/pull/61664)
...
* \[[`6d6742e7db`](https://github.com/nodejs/node/commit/6d6742e7db)] - **child\_process**: treat ipc length header as unsigned uint32 (Ryuhei Shima) [#61344](https://github.com/nodejs/node/pull/61344)
* \[[`6063d888fe`](https://github.com/nodejs/node/commit/6063d888fe)] - **cli**: mark --heapsnapshot-near-heap-limit as stable (Joyee Cheung) [#60956](https://github.com/nodejs/node/pull/60956)
...
* \[[`31760b1beb`](https://github.com/nodejs/node/commit/31760b1beb)] - **typings**: add typing for string\_decoder (Taejin Kim) [#61368](https://github.com/nodejs/node/pull/61368)
...
* \[[`df4cc62954`](https://github.com/nodejs/node/commit/df4cc62954)] - **zlib**: validate write\_result array length (Ryuhei Shima) [#61342](https://github.com/nodejs/node/pull/61342)
