...
## 2024-10-11, Version 22.10.0 (Current), @aduh95

### Notable Changes

#### New `"module-sync"` exports condition

This release introduces a `"module-sync"` exports condition for packages to supply
a synchronous ES module to the Node.js module loader, no matter if it's being
required or imported. This is similar to the `"module"` condition that bundlers
have been using to support `require(esm)` in Node.js, and allows dual-package
authors to opt into ESM-first only on newer versions of Node.js that supports
`require(esm)` to avoid the dual-package hazard.
...
* \[[`568969dff1`](https://github.com/nodejs/node/commit/568969dff1)] - **benchmark**: rewrite detect-esm-syntax benchmark (Joyee Cheung) [#55238](https://github.com/nodejs/node/pull/55238)
...
* \[[`06d0de782d`](https://github.com/nodejs/node/commit/06d0de782d)] - **doc**: add pmarchini to collaborators (Pietro Marchini) [#55331](https://github.com/nodejs/node/pull/55331)
* \[[`8a44dda6fd`](https://github.com/nodejs/node/commit/8a44dda6fd)] - **doc**: fix `events.once()` example using `AbortSignal` (Ivo Janssen) [#55144](https://github.com/nodejs/node/pull/55144)
...
* \[[`f6bfceceef`](https://github.com/nodejs/node/commit/f6bfceceef)] - **meta**: move one or more collaborators to emeritus (Node.js GitHub Bot) [#55300](https://github.com/nodejs/node/pull/55300)
...
* \[[`1394fb16ac`](https://github.com/nodejs/node/commit/1394fb16ac)] - **sqlite**: disable DQS misfeature by default (Tobias Nießen) [#55297](https://github.com/nodejs/node/pull/55297)
...
* \[[`3503658b1e`](https://github.com/nodejs/node/commit/3503658b1e)] - **test\_runner**: ignore unmapped lines for coverage (Edigleysson Silva (Edy)) [#55228](https://github.com/nodejs/node/pull/55228)
