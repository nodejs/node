...
* \[[`f0a40d436d`](https://github.com/nodejs/node/commit/f0a40d436d)] - **crypto**: update root certificates to NSS 3.123.1 (Node.js GitHub Bot) [#63527](https://github.com/nodejs/node/pull/63527)

### Commits

* \[[`90f90ae20e`](https://github.com/nodejs/node/commit/90f90ae20e)] - **assert,util**: fix stale nested cycle memo entries (Ruben Bridgewater) [#62509](https://github.com/nodejs/node/pull/62509)
* \[[`38984dfc94`](https://github.com/nodejs/node/commit/38984dfc94)] - **benchmark**: fix destructuring in dgram/single-buffer (Ali Hassan) [#62084](https://github.com/nodejs/node/pull/62084)
* \[[`c19212397c`](https://github.com/nodejs/node/commit/c19212397c)] - **benchmark**: add startup benchmark for ESM entrypoint (Joyee Cheung) [#61769](https://github.com/nodejs/node/pull/61769)
* \[[`9310acbaa6`](https://github.com/nodejs/node/commit/9310acbaa6)] - **benchmark**: add streaming TextDecoder benchmark (Сковорода Никита Андреевич) [#61549](https://github.com/nodejs/node/pull/61549)
* \[[`8ec00f4711`](https://github.com/nodejs/node/commit/8ec00f4711)] - **buffer**: optimize buffer.concat performance (Mert Can Altin) [#61721](https://github.com/nodejs/node/pull/61721)
* \[[`f957397cd2`](https://github.com/nodejs/node/commit/f957397cd2)] - **build**: def `NODE_USE_NODE_CODE_CACHE` only used in node\_mksnapshot (Chengzhong Wu) [#63588](https://github.com/nodejs/node/pull/63588)
* \[[`830dd0d6ff`](https://github.com/nodejs/node/commit/830dd0d6ff)] - **build**: track PDL files as inputs in inspector GN build (Robo) [#62888](https://github.com/nodejs/node/pull/62888)
* \[[`3bc2bac693`](https://github.com/nodejs/node/commit/3bc2bac693)] - **build**: remove redundant -fuse-linker-plugin from GCC LTO flags (Daniel Lando) [#62667](https://github.com/nodejs/node/pull/62667)
* \[[`3e8ad4c05f`](https://github.com/nodejs/node/commit/3e8ad4c05f)] - **build**: support empty libname flags in `configure.py` (Antoine du Hamel) [#62477](https://github.com/nodejs/node/pull/62477)
* \[[`d27545601d`](https://github.com/nodejs/node/commit/d27545601d)] - **build**: fix timezone-update path references (Chengzhong Wu) [#62280](https://github.com/nodejs/node/pull/62280)
* \[[`aa9c749048`](https://github.com/nodejs/node/commit/aa9c749048)] - **build**: use path-ignore in GHA coverage-windows.yml (Chengzhong Wu) [#61811](https://github.com/nodejs/node/pull/61811)
* \[[`bf1769ea0c`](https://github.com/nodejs/node/commit/bf1769ea0c)] - **build**: generate\_config\_gypi.py generates valid JSON (Shelley Vohr) [#61791](https://github.com/nodejs/node/pull/61791)
* \[[`3df472c6db`](https://github.com/nodejs/node/commit/3df472c6db)] - **build**: build with v8 gdbjit support on supported platform (Joyee Cheung) [#61010](https://github.com/nodejs/node/pull/61010)
* \[[`4fe705f33b`](https://github.com/nodejs/node/commit/4fe705f33b)] - **build**: add --debug-symbols to build with -g without enabling DCHECKs (Joyee Cheung) [#61100](https://github.com/nodejs/node/pull/61100)
* \[[`6923e097f6`](https://github.com/nodejs/node/commit/6923e097f6)] - **build**: aix: deoptimize implementation-visitor.cc with --shared (Stewart X Addison) [#61550](https://github.com/nodejs/node/pull/61550)
* \[[`56b1198459`](https://github.com/nodejs/node/commit/56b1198459)] - **build**: expose libplatform symbols in shared libnode (Joyee Cheung) [#61144](https://github.com/nodejs/node/pull/61144)
* \[[`16535de5a7`](https://github.com/nodejs/node/commit/16535de5a7)] - **build**: ibmi follow aix visibility (SRAVANI GUNDEPALLI) [#60360](https://github.com/nodejs/node/pull/60360)
* \[[`86c44d5109`](https://github.com/nodejs/node/commit/86c44d5109)] - **build**: build v8 with -fvisibility=hidden -fvisibility-inlines-hidden (Joyee Cheung) [#56290](https://github.com/nodejs/node/pull/56290)
* \[[`afb7270785`](https://github.com/nodejs/node/commit/afb7270785)] - **child\_process**: add tracing channel for spawn (Marco) [#61836](https://github.com/nodejs/node/pull/61836)
* \[[`f0a40d436d`](https://github.com/nodejs/node/commit/f0a40d436d)] - **crypto**: update root certificates to NSS 3.123.1 (Node.js GitHub Bot) [#63527](https://github.com/nodejs/node/pull/63527)
* \[[`0249248863`](https://github.com/nodejs/node/commit/0249248863)] - **crypto**: coerce -0 keylen to +0 in pbkdf2 and scrypt (Jordan Harband) [#63531](https://github.com/nodejs/node/pull/63531)
* \[[`ac2f8f340c`](https://github.com/nodejs/node/commit/ac2f8f340c)] - **crypto**: improve system certificate enumeration logic on macOS (Robo) [#62576](https://github.com/nodejs/node/pull/62576)
* \[[`7ea06c192b`](https://github.com/nodejs/node/commit/7ea06c192b)] - **crypto**: fix unsigned conversion of 4-byte RSA publicExponent (DeepView Autofix) [#62839](https://github.com/nodejs/node/pull/62839)
* \[[`f417abd4e4`](https://github.com/nodejs/node/commit/f417abd4e4)] - **crypto**: add crypto::GetSSLCtx API for addon access to OpenSSL contexts (Tim Perry) [#62254](https://github.com/nodejs/node/pull/62254)
* \[[`cd6941d391`](https://github.com/nodejs/node/commit/cd6941d391)] - **crypto**: read algorithm name property only once in normalizeAlgorithm (Filip Skokan) [#62170](https://github.com/nodejs/node/pull/62170)
* \[[`266073a836`](https://github.com/nodejs/node/commit/266073a836)] - **deps**: update c-ares to 1.34.8 (Node.js GitHub Bot) [#64330](https://github.com/nodejs/node/pull/64330)
* \[[`0b80ea3246`](https://github.com/nodejs/node/commit/0b80ea3246)] - **deps**: c-ares: cherry-pick 8ba37af8e3fb (René) [#64110](https://github.com/nodejs/node/pull/64110)
* \[[`5c5dac73d6`](https://github.com/nodejs/node/commit/5c5dac73d6)] - **deps**: update timezone to 2026b (Node.js GitHub Bot) [#62962](https://github.com/nodejs/node/pull/62962)
* \[[`693c40c836`](https://github.com/nodejs/node/commit/693c40c836)] - **deps**: SQLite: cherry-pick b869ed6b067d623cb1383549f2a18aa35508385d (Junsu Han) [#63525](https://github.com/nodejs/node/pull/63525)
* \[[`980577df6d`](https://github.com/nodejs/node/commit/980577df6d)] - **deps**: update sqlite to 3.53.1 (Node.js GitHub Bot) [#63217](https://github.com/nodejs/node/pull/63217)
* \[[`c12b30e2fe`](https://github.com/nodejs/node/commit/c12b30e2fe)] - **deps**: update simdjson to 4.6.4 (Node.js GitHub Bot) [#62811](https://github.com/nodejs/node/pull/62811)
* \[[`896508ee15`](https://github.com/nodejs/node/commit/896508ee15)] - **deps**: cherry-pick libuv/libuv\@a43e543 (Ali Hassan) [#63222](https://github.com/nodejs/node/pull/63222)
* \[[`f056935b47`](https://github.com/nodejs/node/commit/f056935b47)] - **deps**: update corepack to 0.35.0 (Node.js GitHub Bot) [#63375](https://github.com/nodejs/node/pull/63375)
* \[[`0bc4e8e420`](https://github.com/nodejs/node/commit/0bc4e8e420)] - **deps**: update amaro to 1.1.9 (Node.js GitHub Bot) [#63090](https://github.com/nodejs/node/pull/63090)
* \[[`a1495a9d2f`](https://github.com/nodejs/node/commit/a1495a9d2f)] - **deps**: update corepack to 0.34.7 (Node.js GitHub Bot) [#62810](https://github.com/nodejs/node/pull/62810)
* \[[`5a9b8b3d2a`](https://github.com/nodejs/node/commit/5a9b8b3d2a)] - **deps**: cherry-pick libuv/libuv\@439a54b (skooch) [#62881](https://github.com/nodejs/node/pull/62881)
* \[[`c4c94f0d4b`](https://github.com/nodejs/node/commit/c4c94f0d4b)] - **deps**: update sqlite to 3.53.0 (Node.js GitHub Bot) [#62699](https://github.com/nodejs/node/pull/62699)
* \[[`a77a37a352`](https://github.com/nodejs/node/commit/a77a37a352)] - **deps**: update nbytes to 0.1.4 (Node.js GitHub Bot) [#62698](https://github.com/nodejs/node/pull/62698)
* \[[`5e40c7d24b`](https://github.com/nodejs/node/commit/5e40c7d24b)] - **deps**: update minimatch to 10.2.5 (Node.js GitHub Bot) [#62594](https://github.com/nodejs/node/pull/62594)
* \[[`94e87e658d`](https://github.com/nodejs/node/commit/94e87e658d)] - **deps**: update googletest to d72f9c8aea6817cdf1ca0ac10887f328de7f3da2 (Node.js GitHub Bot) [#62593](https://github.com/nodejs/node/pull/62593)
* \[[`b9945f6e7e`](https://github.com/nodejs/node/commit/b9945f6e7e)] - **deps**: update simdjson to 4.6.1 (Node.js GitHub Bot) [#62592](https://github.com/nodejs/node/pull/62592)
* \[[`fb0e8e5c5d`](https://github.com/nodejs/node/commit/fb0e8e5c5d)] - **deps**: libuv: cherry-pick aabb7651de (Santiago Gimeno) [#62561](https://github.com/nodejs/node/pull/62561)
* \[[`f0982fccd5`](https://github.com/nodejs/node/commit/f0982fccd5)] - **deps**: update icu to 78.3 (Node.js GitHub Bot) [#62324](https://github.com/nodejs/node/pull/62324)
* \[[`7fc381f834`](https://github.com/nodejs/node/commit/7fc381f834)] - **deps**: update libuv to 1.52.1 (Node.js GitHub Bot) [#61829](https://github.com/nodejs/node/pull/61829)
* \[[`cb75ed5581`](https://github.com/nodejs/node/commit/cb75ed5581)] - **deps**: V8: cherry-pick cf1bce40a5ef (Richard Lau) [#62449](https://github.com/nodejs/node/pull/62449)
* \[[`9a71f4a7f3`](https://github.com/nodejs/node/commit/9a71f4a7f3)] - **deps**: update googletest to 5a9c3f9e8d9b90bbbe8feb32902146cb8f7c1757 (Node.js GitHub Bot) [#61731](https://github.com/nodejs/node/pull/61731)
* \[[`604e714f17`](https://github.com/nodejs/node/commit/604e714f17)] - **deps**: update googletest to 56efe3983185e3f37e43415d1afa97e3860f187f (Node.js GitHub Bot) [#61605](https://github.com/nodejs/node/pull/61605)
* \[[`b8ff3ede41`](https://github.com/nodejs/node/commit/b8ff3ede41)] - **deps**: V8: cherry-pick 2abc61361dd4 (Richard Lau) [#60177](https://github.com/nodejs/node/pull/60177)
* \[[`f5376bc7f8`](https://github.com/nodejs/node/commit/f5376bc7f8)] - **deps**: V8: cherry-pick f93055fbd5aa (Olivier Flückiger) [#60105](https://github.com/nodejs/node/pull/60105)
* \[[`92dec8a06e`](https://github.com/nodejs/node/commit/92dec8a06e)] - **dns**: fix Windows SRV ECONNREFUSED by adjusting c-ares fallback detection (notvivek12) [#61453](https://github.com/nodejs/node/pull/61453)
* \[[`a0ab434edc`](https://github.com/nodejs/node/commit/a0ab434edc)] - **doc**: remove duplicated sentences in large-pull-requests.md (Joyee Cheung) [#63650](https://github.com/nodejs/node/pull/63650)
* \[[`4a6fb1cd14`](https://github.com/nodejs/node/commit/4a6fb1cd14)] - **doc**: update `git node land` instructions for security releases (Antoine du Hamel) [#63586](https://github.com/nodejs/node/pull/63586)
* \[[`cb597c73b6`](https://github.com/nodejs/node/commit/cb597c73b6)] - **doc**: drop --experimental from --permission (Rafael Gonzaga) [#63583](https://github.com/nodejs/node/pull/63583)
* \[[`2dfd758db9`](https://github.com/nodejs/node/commit/2dfd758db9)] - **doc**: explicitly ask for reproducible in JS (Rafael Gonzaga) [#63479](https://github.com/nodejs/node/pull/63479)
* \[[`7f1151928b`](https://github.com/nodejs/node/commit/7f1151928b)] - **doc**: fix URL postMessage example in worker\_threads (Kit Dallege) [#62203](https://github.com/nodejs/node/pull/62203)
* \[[`b131f748d3`](https://github.com/nodejs/node/commit/b131f748d3)] - **doc**: clarify `filter` option of `sqlite.database.applyChangeset` (Antoine du Hamel) [#63515](https://github.com/nodejs/node/pull/63515)
* \[[`5facf6a315`](https://github.com/nodejs/node/commit/5facf6a315)] - **doc**: fix double spaces in ERR\_TLS\_INVALID\_PROTOCOL\_METHOD (Daijiro Wachi) [#63511](https://github.com/nodejs/node/pull/63511)
* \[[`a60aac1406`](https://github.com/nodejs/node/commit/a60aac1406)] - **doc**: fix double space in modules.md (Daijiro Wachi) [#63512](https://github.com/nodejs/node/pull/63512)
* \[[`faf838b259`](https://github.com/nodejs/node/commit/faf838b259)] - **doc**: fix "options" to "option" in tls.createServer (Daijiro Wachi) [#63453](https://github.com/nodejs/node/pull/63453)
* \[[`83ca1580fd`](https://github.com/nodejs/node/commit/83ca1580fd)] - **doc**: remove unsupported template type from v8.md (René) [#63410](https://github.com/nodejs/node/pull/63410)
* \[[`6c5d10a226`](https://github.com/nodejs/node/commit/6c5d10a226)] - **doc**: remove the bi-monthly contributor spotlight section (Claudio Wunder) [#62734](https://github.com/nodejs/node/pull/62734)
* \[[`de3b154f68`](https://github.com/nodejs/node/commit/de3b154f68)] - **doc**: update http2's `push` and `trailers` events with `rawHeaders` param (YuSheng Chen) [#63259](https://github.com/nodejs/node/pull/63259)
* \[[`7590ffde0b`](https://github.com/nodejs/node/commit/7590ffde0b)] - **doc**: remove inactive members from Triagers list (Antoine du Hamel) [#63329](https://github.com/nodejs/node/pull/63329)
* \[[`5824197d63`](https://github.com/nodejs/node/commit/5824197d63)] - **doc**: recommend explicitly Tier 1 or 2 for production applications (Mike McCready) [#63187](https://github.com/nodejs/node/pull/63187)
* \[[`51609e77e5`](https://github.com/nodejs/node/commit/51609e77e5)] - **doc**: add large pull requests contributing guide (Matteo Collina) [#62829](https://github.com/nodejs/node/pull/62829)
* \[[`7073fdd4b5`](https://github.com/nodejs/node/commit/7073fdd4b5)] - **doc**: clarify SEA platform support excludes darwin-x64 (MJSHANG) [#63181](https://github.com/nodejs/node/pull/63181)
* \[[`7bd09ee9b7`](https://github.com/nodejs/node/commit/7bd09ee9b7)] - **doc**: update release steps when post-release fails (Rafael Gonzaga) [#63131](https://github.com/nodejs/node/pull/63131)
* \[[`1b0420b3cb`](https://github.com/nodejs/node/commit/1b0420b3cb)] - **doc**: remove list of versions in `BUILDING.md` (Antoine du Hamel) [#63113](https://github.com/nodejs/node/pull/63113)
* \[[`658392c352`](https://github.com/nodejs/node/commit/658392c352)] - **doc**: fix the TypeScript Execute (tsx) project link (David Thornton) [#63093](https://github.com/nodejs/node/pull/63093)
* \[[`cac004b65d`](https://github.com/nodejs/node/commit/cac004b65d)] - **doc**: correct diagnostics\_channel built-in channel names (Bryan English) [#62995](https://github.com/nodejs/node/pull/62995)
* \[[`ffe8635061`](https://github.com/nodejs/node/commit/ffe8635061)] - **doc**: use mjs/cjs blocks for callbackify null reason example (Daijiro Wachi) [#62884](https://github.com/nodejs/node/pull/62884)
* \[[`4625824cfb`](https://github.com/nodejs/node/commit/4625824cfb)] - **doc**: correct typo in PR contribution instructions (Mike McCready) [#62738](https://github.com/nodejs/node/pull/62738)
* \[[`1a2ed986f7`](https://github.com/nodejs/node/commit/1a2ed986f7)] - **doc**: fix duplicate word "of of" in postMessageToThread (Daijiro Wachi) [#62917](https://github.com/nodejs/node/pull/62917)
* \[[`99ff83aeab`](https://github.com/nodejs/node/commit/99ff83aeab)] - **doc**: fix duplicate word "for for" in compile cache (Daijiro Wachi) [#62917](https://github.com/nodejs/node/pull/62917)
* \[[`96800c7c01`](https://github.com/nodejs/node/commit/96800c7c01)] - **doc**: fix typo in dns.lookup options description (Daijiro Wachi) [#62882](https://github.com/nodejs/node/pull/62882)
* \[[`67e6404cee`](https://github.com/nodejs/node/commit/67e6404cee)] - **doc**: clarify diffieHellman.generateKeys recomputes same key (Kit Dallege) [#62205](https://github.com/nodejs/node/pull/62205)
* \[[`9e1a0bc2d0`](https://github.com/nodejs/node/commit/9e1a0bc2d0)] - **doc**: remove Ayase-252 and meixg from triagger team (Antoine du Hamel) [#62841](https://github.com/nodejs/node/pull/62841)
* \[[`6963d141c8`](https://github.com/nodejs/node/commit/6963d141c8)] - **doc**: clarify dns.lookup() callback signature when all is true (eungi) [#62800](https://github.com/nodejs/node/pull/62800)
* \[[`521f5aeed4`](https://github.com/nodejs/node/commit/521f5aeed4)] - **doc**: add experimental modules lifetime policy (Paolo Insogna) [#62753](https://github.com/nodejs/node/pull/62753)
* \[[`53fe5a0725`](https://github.com/nodejs/node/commit/53fe5a0725)] - **doc**: clarify process.\_debugProcess() in Permission Model (Fahad Khan) [#62537](https://github.com/nodejs/node/pull/62537)
* \[[`2e5ea5da46`](https://github.com/nodejs/node/commit/2e5ea5da46)] - **doc**: fix typo in devcontainer guide (Rohan Santhosh Kumar) [#62687](https://github.com/nodejs/node/pull/62687)
* \[[`dcbb795532`](https://github.com/nodejs/node/commit/dcbb795532)] - **doc**: clarify Backport-PR-URL metadata added automatically (Mike McCready) [#62668](https://github.com/nodejs/node/pull/62668)
* \[[`558d28fee4`](https://github.com/nodejs/node/commit/558d28fee4)] - **doc**: update WPT test runner README.md (Filip Skokan) [#62680](https://github.com/nodejs/node/pull/62680)
* \[[`12a372dcc0`](https://github.com/nodejs/node/commit/12a372dcc0)] - **doc**: fix spelling in release announcement guidance (Rohan Santhosh Kumar) [#62663](https://github.com/nodejs/node/pull/62663)
* \[[`29d5ad9172`](https://github.com/nodejs/node/commit/29d5ad9172)] - **doc**: update bug bounty program (Rafael Gonzaga) [#62590](https://github.com/nodejs/node/pull/62590)
* \[[`ab9555eb4b`](https://github.com/nodejs/node/commit/ab9555eb4b)] - **doc**: document TransformStream transformer.cancel option (Tom Pereira) [#62566](https://github.com/nodejs/node/pull/62566)
* \[[`fb078ad8c1`](https://github.com/nodejs/node/commit/fb078ad8c1)] - **doc**: remove spawn with shell example from bat/cmd section (Kit Dallege) [#62243](https://github.com/nodejs/node/pull/62243)
* \[[`9e6dfe6435`](https://github.com/nodejs/node/commit/9e6dfe6435)] - **doc**: fix typo in --disable-wasm-trap-handler description (Dmytro Semchuk) [#61820](https://github.com/nodejs/node/pull/61820)
* \[[`6eeefbd3bf`](https://github.com/nodejs/node/commit/6eeefbd3bf)] - **doc**: clarify that features cannot be both experimental and deprecated (Antoine du Hamel) [#62456](https://github.com/nodejs/node/pull/62456)
* \[[`d11fbc3602`](https://github.com/nodejs/node/commit/d11fbc3602)] - **doc**: enhance clarification about the main field (Mowafak Almahaini) [#62302](https://github.com/nodejs/node/pull/62302)
* \[[`ced0276cb3`](https://github.com/nodejs/node/commit/ced0276cb3)] - **doc**: minor typo fix (Jeff Matson) [#62358](https://github.com/nodejs/node/pull/62358)
* \[[`c4e517b794`](https://github.com/nodejs/node/commit/c4e517b794)] - **doc**: test and test-only targets do not run linter (Xavier Stouder) [#62120](https://github.com/nodejs/node/pull/62120)
* \[[`020d2b5eb9`](https://github.com/nodejs/node/commit/020d2b5eb9)] - **doc**: clarify that any truthy value of `shell` is part of DEP0190 (Antoine du Hamel) [#62249](https://github.com/nodejs/node/pull/62249)
* \[[`e7bf300619`](https://github.com/nodejs/node/commit/e7bf300619)] - **doc**: remove outdated Chrome 66 and ndb references from debugger (Kit Dallege) [#62202](https://github.com/nodejs/node/pull/62202)
* \[[`46f24da4e8`](https://github.com/nodejs/node/commit/46f24da4e8)] - **doc**: copyedit `addons.md` (Antoine du Hamel) [#62071](https://github.com/nodejs/node/pull/62071)
* \[[`5c4d681699`](https://github.com/nodejs/node/commit/5c4d681699)] - **doc**: expand SECURITY.md with non-vulnerability examples (Rafael Gonzaga) [#61972](https://github.com/nodejs/node/pull/61972)
* \[[`0206134748`](https://github.com/nodejs/node/commit/0206134748)] - **doc**: separate in-types and out-types in SQLite conversion docs (René) [#62034](https://github.com/nodejs/node/pull/62034)
* \[[`861fbe8338`](https://github.com/nodejs/node/commit/861fbe8338)] - **doc**: update DEP0040 (punycode) to application type deprecation (Mike McCready) [#61916](https://github.com/nodejs/node/pull/61916)
* \[[`7fada736e7`](https://github.com/nodejs/node/commit/7fada736e7)] - **doc**: add esm and cjs examples to node:vm (Alfredo González) [#61498](https://github.com/nodejs/node/pull/61498)
* \[[`5c3fe52fb5`](https://github.com/nodejs/node/commit/5c3fe52fb5)] - **doc**: clarify build environment is trusted in threat model (Matteo Collina) [#61865](https://github.com/nodejs/node/pull/61865)
* \[[`fa0324ddb8`](https://github.com/nodejs/node/commit/fa0324ddb8)] - **doc**: clean up Windows code snippet in `child_process.md` (reillylm) [#61422](https://github.com/nodejs/node/pull/61422)
* \[[`6ed9a5815d`](https://github.com/nodejs/node/commit/6ed9a5815d)] - **doc**: clarify EventEmitter error handling in threat model (Matteo Collina) [#61701](https://github.com/nodejs/node/pull/61701)
* \[[`783ea7df90`](https://github.com/nodejs/node/commit/783ea7df90)] - **doc**: fix --inspect security warning section (Tim Perry) [#61675](https://github.com/nodejs/node/pull/61675)
* \[[`a6d3846020`](https://github.com/nodejs/node/commit/a6d3846020)] - **doc**: fix grammatical error in README.md (ayj8201) [#61653](https://github.com/nodejs/node/pull/61653)
* \[[`cbc32838e2`](https://github.com/nodejs/node/commit/cbc32838e2)] - **doc**: update `server.dropMaxConnection` link (YuSheng Chen) [#61584](https://github.com/nodejs/node/pull/61584)
* \[[`dccfee1cd0`](https://github.com/nodejs/node/commit/dccfee1cd0)] - **doc**: clean up writing-and-running-benchmarks.md (Hardanish Singh) [#61345](https://github.com/nodejs/node/pull/61345)
* \[[`767a5742d3`](https://github.com/nodejs/node/commit/767a5742d3)] - **doc**: add --heap-snapshot-on-oom to useful v8 flag (jakecastelli) [#60260](https://github.com/nodejs/node/pull/60260)
...
* \[[`1efbbc98a8`](https://github.com/nodejs/node/commit/1efbbc98a8)] - **doc,sqlite**: document entryPoint argument for loadExtension (Edy Silva) [#63152](https://github.com/nodejs/node/pull/63152)
* \[[`2d4e35961d`](https://github.com/nodejs/node/commit/2d4e35961d)] - **doc,test**: clarify --eval syntax for leading '-' scripts (kovan) [#62244](https://github.com/nodejs/node/pull/62244)
* \[[`61bae78c56`](https://github.com/nodejs/node/commit/61bae78c56)] - **errors**: handle V8 warnings in DisallowJavascriptExecutionScope (Divyanshu Sharma) [#63491](https://github.com/nodejs/node/pull/63491)
* \[[`5dca770350`](https://github.com/nodejs/node/commit/5dca770350)] - **events**: avoid cloning listeners array on every emit (Gürgün Dayıoğlu) [#62261](https://github.com/nodejs/node/pull/62261)
* \[[`3dbf693bb8`](https://github.com/nodejs/node/commit/3dbf693bb8)] - **fs**: make `Date` properties on `Stats` enumerable (LiviaMedeiros) [#63328](https://github.com/nodejs/node/pull/63328)
* \[[`1878e7b675`](https://github.com/nodejs/node/commit/1878e7b675)] - **fs**: validate position argument before length === 0 early return (Edy Silva) [#62674](https://github.com/nodejs/node/pull/62674)
* \[[`078777fc7f`](https://github.com/nodejs/node/commit/078777fc7f)] - **http**: emit 'drain' on OutgoingMessage only after buffers drain (Robert Nagy) [#62936](https://github.com/nodejs/node/pull/62936)
* \[[`2ffb92bc35`](https://github.com/nodejs/node/commit/2ffb92bc35)] - **http**: fix leaked error listener on sync HTTP req create + destroy (Tim Perry) [#62872](https://github.com/nodejs/node/pull/62872)
* \[[`d7d6fdbbb8`](https://github.com/nodejs/node/commit/d7d6fdbbb8)] - **http**: fix no\_proxy leading-dot suffix matching (Daijiro Wachi) [#62333](https://github.com/nodejs/node/pull/62333)
* \[[`b27b85fb3d`](https://github.com/nodejs/node/commit/b27b85fb3d)] - **http**: cleanup pipeline queue (Robert Nagy) [#62534](https://github.com/nodejs/node/pull/62534)
* \[[`a89339faf5`](https://github.com/nodejs/node/commit/a89339faf5)] - **http**: fix use-after-free when freeParser is called during llhttp\_execute (Gerhard Stöbich) [#62095](https://github.com/nodejs/node/pull/62095)
* \[[`775ae50221`](https://github.com/nodejs/node/commit/775ae50221)] - **http**: validate ClientRequest path on set (Matteo Collina) [#62030](https://github.com/nodejs/node/pull/62030)
* \[[`956d8db822`](https://github.com/nodejs/node/commit/956d8db822)] - **http**: validate headers in writeEarlyHints (Richard Clarke) [#61897](https://github.com/nodejs/node/pull/61897)
* \[[`c34d610ffc`](https://github.com/nodejs/node/commit/c34d610ffc)] - **http**: remove redundant keepAliveTimeoutBuffer assignment (Efe) [#61743](https://github.com/nodejs/node/pull/61743)
* \[[`b75073d5aa`](https://github.com/nodejs/node/commit/b75073d5aa)] - **http**: attach error handler to socket synchronously in onSocket (RajeshKumar11) [#61770](https://github.com/nodejs/node/pull/61770)
* \[[`967289993a`](https://github.com/nodejs/node/commit/967289993a)] - **http**: implement slab allocation for HTTP header parsing (Mert Can Altin) [#61375](https://github.com/nodejs/node/pull/61375)
* \[[`a6b3a35e1d`](https://github.com/nodejs/node/commit/a6b3a35e1d)] - **http2**: retain header memory in session accounting (Matteo Collina) [#63752](https://github.com/nodejs/node/pull/63752)
* \[[`5240ced575`](https://github.com/nodejs/node/commit/5240ced575)] - **http2**: emit session close before stream close (Matteo Collina) [#63414](https://github.com/nodejs/node/pull/63414)
* \[[`64ff4c8f58`](https://github.com/nodejs/node/commit/64ff4c8f58)] - **http2**: validate non-link headers in writeEarlyHints (Matteo Collina) [#62017](https://github.com/nodejs/node/pull/62017)
* \[[`f83f1155e8`](https://github.com/nodejs/node/commit/f83f1155e8)] - **http2**: expose writable stream state on compat response (T) [#63003](https://github.com/nodejs/node/pull/63003)
* \[[`694c1685f0`](https://github.com/nodejs/node/commit/694c1685f0)] - **inspector**: fix absolute URLs in network http (bugyaluwang) [#62955](https://github.com/nodejs/node/pull/62955)
* \[[`8be503223b`](https://github.com/nodejs/node/commit/8be503223b)] - **inspector**: unwrap internal/debugger/inspect imports (René) [#61974](https://github.com/nodejs/node/pull/61974)
* \[[`e797fa0972`](https://github.com/nodejs/node/commit/e797fa0972)] - **inspector**: fix crash when receiving non json message (Shima Ryuhei) [#60388](https://github.com/nodejs/node/pull/60388)
* \[[`30c40ce3ab`](https://github.com/nodejs/node/commit/30c40ce3ab)] - **lib**: define `kEnumerableProperty` atomically (Antoine du Hamel) [#63609](https://github.com/nodejs/node/pull/63609)
* \[[`e739ffcaaa`](https://github.com/nodejs/node/commit/e739ffcaaa)] - **lib**: fix typos in esm loader comments (RonGamzu) [#63465](https://github.com/nodejs/node/pull/63465)
* \[[`93bd642c9b`](https://github.com/nodejs/node/commit/93bd642c9b)] - **lib**: fixes validator message (Daijiro Wachi) [#62823](https://github.com/nodejs/node/pull/62823)
* \[[`9fc3e9b3ac`](https://github.com/nodejs/node/commit/9fc3e9b3ac)] - **lib**: narrow ReadableStreamBYOBRequest.view return type to Uint8Array (RoomWithOutRoof) [#63017](https://github.com/nodejs/node/pull/63017)
* \[[`eaa817f243`](https://github.com/nodejs/node/commit/eaa817f243)] - **lib**: avoid quadratic shift() in startup snapshot callback (Daijiro Wachi) [#62914](https://github.com/nodejs/node/pull/62914)
* \[[`e1df7f5615`](https://github.com/nodejs/node/commit/e1df7f5615)] - **lib**: harden kKeyOps lookup with null prototype (Filip Skokan) [#62877](https://github.com/nodejs/node/pull/62877)
* \[[`16db5927da`](https://github.com/nodejs/node/commit/16db5927da)] - **lib**: use js-only implementation of `isDataView()` (René) [#62780](https://github.com/nodejs/node/pull/62780)
* \[[`de8e6dca08`](https://github.com/nodejs/node/commit/de8e6dca08)] - **lib**: fix sequence argument handling in Blob constructor (Ms2ger) [#62179](https://github.com/nodejs/node/pull/62179)
* \[[`b60f32f234`](https://github.com/nodejs/node/commit/b60f32f234)] - **lib**: make SubtleCrypto.supports enumerable (Filip Skokan) [#62307](https://github.com/nodejs/node/pull/62307)
* \[[`905489c17c`](https://github.com/nodejs/node/commit/905489c17c)] - **lib**: improve argument handling in Blob constructor (Ms2ger) [#61980](https://github.com/nodejs/node/pull/61980)
* \[[`53d6e6d2bb`](https://github.com/nodejs/node/commit/53d6e6d2bb)] - **lib**: recycle queues (Robert Nagy) [#61461](https://github.com/nodejs/node/pull/61461)
* \[[`7929eccb7b`](https://github.com/nodejs/node/commit/7929eccb7b)] - **meta**: flip mcollina emails in .mailmap (Matteo Collina) [#63621](https://github.com/nodejs/node/pull/63621)
* \[[`88fff80038`](https://github.com/nodejs/node/commit/88fff80038)] - **meta**: label "source maps" PRs (Chengzhong Wu) [#63591](https://github.com/nodejs/node/pull/63591)
* \[[`633b89fff0`](https://github.com/nodejs/node/commit/633b89fff0)] - **meta**: add `vfs` subsystem label (René) [#62331](https://github.com/nodejs/node/pull/62331)
* \[[`fd1be728a4`](https://github.com/nodejs/node/commit/fd1be728a4)] - **meta**: skip scheduled workflows on forks (Jamie Magee) [#63565](https://github.com/nodejs/node/pull/63565)
* \[[`0320ed9a00`](https://github.com/nodejs/node/commit/0320ed9a00)] - **meta**: add additional gitignore entries (James M Snell) [#63267](https://github.com/nodejs/node/pull/63267)
* \[[`c6780fc44d`](https://github.com/nodejs/node/commit/c6780fc44d)] - **meta**: move one or more collaborators to emeritus (Node.js GitHub Bot) [#63402](https://github.com/nodejs/node/pull/63402)
* \[[`530ec89309`](https://github.com/nodejs/node/commit/530ec89309)] - **meta**: move one or more collaborators to emeritus (Node.js GitHub Bot) [#63235](https://github.com/nodejs/node/pull/63235)
* \[[`5c582b48c1`](https://github.com/nodejs/node/commit/5c582b48c1)] - **meta**: ignore AI assistants files (Matteo Collina) [#62612](https://github.com/nodejs/node/pull/62612)
* \[[`f84f40547b`](https://github.com/nodejs/node/commit/f84f40547b)] - **meta**: bump actions/download-artifact from 8.0.0 to 8.0.1 (dependabot\[bot]) [#62549](https://github.com/nodejs/node/pull/62549)
* \[[`47921256cc`](https://github.com/nodejs/node/commit/47921256cc)] - **meta**: bump github/codeql-action from 4.35.1 to 4.35.3 (dependabot\[bot]) [#63074](https://github.com/nodejs/node/pull/63074)
* \[[`b1fda47c93`](https://github.com/nodejs/node/commit/b1fda47c93)] - **meta**: bump Mozilla-Actions/sccache-action from 0.0.9 to 0.0.10 (dependabot\[bot]) [#63073](https://github.com/nodejs/node/pull/63073)
* \[[`ff7b0422e9`](https://github.com/nodejs/node/commit/ff7b0422e9)] - **meta**: add automation policy (Chengzhong Wu) [#62871](https://github.com/nodejs/node/pull/62871)
* \[[`94080c81a2`](https://github.com/nodejs/node/commit/94080c81a2)] - **meta**: move VoltrexKeyva to emeritus (Matteo Collina) [#62895](https://github.com/nodejs/node/pull/62895)
* \[[`e7f59a2655`](https://github.com/nodejs/node/commit/e7f59a2655)] - **meta**: bump peter-evans/create-pull-request from 8.1.0 to 8.1.1 (dependabot\[bot]) [#62845](https://github.com/nodejs/node/pull/62845)
* \[[`d3a7b2a817`](https://github.com/nodejs/node/commit/d3a7b2a817)] - **meta**: bump step-security/harden-runner from 2.16.1 to 2.19.0 (dependabot\[bot]) [#62844](https://github.com/nodejs/node/pull/62844)
* \[[`782b75ba1e`](https://github.com/nodejs/node/commit/782b75ba1e)] - **meta**: bump actions/setup-node from 6.3.0 to 6.4.0 (dependabot\[bot]) [#62842](https://github.com/nodejs/node/pull/62842)
* \[[`ddc8fe02c6`](https://github.com/nodejs/node/commit/ddc8fe02c6)] - **meta**: broaden stale bot (Aviv Keller) [#62658](https://github.com/nodejs/node/pull/62658)
* \[[`c1432639ee`](https://github.com/nodejs/node/commit/c1432639ee)] - **meta**: move Michael to emeritus (Michael Dawson) [#62536](https://github.com/nodejs/node/pull/62536)
* \[[`fff4379cfc`](https://github.com/nodejs/node/commit/fff4379cfc)] - **meta**: populate apt list for slim runner in update-openssl workflow (René) [#62628](https://github.com/nodejs/node/pull/62628)
* \[[`7f78de5733`](https://github.com/nodejs/node/commit/7f78de5733)] - **meta**: bump step-security/harden-runner from 2.15.0 to 2.16.1 (dependabot\[bot]) [#62550](https://github.com/nodejs/node/pull/62550)
* \[[`d30f9f1902`](https://github.com/nodejs/node/commit/d30f9f1902)] - **meta**: bump actions/setup-node from 6.2.0 to 6.3.0 (dependabot\[bot]) [#62548](https://github.com/nodejs/node/pull/62548)
* \[[`a309795dba`](https://github.com/nodejs/node/commit/a309795dba)] - **meta**: bump github/codeql-action from 4.32.4 to 4.35.1 (dependabot\[bot]) [#62547](https://github.com/nodejs/node/pull/62547)
* \[[`19a1e7b386`](https://github.com/nodejs/node/commit/19a1e7b386)] - **meta**: bump codecov/codecov-action from 5.5.2 to 6.0.0 (dependabot\[bot]) [#62545](https://github.com/nodejs/node/pull/62545)
* \[[`885f22fd73`](https://github.com/nodejs/node/commit/885f22fd73)] - **meta**: bump actions/cache from 5.0.3 to 5.0.4 (dependabot\[bot]) [#62543](https://github.com/nodejs/node/pull/62543)
* \[[`9cc46a1e7d`](https://github.com/nodejs/node/commit/9cc46a1e7d)] - **meta**: require DCO signoff in commit message guidelines (James M Snell) [#62510](https://github.com/nodejs/node/pull/62510)
* \[[`5e84a2f470`](https://github.com/nodejs/node/commit/5e84a2f470)] - **meta**: expand memory leak DoS criteria to all DoS (Joyee Cheung) [#62505](https://github.com/nodejs/node/pull/62505)
* \[[`78c7630c74`](https://github.com/nodejs/node/commit/78c7630c74)] - **meta**: bump actions/download-artifact from 7.0.0 to 8.0.0 (dependabot\[bot]) [#62063](https://github.com/nodejs/node/pull/62063)
* \[[`52a363faef`](https://github.com/nodejs/node/commit/52a363faef)] - **meta**: bump actions/upload-artifact from 6.0.0 to 7.0.0 (dependabot\[bot]) [#62062](https://github.com/nodejs/node/pull/62062)
* \[[`0e1030b961`](https://github.com/nodejs/node/commit/0e1030b961)] - **meta**: bump step-security/harden-runner from 2.14.2 to 2.15.0 (dependabot\[bot]) [#62064](https://github.com/nodejs/node/pull/62064)
* \[[`abf0a9ddd3`](https://github.com/nodejs/node/commit/abf0a9ddd3)] - **meta**: bump github/codeql-action from 4.32.0 to 4.32.4 (dependabot\[bot]) [#61911](https://github.com/nodejs/node/pull/61911)
* \[[`f1635ecd3f`](https://github.com/nodejs/node/commit/f1635ecd3f)] - **meta**: bump step-security/harden-runner from 2.14.1 to 2.14.2 (dependabot\[bot]) [#61909](https://github.com/nodejs/node/pull/61909)
* \[[`9f7cb33da8`](https://github.com/nodejs/node/commit/9f7cb33da8)] - **meta**: bump actions/stale from 10.1.1 to 10.2.0 (dependabot\[bot]) [#61908](https://github.com/nodejs/node/pull/61908)
* \[[`c4ae0bdd72`](https://github.com/nodejs/node/commit/c4ae0bdd72)] - **meta**: bump github/codeql-action from 4.31.9 to 4.32.0 (dependabot\[bot]) [#61622](https://github.com/nodejs/node/pull/61622)
* \[[`2af2bcdc2d`](https://github.com/nodejs/node/commit/2af2bcdc2d)] - **meta**: bump step-security/harden-runner from 2.14.0 to 2.14.1 (dependabot\[bot]) [#61621](https://github.com/nodejs/node/pull/61621)
* \[[`8959eca36e`](https://github.com/nodejs/node/commit/8959eca36e)] - **meta**: bump actions/setup-python from 6.1.0 to 6.2.0 (dependabot\[bot]) [#61627](https://github.com/nodejs/node/pull/61627)
* \[[`b9a07ea8de`](https://github.com/nodejs/node/commit/b9a07ea8de)] - **meta**: bump actions/setup-node from 6.1.0 to 6.2.0 (dependabot\[bot]) [#61625](https://github.com/nodejs/node/pull/61625)
* \[[`a50861b017`](https://github.com/nodejs/node/commit/a50861b017)] - **meta**: bump actions/cache from 5.0.1 to 5.0.3 (dependabot\[bot]) [#61624](https://github.com/nodejs/node/pull/61624)
* \[[`c4ea7452d3`](https://github.com/nodejs/node/commit/c4ea7452d3)] - **meta**: bump peter-evans/create-pull-request from 8.0.0 to 8.1.0 (dependabot\[bot]) [#61623](https://github.com/nodejs/node/pull/61623)
* \[[`4b4abda6e8`](https://github.com/nodejs/node/commit/4b4abda6e8)] - **meta**: bump actions/stale from 10.1.0 to 10.1.1 (dependabot\[bot]) [#61620](https://github.com/nodejs/node/pull/61620)
* \[[`c90a1e49b5`](https://github.com/nodejs/node/commit/c90a1e49b5)] - **meta**: bump actions/checkout from 6.0.1 to 6.0.2 (dependabot\[bot]) [#61619](https://github.com/nodejs/node/pull/61619)
* \[[`d222c50df6`](https://github.com/nodejs/node/commit/d222c50df6)] - **meta**: bump actions/download-artifact from 6.0.0 to 7.0.0 (dependabot\[bot]) [#61242](https://github.com/nodejs/node/pull/61242)
* \[[`cd29ecbdb4`](https://github.com/nodejs/node/commit/cd29ecbdb4)] - **meta**: bump actions/checkout from 6.0.0 to 6.0.1 (dependabot\[bot]) [#61239](https://github.com/nodejs/node/pull/61239)
* \[[`7cdfbf9ca0`](https://github.com/nodejs/node/commit/7cdfbf9ca0)] - **meta**: bump actions/upload-artifact from 5.0.0 to 6.0.0 (dependabot\[bot]) [#61238](https://github.com/nodejs/node/pull/61238)
* \[[`c61668b23d`](https://github.com/nodejs/node/commit/c61668b23d)] - **meta**: bump actions/checkout from 5.0.1 to 6.0.0 (dependabot\[bot]) [#60925](https://github.com/nodejs/node/pull/60925)
* \[[`ee10d08ede`](https://github.com/nodejs/node/commit/ee10d08ede)] - **meta**: bump actions/checkout from 5.0.0 to 5.0.1 (dependabot\[bot]) [#60767](https://github.com/nodejs/node/pull/60767)
* \[[`e22786e470`](https://github.com/nodejs/node/commit/e22786e470)] - **module**: remove duplicated checks from `_resolveFilename` (Antoine du Hamel) [#62729](https://github.com/nodejs/node/pull/62729)
* \[[`979e095bd4`](https://github.com/nodejs/node/commit/979e095bd4)] - **module**: fix coverage of mocked CJS modules imported from ESM (Marco) [#62133](https://github.com/nodejs/node/pull/62133)
* \[[`0a704f160e`](https://github.com/nodejs/node/commit/0a704f160e)] - **module,win**: fix long subpath import (Stefan Stojanovic) [#62101](https://github.com/nodejs/node/pull/62101)
* \[[`1f999d2c8b`](https://github.com/nodejs/node/commit/1f999d2c8b)] - **net**: defer synchronous destroy calls in internalConnect (RajeshKumar11) [#61658](https://github.com/nodejs/node/pull/61658)
* \[[`fdac54f0e9`](https://github.com/nodejs/node/commit/fdac54f0e9)] - **node-api**: update libuv ABI stability note (Chengzhong Wu) [#62789](https://github.com/nodejs/node/pull/62789)
* \[[`0e83bae7cb`](https://github.com/nodejs/node/commit/0e83bae7cb)] - **node-api**: add napi\_create\_external\_sharedarraybuffer (Ben Noordhuis) [#62623](https://github.com/nodejs/node/pull/62623)
* \[[`e9e73f56fa`](https://github.com/nodejs/node/commit/e9e73f56fa)] - **node-api**: execute tsfn finalizer after queue drains when aborted (Kevin Eady) [#61956](https://github.com/nodejs/node/pull/61956)
* \[[`90eb644a50`](https://github.com/nodejs/node/commit/90eb644a50)] - **node-api**: fix data race and use-after-free in napi\_threadsafe\_function (Mika Fischer) [#55877](https://github.com/nodejs/node/pull/55877)
* \[[`bfab50300a`](https://github.com/nodejs/node/commit/bfab50300a)] - **perf\_hooks**: fix histogram fast call signatures (Renegade334) [#59600](https://github.com/nodejs/node/pull/59600)
* \[[`75b0b18e61`](https://github.com/nodejs/node/commit/75b0b18e61)] - **process**: handle rejections only when needed (Gürgün Dayıoğlu) [#62919](https://github.com/nodejs/node/pull/62919)
* \[[`df6e226943`](https://github.com/nodejs/node/commit/df6e226943)] - **process**: optimize asyncHandledRejections by using FixedQueue (Gürgün Dayıoğlu) [#60854](https://github.com/nodejs/node/pull/60854)
* \[[`27fb167f77`](https://github.com/nodejs/node/commit/27fb167f77)] - **process**: do not truncate long strings in `--print` (Mohamed Akram) [#61497](https://github.com/nodejs/node/pull/61497)
* \[[`8450c1cf33`](https://github.com/nodejs/node/commit/8450c1cf33)] - **repl**: keep reference count for `process.on('newListener')` (Anna Henningsen) [#61895](https://github.com/nodejs/node/pull/61895)
* \[[`3982634613`](https://github.com/nodejs/node/commit/3982634613)] - **sqlite**: keep source database alive during backup (Matteo Collina) [#62673](https://github.com/nodejs/node/pull/62673)
* \[[`9b1900617c`](https://github.com/nodejs/node/commit/9b1900617c)] - **sqlite**: enable Percentile extension (Jurj Andrei George) [#61295](https://github.com/nodejs/node/pull/61295)
* \[[`bf3ff4b226`](https://github.com/nodejs/node/commit/bf3ff4b226)] - **sqlite**: avoid extra copy for large text binds (Ali Hassan) [#61580](https://github.com/nodejs/node/pull/61580)
* \[[`2c91e2a05e`](https://github.com/nodejs/node/commit/2c91e2a05e)] - **src**: improve token return value check (James M Snell) [#63483](https://github.com/nodejs/node/pull/63483)
* \[[`1060fba453`](https://github.com/nodejs/node/commit/1060fba453)] - **src**: expose `node::RegisterContext` to make a node managed context (Chengzhong Wu) [#62322](https://github.com/nodejs/node/pull/62322)
* \[[`78bf3fa476`](https://github.com/nodejs/node/commit/78bf3fa476)] - **src**: fix crash in GetErrorSource() for invalid using syntax (semimikoh) [#62770](https://github.com/nodejs/node/pull/62770)
* \[[`9a26db0eb7`](https://github.com/nodejs/node/commit/9a26db0eb7)] - **src**: simplify `TCPWrap::Connect` signature (Anna Henningsen) [#62929](https://github.com/nodejs/node/pull/62929)
* \[[`b4fce608d1`](https://github.com/nodejs/node/commit/b4fce608d1)] - **src**: use DCHECK in AsyncWrap::MakeCallback instead emiting a warning (Gerhard Stöbich) [#62795](https://github.com/nodejs/node/pull/62795)
* \[[`8ece7d4722`](https://github.com/nodejs/node/commit/8ece7d4722)] - **src**: fix MaybeStackBuffer char\_traits deprecation warning (om-ghante) [#62507](https://github.com/nodejs/node/pull/62507)
* \[[`0454a3bb73`](https://github.com/nodejs/node/commit/0454a3bb73)] - **src**: use context-free V8 message column getters (René) [#62778](https://github.com/nodejs/node/pull/62778)
* \[[`737db4e81b`](https://github.com/nodejs/node/commit/737db4e81b)] - **src**: coerce `spawnSync` args to string once (Antoine du Hamel) [#62633](https://github.com/nodejs/node/pull/62633)
* \[[`7ea1b92256`](https://github.com/nodejs/node/commit/7ea1b92256)] - **src**: convert context\_frame field in AsyncWrap to internal field (Anna Henningsen) [#62103](https://github.com/nodejs/node/pull/62103)
* \[[`fbfbc83809`](https://github.com/nodejs/node/commit/fbfbc83809)] - **src**: make AsyncWrap subclass internal field counts explicit (Anna Henningsen) [#62103](https://github.com/nodejs/node/pull/62103)
* \[[`2377eca925`](https://github.com/nodejs/node/commit/2377eca925)] - **src**: improve EC JWK import performance (Filip Skokan) [#62396](https://github.com/nodejs/node/pull/62396)
* \[[`d996238946`](https://github.com/nodejs/node/commit/d996238946)] - **src**: handle null backing store in ArrayBufferViewContents::Read (Mert Can Altin) [#62343](https://github.com/nodejs/node/pull/62343)
* \[[`eb3d1475d2`](https://github.com/nodejs/node/commit/eb3d1475d2)] - **src**: expose async context frame debugging helper to JS (Anna Henningsen) [#62103](https://github.com/nodejs/node/pull/62103)
* \[[`cd6368089a`](https://github.com/nodejs/node/commit/cd6368089a)] - **src**: release context frame in AsyncWrap::EmitDestroy (Gerhard Stöbich) [#61995](https://github.com/nodejs/node/pull/61995)
* \[[`831b9d91f3`](https://github.com/nodejs/node/commit/831b9d91f3)] - **src**: use validate\_ascii\_with\_errors instead of validate\_ascii (Сковорода Никита Андреевич) [#61122](https://github.com/nodejs/node/pull/61122)
* \[[`9d3cecd7fc`](https://github.com/nodejs/node/commit/9d3cecd7fc)] - **src**: use bool literals in TraceEnvVarOptions (Tobias Nießen) [#61425](https://github.com/nodejs/node/pull/61425)
* \[[`bf636048ab`](https://github.com/nodejs/node/commit/bf636048ab)] - **src**: release memory for zstd contexts in `Close()` (Anna Henningsen) [#61717](https://github.com/nodejs/node/pull/61717)
* \[[`d18c010dfb`](https://github.com/nodejs/node/commit/d18c010dfb)] - **src**: add more checks and clarify docs for external references (Joyee Cheung) [#61719](https://github.com/nodejs/node/pull/61719)
* \[[`c471c1229e`](https://github.com/nodejs/node/commit/c471c1229e)] - **src**: elide heap allocation in structured clone implementation (Anna Henningsen) [#61703](https://github.com/nodejs/node/pull/61703)
* \[[`37b4a82a97`](https://github.com/nodejs/node/commit/37b4a82a97)] - **src**: use `Utf8Value` and `TwoByteValue` instead of V8 helpers (Anna Henningsen) [#60244](https://github.com/nodejs/node/pull/60244)
* \[[`310f60a6f9`](https://github.com/nodejs/node/commit/310f60a6f9)] - **src,sqlite**: only pass `xFilter` when user provided a callback (Antoine du Hamel) [#63516](https://github.com/nodejs/node/pull/63516)
* \[[`d2ae0f3fd6`](https://github.com/nodejs/node/commit/d2ae0f3fd6)] - **src,sqlite**: remove dead code (Edy Silva) [#63204](https://github.com/nodejs/node/pull/63204)
* \[[`f1f7c8d367`](https://github.com/nodejs/node/commit/f1f7c8d367)] - **stream**: use data listener for compose forwarding (Trivikram Kamat) [#63593](https://github.com/nodejs/node/pull/63593)
* \[[`158f555cce`](https://github.com/nodejs/node/commit/158f555cce)] - **stream**: remove unnecessary check (Antoine du Hamel) [#63030](https://github.com/nodejs/node/pull/63030)
* \[[`6e1e1ab8c7`](https://github.com/nodejs/node/commit/6e1e1ab8c7)] - **stream**: simplify `setPromiseHandled` utility (Antoine du Hamel) [#63032](https://github.com/nodejs/node/pull/63032)
* \[[`e32b026625`](https://github.com/nodejs/node/commit/e32b026625)] - **stream**: ensuring cross-destruction in \_duplexify to prevent leaks (Daijiro Wachi) [#62824](https://github.com/nodejs/node/pull/62824)
* \[[`b86fb9073b`](https://github.com/nodejs/node/commit/b86fb9073b)] - **stream**: fix nested compose error propagation (Matteo Collina) [#62556](https://github.com/nodejs/node/pull/62556)
* \[[`f370889d1a`](https://github.com/nodejs/node/commit/f370889d1a)] - **stream**: simplify `createPromiseCallback` (Antoine du Hamel) [#62650](https://github.com/nodejs/node/pull/62650)
* \[[`04e1e7efb7`](https://github.com/nodejs/node/commit/04e1e7efb7)] - **stream**: fix writev unhandled rejection in fromWeb (sangwook) [#62297](https://github.com/nodejs/node/pull/62297)
* \[[`dae9644789`](https://github.com/nodejs/node/commit/dae9644789)] - **stream**: refactor duplexify to be less suceptible to prototype pollution (Antoine du Hamel) [#62559](https://github.com/nodejs/node/pull/62559)
* \[[`289e747d5a`](https://github.com/nodejs/node/commit/289e747d5a)] - **stream**: replace bind with arrow function for onwrite callback (Ali Hassan) [#62087](https://github.com/nodejs/node/pull/62087)
* \[[`cfeaa8730e`](https://github.com/nodejs/node/commit/cfeaa8730e)] - **stream**: optimize webstreams pipeTo (Mattias Buelens) [#62079](https://github.com/nodejs/node/pull/62079)
* \[[`2308c74ad9`](https://github.com/nodejs/node/commit/2308c74ad9)] - **stream**: fix TransformStream race on cancel with pending write (Marco) [#62040](https://github.com/nodejs/node/pull/62040)
* \[[`03f4121ebb`](https://github.com/nodejs/node/commit/03f4121ebb)] - **stream**: fix pipeTo to defer writes per WHATWG spec (Matteo Collina) [#61800](https://github.com/nodejs/node/pull/61800)
* \[[`8f8bcb2b0a`](https://github.com/nodejs/node/commit/8f8bcb2b0a)] - **stream**: add fast paths for webstreams read and pipeTo (Matteo Collina) [#61807](https://github.com/nodejs/node/pull/61807)
* \[[`a7c405b165`](https://github.com/nodejs/node/commit/a7c405b165)] - **test**: shorten path in net pipe connect errors (Matteo Collina) [#63405](https://github.com/nodejs/node/pull/63405)
* \[[`f159ad29d2`](https://github.com/nodejs/node/commit/f159ad29d2)] - **test**: update test426-fixtures to 9b9e225b5a63139e9a95cdd1bf874a8f0b9d131 (Node.js GitHub Bot) [#63373](https://github.com/nodejs/node/pull/63373)
* \[[`20ca3152b4`](https://github.com/nodejs/node/commit/20ca3152b4)] - **test**: deflake async-hooks statwatcher test (Trivikram Kamat) [#63396](https://github.com/nodejs/node/pull/63396)
* \[[`4ed8992913`](https://github.com/nodejs/node/commit/4ed8992913)] - **test**: wait for ok before initial break after restart (Yuya Inoue) [#62807](https://github.com/nodejs/node/pull/62807)
* \[[`e30f818651`](https://github.com/nodejs/node/commit/e30f818651)] - **test**: disable Maglev in near-heap-limit worker test (Trivikram Kamat) [#63398](https://github.com/nodejs/node/pull/63398)
* \[[`2ef793d7e9`](https://github.com/nodejs/node/commit/2ef793d7e9)] - **test**: relax test-memory-usage arrayBuffers check (inoway46) [#63244](https://github.com/nodejs/node/pull/63244)
* \[[`377cb14229`](https://github.com/nodejs/node/commit/377cb14229)] - **test**: reduce flakiness of `different-registry-per-thread` (Antoine du Hamel) [#63244](https://github.com/nodejs/node/pull/63244)
* \[[`73dae4af30`](https://github.com/nodejs/node/commit/73dae4af30)] - **test**: fix flaky test-watch-mode-inspect timeout (Matteo Collina) [#63361](https://github.com/nodejs/node/pull/63361)
* \[[`f54cd309bd`](https://github.com/nodejs/node/commit/f54cd309bd)] - **test**: avoid flaky restart sync in debugger exceptions test (Yuya Inoue) [#62055](https://github.com/nodejs/node/pull/62055)
* \[[`daa640c8ac`](https://github.com/nodejs/node/commit/daa640c8ac)] - **test**: avoid initial-break wait in restart-message (inoway46) [#62060](https://github.com/nodejs/node/pull/62060)
* \[[`c337233a31`](https://github.com/nodejs/node/commit/c337233a31)] - **test**: export isRiscv64 from common module (Jamie Magee) [#62609](https://github.com/nodejs/node/pull/62609)
* \[[`aafbd6974c`](https://github.com/nodejs/node/commit/aafbd6974c)] - **test**: mark test-snapshot-reproducible flaky (Filip Skokan) [#62808](https://github.com/nodejs/node/pull/62808)
* \[[`0a8aaa1dde`](https://github.com/nodejs/node/commit/0a8aaa1dde)] - **test**: check contextify contextual store behavior in strict mode (René) [#62571](https://github.com/nodejs/node/pull/62571)
* \[[`bfb7fd2be8`](https://github.com/nodejs/node/commit/bfb7fd2be8)] - **test**: ensure WPT report is in out/wpt (Filip Skokan) [#62637](https://github.com/nodejs/node/pull/62637)
* \[[`357842d0bb`](https://github.com/nodejs/node/commit/357842d0bb)] - **test**: improve WPT runner summary (Filip Skokan) [#62636](https://github.com/nodejs/node/pull/62636)
* \[[`f2a148137b`](https://github.com/nodejs/node/commit/f2a148137b)] - **test**: capture negative utimes mtime at call time (Yuya Inoue) [#62490](https://github.com/nodejs/node/pull/62490)
* \[[`5ff8428f4b`](https://github.com/nodejs/node/commit/5ff8428f4b)] - **test**: allow skipping individual WPT subtests (Filip Skokan) [#62517](https://github.com/nodejs/node/pull/62517)
* \[[`33b0ba3155`](https://github.com/nodejs/node/commit/33b0ba3155)] - **test**: use on-disk fixture for test-npm-install (Joyee Cheung) [#62584](https://github.com/nodejs/node/pull/62584)
* \[[`f5e11a2d5f`](https://github.com/nodejs/node/commit/f5e11a2d5f)] - **test**: fix test-buffer-zero-fill-cli to be effective (Сковорода Никита Андреевич) [#60623](https://github.com/nodejs/node/pull/60623)
* \[[`c5870843a8`](https://github.com/nodejs/node/commit/c5870843a8)] - **test**: wait for reattach before initial break on restart (Yuya Inoue) [#62471](https://github.com/nodejs/node/pull/62471)
* \[[`86f5fd3365`](https://github.com/nodejs/node/commit/86f5fd3365)] - **test**: disable flaky WPT Blob test on AIX (James M Snell) [#62470](https://github.com/nodejs/node/pull/62470)
* \[[`5ca31e53da`](https://github.com/nodejs/node/commit/5ca31e53da)] - **test**: avoid flaky run wait in debugger restart test (Yuya Inoue) [#62112](https://github.com/nodejs/node/pull/62112)
* \[[`6e532736f4`](https://github.com/nodejs/node/commit/6e532736f4)] - **test**: improve WPT report runner (Filip Skokan) [#62107](https://github.com/nodejs/node/pull/62107)
* \[[`aab80f9595`](https://github.com/nodejs/node/commit/aab80f9595)] - **test**: fix skipping behavior for `test-runner-run-files-undefined` (Antoine du Hamel) [#62026](https://github.com/nodejs/node/pull/62026)
* \[[`b420154efc`](https://github.com/nodejs/node/commit/b420154efc)] - **test**: remove unnecessary `process.exit` calls from test files (Antoine du Hamel) [#62020](https://github.com/nodejs/node/pull/62020)
* \[[`4106f9be6d`](https://github.com/nodejs/node/commit/4106f9be6d)] - **test**: avoid flaky debugger restart waits (Yuya Inoue) [#61773](https://github.com/nodejs/node/pull/61773)
* \[[`0cfb3be008`](https://github.com/nodejs/node/commit/0cfb3be008)] - **test**: check stability block position in API markdown (René) [#58590](https://github.com/nodejs/node/pull/58590)
* \[[`d7272f1d3d`](https://github.com/nodejs/node/commit/d7272f1d3d)] - **test**: update FileAPI tests from WPT (Ms2ger) [#61750](https://github.com/nodejs/node/pull/61750)
* \[[`f9cb30172c`](https://github.com/nodejs/node/commit/f9cb30172c)] - **test**: print stack immediately avoiding GC interleaving (Chengzhong Wu) [#61699](https://github.com/nodejs/node/pull/61699)
* \[[`b6996fe95f`](https://github.com/nodejs/node/commit/b6996fe95f)] - **test**: remove duplicate wpt tests (Filip Skokan) [#61617](https://github.com/nodejs/node/pull/61617)
* \[[`bdf0f2a7d4`](https://github.com/nodejs/node/commit/bdf0f2a7d4)] - **test**: ensure assertions are reachable in `test/internet` (Antoine du Hamel) [#60513](https://github.com/nodejs/node/pull/60513)
* \[[`f85c73979b`](https://github.com/nodejs/node/commit/f85c73979b)] - **test**: ensure assertions are reached on more tests (Antoine du Hamel) [#60500](https://github.com/nodejs/node/pull/60500)
* \[[`509f27343d`](https://github.com/nodejs/node/commit/509f27343d)] - **test**: ensure assertions are reachable in more folders (Antoine du Hamel) [#60411](https://github.com/nodejs/node/pull/60411)
* \[[`a2193a5d5f`](https://github.com/nodejs/node/commit/a2193a5d5f)] - **test**: ensure assertions are reachable in `test/addons` (Antoine du Hamel) [#60142](https://github.com/nodejs/node/pull/60142)
* \[[`113d09a9f2`](https://github.com/nodejs/node/commit/113d09a9f2)] - **test**: ensure assertions are reachable in `test/client-proxy` (Antoine du Hamel) [#60175](https://github.com/nodejs/node/pull/60175)
* \[[`c6e08cd3ae`](https://github.com/nodejs/node/commit/c6e08cd3ae)] - **test**: mark `test-runner-run-watch` flaky on macOS (Richard Lau) [#60115](https://github.com/nodejs/node/pull/60115)
* \[[`7748f609c2`](https://github.com/nodejs/node/commit/7748f609c2)] - **test\_runner**: make it compatible with fake timers (Matteo Collina) [#59272](https://github.com/nodejs/node/pull/59272)
* \[[`263129fb93`](https://github.com/nodejs/node/commit/263129fb93)] - **test\_runner**: run afterEach on runtime skip (Igor Shevelenkov) [#61525](https://github.com/nodejs/node/pull/61525)
* \[[`7d67940bca`](https://github.com/nodejs/node/commit/7d67940bca)] - **test\_runner**: replace native methods with primordials (Ayoub Mabrouk) [#61219](https://github.com/nodejs/node/pull/61219)
* \[[`4edecac522`](https://github.com/nodejs/node/commit/4edecac522)] - **test\_runner**: fix test enqueue when test file has syntax error (Edy Silva) [#61573](https://github.com/nodejs/node/pull/61573)
* \[[`1efdb58e9f`](https://github.com/nodejs/node/commit/1efdb58e9f)] - **test\_runner**: fix memory leaks in runner (Abhishek Kv. Savani) [#60860](https://github.com/nodejs/node/pull/60860)
* \[[`cba42aad5e`](https://github.com/nodejs/node/commit/cba42aad5e)] - **test\_runner**: fix coverage report when a directory is named file (Heath Dutton🕴️) [#61169](https://github.com/nodejs/node/pull/61169)
* \[[`a3ae49d4a7`](https://github.com/nodejs/node/commit/a3ae49d4a7)] - **test\_runner**: print info when test restarts (Xavier Stouder) [#61160](https://github.com/nodejs/node/pull/61160)
* \[[`4ad06c3c32`](https://github.com/nodejs/node/commit/4ad06c3c32)] - **test\_runner**: nix dead reporter code (Vas Sudanagunta) [#59700](https://github.com/nodejs/node/pull/59700)
* \[[`18ea3039dc`](https://github.com/nodejs/node/commit/18ea3039dc)] - **test\_runner**: fix lazy `test.assert` accessor (René) [#61097](https://github.com/nodejs/node/pull/61097)
* \[[`54112cee3e`](https://github.com/nodejs/node/commit/54112cee3e)] - **test\_runner**: use module.registerHooks in module mocks (Joyee Cheung) [#60326](https://github.com/nodejs/node/pull/60326)
* \[[`2904821b77`](https://github.com/nodejs/node/commit/2904821b77)] - **tools**: skip commit-lint on backport pull requests (Marco) [#63378](https://github.com/nodejs/node/pull/63378)
* \[[`20c6e56b36`](https://github.com/nodejs/node/commit/20c6e56b36)] - **tools**: fix skip of `test-internet` on forks (Antoine du Hamel) [#63492](https://github.com/nodejs/node/pull/63492)
* \[[`e3b531cb36`](https://github.com/nodejs/node/commit/e3b531cb36)] - **tools**: update gyp-next to 0.22.2 (Node.js GitHub Bot) [#63374](https://github.com/nodejs/node/pull/63374)
* \[[`971bc2dd51`](https://github.com/nodejs/node/commit/971bc2dd51)] - **tools**: fix test426 updater (Antoine du Hamel) [#63271](https://github.com/nodejs/node/pull/63271)
* \[[`1870580609`](https://github.com/nodejs/node/commit/1870580609)] - **tools**: use different branch for tool updates on staging branches (Antoine du Hamel) [#63110](https://github.com/nodejs/node/pull/63110)
* \[[`b943a31a0c`](https://github.com/nodejs/node/commit/b943a31a0c)] - **tools**: add a check for clean git tree after tests (Antoine du Hamel) [#62661](https://github.com/nodejs/node/pull/62661)
* \[[`cd82901282`](https://github.com/nodejs/node/commit/cd82901282)] - **tools**: use LTS Node.js in notify-on-push workflow (Nenad Spasenic) [#63084](https://github.com/nodejs/node/pull/63084)
* \[[`8a5d51e441`](https://github.com/nodejs/node/commit/8a5d51e441)] - **tools**: update gr2m/create-or-update-pull-request-action to v1.10.1 (Mike McCready) [#63065](https://github.com/nodejs/node/pull/63065)
* \[[`457ad6291d`](https://github.com/nodejs/node/commit/457ad6291d)] - **tools**: simplify `update-undici.sh` (Antoine du Hamel) [#63044](https://github.com/nodejs/node/pull/63044)
* \[[`b1043b7ac0`](https://github.com/nodejs/node/commit/b1043b7ac0)] - **tools**: do not run `test-linux` on unrelated tools changes (Antoine du Hamel) [#63037](https://github.com/nodejs/node/pull/63037)
* \[[`4226fefe08`](https://github.com/nodejs/node/commit/4226fefe08)] - **tools**: update gyp-next to 0.22.1 (Node.js GitHub Bot) [#62961](https://github.com/nodejs/node/pull/62961)
* \[[`7066835db6`](https://github.com/nodejs/node/commit/7066835db6)] - **tools**: fix commit linter for semver-major release proposals (Antoine du Hamel) [#62993](https://github.com/nodejs/node/pull/62993)
* \[[`da3ac70bcd`](https://github.com/nodejs/node/commit/da3ac70bcd)] - **tools**: consolidate and simplify .editorconfig deps section (Daijiro Wachi) [#62887](https://github.com/nodejs/node/pull/62887)
* \[[`8931c2a359`](https://github.com/nodejs/node/commit/8931c2a359)] - **tools**: set bot as author of tools-deps-update PRs (Antoine du Hamel) [#62856](https://github.com/nodejs/node/pull/62856)
* \[[`434fe0b23d`](https://github.com/nodejs/node/commit/434fe0b23d)] - **tools**: bump brace-expansion in /tools/clang-format (dependabot\[bot]) [#62467](https://github.com/nodejs/node/pull/62467)
* \[[`56903ce09c`](https://github.com/nodejs/node/commit/56903ce09c)] - **tools**: exclude @node-core/doc-kit from dependabot cooldown (Levi Zim) [#62775](https://github.com/nodejs/node/pull/62775)
* \[[`b9d778a2c1`](https://github.com/nodejs/node/commit/b9d778a2c1)] - **tools**: re-enable undici WPTs in daily wpt.fyi job (Filip Skokan) [#62677](https://github.com/nodejs/node/pull/62677)
* \[[`faa6d4572c`](https://github.com/nodejs/node/commit/faa6d4572c)] - **tools**: update gyp-next to 0.22.0 (Node.js GitHub Bot) [#62697](https://github.com/nodejs/node/pull/62697)
* \[[`2238aa6b84`](https://github.com/nodejs/node/commit/2238aa6b84)] - **tools**: improve backport review script (Antoine du Hamel) [#62573](https://github.com/nodejs/node/pull/62573)
* \[[`8198b32080`](https://github.com/nodejs/node/commit/8198b32080)] - **tools**: improve output for unexpected passes in WTP tests (Antoine du Hamel) [#62587](https://github.com/nodejs/node/pull/62587)
* \[[`207d61e5e7`](https://github.com/nodejs/node/commit/207d61e5e7)] - **tools**: revert OpenSSL update workflow to ubuntu-latest (Richard Lau) [#62627](https://github.com/nodejs/node/pull/62627)
* \[[`483220ec0d`](https://github.com/nodejs/node/commit/483220ec0d)] - **tools**: allow triagers to queue a PR for CI until it's reviewed (Antoine du Hamel) [#62524](https://github.com/nodejs/node/pull/62524)
* \[[`9016178031`](https://github.com/nodejs/node/commit/9016178031)] - **tools**: do not run `commit-lint` on release proposals (Antoine du Hamel) [#62523](https://github.com/nodejs/node/pull/62523)
* \[[`6018b37d7f`](https://github.com/nodejs/node/commit/6018b37d7f)] - **tools**: adopt the `--check-for-duplicates` NCU flag (Antoine du Hamel) [#62478](https://github.com/nodejs/node/pull/62478)
* \[[`49cc337ca7`](https://github.com/nodejs/node/commit/49cc337ca7)] - **tools**: bump flatted from 3.3.3 to 3.4.1 in /tools/eslint (dependabot\[bot]) [#62255](https://github.com/nodejs/node/pull/62255)
* \[[`7a29409ed3`](https://github.com/nodejs/node/commit/7a29409ed3)] - **tools**: validate all commits that are pushed to `main` (Antoine du Hamel) [#62246](https://github.com/nodejs/node/pull/62246)
* \[[`ed7c6c4411`](https://github.com/nodejs/node/commit/ed7c6c4411)] - **tools**: revert timezone update GHA workflow to ubuntu-latest (Richard Lau) [#62140](https://github.com/nodejs/node/pull/62140)
* \[[`98c53f813e`](https://github.com/nodejs/node/commit/98c53f813e)] - **tools**: improve error handling in test426 update script (Rich Trott) [#62121](https://github.com/nodejs/node/pull/62121)
* \[[`b933e86422`](https://github.com/nodejs/node/commit/b933e86422)] - **tools**: fix daily wpt workflow nighly release version lookup (Filip Skokan) [#62076](https://github.com/nodejs/node/pull/62076)
* \[[`eb88e6b1f4`](https://github.com/nodejs/node/commit/eb88e6b1f4)] - **tools**: fix example in release proposal linter (Richard Lau) [#62074](https://github.com/nodejs/node/pull/62074)
* \[[`80d65bd46c`](https://github.com/nodejs/node/commit/80d65bd46c)] - **tools**: bump minimatch from 3.1.3 to 3.1.5 in /tools/clang-format (dependabot\[bot]) [#62013](https://github.com/nodejs/node/pull/62013)
* \[[`4da5cc0773`](https://github.com/nodejs/node/commit/4da5cc0773)] - **tools**: bump minimatch from 3.1.2 to 3.1.3 in `/tools/clang-format` (dependabot\[bot]) [#61977](https://github.com/nodejs/node/pull/61977)
* \[[`6501eccbbb`](https://github.com/nodejs/node/commit/6501eccbbb)] - **tools**: bump minimatch from 3.1.2 to 3.1.3 in /tools/eslint (dependabot\[bot]) [#61976](https://github.com/nodejs/node/pull/61976)
* \[[`7eec895e6c`](https://github.com/nodejs/node/commit/7eec895e6c)] - **tools**: roll back to x86 runner on `scorecard.yml` (Antoine du Hamel) [#61944](https://github.com/nodejs/node/pull/61944)
* \[[`8606ed7be3`](https://github.com/nodejs/node/commit/8606ed7be3)] - **tools**: do not checkout repo in `auto-start-ci.yml` (Antoine du Hamel) [#61874](https://github.com/nodejs/node/pull/61874)
* \[[`a5425e276f`](https://github.com/nodejs/node/commit/a5425e276f)] - **tools**: automate updates for test/fixtures/test426 (Rich Trott) [#60978](https://github.com/nodejs/node/pull/60978)
* \[[`46ac84b19f`](https://github.com/nodejs/node/commit/46ac84b19f)] - **tools**: bump unist-util-visit in /tools/doc in the doc group (dependabot\[bot]) [#61646](https://github.com/nodejs/node/pull/61646)
* \[[`81f1f747de`](https://github.com/nodejs/node/commit/81f1f747de)] - **tools**: fix small inconsistencies in JSON doc output (Antoine du Hamel) [#61757](https://github.com/nodejs/node/pull/61757)
* \[[`5c7dd69bce`](https://github.com/nodejs/node/commit/5c7dd69bce)] - **tools**: add LIEF to license builder (Chengzhong Wu) [#61523](https://github.com/nodejs/node/pull/61523)
* \[[`156ec6e1ff`](https://github.com/nodejs/node/commit/156ec6e1ff)] - **tools**: limit inspector protocol PR title length (Chengzhong Wu) [#60324](https://github.com/nodejs/node/pull/60324)
* \[[`c55bebc3c0`](https://github.com/nodejs/node/commit/c55bebc3c0)] - **tools**: fix inspector\_protocol updater (Chengzhong Wu) [#60277](https://github.com/nodejs/node/pull/60277)
* \[[`d32e3efe4f`](https://github.com/nodejs/node/commit/d32e3efe4f)] - **tools**: add inspector\_protocol updater (Chengzhong Wu) [#60245](https://github.com/nodejs/node/pull/60245)
* \[[`15a79da90f`](https://github.com/nodejs/node/commit/15a79da90f)] - **typings**: rationalise TypedArray types (René) [#62174](https://github.com/nodejs/node/pull/62174)
* \[[`a0b970af77`](https://github.com/nodejs/node/commit/a0b970af77)] - **url**: optimize URLSearchParams set/delete duplicate handling (Gürgün Dayıoğlu) [#62266](https://github.com/nodejs/node/pull/62266)
* \[[`5d0a1b522f`](https://github.com/nodejs/node/commit/5d0a1b522f)] - **util**: add fast path to stripVTControlCharacters (Hiroki Osame) [#61833](https://github.com/nodejs/node/pull/61833)
* \[[`a944283631`](https://github.com/nodejs/node/commit/a944283631)] - **worker**: eliminate race condition in process.cwd() (giulioAZ) [#61664](https://github.com/nodejs/node/pull/61664)
