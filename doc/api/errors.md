...
is generated by calling `String(message)`. The `error.cause` property is set
...
The `error.cause` property is set by calling `new Error(message, { cause })`.
It is not set if the `cause` option is not provided.
