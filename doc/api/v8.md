...
* `code_and_metadata_size` {integer}
* `bytecode_and_metadata_size` {integer}
* `external_script_source_size` {integer}
* `cpu_profiler_metadata_size` {integer}
...
* `space_name` {string}
* `space_size` {integer}
* `space_used_size` {integer}
* `space_available_size` {integer}
* `physical_space_size` {integer}
...
* `total_heap_size_executable` {integer}
* `total_physical_size` {integer}
* `total_available_size` {integer}
* `used_heap_size` {integer}
* `heap_size_limit` {integer}
* `malloced_memory` {integer}
* `peak_malloced_memory` {integer}
* `does_zap_garbage` {integer}
* `number_of_native_contexts` {integer}
* `number_of_detached_contexts` {integer}
* `total_global_handles_size` {integer}
* `used_global_handles_size` {integer}
