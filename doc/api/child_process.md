...
[`subprocess.disconnect()`]: #child_process_child_disconnect
[`subprocess.kill()`]: #child_process_child_kill_signal
[`subprocess.send()`]: #child_process_child_send_message_sendhandle_options_callback
[`subprocess.stderr`]: #child_process_child_stderr
[`subprocess.stdin`]: #child_process_child_stdin
[`subprocess.stdout`]: #child_process_child_stdout
