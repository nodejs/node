...
The `--experimental-specifier-resolution=[resolution-mode]` flag can be used
to customize the extension resolution algorithm. The default mode is `explicit`, which
