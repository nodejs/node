...
Node will generate and throw TypeError instances *immediately* -- they are a form
of argument validation.
...
`Error`, all exceptions thrown by Node or the JavaScript runtime *will* be instances of Error.
