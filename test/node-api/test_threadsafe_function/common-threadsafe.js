...
module.exports.expectedArray = (function(arrayLength) {
  const result = [];
...
module.exports.testWithJSMarshaller = function testWithJSMarshaller({
  threadStarter,
  quitAfter,
  abort,
  maxQueueSize,
...
module.exports.testUnref = function testUnref(queueSize) {
...
module.exports.start = new Promise(function testWithoutJSMarshaller(resolve) {
  let callCount = 0;
