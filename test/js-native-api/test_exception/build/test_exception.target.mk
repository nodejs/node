...
$(obj).target/test_exception.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(obj).target/test_exception.node: LIBS := $(LIBS)
$(obj).target/test_exception.node: TOOLSET := $(TOOLSET)
$(obj).target/test_exception.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(obj).target/test_exception.node
# Add target alias
...
$(builddir)/test_exception.node: $(obj).target/test_exception.node FORCE_DO_CMD
	$(call do_cmd,copy)

all_deps += $(builddir)/test_exception.node
# Short alias for building this executable.
.PHONY: test_exception.node
test_exception.node: $(obj).target/test_exception.node $(builddir)/test_exception.node
