...
$(obj).target/test_number.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(obj).target/test_number.node: LIBS := $(LIBS)
$(obj).target/test_number.node: TOOLSET := $(TOOLSET)
$(obj).target/test_number.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(obj).target/test_number.node
# Add target alias
.PHONY: test_number
...
$(builddir)/test_number.node: $(obj).target/test_number.node FORCE_DO_CMD
	$(call do_cmd,copy)

all_deps += $(builddir)/test_number.node
# Short alias for building this executable.
.PHONY: test_number.node
test_number.node: $(obj).target/test_number.node $(builddir)/test_number.node
