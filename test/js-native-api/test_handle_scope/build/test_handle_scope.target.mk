...
$(obj).target/test_handle_scope.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(obj).target/test_handle_scope.node: LIBS := $(LIBS)
$(obj).target/test_handle_scope.node: TOOLSET := $(TOOLSET)
$(obj).target/test_handle_scope.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(obj).target/test_handle_scope.node
# Add target alias
...
$(builddir)/test_handle_scope.node: $(obj).target/test_handle_scope.node FORCE_DO_CMD
	$(call do_cmd,copy)

all_deps += $(builddir)/test_handle_scope.node
# Short alias for building this executable.
.PHONY: test_handle_scope.node
test_handle_scope.node: $(obj).target/test_handle_scope.node $(builddir)/test_handle_scope.node
