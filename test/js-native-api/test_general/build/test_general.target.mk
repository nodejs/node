...
$(obj).target/test_general.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(obj).target/test_general.node: LIBS := $(LIBS)
$(obj).target/test_general.node: TOOLSET := $(TOOLSET)
$(obj).target/test_general.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(obj).target/test_general.node
# Add target alias
.PHONY: test_general
...
$(builddir)/test_general.node: $(obj).target/test_general.node FORCE_DO_CMD
	$(call do_cmd,copy)

all_deps += $(builddir)/test_general.node
# Short alias for building this executable.
.PHONY: test_general.node
test_general.node: $(obj).target/test_general.node $(builddir)/test_general.node
