...
$(obj).target/test_array.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(obj).target/test_array.node: LIBS := $(LIBS)
$(obj).target/test_array.node: TOOLSET := $(TOOLSET)
$(obj).target/test_array.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(obj).target/test_array.node
# Add target alias
.PHONY: test_array
...
$(builddir)/test_array.node: $(obj).target/test_array.node FORCE_DO_CMD
	$(call do_cmd,copy)

all_deps += $(builddir)/test_array.node
# Short alias for building this executable.
.PHONY: test_array.node
test_array.node: $(obj).target/test_array.node $(builddir)/test_array.node
