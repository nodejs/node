...
$(obj).target/test_symbol.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(obj).target/test_symbol.node: LIBS := $(LIBS)
$(obj).target/test_symbol.node: TOOLSET := $(TOOLSET)
$(obj).target/test_symbol.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(obj).target/test_symbol.node
# Add target alias
.PHONY: test_symbol
...
$(builddir)/test_symbol.node: $(obj).target/test_symbol.node FORCE_DO_CMD
	$(call do_cmd,copy)

all_deps += $(builddir)/test_symbol.node
# Short alias for building this executable.
.PHONY: test_symbol.node
test_symbol.node: $(obj).target/test_symbol.node $(builddir)/test_symbol.node
