...
$(obj).target/test_conversions.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(obj).target/test_conversions.node: LIBS := $(LIBS)
$(obj).target/test_conversions.node: TOOLSET := $(TOOLSET)
$(obj).target/test_conversions.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(obj).target/test_conversions.node
# Add target alias
...
$(builddir)/test_conversions.node: $(obj).target/test_conversions.node FORCE_DO_CMD
	$(call do_cmd,copy)

all_deps += $(builddir)/test_conversions.node
# Short alias for building this executable.
.PHONY: test_conversions.node
test_conversions.node: $(obj).target/test_conversions.node $(builddir)/test_conversions.node
