...
$(obj).target/test_properties.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(obj).target/test_properties.node: LIBS := $(LIBS)
$(obj).target/test_properties.node: TOOLSET := $(TOOLSET)
$(obj).target/test_properties.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(obj).target/test_properties.node
# Add target alias
...
$(builddir)/test_properties.node: $(obj).target/test_properties.node FORCE_DO_CMD
	$(call do_cmd,copy)

all_deps += $(builddir)/test_properties.node
# Short alias for building this executable.
.PHONY: test_properties.node
test_properties.node: $(obj).target/test_properties.node $(builddir)/test_properties.node
