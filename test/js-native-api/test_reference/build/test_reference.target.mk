...
$(obj).target/test_reference.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(obj).target/test_reference.node: LIBS := $(LIBS)
$(obj).target/test_reference.node: TOOLSET := $(TOOLSET)
$(obj).target/test_reference.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(obj).target/test_reference.node
# Add target alias
...
$(builddir)/test_reference.node: $(obj).target/test_reference.node FORCE_DO_CMD
	$(call do_cmd,copy)

all_deps += $(builddir)/test_reference.node
# Short alias for building this executable.
.PHONY: test_reference.node
test_reference.node: $(obj).target/test_reference.node $(builddir)/test_reference.node
