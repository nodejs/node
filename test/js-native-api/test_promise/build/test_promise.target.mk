...
$(obj).target/test_promise.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(obj).target/test_promise.node: LIBS := $(LIBS)
$(obj).target/test_promise.node: TOOLSET := $(TOOLSET)
$(obj).target/test_promise.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(obj).target/test_promise.node
# Add target alias
.PHONY: test_promise
...
$(builddir)/test_promise.node: $(obj).target/test_promise.node FORCE_DO_CMD
	$(call do_cmd,copy)

all_deps += $(builddir)/test_promise.node
# Short alias for building this executable.
.PHONY: test_promise.node
test_promise.node: $(obj).target/test_promise.node $(builddir)/test_promise.node
