...
describe('ESM: loader chaining', { concurrency: true }, () => {
  ...
  it('should load properly different source when only load changes something', async () => {
    const { code, stderr, stdout } = await spawnPromisified(
      ...
      [
        '--loader',
        fileURL('es-module-loaders', 'loader-resolve-passthru.mjs'),
        '--loader',
        fileURL('es-module-loaders', 'loader-load-foo-or-42.mjs'),
        '--loader',
        fileURL('es-module-loaders', 'loader-load-passthru.mjs'),
        ...commonArgs,
      ],
      { encoding: 'utf8' },
    );
  ...
  it('should result in proper output from multiple changes in resolve hooks', async () => {
    const { code, stderr, stdout } = await spawnPromisified(
      ...
      [
        '--loader',
        fileURL('es-module-loaders', 'loader-resolve-shortcircuit.mjs'),
        '--loader',
        fileURL('es-module-loaders', 'loader-resolve-foo.mjs'),
        '--loader',
        fileURL('es-module-loaders', 'loader-resolve-42.mjs'),
        '--loader',
        fileURL('es-module-loaders', 'loader-load-foo-or-42.mjs'),
        ...commonArgs,
      ],
  ...
  it('should respect modified context within resolve chain', async () => {
    const { code, stderr, stdout } = await spawnPromisified(
      ...
      [
        ...
        fileURL('es-module-loaders', 'loader-load-foo-or-42.mjs'),
        '--loader',
        fileURL('es-module-loaders', 'loader-load-receiving-modified-context.mjs'),
        '--loader',
        fileURL('es-module-loaders', 'loader-load-passing-modified-context.mjs'),
        ...commonArgs,
      ],
      { encoding: 'utf8' },
    );
  ...
  it('should provide the correct "next" fn when multiple calls to next within same loader', async () => {
    const { code, stderr, stdout } = await spawnPromisified(
      ...
      [
        ...
        fileURL('es-module-loaders', 'loader-resolve-foo.mjs'),
        '--loader',
        fileURL('es-module-loaders', 'loader-resolve-multiple-next-calls.mjs'),
        '--loader',
        fileURL('es-module-loaders', 'loader-load-foo-or-42.mjs'),
        ...commonArgs,
      ],
  ...
  it('should throw for incomplete resolve chain, citing errant loader & hook', async () => {
    const { code, stderr, stdout } = await spawnPromisified(
      ...
      [
        '--loader',
        fileURL('es-module-loaders', 'loader-resolve-incomplete.mjs'),
        '--loader',
        fileURL('es-module-loaders', 'loader-resolve-passthru.mjs'),
        '--loader',
        fileURL('es-module-loaders', 'loader-load-foo-or-42.mjs'),
  ...
  it('should NOT throw when nested resolve hook signaled a short circuit', async () => {
    const { code, stderr, stdout } = await spawnPromisified(
      ...
      [
        ...
        fileURL('es-module-loaders', 'loader-resolve-shortcircuit.mjs'),
        '--loader',
        fileURL('es-module-loaders', 'loader-resolve-next-modified.mjs'),
        '--loader',
        fileURL('es-module-loaders', 'loader-load-foo-or-42.mjs'),
        ...commonArgs,
      ],
  ...
  it('should NOT throw when nested load hook signaled a short circuit', async () => {
    const { code, stderr, stdout } = await spawnPromisified(
      ...
      [
        ...
        fileURL('es-module-loaders', 'loader-load-foo-or-42.mjs'),
        '--loader',
        fileURL('es-module-loaders', 'loader-load-next-modified.mjs'),
        ...commonArgs,
      ],
      { encoding: 'utf8' },
    );
  ...
  it('should throw for incomplete load chain, citing errant loader & hook', async () => {
    const { code, stderr, stdout } = await spawnPromisified(
      ...
      [
        ...
        fileURL('es-module-loaders', 'loader-resolve-passthru.mjs'),
        '--loader',
        fileURL('es-module-loaders', 'loader-load-incomplete.mjs'),
        '--loader',
        fileURL('es-module-loaders', 'loader-load-passthru.mjs'),
        ...commonArgs,
      ],
  ...
  it('should throw when invalid `specifier` argument passed to `nextResolve`', async () => {
    const { code, stderr } = await spawnPromisified(
      ...
      [
        ...
        fileURL('es-module-loaders', 'loader-resolve-passthru.mjs'),
        '--loader',
        fileURL('es-module-loaders', 'loader-resolve-bad-next-specifier.mjs'),
        ...commonArgs,
      ],
      { encoding: 'utf8' },
    );
  ...
  it('should throw when resolve hook is invalid', async () => {
    const { code, stderr } = await spawnPromisified(
      ...
      [
        ...
        fileURL('es-module-loaders', 'loader-resolve-passthru.mjs'),
        '--loader',
        fileURL('es-module-loaders', 'loader-resolve-null-return.mjs'),
        ...commonArgs,
      ],
      { encoding: 'utf8' },
    );
  ...
  it('should throw when invalid `context` argument passed to `nextResolve`', async () => {
    const { code, stderr } = await spawnPromisified(
      ...
      [
        ...
        fileURL('es-module-loaders', 'loader-resolve-passthru.mjs'),
        '--loader',
        fileURL('es-module-loaders', 'loader-resolve-bad-next-context.mjs'),
        ...commonArgs,
      ],
      { encoding: 'utf8' },
    );
  ...
  it('should throw when load hook is invalid', async () => {
    const { code, stderr } = await spawnPromisified(
      ...
      [
        ...
        fileURL('es-module-loaders', 'loader-load-passthru.mjs'),
        '--loader',
        fileURL('es-module-loaders', 'loader-load-null-return.mjs'),
        ...commonArgs,
      ],
      { encoding: 'utf8' },
    );
  ...
  it('should throw when invalid `url` argument passed to `nextLoad`', async () => {
    const { code, stderr } = await spawnPromisified(
      ...
      [
        ...
        fileURL('es-module-loaders', 'loader-load-passthru.mjs'),
        '--loader',
        fileURL('es-module-loaders', 'loader-load-bad-next-url.mjs'),
        ...commonArgs,
      ],
      { encoding: 'utf8' },
    );
  ...
  it('should throw when invalid `url` argument passed to `nextLoad`', async () => {
    const { code, stderr } = await spawnPromisified(
      ...
      [
        ...
        fileURL('es-module-loaders', 'loader-load-passthru.mjs'),
        '--loader',
        fileURL('es-module-loaders', 'loader-load-impersonating-next-url.mjs'),
        ...commonArgs,
      ],
      { encoding: 'utf8' },
    );
  ...
  it('should throw when invalid `context` argument passed to `nextLoad`', async () => {
    const { code, stderr } = await spawnPromisified(
      ...
      [
        ...
        fileURL('es-module-loaders', 'loader-load-passthru.mjs'),
        '--loader',
        fileURL('es-module-loaders', 'loader-load-bad-next-context.mjs'),
        ...commonArgs,
      ],
      { encoding: 'utf8' },
    );
