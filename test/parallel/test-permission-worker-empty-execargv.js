...
// Keep the denied tree outside NODE_TEST_DIR / test/.tmp.* so a parent
// prefix grant cannot accidentally cover the sibling "secret" file.
const deniedDir = fs.mkdtempSync(path.join(os.tmpdir(), 'perm-deny-'));
