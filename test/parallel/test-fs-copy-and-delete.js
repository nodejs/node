...
let testDir = common.tmpDir + "/copyanddeletetest" ;
...
assert.strictEqual(fs.readFileSync(`${testDir}/test1-copied/file1`).toString(),"Contents of file\r\n1") ;
assert.strictEqual(fs.readFileSync(`${testDir}/test1-copied/file2`).toString(),"Contents of file 2") ;
assert.strictEqual(fs.readFileSync(`${testDir}/test1-copied/test1/file3`).toString(),"Contents of file\r\n3") ;
assert.strictEqual(fs.readFileSync(`${testDir}/test1-copied/test3/file4`).toString(),"Contents of file 4") ;
assert.strictEqual(fs.readFileSync(`${testDir}/test1-copied/test3/file5`).toString(),"Contents of file 5") ;
...
checkProps(`${testDir}/test1/test1/file3`,`${testDir}/test1-copied/test1/file3`) ;
checkProps(`${testDir}/test1/test3/file4`,`${testDir}/test1-copied/test3/file4`) ;
checkProps(`${testDir}/test1/test3/file5`,`${testDir}/test1-copied/test3/file5`) ;
...
assert.strictEqual(common.fileExists(`${testDir}/test1-copied/test1/file3`),false) ;
assert.strictEqual(common.fileExists(`${testDir}/test1-copied/test3/file4`),false) ;
assert.strictEqual(common.fileExists(`${testDir}/test1-copied/test3/file5`),false) ;
