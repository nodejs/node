...
// Test reading sourcecode from /dev/stdin
...
// Test reading sourcecode from a symlink to /dev/stdin
tmpdir.refresh();
...
// Test reading sourcecode from a symlink to the `readlink /dev/stdin`
