...
describe('errors output', { concurrency: !process.env.TEST_PARALLEL }, () => {
  ...
  const tests = [
    ...
    { name: 'errors/assert_throws_stack.js', transform: errTransform },
    { name: 'errors/console_assert.js', transform: errTransform },
    ...
    { name: 'errors/eval_messages.js', transform: errTransform },
    ...
    { name: 'errors/internal_assert_fail.js', transform: errTransform },
    { name: 'errors/internal_assert.js', transform: errTransform },
