...
describe('errors output', { concurrency: !process.env.TEST_PARALLEL }, () => {
  ...
  const tests = [
    ...
    { name: 'errors/assert_throws_stack.js', transform: promiseTransform },
    { name: 'errors/core_line_numbers.js' },
    { name: 'errors/console_assert.js' },
    ...
    { name: 'errors/internal_assert_fail.js', transform: promiseTransform },
    { name: 'errors/internal_assert.js', transform: promiseTransform },
    { name: 'errors/max_tick_depth.js' },
    ...
    { name: 'errors/util_inspect_error_cause.js', transform: promiseTransform },
    { name: 'errors/util_inspect_error.js', transform: promiseTransform },
