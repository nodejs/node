...
assert.strictEqual(process.env.RETAIN_INNER_SINGLE_QUOTES_AS_ESCAPE_SLASH, "{'foo': 'bar'}");
assert.strictEqual(process.env.RETAIN_INNER_DOUBLE_QUOTES_AS_ESCAPE_SLASH, '{"foo": "bar"}');
