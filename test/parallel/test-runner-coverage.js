...
function getSpecCoverageFixtureReport() {
  ...
  const report = [
    ...
    '\u2139 ------------------------------------------------------------------------------------------------------',
    '\u2139 file              | stmts % | line % | branch % | funcs % | uncovered lines',
    '\u2139 ------------------------------------------------------------------------------------------------------',
    '\u2139 test              |         |        |          |         | ',
    '\u2139  fixtures         |         |        |          |         | ',
    '\u2139   test-runner     |         |        |          |         | ',
    '\u2139    coverage.js    |   75.00 |  78.65 |    38.46 |   60.00 | 12-13 16-22 27 39 43-44 61-62 66-67 71-72',
    '\u2139    invalid-tap.js |  100.00 | 100.00 |   100.00 |  100.00 | ',
    '\u2139   v8-coverage     |         |        |          |         | ',
    '\u2139    throw.js       |   80.00 |  71.43 |    50.00 |  100.00 | 5-6',
    '\u2139 ------------------------------------------------------------------------------------------------------',
    '\u2139 all files         |   76.00 |  78.35 |    43.75 |   60.00 | ',
    '\u2139 ------------------------------------------------------------------------------------------------------',
...
test.skip('coverage works with isolation=none', skipIfNoInspector, common.mustCallAtLeast(() => {
  ...
  let report = [
    ...
    '# file           | stmts % | line % | branch % | funcs % | uncovered lines',
    '# -----------------------------------------------------------------------------',
    '# common.js      |   89.47 |  89.86 |    68.42 |  100.00 | 8 13-14 18 34-35 53',
    '# first.test.js  |   87.50 |  83.33 |   100.00 |   50.00 | 5-6',
    '# second.test.js |  100.00 | 100.00 |   100.00 |  100.00 | ',
    '# third.test.js  |  100.00 | 100.00 |   100.00 |  100.00 | ',
    '# -----------------------------------------------------------------------------',
    '# all files      |   92.54 |  92.11 |    76.00 |   88.89 | ',
    '# -----------------------------------------------------------------------------',
    '# end of coverage report',
  ].join('\n');
...
test('coverage with ESM hook - source irrelevant', skipIfNoInspector, () => {
  let report = [
    ...
    '# file              | stmts % | line % | branch % | funcs % | uncovered lines',
    '# ----------------------------------------------------------------------------',
    '# hooks.mjs         |  100.00 | 100.00 |   100.00 |  100.00 | ',
    '# register-hooks.js |  100.00 | 100.00 |   100.00 |  100.00 | ',
    '# virtual.js        |  100.00 | 100.00 |   100.00 |  100.00 | ',
    '# ----------------------------------------------------------------------------',
...
test('coverage with ESM hook - source transpiled', skipIfNoInspector, () => {
  let report = [
    ...
    '# hooks.mjs         |  100.00 | 100.00 |   100.00 |  100.00 | ',
    '# register-hooks.js |  100.00 | 100.00 |   100.00 |  100.00 | ',
    '# sum.test.ts       |  100.00 | 100.00 |   100.00 |  100.00 | ',
    '# sum.ts            |  100.00 | 100.00 |   100.00 |  100.00 | ',
    '# ----------------------------------------------------------------------------',
    '# all files         |  100.00 | 100.00 |   100.00 |  100.00 | ',
    '# ----------------------------------------------------------------------------',
    '# end of coverage report',
...
test('coverage with excluded files', skipIfNoInspector, () => {
  ...
  const report = [
    ...
    '#    throw.js    |   80.00 |  71.43 |    50.00 |  100.00 | 5-6',
    '# ---------------------------------------------------------------------------------------------------',
    '# all files      |   75.51 |  78.13 |    40.00 |   60.00 | ',
    '# ---------------------------------------------------------------------------------------------------',
    '# end of coverage report',
  ].join('\n');
...
test('coverage with included and excluded files', skipIfNoInspector, () => {
  ...
  const report = [
    ...
    '#    coverage.js |   75.00 |  78.65 |    38.46 |   60.00 | 12-13 16-22 27 39 43-44 61-62 66-67 71-72',
    '# ---------------------------------------------------------------------------------------------------',
    '# all files      |   75.00 |  78.65 |    38.46 |   60.00 | ',
    '# ---------------------------------------------------------------------------------------------------',
    '# end of coverage report',
  ].join('\n');
