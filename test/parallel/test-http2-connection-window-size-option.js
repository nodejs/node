...
// before any WINDOW_UPDATE can be sent again. Larger windows only ever grow it.
// setLocalWindowSize() cannot do this once the connection is established.
// Send more than the window to prove the connection still resumes rather than
// stalling once the reduction is paid.
{
