...
for (const u in parseTests) {
  ...
  Object.keys(actual).forEach(function (i) {
    // Private properties starting with _ don't need to be checked.
    if (i.charAt(0) === "_")
      expected[i] = actual[i];
...
for (const u in parseTestsWithQueryString) {
  ...
  for (const i in actual) {
    // Private properties starting with _ don't need to be checked.
    if (i.charAt(0) === '_')
      Object.defineProperty(expected, i, {enumerable: actual.propertyIsEnumerable(i), value: actual[i]});
    else if (expected[i] === undefined && actual[i] === null)
      expected[i] = null;
  }
...
var whatwgTests = [
  ...
  },
  {
    ...
    // pre-v6
    'nodejs': 'http://:4/[1::2]:3',
    'override': 'http://[1::2]:3:4/' // https://url.spec.whatwg.org/interop/test-results/73fe5361ec
  },
  {
    'base': 'http://example.org/foo/bar',
    'input': 'http://2001::1',
    // pre-v6
    'nodejs': 'http://2001:1/:',
    'override': 'http://2001::1' // https://url.spec.whatwg.org/interop/test-results/96db824e63
  },
  {
    'base': 'http://example.org/foo/bar',
    'input': 'http://2001::1]',
    // pre-v6 - nodejs is an outlier here
    'nodejs': 'http://2001/::1]',
    'override': 'http://2001::1]' // https://url.spec.whatwg.org/interop/test-results/85201c8d8f
  },
  {
    'base': 'http://example.org/foo/bar',
    ...
    'override': 'http://2001::1]:80' // https://url.spec.whatwg.org/interop/test-results/f921120f8c
  },
  {
    'base': 'http://example.org/foo/bar',
    'input': 'http://[2001::1]',
  ...
  },
  {
    'base': 'http://example.org/foo/bar',
    'input': 'http://[2001::1]:80',
    // FIXME: This is failing WHATWG, should return http://[2001::1]/
    // https://url.spec.whatwg.org/interop/test-results/2757692299
  ...
  },
  {
    ...
    // FIXME: This is failing WHATWG
    // https://url.spec.whatwg.org/interop/test-results/8c35076c8c
    'refimpl': 'file:///C:/foo/bar',
  ...
  },
  {
    ...
    // FIXME: This is failing WHATWG
    // https://url.spec.whatwg.org/interop/test-results/4f239944e1
    'refimpl': 'file:///C:/foo/bar',
  ...
  },
  {
    ...
    'input': 'C|/foo/bar',
    // FIXME: This is failing WHATWG
    // https://url.spec.whatwg.org/interop/test-results/b1430fc379
    'refimpl': 'file:///C:/foo/bar',
  ...
  },
  {
    ...
    'input': '//C|/foo/bar',
    // FIXME: This is failing WHATWG
    // https://url.spec.whatwg.org/interop/test-results/9dc9a8fa31
    'refimpl': 'file:///C:/foo/bar',
    'nodejs': 'file://c/%7C/foo/bar'
  },
  {
  ...
  },
  {
    ...
    'nodejs': 'file://',
    // FIXME: This is failing WHATWG
    // https://url.spec.whatwg.org/interop/test-results/ebfaa37416
    // Neither pre-v6 or v6 is correct
    'refimpl': 'file:///',
    'override': 'file:////'
  },
  {
  ...
  },
  {
    ...
    // FIXME: This is failing WHATWG
    // https://url.spec.whatwg.org/interop/test-results/22f485f543
    'refimpl': 'http://example.com/foo',
  ...
  },
  {
    ...
    'input': 'http://example.com/./.foo',
    // FIXME: This is failing WHATWG
    // https://url.spec.whatwg.org/interop/test-results/e1d6c4e019
    'refimpl': 'http://example.com/.foo',
    'nodejs': 'http://example.com/./.foo'
  },
  {
  ...
  },
  {
    ...
    'input': 'http://example.com/foo/./',
    // FIXME: This is failing WHATWG
    // https://url.spec.whatwg.org/interop/test-results/b48b8bb38e
    'refimpl': 'http://example.com/foo/',
    'nodejs': 'http://example.com/foo/./'
  },
  {
    ...
    // FIXME: This is failing WHATWG
    // https://url.spec.whatwg.org/interop/test-results/1b005cdfe9
    'refimpl': 'http://example.com/foo/',
  ...
  },
  {
    ...
    'input': 'http://example.com/foo/bar/../',
    // FIXME: This is failing WHATWG
    // https://url.spec.whatwg.org/interop/test-results/8fc653ea6b
    'refimpl': 'http://example.com/foo/',
    'nodejs': 'http://example.com/foo/bar/../'
  },
  {
  ...
  },
  {
    ...
    // FIXME: This is failing WHATWG
    // https://url.spec.whatwg.org/interop/test-results/e27195ad3c
    'refimpl': 'http://example.com/foo/ton',
  ...
  },
  {
    ...
    // FIXME: This is failing WHATWG
    // https://url.spec.whatwg.org/interop/test-results/84a25b8dc7
    'refimpl': 'http://example.com/a',
  ...
  },
  {
    ...
    'input': 'http://example.com/foo/../../..',
    // FIXME: This is failing WHATWG
    // https://url.spec.whatwg.org/interop/test-results/863dbcb8b6
    'refimpl': 'http://example.com/',
    'nodejs': 'http://example.com/foo/../../..'
  },
  {
    'base': 'about:blank',
    ...
    // FIXME: This is failing WHATWG
    // https://url.spec.whatwg.org/interop/test-results/a01656d820
    'refimpl': 'http://example.com/ton',
  ...
  },
  {
    ...
    // FIXME: This is failing WHATWG
    // https://url.spec.whatwg.org/interop/test-results/a78e460b47
    'refimpl': 'http://example.com/',
  ...
  },
  {
    ...
    // FIXME: This is failing WHATWG
    // https://url.spec.whatwg.org/interop/test-results/27c205abd8
    'refimpl': 'http://example.com/%2e.bar',
  ...
  },
  {
    ...
    'input': 'http://example.com////../..',
    // FIXME: This is failing WHATWG
    // https://url.spec.whatwg.org/interop/test-results/e1ed8b8d91
    'refimpl': 'http://example.com//',
