...
describe('Object Comparison Tests', () => {
  ...
  describe('does not throw an error', () => {
    ...
    [
      ...
      },
      {
        ...
        actual: new Set(['value1', 'value2']),
        expected: new Set(['value1', 'value2', 'value3']),
      },
      {
        description:
  ...
  describe('includes', () => {
    describe('throws an error', () => {
      [
        {
          description: 'throws because expected is not a valid type',
          actual: { a: 1 },
          expected: undefined,
        ...
        {
          description:
            'throws because a string is being compared to an array',
          actual: 'abc',
          expected: ['a', 'b', 'c'],
        },
        {
          description:
            'throws because an array is being compared to a string',
          actual: ['a', 'b', 'c'],
          expected: 'abc',
        },
        {
