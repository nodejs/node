...

{
  ...
  assert.match(stdout, /ok 4 - this should be skipped/);
  assert.match(stdout, /ok 5 - subdir.+subdir_test\.js/);
}
...

{
  ...
  assert.match(stdout, /ok 3 - .+invalid-tap\.js/);
