...
export const vectors = {
  ...
  'sign': [
    ...
    [pqc, { name: 'ML-DSA-44', context: Buffer.alloc(255) }],
    [pqc, { name: 'ML-DSA-65', context: Buffer.alloc(255) }],
    [pqc, { name: 'ML-DSA-87', context: Buffer.alloc(255) }],
    [false, { name: 'ML-DSA-44', context: Buffer.alloc(256) }],
    [false, { name: 'ML-DSA-65', context: Buffer.alloc(256) }],
    [false, { name: 'ML-DSA-87', context: Buffer.alloc(256) }],
    [false, 'Argon2d'],
    [false, 'Argon2i'],
    [false, 'Argon2id'],
    [false, 'KMAC128'],
  ...
  'encapsulateKey': [
    ...
    [false, 'ML-KEM-768', { name: 'HMAC', hash: 'SHA-256', length: 248 }],
    [false, 'ML-KEM-768', { name: 'HMAC', hash: 'SHA-256', length: 512 }],
    [false, 'ML-KEM-768', { name: 'HMAC', hash: 'SHA-256', length: 257 }],
    [false, 'ML-KEM-768', { name: 'KMAC128', length: 248 }],
    [false, 'ML-KEM-768', 'Ed25519'],
  ],
  'decapsulateBits': [
    [pqc && !boringSSL, 'ML-KEM-512'],
    [pqc, 'ML-KEM-768'],
