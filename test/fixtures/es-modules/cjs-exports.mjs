...
deepEqual(Object.keys(ns), ['?invalid', '__cjsModule', 'default', 'invalid identifier', 'isObject', 'package', 'z', 'π', '\u{d83c}\u{df10}']);
strictEqual(ns.__cjsModule, true);
strictEqual(π, 'yes');
...
strictEqual(ns2.__cjsModule, true);
deepEqual(Object.keys(ns2), ['__cjsModule', '__esModule', 'case2', 'default', 'name', 'pi']);
...
strictEqual(ns3.__cjsModule, true);
