{
  'variables': {
    ...
    'node_sources': [
      ...
      'src/streams/writable_stream.cc',
      'src/streams/transform_stream.cc',
      'src/streams/streams_binding.cc',
      ...
      'src/streams/writable_stream.h',
      'src/streams/transform_stream.h',
      'src/streams/streams_binding.h',
