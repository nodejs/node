{
  'variables': {
    ...
    'node_sources': [
      'src/cppnv/EnvKey.cc',
      'src/cppnv/EnvPair.cc',
      'src/cppnv/EnvReader.cc',
      'src/cppnv/EnvStream.cc',
      'src/cppnv/EnvValue.cc',
      'src/cppnv/VariablePosition.cc',
      'src/cppnv/EnvKey.h',
      'src/cppnv/EnvPair.h',
      'src/cppnv/EnvReader.h',
      'src/cppnv/EnvStream.h',
      'src/cppnv/EnvValue.h',
      'src/cppnv/VariablePosition.h',
