...
#if defined(NODE_HAVE_I18N_SUPPORT)
void DefineICUConstants(Local<Object> target) {
  // Character Property Constants
  NODE_DEFINE_CONSTANT(target, UCHAR_ALPHABETIC);
  NODE_DEFINE_CONSTANT(target, UCHAR_ASCII_HEX_DIGIT);
  NODE_DEFINE_CONSTANT(target, UCHAR_BIDI_CONTROL);
  NODE_DEFINE_CONSTANT(target, UCHAR_BIDI_MIRRORED);
  NODE_DEFINE_CONSTANT(target, UCHAR_DASH);
  NODE_DEFINE_CONSTANT(target, UCHAR_DEFAULT_IGNORABLE_CODE_POINT);
  NODE_DEFINE_CONSTANT(target, UCHAR_DEPRECATED);
  NODE_DEFINE_CONSTANT(target, UCHAR_DIACRITIC);
  NODE_DEFINE_CONSTANT(target, UCHAR_EXTENDER);
  NODE_DEFINE_CONSTANT(target, UCHAR_FULL_COMPOSITION_EXCLUSION);
  NODE_DEFINE_CONSTANT(target, UCHAR_GRAPHEME_BASE);
  NODE_DEFINE_CONSTANT(target, UCHAR_GRAPHEME_EXTEND);
  NODE_DEFINE_CONSTANT(target, UCHAR_GRAPHEME_LINK);
  NODE_DEFINE_CONSTANT(target, UCHAR_HEX_DIGIT);
  NODE_DEFINE_CONSTANT(target, UCHAR_HYPHEN);
  NODE_DEFINE_CONSTANT(target, UCHAR_ID_CONTINUE);
  NODE_DEFINE_CONSTANT(target, UCHAR_ID_START);
  NODE_DEFINE_CONSTANT(target, UCHAR_IDEOGRAPHIC);
  NODE_DEFINE_CONSTANT(target, UCHAR_IDS_BINARY_OPERATOR);
  NODE_DEFINE_CONSTANT(target, UCHAR_IDS_TRINARY_OPERATOR);
  NODE_DEFINE_CONSTANT(target, UCHAR_JOIN_CONTROL);
  NODE_DEFINE_CONSTANT(target, UCHAR_LOGICAL_ORDER_EXCEPTION);
  NODE_DEFINE_CONSTANT(target, UCHAR_LOWERCASE);
  NODE_DEFINE_CONSTANT(target, UCHAR_MATH);
  NODE_DEFINE_CONSTANT(target, UCHAR_NONCHARACTER_CODE_POINT);
  NODE_DEFINE_CONSTANT(target, UCHAR_QUOTATION_MARK);
  NODE_DEFINE_CONSTANT(target, UCHAR_RADICAL);
  NODE_DEFINE_CONSTANT(target, UCHAR_SOFT_DOTTED);
  NODE_DEFINE_CONSTANT(target, UCHAR_TERMINAL_PUNCTUATION);
  NODE_DEFINE_CONSTANT(target, UCHAR_UNIFIED_IDEOGRAPH);
  NODE_DEFINE_CONSTANT(target, UCHAR_UPPERCASE);
  NODE_DEFINE_CONSTANT(target, UCHAR_WHITE_SPACE);
  NODE_DEFINE_CONSTANT(target, UCHAR_XID_CONTINUE);
  NODE_DEFINE_CONSTANT(target, UCHAR_XID_START);
  NODE_DEFINE_CONSTANT(target, UCHAR_CASE_SENSITIVE);
  NODE_DEFINE_CONSTANT(target, UCHAR_S_TERM);
  NODE_DEFINE_CONSTANT(target, UCHAR_VARIATION_SELECTOR);
  NODE_DEFINE_CONSTANT(target, UCHAR_NFD_INERT);
  NODE_DEFINE_CONSTANT(target, UCHAR_NFKD_INERT);
  NODE_DEFINE_CONSTANT(target, UCHAR_NFC_INERT);
  NODE_DEFINE_CONSTANT(target, UCHAR_NFKC_INERT);
  NODE_DEFINE_CONSTANT(target, UCHAR_SEGMENT_STARTER);
  NODE_DEFINE_CONSTANT(target, UCHAR_PATTERN_SYNTAX);
  NODE_DEFINE_CONSTANT(target, UCHAR_PATTERN_WHITE_SPACE);
  NODE_DEFINE_CONSTANT(target, UCHAR_POSIX_ALNUM);
  NODE_DEFINE_CONSTANT(target, UCHAR_POSIX_BLANK);
  NODE_DEFINE_CONSTANT(target, UCHAR_POSIX_GRAPH);
  NODE_DEFINE_CONSTANT(target, UCHAR_POSIX_PRINT);
  NODE_DEFINE_CONSTANT(target, UCHAR_POSIX_XDIGIT);
  NODE_DEFINE_CONSTANT(target, UCHAR_CASED);
  NODE_DEFINE_CONSTANT(target, UCHAR_CASE_IGNORABLE);
  NODE_DEFINE_CONSTANT(target, UCHAR_CHANGES_WHEN_LOWERCASED);
  NODE_DEFINE_CONSTANT(target, UCHAR_CHANGES_WHEN_UPPERCASED);
  NODE_DEFINE_CONSTANT(target, UCHAR_CHANGES_WHEN_TITLECASED);
  NODE_DEFINE_CONSTANT(target, UCHAR_CHANGES_WHEN_CASEFOLDED);
  NODE_DEFINE_CONSTANT(target, UCHAR_CHANGES_WHEN_CASEMAPPED);
  NODE_DEFINE_CONSTANT(target, UCHAR_CHANGES_WHEN_NFKC_CASEFOLDED);
  NODE_DEFINE_CONSTANT(target, UCHAR_EMOJI);
  NODE_DEFINE_CONSTANT(target, UCHAR_EMOJI_PRESENTATION);
  NODE_DEFINE_CONSTANT(target, UCHAR_EMOJI_MODIFIER);
  NODE_DEFINE_CONSTANT(target, UCHAR_EMOJI_MODIFIER_BASE);
  NODE_DEFINE_CONSTANT(target, UCHAR_BIDI_CLASS);
  NODE_DEFINE_CONSTANT(target, UCHAR_BLOCK);
  NODE_DEFINE_CONSTANT(target, UCHAR_CANONICAL_COMBINING_CLASS);
  NODE_DEFINE_CONSTANT(target, UCHAR_DECOMPOSITION_TYPE);
  NODE_DEFINE_CONSTANT(target, UCHAR_EAST_ASIAN_WIDTH);
  NODE_DEFINE_CONSTANT(target, UCHAR_GENERAL_CATEGORY);
  NODE_DEFINE_CONSTANT(target, UCHAR_JOINING_GROUP);
  NODE_DEFINE_CONSTANT(target, UCHAR_JOINING_TYPE);
  NODE_DEFINE_CONSTANT(target, UCHAR_LINE_BREAK);
  NODE_DEFINE_CONSTANT(target, UCHAR_NUMERIC_TYPE);
  NODE_DEFINE_CONSTANT(target, UCHAR_SCRIPT);
  NODE_DEFINE_CONSTANT(target, UCHAR_HANGUL_SYLLABLE_TYPE);
  NODE_DEFINE_CONSTANT(target, UCHAR_NFD_QUICK_CHECK);
  NODE_DEFINE_CONSTANT(target, UCHAR_NFKD_QUICK_CHECK);
  NODE_DEFINE_CONSTANT(target, UCHAR_NFC_QUICK_CHECK);
  NODE_DEFINE_CONSTANT(target, UCHAR_NFKC_QUICK_CHECK);
  NODE_DEFINE_CONSTANT(target, UCHAR_LEAD_CANONICAL_COMBINING_CLASS);
  NODE_DEFINE_CONSTANT(target, UCHAR_TRAIL_CANONICAL_COMBINING_CLASS);
  NODE_DEFINE_CONSTANT(target, UCHAR_GRAPHEME_CLUSTER_BREAK);
  NODE_DEFINE_CONSTANT(target, UCHAR_SENTENCE_BREAK);
  NODE_DEFINE_CONSTANT(target, UCHAR_WORD_BREAK);
  NODE_DEFINE_CONSTANT(target, UCHAR_BIDI_PAIRED_BRACKET_TYPE);
  NODE_DEFINE_CONSTANT(target, UCHAR_GENERAL_CATEGORY_MASK);
  NODE_DEFINE_CONSTANT(target, UCHAR_NUMERIC_VALUE);

  // Char Category Constants
  NODE_DEFINE_CONSTANT(target, U_UNASSIGNED);
  NODE_DEFINE_CONSTANT(target, U_GENERAL_OTHER_TYPES);
  NODE_DEFINE_CONSTANT(target, U_UPPERCASE_LETTER);
  NODE_DEFINE_CONSTANT(target, U_LOWERCASE_LETTER);
  NODE_DEFINE_CONSTANT(target, U_TITLECASE_LETTER);
  NODE_DEFINE_CONSTANT(target, U_MODIFIER_LETTER);
  NODE_DEFINE_CONSTANT(target, U_OTHER_LETTER);
  NODE_DEFINE_CONSTANT(target, U_NON_SPACING_MARK);
  NODE_DEFINE_CONSTANT(target, U_ENCLOSING_MARK);
  NODE_DEFINE_CONSTANT(target, U_COMBINING_SPACING_MARK);
  NODE_DEFINE_CONSTANT(target, U_DECIMAL_DIGIT_NUMBER);
  NODE_DEFINE_CONSTANT(target, U_LETTER_NUMBER);
  NODE_DEFINE_CONSTANT(target, U_OTHER_NUMBER);
  NODE_DEFINE_CONSTANT(target, U_SPACE_SEPARATOR);
  NODE_DEFINE_CONSTANT(target, U_LINE_SEPARATOR);
  NODE_DEFINE_CONSTANT(target, U_PARAGRAPH_SEPARATOR);
  NODE_DEFINE_CONSTANT(target, U_CONTROL_CHAR);
  NODE_DEFINE_CONSTANT(target, U_FORMAT_CHAR);
  NODE_DEFINE_CONSTANT(target, U_PRIVATE_USE_CHAR);
  NODE_DEFINE_CONSTANT(target, U_SURROGATE);
  NODE_DEFINE_CONSTANT(target, U_DASH_PUNCTUATION);
  NODE_DEFINE_CONSTANT(target, U_START_PUNCTUATION);
  NODE_DEFINE_CONSTANT(target, U_END_PUNCTUATION);
  NODE_DEFINE_CONSTANT(target, U_CONNECTOR_PUNCTUATION);
  NODE_DEFINE_CONSTANT(target, U_OTHER_PUNCTUATION);
  NODE_DEFINE_CONSTANT(target, U_MATH_SYMBOL);
  NODE_DEFINE_CONSTANT(target, U_CURRENCY_SYMBOL);
  NODE_DEFINE_CONSTANT(target, U_MODIFIER_SYMBOL);
  NODE_DEFINE_CONSTANT(target, U_OTHER_SYMBOL);
  NODE_DEFINE_CONSTANT(target, U_INITIAL_PUNCTUATION);
  NODE_DEFINE_CONSTANT(target, U_FINAL_PUNCTUATION);

  // Direction Constants
  NODE_DEFINE_CONSTANT(target, U_LEFT_TO_RIGHT);
  NODE_DEFINE_CONSTANT(target, U_RIGHT_TO_LEFT);
  NODE_DEFINE_CONSTANT(target, U_EUROPEAN_NUMBER);
  NODE_DEFINE_CONSTANT(target, U_EUROPEAN_NUMBER_SEPARATOR);
  NODE_DEFINE_CONSTANT(target, U_EUROPEAN_NUMBER_TERMINATOR);
  NODE_DEFINE_CONSTANT(target, U_ARABIC_NUMBER);
  NODE_DEFINE_CONSTANT(target, U_COMMON_NUMBER_SEPARATOR);
  NODE_DEFINE_CONSTANT(target, U_BLOCK_SEPARATOR);
  NODE_DEFINE_CONSTANT(target, U_SEGMENT_SEPARATOR);
  NODE_DEFINE_CONSTANT(target, U_WHITE_SPACE_NEUTRAL);
  NODE_DEFINE_CONSTANT(target, U_OTHER_NEUTRAL);
  NODE_DEFINE_CONSTANT(target, U_LEFT_TO_RIGHT_EMBEDDING);
  NODE_DEFINE_CONSTANT(target, U_LEFT_TO_RIGHT_OVERRIDE);
  NODE_DEFINE_CONSTANT(target, U_RIGHT_TO_LEFT_ARABIC);
  NODE_DEFINE_CONSTANT(target, U_RIGHT_TO_LEFT_EMBEDDING);
  NODE_DEFINE_CONSTANT(target, U_RIGHT_TO_LEFT_OVERRIDE);
  NODE_DEFINE_CONSTANT(target, U_POP_DIRECTIONAL_FORMAT);
  NODE_DEFINE_CONSTANT(target, U_DIR_NON_SPACING_MARK);
  NODE_DEFINE_CONSTANT(target, U_BOUNDARY_NEUTRAL);
  NODE_DEFINE_CONSTANT(target, U_FIRST_STRONG_ISOLATE);
  NODE_DEFINE_CONSTANT(target, U_LEFT_TO_RIGHT_ISOLATE);
  NODE_DEFINE_CONSTANT(target, U_RIGHT_TO_LEFT_ISOLATE);
  NODE_DEFINE_CONSTANT(target, U_POP_DIRECTIONAL_ISOLATE);

  // Width Constants
  NODE_DEFINE_CONSTANT(target, U_EA_NEUTRAL);
  NODE_DEFINE_CONSTANT(target, U_EA_AMBIGUOUS);
  NODE_DEFINE_CONSTANT(target, U_EA_HALFWIDTH);
  NODE_DEFINE_CONSTANT(target, U_EA_FULLWIDTH);
  NODE_DEFINE_CONSTANT(target, U_EA_NARROW);
  NODE_DEFINE_CONSTANT(target, U_EA_WIDE);
}
#endif
...
void DefineConstants(v8::Isolate* isolate, Local<Object> target) {
  ...
  #if defined(NODE_HAVE_I18N_SUPPORT)
    Local<Object> icu_constants = Object::New(isolate);
    DefineICUConstants(icu_constants);
    target->Set(OneByteString(isolate, "icu"), icu_constants);
  #endif
}
