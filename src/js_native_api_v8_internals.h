...
// The V8 implementation of the Node.js API, including `js_native_api_v8.h`
// uses certain idioms which require definition here. For example, it uses a
// variant of persistent references which need not be reset in the constructor.
// It is the responsibility of this file to define these idioms. Optionally,
// this file may also define `NODE_API_VERSION` and set it to the version of
// the Node.js API to be exposed.

// In the case of the Node.js implementation of the API some of the idioms are
...
// included below, defines `NODE_API_VERSION`.
