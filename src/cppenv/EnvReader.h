...
public:
    static finalize_result finalize_value(const env_pair* pair, std::map<std::string, env_pair *>* mapped_pairs);
    ...
    static int read_pairs(  std::istream& file, std::map<std::string, env_pair *>* mapped_pairs);
};
