...
class BindingData : public SnapshotableObject {
 public:
  ...
  // Like ReadPackageJSON but the caller supplies the raw JSON body.
  // Does not populate the C++ `package_configs_` cache.
  // Signature: parsePackageJSON(source, jsonPath, isESM, base, specifier)
  static void ParsePackageJSONBinding(
 ...
 private:
  ...
  // Parses `package_config->raw_json` into `package_config`; caller
  // must set raw_json and file_path first. Returns false and throws
  // ERR_INVALID_PACKAGE_CONFIG on a syntactic error.
  static bool ParsePackageJSON(Realm* realm,
