...
const BindingData::PackageConfig* BindingData::GetPackageJSON(
  ...
  simdjson::padded_string padded_json = simdjson::pad(package_config.raw_json);
  simdjson::ondemand::document document;
  simdjson::ondemand::object main_object;
  simdjson::error_code error =
      binding_data->json_parser.iterate([padded_json](simdjson::pad(package_config.raw_json))).get(document);
