...
class StatementSQLiteToJSConverter {
 public:
  ...
  static v8::MaybeLocal<v8::Object> ConvertStatementGet(Environment* env,
                                                        sqlite3_stmt* stmt,
                                                        int num_cols,
                                                        bool use_big_ints,
                                                        bool return_arrays);
...
class StatementAsyncExecutionHelper {
 public:
  static v8::MaybeLocal<v8::Promise::Resolver> Run(Environment* env,
                                                   Statement* stmt);
  static v8::MaybeLocal<v8::Promise::Resolver> Get(Environment* env,
                                                   Statement* stmt);
  static v8::MaybeLocal<v8::Promise::Resolver> All(Environment* env,
                                                   Statement* stmt);
};
