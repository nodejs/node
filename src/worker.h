...
class WorkerContext {
  public:
    ...
    static void RunWorkerInstance(void* arg);
  ...
  private:
    ...
    void Dispose();
    void QueueGlobalCleanup();
    static void GlobalCleanupCallback(uv_async_t* handle);
    static void InitWorkersOnce();
    ...
    v8::Isolate* const worker_isolate_;
