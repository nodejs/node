...
void HistogramImpl::RegisterExternalReferences(
  ...
  registry->RegisterCFunction(fast_reset_);
  registry->RegisterCFunction(fast_get_count_);
  registry->RegisterCFunction(fast_get_min_);
  registry->RegisterCFunction(fast_get_max_);
  registry->RegisterCFunction(fast_get_mean_);
  registry->RegisterCFunction(fast_get_exceeds_);
  registry->RegisterCFunction(fast_get_stddev_);
  registry->RegisterCFunction(fast_get_percentile_);
  is_registered = true;
}
...
void HistogramBase::RegisterExternalReferences(
  ...
  registry->RegisterCFunction(fast_record_);
  registry->RegisterCFunction(fast_record_delta_);
...
void IntervalHistogram::RegisterExternalReferences(
  ...
  registry->RegisterCFunction(fast_start_);
  registry->RegisterCFunction(fast_stop_);
  HistogramImpl::RegisterExternalReferences(registry);
}
