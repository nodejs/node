...
#define PER_ISOLATE_SYMBOL_PROPERTIES(V)                                       \
  ...
  V(ffi_fastcall_alive_symbol, "ffi.fastcall.alive")                           \
  V(ffi_fastcall_invoke_slow_symbol, "ffi.fastcall.invokeSlow")                \
  V(ffi_fastcall_params_symbol, "ffi.fastcall.params")                         \
  V(ffi_fastcall_result_symbol, "ffi.fastcall.result")                         \
