...
void BindingData::RegisterTimerExternalReferences(
  ...
  registry->RegisterCFunction(fast_get_libuv_now_);

  registry->Register(SlowScheduleTimer);
  registry->RegisterCFunction(fast_schedule_timer_);

  registry->Register(SlowToggleTimerRef);
  registry->RegisterCFunction(fast_toggle_timer_ref_);

  registry->Register(SlowToggleImmediateRef);
  registry->RegisterCFunction(fast_toggle_immediate_ref_);
}
