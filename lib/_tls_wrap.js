...
function TLSSocket(socket, options) {
  ...
  net.Socket.call(this, {
    handle: this._wrapHandle(socket ? socket._handle : createTCP()),
...
TLSSocket.prototype._wrapHandle = function(handle) {
  ...
  // Proxy HandleWrap and TCPWrap methods
  // TODO(indutny): Do we want to support Pipes and TTYs?
  tcpMethods.forEach(function(name) {
