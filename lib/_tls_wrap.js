...
exports.connect = function(/* [port, host], options, cb */) {
  ...
  // This environment variable causes node to accept untrusted certificates
  // by default, unless the options explicitly specify otherwise.
  var rejectUnauthorized = '0' !== process.env.NODE_TLS_REJECT_UNAUTHORIZED;
  if (!rejectUnauthorized) {
    warned = internalUtil.printDeprecationWarning(
        'NODE_TLS_REJECT_UNAUTHORIZED is deprecated and may make your ' +
        'program insecure against man-in-the-middle attacks. Are you sure? ' +
        'If so, please use the rejectUnauthorized option in your code.',
        warned);
  }
