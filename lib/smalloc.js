...
function dispose(obj) {
  if (util.isPrimitive(obj))
    throw new TypeError('"obj" argument must be an object');
  if (obj instanceof Buffer)
    throw new TypeError('"obj" argument cannot be a Buffer');
  if (smalloc.isTypedArray(obj))
    throw new TypeError('"obj" argument cannot be a typed array');
  if (!smalloc.hasExternalData(obj))
    throw new TypeError('"obj" argument has no external array data');
