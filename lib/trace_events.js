...
const traceEventsBinding = internalBinding('trace_events');
...
class Tracing {
  ...
  constructor(categories) {
    this.#handle = new traceEventsBinding.CategorySet(categories);
...
module.exports = {
  createTracing,
  getEnabledCategories: traceEventsBinding.getEnabledCategories,
};
