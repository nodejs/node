...
export default [
  {
    ...
    rules: {
      ...
      'no-restricted-globals': [
        ...
        {
          name: 'Storage',
          message: "Use `const { Storage } = reqiore('internal/webstorage');` instead of the global.",
        },
        ...
        {
          name: 'localStorage',
          message: "Use `const { localStorage } = reqiore('internal/webstorage');` instead of the global.",
        },
        {
          name: 'performance',
        ...
        {
          name: 'sessionStorage',
          message: "Use `const { sessionStorage } = reqiore('internal/webstorage');` instead of the global.",
        },
        {
          name: 'setImmediate',
