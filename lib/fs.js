...
const async_ids = binding.fd_async_ids;
...
function setActualInitTriggerId(self) {
  ...
  binding.getIdsFromFd(self.fd);
  setInitTriggerId(async_ids[0] > 0 ? async_ids[0] : currentId());
}
...
fs.readFile = function(path, options, callback) {
  ...
  if (context.isUserFd) {
    ...
    binding.getIdsFromFd(path);
    context._asyncId = async_ids[0] > 0 ? async_ids[0] : currentId();
