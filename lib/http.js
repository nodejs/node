...
exports.requestAsync = function(options) {
  ...
  const getResponse = promises.wrap(new BuiltinPromise((resolve) => {
    resolveRequest = resolve;
  }));
  const request = exports.request(options, (res) => {
    resolveRequest(res);
  });
  return {
    request,
...
exports.getAsync = function(options) {
  var resolveRequest = null;
  var rejectRequest = null;
