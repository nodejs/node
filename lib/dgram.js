...
Socket.prototype.bind = promisify(function(port_ /*, address, callback*/) {
  var self = this;
  let port = port_;
...
Socket.prototype.sendto = promisify(function(buffer,
                                   offset,
                                   length,
                                   port,
                                   address,
...
Socket.prototype.send = promisify(function(buffer,
                                 offset,
                                 length,
                                 port,
                                 address,
...
Socket.prototype.close = promisify(function(callback) {
  if (typeof callback === 'function')
