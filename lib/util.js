...
function _deepEqual(a, b, strict) {
  ...
  if (a === b) {
    ...
    return process.binding('buffer').compare(a, b) === 0;
  ...
  // coercive equivalence is determined by ==,
  // strict equivalence is determined by ===.
  ...
  // corresponding key, and if strict - an identical 'prototype' property.
  // Note: this accounts for both named and indexed properties on Arrays.
  } else {
    return objEquiv(a, b, strict);
  }
}
