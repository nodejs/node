...
exports.debuglog = require('internal/debuglog');
exports.deprecate = internalUtil._deprecate;
exports.format = require('internal/format');
...
exports._extend = require('internal/extend');
exports.inherits = require('internal/inherits');
...
// XXX(bnoordhuis) I think these can just be removed.
exports._errnoException = require('internal/errno_exception');
exports._exceptionWithHostPort = require('internal/exception_with_host_port');
