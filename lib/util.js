...
exports.inherits = function(ctor, superCtor) {
  ...
  if (ctor === undefined || ctor === null)
    throw new I18N.TypeError(I18N.UTIL_INHERITS_CONSTRUCTOR);

  if (superCtor === undefined || superCtor === null)
    throw new I18N.TypeError(I18N.UTIL_INHERITS_SUPER_CONSTRUCTOR);

  if (superCtor.prototype === undefined)
    throw new I18N.TypeError(I18N.UTIL_INHERITS_SUPER_CONSTRUCTOR_PROTOTYPE);
...
}, I18N(I18N.UTIL_PRINT_DEPRECATED));
...
}, I18N(I18N.UTIL_PUTS_DEPRECATED));


exports.debug = internalUtil.deprecate(function(x) {
  process.stderr.write('DEBUG: ' + x + '\n');
}, I18N(I18N.UTIL_DEBUG_DEPRECATED));
...
}, I18N(I18N.UTIL_ERROR_DEPRECATED));
...
exports._exceptionWithHostPort = function(err,
  ...
  if (additional) {
    details += ` - ${I18N(I18N.UTIL_LOCAL)} (${additional})`;
  }
