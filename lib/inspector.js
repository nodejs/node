...
const NodeNetwork = {
  requestWillBeSent: (params) => emit('NodeNetwork.requestWillBeSent', params),
  responseReceived: (params) => emit('NodeNetwork.responseReceived', params),
  loadingFinished: (params) => emit('NodeNetwork.loadingFinished', params),
};
