...
let dcSubscribeChannel;
let dcUnsubscribeChannel;
let dcPublishChannel;
...
class ActiveChannel {
  subscribe(subscription) {
    ...
    if (dcSubscribeChannel.hasSubscribers) {
      dcSubscribeChannel._publish({ channel: this, subscription });
    }
  ...
  unsubscribe(subscription) {
    if (dcUnsubscribeChannel.hasSubscribers) {
      dcUnsubscribeChannel._publish({ channel: this, subscription });
    }
...
dcSubscribeChannel = channel('diagnostics_channel.subscribe');
dcUnsubscribeChannel = channel('diagnostics_channel.unsubscribe');
dcPublishChannel = channel('diagnostics_channel.publish');
