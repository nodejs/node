...
const unsafeProtocol = /^(javascript):?$/;
// protocols that never have a hostname.
const hostlessProtocol = /^(javascript):?$/;
// protocols that always contain a // bit.
const slashedProtocol = /^(https?|ftp|gopher|file):?$/;
...
Url.prototype.parse = function(url, parseQueryString, slashesDenoteHost) {
  ...
  if (slashesDenoteHost || proto || hostPattern.test(rest)) {
    ...
    if (slashes && !(proto && hostlessProtocol.test(proto))) {
      rest = rest.slice(2);
      this.slashes = true;
    }
  }

  if (!hostlessProtocol.test(proto) &&
      (slashes || (proto && !slashedProtocol.test(proto)))) {
  ...
  if (!unsafeProtocol.test(lowerProto)) {
  ...
  if (slashedProtocol.test(lowerProto) &&
...
Url.prototype.format = function() {
  ...
  if (this.slashes || slashedProtocol.test(protocol)) {
...
Url.prototype.resolveObject = function(relative) {
  ...
  if (relative.slashes && !relative.protocol) {
    ...
    if (slashedProtocol.test(result.protocol) &&
  ...
  if (relative.protocol && relative.protocol !== result.protocol) {
    ...
    if (!slashedProtocol.test(relative.protocol)) {
    ...
    if (!relative.host &&
        ...
        !hostlessProtocol.test(relative.protocol)) {
  ...
  var psychotic = result.protocol && !slashedProtocol.test(result.protocol);
