...
// move the static NULL pointer buffer to `exports` instead of `Buffer.prototype`
exports.NULL = NativeBuffer.prototype.NULL;
delete NativeBuffer.prototype.NULL;
...
Buffer.prototype.address = function address(offset) {
  offset = offset >>> 0;
  return binding.address(this, offset);
};


Buffer.prototype.isNull = function isNull(offset) {
  offset = offset >>> 0;
  return binding.isNull(this, offset);
};
...
Buffer.prototype.readPointerLE = function readPointerLE(offset, length, noAssert) {
  offset = offset >>> 0;
  return binding.readPointerLE(this, offset, length);
};


Buffer.prototype.readPointerBE = function readPointerBE(offset, length, noAssert) {
  offset = offset >>> 0;
  return binding.readPointerBE(this, offset, length);
};
