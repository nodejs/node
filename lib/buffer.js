...
function Buffer(arg, encoding) {
  ...
  if (typeof arg === 'number') {
    if (typeof encoding === 'string')
      throw new I18N.Error(I18N.BUFFER_ENCODING_STR);
...
function fromObject(obj) {
  ...
  if (obj !== null && obj !== undefined) {
    if (obj instanceof ArrayBuffer) {
    ...
    } else if (obj.buffer instanceof ArrayBuffer || obj.length) {
      var length;
      ...
      return b;
    } else if (obj.type === 'Buffer' && Array.isArray(obj.data)) {
      var array = obj.data;
  ...
  throw new I18N.TypeError(I18N.BUFFER_INVALID_ARG, 'obj');
}
...
Buffer.compare = function compare(a, b) {
  if (!(a instanceof Buffer) ||
      !(b instanceof Buffer)) {
    throw new I18N.TypeError(I18N.BUFFER_INVALID_ARGS);
  }
...
Buffer.concat = function(list, length) {
  if (!Array.isArray(list))
    throw new I18N.TypeError(I18N.INVALID_ARG_TYPE, 'list', 'Buffer[]');
...
Buffer.prototype.toString = function() {
  ...
  if (result === undefined)
    throw new I18N.Error(I18N.BUFFER_TOSTRING_FAILED);
  return result;
};
...
Buffer.prototype.equals = function equals(b) {
  if (!(b instanceof Buffer))
    throw new I18N.TypeError(I18N.INVALID_ARG_TYPE, 'b', 'Buffer');
...
Buffer.prototype.compare = function compare(b) {
  if (!(b instanceof Buffer))
    throw new I18N.Error(I18N.INVALID_ARG_TYPE, 'b', 'Buffer');
...
Buffer.prototype.indexOf = function indexOf(val, byteOffset, encoding) {
  ...
  throw new I18N.TypeError(I18N.BUFFER_INVALID_ARG2, 'val');
};
...
Buffer.prototype.fill = function fill(val, start, end) {
  ...
  if (start < 0 || end > this.length)
    throw new I18N.RangeError(I18N.INDEX_OUT_OF_RANGE);
  if (end <= start)
    return this;
...
const writeMsg = I18N(I18N.BUFFER_WRITE_DEPRECATED);
Buffer.prototype.write = function(string, offset, length, encoding) {
  ...
  if (string.length > 0 && (length < 0 || offset < 0))
    throw new I18N.RangeError(I18N.OUT_OF_BOUNDS_WRITE);
...
function checkInt(buffer, value, offset, ext, max, min) {
  if (!(buffer instanceof Buffer))
    throw new I18N.TypeError(I18N.INVALID_ARG_TYPE, 'buffer', 'Buffer');
  if (value > max || value < min)
    throw new I18N.TypeError(I18N.BUFFER_OUTOFBOUNDS_ARG, 'value');
