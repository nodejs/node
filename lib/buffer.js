...
function Buffer(arg, encoding) {
  ...
  if (typeof arg === 'number') {
    if (typeof encoding === 'string')
      throw I18N.Error(I18N.BUFFER_ENCODING_STR);
...
function fromObject(obj) {
  ...
  throw I18N.TypeError(I18N.BUFFER_INVALID_ARG, 'obj');
}
...
Buffer.compare = function compare(a, b) {
  if (!(a instanceof Buffer) ||
      !(b instanceof Buffer)) {
    throw I18N.TypeError(I18N.BUFFER_INVALID_ARGS);
  }
...
Buffer.concat = function(list, length) {
  if (!Array.isArray(list))
    throw I18N.TypeError(I18N.INVALID_ARG_TYPE, 'list', 'Buffer[]');
...
Buffer.prototype.toString = function() {
  ...
  if (result === undefined)
    throw I18N.Error(I18N.BUFFER_TOSTRING_FAILED);
  return result;
};
...
Buffer.prototype.equals = function equals(b) {
  if (!(b instanceof Buffer))
    throw I18N.TypeError(I18N.INVALID_ARG_TYPE, 'b', 'Buffer');
...
Buffer.prototype.compare = function compare(b) {
  if (!(b instanceof Buffer))
    throw I18N.Error(I18N.INVALID_ARG_TYPE, 'b', 'Buffer');
...
Buffer.prototype.indexOf = function indexOf(val, byteOffset, encoding) {
  ...
  throw I18N.TypeError(I18N.BUFFER_INVALID_ARG2, 'val');
};
...
Buffer.prototype.fill = function fill(val, start, end) {
  ...
  if (start < 0 || end > this.length)
    throw I18N.RangeError(I18N.INDEX_OUT_OF_RANGE);
  if (end <= start)
    return this;
...
Buffer.prototype.write = function(string, offset, length, encoding) {
  ...
  if (string.length > 0 && (length < 0 || offset < 0))
    throw I18N.RangeError(I18N.OUT_OF_BOUNDS_WRITE);
...
function checkInt(buffer, value, offset, ext, max, min) {
  if (!(buffer instanceof Buffer))
    throw I18N.TypeError(I18N.INVALID_ARG_TYPE, 'buffer', 'Buffer');
  if (value > max || value < min)
    throw I18N.TypeError(I18N.BUFFER_OUTOFBOUNDS_ARG, 'value');
