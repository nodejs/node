...
/**
 * Returns the named VirtualFileSystem instances currently mounted in this
 * thread, keyed by name. Where several share a name, the earliest mounted
 * one is used.
 * @returns {Record<string, VirtualFileSystem>}
 */
function mounted() {
  return require('internal/vfs/setup').getNamedMounts();
}
