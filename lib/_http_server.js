...
function connectionListener(socket) {
  ...
  function serverSocketCloseListener() {
    debug(I18N.HTTP_SERVER_DEBUG_SOCKET_CLOSE);
  ...
  debug(I18N.HTTP_SERVER_DEBUG_NEW_CONNECTION);
  ...
  function socketOnData(d) {
    ...
    debug(I18N.HTTP_SERVER_DEBUG_SOCKETONDATA, d.length);
  ...
  function onParserExecute(ret, d) {
    debug(I18N.HTTP_SERVER_DEBUG_SOCKETONPARSEREXECUTE, ret);
  ...
  function onParserExecuteCommon(ret, d) {
    if (ret instanceof Error) {
      ...
      debug(I18N.HTTP_SERVER_DEBUG_UPGRADE_OR_CONNECT, req.method);
      ...
      if (EventEmitter.listenerCount(self, eventName) > 0) {
        debug(I18N.HTTP_SERVER_DEBUG_HAVE_LISTENER, eventName);
    ...
    if (socket._paused && socket.parser) {
      ...
      debug(I18N.HTTP_SERVER_DEBUG_PAUSE_PARSER);
      socket.parser.pause();
    }
  }
