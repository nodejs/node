...
QueryString.unescapeBuffer = function unescapeBuffer(s, decodeSpaces) {
...
QueryString.escape = function escape(str) {
...
QueryString.stringify = QueryString.encode = function stringify(obj,
                                                                sep,
                                                                eq,
                                                                options) {
  sep = sep || '&';
...
QueryString.parse = QueryString.decode = function parse(qs, sep, eq, options) {
  sep = sep || '&';
  eq = eq || '=';
