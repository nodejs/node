...
function Interface(input, output, completer, terminal) {
  ...
  if (completer && typeof completer !== 'function')
    throw new I18N.TypeError(I18N.FUNCTION_REQUIRED, 'completer');

  if (typeof historySize !== 'number' ||
      isNaN(historySize) ||
      historySize < 0) {
    throw new I18N.TypeError(I18N.ARGUMENT_POSITIVE_NUMBER, 'historySize');
  }
...
Interface.prototype._writeToOutput = function _writeToOutput(stringToWrite) {
  if (typeof stringToWrite !== 'string')
    throw I18N.TypeErrir(I18N.INVALID_ARG_TYPE, 'stringToWrite', 'string');
...
function cursorTo(stream, x, y) {
  ...
  if (typeof x !== 'number')
    throw new I18N.Error(I18N.READLINE_CANNOT_SET_COL);
