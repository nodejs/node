...
function Interface(input, output, completer, terminal) {
  ...
  if (completer && typeof completer !== 'function')
    throw I18N.TypeError(I18N.FUNCTION_REQUIRED, 'completer');

  if (typeof historySize !== 'number' ||
      isNaN(historySize) ||
      historySize < 0) {
    throw I18N.TypeError(I18N.ARGUMENT_POSITIVE_NUMBER, 'historySize');
  }
...
function cursorTo(stream, x, y) {
  ...
  if (typeof x !== 'number')
    throw I18N.Error(I18N.READLINE_CANNOT_SET_COL);
