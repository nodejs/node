...
function getDecoder(decoder, encoding) {
  ...
  assert(decoder.encoding === encoding,
         I18N(I18N.CRYPTO_CANNOT_CHANGE_ENCODING));
  return decoder;
}
...
Sign.prototype.sign = function(options, encoding) {
  if (!options)
    throw new I18N.Error(I18N.CRYPTO_NO_KEY);
...
function DiffieHellman(sizeOrKey, keyEncoding, generator, genEncoding) {
  ...
  if (!(sizeOrKey instanceof Buffer) &&
    ...
    throw new I18N.TypeError(I18N.BUFFER_INVALID_ARG2, 'sizeOrKey');
...
function ECDH(curve) {
  if (typeof curve !== 'string')
    throw new I18N.TypeError(I18N.INVALID_ARG_TYPE, 'curve', 'string');
...
ECDH.prototype.getPublicKey = function getPublicKey(encoding, format) {
  ...
  if (format) {
    ...
    // Default
      ...
      throw new I18N.TypeError(I18N.CRYPTO_BAD_FORMAT, format);
  } else {
    f = constants.POINT_CONVERSION_UNCOMPRESSED;
  }
...
exports.setEngine = function setEngine(id, flags) {
  if (typeof id !== 'string')
    throw new I18N.TypeError(I18N.INVALID_ARG_TYPE, 'id', 'string');

  if (flags && typeof flags !== 'number')
    throw new I18N.TypeError(I18N.INVALID_ARG_TYPE, 'flags', 'number');
  flags = flags >>> 0;
...
exports.__defineGetter__('createCredentials',
  ...
  }, I18N(I18N.CRYPTO_CREATECREDENTIALS_DEPRECATED)));

exports.__defineGetter__('Credentials', internalUtil.deprecate(function() {
  return require('tls').SecureContext;
}, I18N(I18N.CRYPTO_CREDENTIALS_DEPRECATED)));
