...
function ECDH(curve) {
  if (typeof curve !== 'string')
    throw new errors.TypeError('INVALIDARG', 'curve', 'string');
...
ECDH.prototype.getPublicKey = function getPublicKey(encoding, format) {
  ...
  if (format) {
    ...
    // Default
      ...
      throw new errors.TypeError('INVALIDARGVALUE', 'format', format);
  } else {
    f = constants.POINT_CONVERSION_UNCOMPRESSED;
  }
...
exports.setEngine = function setEngine(id, flags) {
  if (typeof id !== 'string')
    throw new errors.TypeError('INVALIDARG', 'id', 'string');

  if (flags && typeof flags !== 'number')
    throw new errors.TypeError('INVALIDARG', 'flags', 'number');
  flags = flags >>> 0;
