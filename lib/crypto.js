...
exports.randomBytes = util._deprecateSync(randomBytes,
    '`crypto.randomBytes(size)` is deprecated. ' +
    'Please use `crypto.randomBytesSync(size)` instead.');
exports.randomBytesSync = randomBytes;
exports.pseudoRandomBytes = util.deprecate(randomBytes,
    '`crypto.pseudoRandomBytes()` is deprecated. ' +
    'Please use `crypto.randomBytes()` instead.');

exports.rng = util._deprecateSync(randomBytes,
    '`crypto.rng(size)` is deprecated. ' +
    'Please use `crypto.rngSync(size)` instead.');
