...
exports.lookup = function lookup(hostname, options, callback) {
  ...
  if (hostname && typeof hostname !== 'string') {
    throw new errors.TypeError('INVALIDARG', 'hostname', ['string', 'falsy']);
    ...
    if (hints !== 0 &&
      ...
      throw new errors.TypeError('INVALIDOPTVALUE', 'hints');
    }
  } else {
    family = options >>> 0;
  }
  ...
  if (family !== 0 && family !== 4 && family !== 6) {
    throw new errors.TypeError('INVALIDFAMILY');
  }
...
exports.lookupService = function(host, port, callback) {
  ...
  if (isIP(host) === 0)
    throw new errors.TypeError('INVALIDARG', 'host', 'valid IP address');

  if (port == null || !isLegalPort(port))
    throw new errors.TypeError('PORTRANGE');
