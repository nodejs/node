...
exports.lookup = function lookup(hostname, options, callback) {
  ...
  if (hostname && typeof hostname !== 'string') {
    throw new I18N.TypeError(I18N.INVALID_ARG_TYPE, 'hostname', 'string');
    ...
    if (hints !== 0 &&
      ...
      throw new I18N.TypeError(I18N.DNS_HINTS_VALUE, 'hints');
    }
  } else {
    family = options >>> 0;
  }
  ...
  if (family !== 0 && family !== 4 && family !== 6)
    throw new I18N.TypeError(I18N.DNS_FAMILY_VALUE, 'family');
...
exports.lookupService = function(host, port, callback) {
  if (arguments.length !== 3)
    throw new I18N.Error(I18N.DNS_INVALID_ARGUMENTS);

  if (cares.isIP(host) === 0)
    throw new I18N.TypeError(I18N.DNS_VALID_ID, 'host');
...
function resolver(bindingName) {
  ...
  return function query(name, callback) {
    if (typeof name !== 'string') {
      throw new I18N.Error(I18N.INVALID_ARG_TYPE, 'name', 'string');
    } else if (typeof callback !== 'function') {
      throw new I18N.Error(I18N.FUNCTION_REQUIRED, 'callback');
    }
...
exports.resolve = function(hostname, type_, callback_) {
  ...
  if (typeof type_ === 'string') {
    ...
    throw new I18N.Error(I18N.INVALID_ARG_TYPE, 'type', 'string');
  }

  if (typeof resolver === 'function') {
    return resolver(hostname, callback);
  } else {
    throw new I18N.Error(I18N.DNS_UNKNOWN_TYPE, type_);
  }
};
...
exports.setServers = function(servers) {
  ...
  servers.forEach(function(serv) {
    ...
    throw new I18N.Error(I18N.DNS_MALFORMED_IP, serv);
  });
  ...
  if (r) {
    ...
    throw new I18N.Error(I18N.DNS_FAILED_TO_SET_SERVERS, err, servers);
  }
};
