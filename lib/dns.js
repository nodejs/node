...
exports.lookupService = promisify(function(host, port, callback) {
...
function resolver(bindingName) {
  ...
  return promisify(function query(name, callback) {
...
exports.resolve = promisify(function(hostname, type_, callback_) {
