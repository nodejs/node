...
function inspectWithNoCustomRetry(obj, options) {
  ...
  try {
    ...
    return utilInspect.inspect(obj, { __proto__: null, ...options, customInspect: false });
  }
}
...
function determineSpecificType(value) {
  ...
  if (typeof value === 'object') {
    ...
    return `${lazyInternalUtilInspect().inspect(value, { __proto__: null, depth: -1 })}`;
  }
  let inspected = lazyInternalUtilInspect()
    .inspect(value, { __proto__: null, colors: false });
