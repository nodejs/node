...
E('ERR_INVALID_PROTOCOL',
  ...
  TypeError);
E('ERR_INVALID_PROTOCOL_WITH_SOCKET_PATH', (actual, expected) => {
  return `Protocol "${actual}" not supported with socketPath` +
  `. Expected ${oneOf(expected, 'protocol')}`;
}, TypeError);
...
E('ERR_INVALID_URL_OBJECT_TO_FORMAT_BOTH_HOST_SOCKET',
  'URL scheme not support host and socketPath simultaneous.', TypeError);
