...
E('ERR_CONSTRUCT_CALL_INVALID', 'Constructor cannot be called', TypeError);
E('ERR_CONSTRUCT_CALL_REQUIRED', 'Cannot call constructor without `new`', TypeError);
...
E('ERR_DLOPEN_FAILED', 'DLOpen failed', Error);
...
E('ERR_EXECUTION_ENVIRONMENT_NOT_AVAILABLE',
  'Context not associated with Node.js environment', Error);
...
E('ERR_LOAD_SQLITE_EXTENSION', 'Failed to load SQLite extension', Error);
E('ERR_MEMORY_ALLOCATION_FAILED', 'Failed to allocate memory', Error);
...
E('ERR_NON_CONTEXT_AWARE_DISABLED', 'Loading non context-aware native addons has been disabled', Error);
...
E('ERR_WASI_NOT_STARTED', 'wasi.start() has not been called', Error);
