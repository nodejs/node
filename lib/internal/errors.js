...
E('ERR_BENCHMARK_CLOCK_PRECISION', 'insufficient clock precision for short benchmark', Error);
E('ERR_BENCHMARK_END_CALLED_MORE_THAN_ONCE', 'Called end multiple times', Error);
E('ERR_BENCHMARK_HTTP_BENCHMARKER_NOT_INSTALLED', '%s', Error);
E('ERR_BENCHMARK_HTTP_BENCHMARKER_NOT_SUPPROTED', '%s', Error);
E('ERR_BENCHMARK_HTTP_COULD_NOT_LOCATE_BENCHMARKER', '%s', Error);
E('ERR_BENCHMARK_HTTP_STRANGE_OUTPUT', '%s', Error);
E('ERR_BENCHMARK_HTTP_UNKNOWN_OUTPUT', '%s', Error);
E('ERR_BENCHMARK_INVALID_OPERATION_COUNT', 'called end() with operation count <= 0', RangeError);
E('ERR_BENCHMARK_NO_OPERATION_COUNT', 'called end() without specifying operation count', Error);
E('ERR_BENCHMARK_START_CALLED_MORE_THAN_ONCE', 'Called start more than once in a single benchmark', Error);
E('ERR_BENCHMARK_START_NOT_CALLED', 'called end without start', Error);
