...
converters.ArrayBufferView = (V, options = kEmptyObject) => {
  if (!ArrayBufferIsView(V)) {
    throw makeException('is not an ArrayBufferView.', options);
  }
  validateBufferSourceBacking(getViewedArrayBuffer(V), options);
  return V;
};
