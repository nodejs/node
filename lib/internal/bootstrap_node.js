...
(function(process) {
  ...
  function preloadModules() {
    if (process._preload_modules) {
      ...
      if (process.moduleWrap) {
        NativeModule.preloadModuleWrap = process.moduleWrap;
        delete process.moduleWrap;
      }
    }
  }
  ...
  NativeModule.prototype.compile = function() {
    ...
    if (NativeModule.preloadModuleWrap !== null) {
      source = NativeModule.preloadModuleWrap(source, this.filename);
    }
