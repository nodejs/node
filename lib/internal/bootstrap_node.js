...
(function(process) {
  ...
  NativeModule.require = function(id) {
    ...
    if (!NativeModule.exists(id)) {
      const err = new Error(`No such native module ${id}`);
      // Cannot depend on internal/errors here, set manually.
      // Note, these are not set as read only accessors whereas
      // in internal/errors they are set to be read only.
      err.name = 'Error[ENOMODULE]';
      err.code = err.errno = 'ENOMODULE';
      throw err;
    }
