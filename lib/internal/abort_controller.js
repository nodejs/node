...
function customInspect(self, obj, depth, options) {
  ...
  const opts = ObjectAssign({ __proto__: null }, options, {
    __proto__: null,
...
class AbortSignal extends EventTarget {
  ...
  static abort(
    ...
    return createAbortSignal({ __proto__: null, aborted: true, reason });
  }
  ...
  static any(signals) {
    ...
    const resultSignal = createAbortSignal({ __proto__: null, composite: true });
    if (!signals.length) {
      return resultSignal;
    }
  ...
  [kTransfer]() {
    ...
    if (aborted) {
      ...
      return {
        __proto__: null,
        data: { __proto__: null, aborted, reason },
...
function ClonedAbortSignal() {
  return createAbortSignal({ __proto__: null, transferable: true });
}
...
class AbortController {
  ...
  static [kMakeTransferable]() {
    ...
    controller.#signal = createAbortSignal({ __proto__: null, transferable: true });
    return controller;
  }
}
...
async function aborted(signal, resource) {
  ...
  validateObject(resource, 'resource', { __proto__: null, nullable: false, allowFunction: true, allowArray: true });
  if (signal.aborted)
    return PromiseResolve();
  const abortPromise = createDeferredPromise();
  signal.addEventListener('abort', abortPromise.resolve, { __proto__: null, [kWeakHandler]: resource, once: true });
