...
class ReadableStream {
   ...
   */
  constructor(source = { __proto__: null }, strategy = kEmptyObject) {
    if (source === null)
  ...
  getReader(options = kEmptyObject) {
    if (!isReadableStream(this))
      throw new ERR_INVALID_THIS('ReadableStream');
    validateObject(options, 'options', { __proto__: null, nullable: true, allowFunction: true });
  ...
  values(options = kEmptyObject) {
    ...
    function nextSteps() {
      if (done)
        return PromiseResolve({ __proto__: null, done: true, value: undefined });
      ...
      readableStreamDefaultReaderRead(reader, {
        ...
        [kChunk](chunk) {
          current = undefined;
          promise.resolve({ __proto__: null, value: chunk, done: false });
        },
        [kClose]() {
          current = undefined;
          done = true;
          readableStreamReaderGenericRelease(reader);
          promise.resolve({ __proto__: null, done: true, value: undefined });
        },
        [kError](error) {
          current = undefined;
          done = true;
  ...
  [kTransfer]() {
    ...
    return {
      __proto__: null,
      data: { __proto__: null, port: this[kState].transfer.port2 },
      deserializeInfo:
...
class DefaultReadRequest {
  ...
  [kChunk](value) {
    this[kState].resolve?.({ __proto__: null, value, done: false });
  }

  [kClose]() {
    this[kState].resolve?.({ __proto__: null, value: undefined, done: true });
  }
...
class ReadIntoRequest {
  ...
  [kClose](value) {
    this[kState].resolve?.({ __proto__: null, value, done: true });
  }
...
class ReadableStreamDefaultController {
  ...
  [kInspect](depth, options) {
    return customInspect(depth, options, this[kType], { __proto__: null });
  }
}
...
function readableStreamPipeTo(
  ...
  if (signal !== undefined) {
    ...
    signal.addEventListener('abort', abortAlgorithm, { __proto__: null, once: true });
  }
