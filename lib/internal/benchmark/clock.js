...
const {
  codes: { ERR_BENCHMARK_MISSING_OPERATION },
...
class ManagedTimer {
  ...
  [kUnmanagedTimerResult]() {
    if (this.#start === undefined)
      throw new ERR_BENCHMARK_MISSING_OPERATION('You forgot to call .start()');

    if (this.#end === undefined)
      throw new ERR_BENCHMARK_MISSING_OPERATION('You forgot to call .end(count)');
