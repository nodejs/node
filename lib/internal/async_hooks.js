...
const topLevelResource = { __proto__: null };
...
function inspectExceptionValue(e) {
  ...
  return { __proto__: null, message: inspect(e) };
}
...
module.exports = {
  ...
  getHookArrays,
  symbols: {
    __proto__: null, async_id_symbol, trigger_async_id_symbol,
    init_symbol, before_symbol, after_symbol, destroy_symbol,
    promise_resolve_symbol, owner_symbol,
  },
  constants: {
    __proto__: null, kInit, kBefore, kAfter, kDestroy, kTotals, kPromiseResolve,
  },
  enableHooks,
  disableHooks,
