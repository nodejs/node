...
const { validateObject, isUint32 } = require('internal/validators');
...
class Blob {
  ...
  constructor(sources = [], options = {}) {
    ...
    let { type = '', endings = 'transparent' } = options;
  ...
  arrayBuffer() {
    ...
    if (this[kArrayBufferPromise]) return this[kArrayBufferPromise];
    ...
    // directly.
    if (ret !== undefined) return PromiseResolve(ret);
    ...
    this[kArrayBufferPromise] = SafePromisePrototypeFinally(
      promise,
