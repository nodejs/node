...
/**
 * Delete every entry in `cache` whose owned string is under `mountPoint`.
 * `byValue: true` tests the entry value instead of the key (used for
 * Module._pathCache whose keys are `request\0parent` tokens).
