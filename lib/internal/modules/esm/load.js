 ...
 * @typedef LoadContext
 * @property {string} [format] Hint possibly returned by `resolve`
 * @property {string | Buffer | ArrayBuffer} [source]
 * @property {Record<string, string>} [importAssertions]
 * @returns {LoadReturn}
 * @typedef LoadReturn
 * @property {string} format
 * @property {string} responseURL
 * @property {Buffer} source
 */
