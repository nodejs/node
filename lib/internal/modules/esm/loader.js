 ...
 * @param {string} moduleURL URL of the module accessing import.meta
 * @returns {function(string): ModuleNamespace} The import.meta.sync function
 */
function createImportMetaSync(loader, moduleURL) {
   ...
   */
  return function sync(specifier) {
    const request = { specifier, phase: kEvaluationPhase, attributes: kEmptyObject, __proto__: null };
    const job = loader.getOrCreateModuleJob(moduleURL, request, kImportInRequiredESM);
