...
class Loader {
  constructor() {
    ...
    this._importMetaCallback = initializeImportMeta;
    this.evalIndex = 0;
  }
  ...
  runGlobalPreloadCode() {
    ...
    const preloadInit = compileFunction(preloadCode, [
    ...
    try {
      preloadInit.call(globalThis, (builtinName) => {
        ...
        this._importMetaCallback = (meta, wrap) => fn(meta, {url: wrap.url}, initializeImportMeta);
      });
    } finally {
      finished = true;
    }
