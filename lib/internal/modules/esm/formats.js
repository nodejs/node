...
/**
 * For extensionless files in a `module` package scope, or a default `module` scope enabled by the `--experimental-type`
 * flag, we check the file contents to disambiguate between ES module JavaScript and Wasm.
