...
const { init: cjsInit, parse: cjsParse } =
  require('internal/deps/cjs-module-lexer/dist/lexer');

let cjsParserInitialized = false;
...
translators.set('commonjs', async function commonjsStrategy(url, isMain) {
  ...
  if (!cjsParserInitialized) {
    await cjsInit();
    cjsParserInitialized = true;
  }
...
function cjsPreparseModuleExports(filename) {
  ...
  const exportNames = new SafeSet(esModule ? exports : []);
