...
function defaultGetSource({ url, format, defaultGetSource }) {
...
translators.set('module', async function moduleStrategy(url) {
  ...
  source = await this._transformSource(
    { url, format: 'module', source, defaultTransformSource });
...
translators.set('json', async function jsonStrategy(url) {
  ...
  source = await this._transformSource(
    { url, format: 'json', source, defaultTransformSource });
  if (pathname) {
...
translators.set('wasm', async function(url) {
  ...
  source = await this._transformSource(
    { url, format: 'wasm', source, defaultTransformSource });
