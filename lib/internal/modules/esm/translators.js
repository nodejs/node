...
function cjsPreparseModuleExports(filename) {
  ...
  if (module) {
    ...
    if (cached)
      return { __proto__: null, module, exportNames: cached.exportNames };
  }
  ...
  cjsParseCache.set(module, { __proto__: null, source, exportNames, loaded });
  ...
  return { __proto__: null, module, exportNames };
}
