...
async function initializeHooks() {
  ...
  class ModuleLoader extends DefaultModuleLoader {
    async asyncGetModuleJob(specifier, parentURL, importAssertions) {
    ...
    getModuleJob(specifier, parentURL, importAssertions) {
      const jobPromise = this.asyncGetModuleJob(specifier, parentURL, importAssertions);
      return {
        async run() { return (await jobPromise).run(); },
        get modulePromise() {
