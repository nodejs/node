...
async function importModuleDynamicallyCallback(referrerSymbol, specifier, phase, attributes,
  ...
  if (referrerSymbol === vm_dynamic_import_main_context_default) {
    ...
    // TODO: Discover why this is needed for vm to error with the correct code when esm/defaultLoad
    // is sync. @see https://github.com/nodejs/node/pull/57419#discussion_r2027158688
    if (referrerName === 'node:internal/process/task_queues') { referrerName = undefined; }
