...
class HooksProxy {
  ...
  #unwrapMessage(response) {
    if (!response || !response.message || !response.message.body) {
      ...
      const exception = response.message.body.error;
      exception.stack = response.message.body.stack;
      exception.code = response.message.body.code;
      exception.cause = response.message.body.cause;
      throw exception;
    } else {
