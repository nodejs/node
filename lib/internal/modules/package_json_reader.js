 ...
 * @param {URL['href'] | URL['pathname']} parentURL The location of the current module (ex file://tmp/foo.js).
 */
function findPackageJSON(specifier, parentURL) {
  validateString(specifier, 'specifier');
  validateURLString(parentURL, 'parentURL');
  ...
  const { url: resolvedTarget } = cascadedLoader.resolve(specifier, parentURL, pjsonImportAttributes);
