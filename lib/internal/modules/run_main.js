 ...
 * exposed publicly as `runMain`, and we don't want to expose this functionality to userland
 * as setting the command main is an internal-only capability.
 *
...
function executeUserEntryPointCommand () {
