...
function runMainESM(mainPath) {
  ...
  const importMapFlagValue = getOptionValue('--experimental-import-map');
  ...
  handleMainPromise(loadESM(async (esmLoader) => {
    ...
    if (importMapFlagValue) {
      ...
      const importMapSpecifier = await esmLoader.resolve(importMapFlagValue, parentURL.href, importAttributes);
