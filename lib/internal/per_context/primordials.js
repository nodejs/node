...
[
  { __proto__: null, name: 'TypedArray', original: Reflect.getPrototypeOf(Uint8Array) },
  { __proto__: null, name: 'ArrayIterator', original: {
    __proto__: null,
    prototype: Reflect.getPrototypeOf(Array.prototype[Symbol.iterator]()),
  } },
  { __proto__: null, name: 'StringIterator', original: {
    __proto__: null,
    ...
    ArrayPrototypeForEach(ReflectOwnKeys(unsafe.prototype), (key) => {
      if (!ReflectGetOwnPropertyDescriptor(safe.prototype, key)) {
        ...
        if (
          ...
          desc.value.length === 0 &&
          SymbolIterator in (FunctionPrototypeCall(desc.value, dummy) ?? { __proto__: null })
        ) {
