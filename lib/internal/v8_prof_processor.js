...
async function linker(specifier, referencingModule) {
  ...
  return new SourceTextModule(code, { __proto__: null, context: referencingModule.context });
}
...
(async () => {
  ...
  const tickprocessorDriver = new SourceTextModule(tickProcessor, { __proto__: null, context });
