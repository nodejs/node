...
const kRemoveListenerHelper = SymbolFor('nodejs.internal.removeListenerHelper');
...
function weakListeners() {
  weakListenersState ??= new SafeFinalizationRegistry(
    ({ eventTarget, listener, eventType }) => eventTarget.deref()?.[kRemoveListenerHelper](eventType, listener),
  );
...
class EventTarget {
  ...
  [kRemoveListenerHelper](type, listenerWrapper) {
    const root = this[kEvents].get(type);
    if (root === undefined || root.next === undefined)
      return;
