...
function InterfaceConstructor(input, output, completer, terminal) {
  ...
  if (signal) {
    ...
    if (signal.aborted) {
      ...
      signal.addEventListener('abort', onAborted, { __proto__: null, once: true });
...
class Interface extends InterfaceConstructor {
  ...
  [kPushToUndoStack](text, cursor) {
    if (ArrayPrototypePush(this[kUndoStack], { __proto__: null, text, cursor }) >
  ...
  [kUndo]() {
    ...
    ArrayPrototypePush(
      this[kRedoStack],
      { __proto__: null, text: this.line, cursor: this.cursor },
    );
  ...
  [kGetDisplayPos](str) {
    ...
    return { __proto__: null, cols, rows };
  }
