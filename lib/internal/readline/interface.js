...
function InterfaceConstructor(input, output, completer, terminal) {
  ...
  this.tabSize = 8;
  // Initialise skipHistory flag
  this[kSkipHistory] = false;
...
class Interface extends InterfaceConstructor {
  ...
  [kAddHistory]() {
    ...
    if (this[kSkipHistory]) {
      this[kSkipHistory] = false; // Reset flag for next time
      return currentLine; // Keep the input but don't store in history
    }
