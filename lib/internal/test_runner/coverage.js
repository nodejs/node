...
class TestCoverage {
  ...
  cleanup() {
    ...
    if (this.originalCoverageDirectory === undefined) {
      delete process[env_private_symbol].NODE_V8_COVERAGE;
      return;
    }

    process[env_private_symbol].NODE_V8_COVERAGE = this.originalCoverageDirectory;
    let dir;
...
function setupCoverage() {
  let originalCoverageDirectory = process[env_private_symbol].NODE_V8_COVERAGE;
  ...
  // child processes.
  process[env_private_symbol].NODE_V8_COVERAGE = coverageDirectory;
