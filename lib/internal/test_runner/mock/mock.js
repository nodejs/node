...
class MockModuleContext {
  ...
  constructor({
    ...
    this.#evictDependents(baseURL);
  }

  #evictDependents(baseURL) {
    const { loadCache } = this.#sharedState.moduleLoader;
    for (const dependent of collectMockDependents(baseURL)) {
      loadCache.delete(dependent);
    }
  }
  ...
  restore() {
    ...
    this.#evictDependents(this.#restore.baseURL);
