  ...
  parse() {
    ...
    this.tokens.forEach((chunk) => {
      ...
      if (type === TokenKind.TAP) {
        ...
        if (chunk.length > 2 && chunk[1].type === TokenKind.WHITESPACE) {
        ...
        // this means we are reading a subtest block
          ...
          chunk.length > 4 &&
          chunk[1].type === TokenKind.WHITESPACE &&
          chunk[2].type === TokenKind.WHITESPACE &&
          chunk[3].type === TokenKind.WHITESPACE
        ) {
