...
const { TIMEOUT_MAX, setTimeout, clearTimeout } = require('internal/timers');
...
function stopTest(timeout, signal) {
  ...
  const timer = setTimeout(() => {
    deferred.reject(new ERR_TEST_FAILURE(
  ...
  deferred.cleanup = () => {
    clearTimeout(timer);
    signal.removeEventListener('abort', deferred.resolve);
  };
