...
class TestContext {
  ...
  test(name, options, fn) {
    ...
    const subtest = this.#test.createSubtest(classDefinitionsPublic.Test, name, options, fn);
...
class Test extends AsyncResource {
  ...
  constructor(options) {
    ...
    if (testNamePatterns !== null) {
      const match = this instanceof classDefinitionsPrivate.TestHook || ArrayPrototypeSome(
        testNamePatterns,
  ...
  createHook(name, fn, options) {
    ...
    const hook = new classDefinitionsPrivate.TestHook(fn, options);
...
const classDefinitionsPrivate = {
  TestHook
};

const classDefinitionsPublic = {
  ItTest,
  Suite,
  Test
};
