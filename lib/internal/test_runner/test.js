...
function lazyAssertObject(harness) {
  if (assertObj === undefined) {
    ...
    if (!assertObj.has('inlineSnapshot')) {
      assertObj.set('inlineSnapshot', harness.snapshotManager.createInlineAssert());
    }
  }
  return assertObj;
}
...
class Test extends AsyncResource {
  ...
  postRun(pendingSubtestsError) {
    ...
    if (this.parent !== null) {
      ...
      harness.snapshotManager?.writeInlineSnapshotFiles();
