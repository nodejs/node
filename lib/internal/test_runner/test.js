...
const kInvalidTestOptions = 'invalidTestOptions';
...
class Test extends AsyncResource {
  ...
  constructor(options) {
    ...
    if (todo != null && !(typeof todo === 'boolean' || typeof todo === 'string'))
      throw new ERR_INVALID_ARG_TYPE('options.todo', ['boolean', 'string'], todo);
