...
const kTestBailedOut = 'testBailedOut';
...
class Test extends AsyncResource {
  ...
  postRun(pendingSubtestsError) {
    ...
    if (this.parent !== null) {
      ...
      // We're reporting the bail into the testStream in order to allow the runner to interrupt the active processes
      if (this.bailed) {
        reporter.bail(this.nesting, this.loc, this.name);
      }
