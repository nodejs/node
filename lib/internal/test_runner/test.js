...
class Test extends AsyncResource {
  ...
  #parseProps(name, options, fn, overrides) {
  ...
  createSubtest(...props) {
    const test = new Test(ReflectApply(this.#parseProps, this, props));
  ...
  createSubSuite(...props) {
    ...
    const suite = new Suite(ReflectApply(this.#parseProps, this, props));
