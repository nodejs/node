'use strict';
const { ReflectConstruct, SafeMap, Symbol } = primordials;

const {
  codes: { ERR_ILLEGAL_CONSTRUCTOR, ERR_INVALID_THIS },
...
const { makeTransferable } = require('internal/worker/js_transferable');
