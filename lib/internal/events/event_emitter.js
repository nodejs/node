...
const { FastEventEmitter, isEventUnsupportedForFastPath } = require('internal/events/fast_event_emitter');
...
EventEmitter.prototype.emit = function emit(type, ...args) {
  ...
  // This can happen when calling emit for function that was not listened to and we are still in the fast path
  // this is to avoid calling object prototype functions
  if (this[kIsFastPath] === true && isEventUnsupportedForFastPath(type) === true) {
    return false;
  }
...
EventEmitter.prototype.removeAllListeners =
    function removeAllListeners(type) {
      this[kImpl].removeAllListeners.apply(this[kImpl], arguments);
      return this;
    };
