...
function writeUIntBE(value, offset, byteLength) {
  switch (byteLength) {
    case 6: return writeU_Int48BE(this, value, offset, 0, 0xffffffffffffff);
...
function writeIntLE(value, offset, byteLength) {
  switch (byteLength) {
    case 6: return writeU_Int48LE(this, value, offset, -0x800000000000,
                                  0x7fffffffffff);
    case 5: return writeU_Int40LE(this, value, offset, -0x8000000000,
                                  0x7fffffffff);
    case 4: return writeU_Int32LE(this, value, offset, -0x80000000,
                                  0x7fffffff);
    case 3: return writeU_Int24LE(this, value, offset, -0x800000,
                                  0x7fffff);
    case 2: return writeU_Int16LE(this, value, offset, -0x8000,
                                  0x7fff);
    case 1: return writeU_Int8(this, value, offset, -0x80,
                               0x7f);
    default: boundsError(byteLength, 6, 'byteLength');
  }
}
...
function writeIntBE(value, offset, byteLength) {
  switch (byteLength) {
    case 6: return writeU_Int48BE(this, value, offset, -0x800000000000,
                                  0x7fffffffffff);
    case 5: return writeU_Int40BE(this, value, offset, -0x8000000000,
                                  0x7fffffffff);
    case 4: return writeU_Int32BE(this, value, offset, -0x80000000,
                                  0x7fffffff);
    case 3: return writeU_Int24BE(this, value, offset, -0x800000,
                                  0x7fffff);
    case 2: return writeU_Int16BE(this, value, offset, -0x8000,
                                  0x7fff);
    case 1: return writeU_Int8(this, value, offset, -0x80,
                               0x7f);
    default: boundsError(byteLength, 6, 'byteLength');
