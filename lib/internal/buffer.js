...
function readInt48LE(buf, offset = 0) {
  ...
  return buf[kIBDV].getUint32(buf.byteOffset + offset, true) +
    buf[kIBDV].getInt16(buf.byteOffset + offset + 4, true) * 2 ** 32;
}
...
function readInt40LE(buf, offset = 0) {
  ...
  return buf[kIBDV].getUint32(buf.byteOffset + offset, true) +
    buf[kIBDV].getInt8(buf.byteOffset + offset + 4) * 2 ** 32;
}
...
function readInt48BE(buf, offset = 0) {
  ...
  return buf[kIBDV].getInt16(buf.byteOffset + offset) * 2 ** 32 +
...
function readInt40BE(buf, offset = 0) {
  ...
  return buf[kIBDV].getInt8(buf.byteOffset + offset) * 2 ** 32 +
...
function writeU_Int40LE(buf, value, offset, min, max) {
  ...
  buf[kIBDV].setUint32(buf.byteOffset + offset, value, true);
  buf[kIBDV].setUint8(buf.byteOffset + offset + 4,
...
function writeU_Int48BE(buf, value, offset, min, max) {
  ...
  buf[kIBDV].setUint16(buf.byteOffset + offset,
                       Math.floor(value * 2 ** 32));
...
function writeU_Int40BE(buf, value, offset, min, max) {
  ...
  buf[kIBDV].setUint8(buf.byteOffset + offset,
                      Math.floor(value * 2 ** 32));
