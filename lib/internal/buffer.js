...
function readBigUInt128LE(offset = 0) {
  checkNumberType(offset);
  if (this.byteLength < offset + 16 || offset < 0)
...
function readBigUInt64LE(offset = 0) {
  checkNumberType(offset);
  if (this.byteLength < offset + 8 || offset < 0)
...
function readUInt48LE(buf, offset = 0) {
  checkNumberType(offset);
  if (buf.byteLength < offset + 6 || offset < 0)
...
function readUInt40LE(buf, offset = 0) {
  checkNumberType(offset);
  if (buf.byteLength < offset + 5 || offset < 0)
...
function readUInt32LE(offset = 0) {
  checkNumberType(offset);
  if (this.byteLength < offset + 4 || offset < 0)
...
function readUInt24LE(buf, offset = 0) {
  checkNumberType(offset);
  if (buf.byteLength < offset + 3 || offset < 0)
...
function readUInt16LE(offset = 0) {
  checkNumberType(offset);
  if (this.byteLength < offset + 2 || offset < 0)
...
function readUInt8(offset = 0) {
  checkNumberType(offset);
  if (this.byteLength < offset + 1 || offset < 0)
...
function readInt8(offset = 0) {
  checkNumberType(offset);
  if (this.byteLength < offset || offset < 0)
    boundsError(offset, this.byteLength - 1);
