...
function readBigUInt128LE(offset = 0) {
  ...
  const dv = gdv(this.buffer);
  return dv.getBigUint64(this.byteOffset + offset + 8, true) +
    (dv.getBigUint64(this.byteOffset + offset, true) << 64n);
}
...
function readBigUInt64LE(offset = 0) {
  ...
  return gdv(this.buffer).getBigUint64(this.byteOffset + offset, true);
}
...
function readUInt48LE(buf, offset = 0) {
  ...
  const dv = gdv(buf.buffer);
  return dv.getUint16(buf.byteOffset + offset, true) +
    dv.getUint32(buf.byteOffset + offset + 2, true) * 2 ** 16;
}
...
function readUInt40LE(buf, offset = 0) {
  ...
  const dv = gdv(buf.buffer);
  return dv.getUint8(buf.byteOffset + offset) +
    dv.getUint32(buf.byteOffset + offset + 1, true) * 2 ** 8;
}
...
function readUInt32LE(offset = 0) {
  ...
  return gdv(this.buffer).getUint32(this.byteOffset + offset, true);
}
...
function readUInt24LE(buf, offset = 0) {
  ...
  const dv = gdv(buf.buffer);
  return dv.getUint8(buf.byteOffset + offset) +
    dv.getUint16(buf.byteOffset + offset + 1, true) * 2 ** 8;
}
...
function readUInt16LE(offset = 0) {
  ...
  return gdv(this.buffer).getUint16(this.byteOffset + offset, true);
}
...
function readBigUInt128BE(offset = 0) {
  ...
  const dv = gdv(this.buffer);
  return dv.getBigUint64(this.byteOffset + offset) +
    (dv.getBigUint64(this.byteOffset + offset + 8) << 64n);
}
...
function readBigUInt64BE(offset = 0) {
  ...
  return gdv(this.buffer).getBigUint64(this.byteOffset + offset);
}
...
function readUInt48BE(buf, offset = 0) {
  ...
  const dv = gdv(buf.buffer);
  return dv.getUint32(buf.byteOffset + offset + 2) +
    dv.getUint16(buf.byteOffset + offset) * 2 * 32;
}
...
function readUInt40BE(buf, offset = 0) {
  ...
  const dv = gdv(buf.buffer);
  return dv.getUint32(buf.byteOffset + offset + 1) +
    dv.getUint8(buf.byteOffset + offset) * 2 * 32;
}
...
function readUInt32BE(offset = 0) {
  ...
  return gdv(this.buffer).getUint32(this.byteOffset + offset);
}
...
function readUInt24BE(buf, offset = 0) {
  ...
  const dv = gdv(buf.buffer);
  return dv.getUint16(buf.byteOffset + offset + 1) +
    dv.getUint8(buf.byteOffset + offset) * 2 ** 16;
}
...
function readUInt16BE(offset = 0) {
  ...
  return gdv(this.buffer).getUint16(this.byteOffset + offset);
}
...
function readBigInt128LE(offset = 0) {
  ...
  const dv = gdv(this.buffer);
  return dv.getBigInt64(this.byteOffset + offset, true) << 64n |
    dv.getBigUint64(this.byteOffset + offset + 8, true);
}
...
function readBigInt64LE(offset = 0) {
  ...
  return gdv(this.buffer).getBigInt64(this.byteOffset + offset, true);
}
...
function readInt48LE(buf, offset = 0) {
  ...
  const dv = gdv(buf.buffer);
  const val = dv.getUint16(buf.byteOffset + offset + 4, true);
  return (val | (val & 2 ** 15) * 0x1fffe) * 2 ** 32 +
    dv.getUint32(buf.byteOffset + offset, true);
}
...
function readInt40LE(buf, offset = 0) {
  ...
  const dv = gdv(buf.buffer);
  const last = dv.getUint8(buf.byteOffset + offset + 4);
...
function readInt32LE(offset = 0) {
  ...
  return gdv(this.buffer).getInt32(this.byteOffset + offset);
}
...
function readInt24LE(buf, offset = 0) {
  ...
  return dv.getUint8(buf.byteOffset + offset + 2) |
    dv.getInt16(buf.byteOffset + offset, true) << 8;
}
...
function readInt16LE(offset = 0) {
  ...
  return gdv(this.buffer).getInt16(this.byteOffset + offset, true);
}
...
function readInt8(offset = 0) {
  ...
  return gdv(this.buffer).getInt8(this.byteOffset + offset);
}
...
function readBigInt128BE(offset = 0) {
  ...
  const dv = gdv(this.buffer);
  return dv.getBigUint64(this.byteOffset + offset) |
    dv.getBigInt64(this.byteOffset + offset + 8) << 64n;
}
...
function readBigInt64BE(offset = 0) {
  ...
  return gdv(this.buffer).getBigInt64(this.byteOffset + offset);
}
...
function readInt48BE(buf, offset = 0) {
  ...
  const dv = gdv(buf.buffer);
  const val = dv.getUint16(buf.byteOffset + offset);
  return (val | (val & 2 ** 15) * 0x1fffe) * 2 ** 32 +
    dv.getUint32(buf.byteOffset + offset + 2);
}
...
function readInt40BE(buf, offset = 0) {
  ...
  const dv = gdv(buf.buffer);
  const first = dv.getUint8(buf.byteOffset + offset);
  return (first | (first & 2 ** 7) * 0x1fffffe) * 2 ** 32 +
    dv.getUint32(buf.byteOffset + offset + 1);
}
...
function readInt16BE(offset = 0) {
  ...
  return gdv(this.buffer).getInt16(this.byteOffset + offset);
}
...
function readFloatLE(offset = 0) {
  ...
  return gdv(this.buffer).getFloat32(this.byteOffset + offset, true);
}
...
function readFloatBE(offset = 0) {
  ...
  return gdv(this.buffer).getFloat32(this.byteOffset + offset);
}
...
function readDoubleLE(offset = 0) {
  ...
  return gdv(this.buffer).getFloat64(this.byteOffset + offset, true);
}
...
function readDoubleBE(offset = 0) {
  ...
  return gdv(this.buffer).getFloat64(this.byteOffset + offset);
}
...
function writeBigU_Int128LE(buf, value, offset, min, max) {
  ...
  dv.setBigUint64(buf.byteOffset + offset, value, true);
  dv.setBigUint64(buf.byteOffset + offset + 8, newVal, true);
  return offset + 16;
}
...
function writeBigU_Int64LE(buf, value, offset, min, max) {
  ...
  gdv(buf.buffer).setBigUint64(buf.byteOffset + offset, value, true);
  return offset + 8;
}
...
function writeU_Int48LE(buf, value, offset, min, max) {
  ...
  dv.setUint32(buf.byteOffset + offset, value, true);
  dv.setUint16(buf.byteOffset + offset + 4, newVal, true);
  return offset + 6;
}
...
function writeU_Int40LE(buf, value, offset, min, max) {
  ...
  dv.setUint32(this.byteOffset + offset, value, true);
  dv.setUint8(this.byteOffset + offset + 4, newVal);
  return offset + 5;
}
...
function writeU_Int24LE(buf, value, offset, min, max) {
  ...
  dv.setUint16(buf.byteOffset + offset, value, true);
  dv.setUint8(buf.byteOffset + offset, value >>> 16, true);
  return offset + 3;
}
...
function writeU_Int16LE(buf, value, offset, min, max) {
  ...
  gdv(buf.buffer).setUint16(buf.byteOffset + offset, value, true);
  return offset + 2;
}
...
function writeBigU_Int128BE(buf, value, offset, min, max) {
  ...
  dv.setBigUint64(buf.byteOffset + offset, newVal);
  dv.setBigUint64(buf.byteOffset + offset + 8, value);
  return offset + 16;
}
...
function writeBigU_Int64BE(buf, value, offset, min, max) {
  ...
  gdv(buf.buffer).setBigUint64(buf.byteOffset + offset, value);
  return offset + 8;
}
...
function writeU_Int48BE(buf, value, offset, min, max) {
  ...
  dv.setUint16(buf.byteOffset + offset, newVal);
  dv.setUint32(buf.byteOffset + offset + 2, value);
  return offset + 6;
}
...
function writeU_Int40BE(buf, value, offset, min, max) {
  ...
  gdv(buf.buffer).setUint32(buf.byteOffset + offset + 1, value);
  return offset + 5;
}
...
function writeU_Int32BE(buf, value, offset, min, max) {
  ...
  gdv(buf.buffer).setUint32(buf.byteOffset + offset, value);
  return offset + 4;
}
...
function writeU_Int24BE(buf, value, offset, min, max) {
  ...
  dv.setUint16(buf.byteOffset + offset + 1, value);
  dv.setUint8(buf.byteOffset + offset, value >>> 16);
  return offset + 3;
}
...
function writeU_Int16BE(buf, value, offset, min, max) {
  ...
  gdv(buf.buffer).setUint16(buf.byteOffset + offset, value);
  return offset + 2;
}
...
function writeDoubleLE(val, offset = 0) {
  ...
  gdv(this.buffer).setFloat64(this.byteOffset + offset, val, true);
  return offset + 8;
}
...
function writeDoubleBE(val, offset = 0) {
  ...
  gdv(this.buffer).setFloat64(this.byteOffset + offset, val);
  return offset + 8;
}
...
function writeFloatLE(val, offset = 0) {
  ...
  gdv(this.buffer).setFloat32(this.byteOffset + offset, val, true);
  return offset + 4;
}
...
function writeFloatBE(val, offset = 0) {
  ...
  gdv(this.buffer).setFloat32(this.byteOffset + offset, val);
  return offset + 4;
}
