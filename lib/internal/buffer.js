...
// Setup for internal dataview object
...
// Microoptimisations for benchmarking
const _2_32 = 2 ** 32;
const _2__32 = 2 ** -32;
const _2_15 = 2 ** 15;
const _2_7 = 2 ** 7;
...
function readInt48LE(buf, offset = 0) {
  ...
  return (val | (val & _2_15) * 0x1fffe) * _2_32 +
...
function readInt40LE(buf, offset = 0) {
  ...
  return (last | (last & _2_7) * 0x1fffffe) * _2_32 +
    buf[kIBDV].getUint32(buf.byteOffset + offset, true);
}
...
function readInt24LE(buf, offset = 0) {
  ...
  const lower = buf[kIBDV].getUint16(buf.byteOffset + offset, true);
  const upper = buf[kIBDV].getInt8(buf.byteOffset + offset + 2);
...
function readInt40BE(buf, offset = 0) {
  ...
  return (first | (first & _2_7) * 0x1fffffe) * _2_32 +
...
function readInt24BE(buf, offset = 0) {
  ...
  const upper = buf[kIBDV].getInt8(buf.byteOffset + offset);
  const lower = buf[kIBDV].getUint16(buf.byteOffset + offset + 1);
...
// Read floats function readFloatBE(offset = 0) { checkBounds(this, offset, 4);
...
function writeU_Int48LE(buf, value, offset, min, max) {
  ...
  buf[kIBDV].setUint16(buf.byteOffset + offset + 4,
                       floor(value * _2__32), true);
  return offset + 6;
}
...
function writeU_Int40LE(buf, value, offset, min, max) {
  ...
  buf[kIBDV].setUint32(buf.byteOffset + offset, value, true);
  buf[kIBDV].setUint8(buf.byteOffset + offset + 4, floor(value * _2__32));
  return offset + 5;
}
...
function writeU_Int48BE(buf, value, offset, min, max) {
  ...
  buf[kIBDV].setUint16(buf.byteOffset + offset, floor(value * _2__32));
...
function writeU_Int40BE(buf, value, offset, min, max) {
  ...
  buf[kIBDV].setUint8(buf.byteOffset + offset, floor(value * _2__32));
