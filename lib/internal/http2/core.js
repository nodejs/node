...
function onSessionHeaders(handle, id, cat, flags, headers, sensitiveHeaders) {
  ...
  if (stream === undefined) {
    ...
    if (type === NGHTTP2_SESSION_SERVER) {
      stream = new classDefinitionsPrivate.ServerHttp2Stream(session, handle, id, {}, obj);
      if (endOfStream) {
        stream.push(null);
      }
      ...
      stream = new classDefinitionsPrivate.ClientHttp2Stream(session, handle, id, {});
      if (endOfStream) {
        stream.push(null);
      }
      stream.end();
...
class ClientHttp2Session extends Http2Session {
  ...
  request(headers, options) {
    ...
    const stream = new classDefinitionsPrivate.ClientHttp2Stream(this, undefined, undefined, {});
