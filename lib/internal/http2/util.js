...
function updateOptionsBuffer(options) {
  const optionMap = {
    maxDeflateDynamicTableSize: {
      flag: 1 << IDX_OPTIONS_MAX_DEFLATE_DYNAMIC_TABLE_SIZE,
      index: IDX_OPTIONS_MAX_DEFLATE_DYNAMIC_TABLE_SIZE,
    },
    maxReservedRemoteStreams: {
      flag: 1 << IDX_OPTIONS_MAX_RESERVED_REMOTE_STREAMS,
      index: IDX_OPTIONS_MAX_RESERVED_REMOTE_STREAMS,
    },
    maxSendHeaderBlockLength: {
      flag: 1 << IDX_OPTIONS_MAX_SEND_HEADER_BLOCK_LENGTH,
      index: IDX_OPTIONS_MAX_SEND_HEADER_BLOCK_LENGTH,
    },
    peerMaxConcurrentStreams: {
      flag: 1 << IDX_OPTIONS_PEER_MAX_CONCURRENT_STREAMS,
      index: IDX_OPTIONS_PEER_MAX_CONCURRENT_STREAMS,
    },
    paddingStrategy: {
      flag: 1 << IDX_OPTIONS_PADDING_STRATEGY,
      index: IDX_OPTIONS_PADDING_STRATEGY,
    },
    maxHeaderListPairs: {
      flag: 1 << IDX_OPTIONS_MAX_HEADER_LIST_PAIRS,
      index: IDX_OPTIONS_MAX_HEADER_LIST_PAIRS,
    },
    maxOutstandingPings: {
      flag: 1 << IDX_OPTIONS_MAX_OUTSTANDING_PINGS,
      index: IDX_OPTIONS_MAX_OUTSTANDING_PINGS,
    },
    maxOutstandingSettings: {
      flag: 1 << IDX_OPTIONS_MAX_OUTSTANDING_SETTINGS,
      index: IDX_OPTIONS_MAX_OUTSTANDING_SETTINGS,
      min: 1,
    },
    maxSessionMemory: {
      flag: 1 << IDX_OPTIONS_MAX_SESSION_MEMORY,
      index: IDX_OPTIONS_MAX_SESSION_MEMORY,
      min: 1,
    },
    maxSettings: {
      flag: 1 << IDX_OPTIONS_MAX_SETTINGS,
      index: IDX_OPTIONS_MAX_SETTINGS,
      min: 1,
    },
  };
  ...
  for (const optionKey in optionMap) {
    ...
    if (typeof value === 'number') {
      flags |= option.flag;
      optionsBuffer[option.index] = option.min ? Math.max(1, value) : value;
    }
  }
