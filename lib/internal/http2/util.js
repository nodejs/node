...
function updateOptionsBuffer(options) {
  ...
  if (typeof options.slowHeadersTimeout === 'number') {
    flags |= (1 << IDX_OPTIONS_SLOW_HEADERS_TIMEOUT);
    optionsBuffer[IDX_OPTIONS_SLOW_HEADERS_TIMEOUT] =
      options.slowHeadersTimeout | 0;
  }
