...
function deprecate(fn, msg, code) {
  ...
  if (fn.prototype) {
    ...
    // that calling the unwrapped constructor gives an instance of the wrapped
    // constructor.
...
// The build-in Array.prototype.join() is slower in v8 6.0
...
// between 1.5-10x faster than the two-arg version of
