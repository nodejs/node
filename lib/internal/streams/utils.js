...
const kDefaultWritev = Symbol('kDefaultWritev');
const kDestroyMessageBuffer = Symbol('kDestroyMessageBuffer');
const kInternalWritev = Symbol('kInternalWritev');
const kPendingMessageBytes = Symbol('kPendingMessageBytes');
const kRawWritev = Symbol('kRawWritev');
