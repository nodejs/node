...
function destroyer(stream, err) {
  ...
  // TODO: Add opts timeout options for error and close events
  // in order to ensure these events are emitted for "bad"
  // streams and avoid deadlocks in streams logic.
