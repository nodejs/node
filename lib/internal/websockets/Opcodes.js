'use strict'
const WSErrorCodes = require('internal/websockets/WSErrorCodes');

/**
 * utils
 */

// Legacy from cpp dep TODO(eljefedelrodeodeljefe): cleanup
const Validation = {
...
opcodes['close'] = {
  ...
  finish: function(mask, data) {
    ...
    this.messageHandlers.push(function() {
      ...
      if (!WSErrorCodes.isValidErrorCode(code)) {
