...
cluster.workers = { __proto__: null };
cluster.settings = { __proto__: null };
...
function createWorkerProcess(id, env) {
  const workerEnv = { __proto__: null, ...process.env, ...env, NODE_UNIQUE_ID: `${id}` };
...
function exitedAfterDisconnect(worker, message) {
  ...
  send(worker, { __proto__: null, ack: message.seq });
}
...
Worker.prototype.disconnect = function() {
  ...
  send(this, { __proto__: null, act: 'disconnect' });
