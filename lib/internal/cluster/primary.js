...
cluster.setupPrimary = function (options) {
  ...
  if (
    ArrayPrototypeSome(settings.execArgv, (s) =>
      StringPrototypeStartsWith(s, '--prof')
    ) &&
    !ArrayPrototypeSome(settings.execArgv, (s) =>
      StringPrototypeStartsWith(s, '--logfile=')
    )
  ) {
...
function createWorkerProcess(id, env) {
  ...
  if (
    ArrayPrototypeSome(execArgv, (arg) =>
      RegExpPrototypeTest(debugArgRegex, arg)
    ) ||
