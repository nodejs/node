...
cluster.SCHED_STICKY = SCHED_STICKY;// Master handles sticky sessions
...
function queryServer(worker, message) {
  ...
  if (handle === undefined) {
    ...
    if (schedulingPolicy === SCHED_STICKY) {
      constructor = StickyHandle;
    }
