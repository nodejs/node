...
const {
  ...
  IDX_STATS_ENDPOINT_SERVER_REJECTED_COUNT,
  IDX_STATS_ENDPOINT_SERVER_REFUSED_COUNT,
...
assert(IDX_STATS_ENDPOINT_SERVER_REJECTED_COUNT !== undefined);
assert(IDX_STATS_ENDPOINT_SERVER_REFUSED_COUNT !== undefined);
...
class DTLSEndpointStats {
  ...
  /** @type {bigint} */
  get serverRejectedCount() {
    return this.#handle[IDX_STATS_ENDPOINT_SERVER_REJECTED_COUNT];
  }

  /** @type {bigint} */
  get serverRefusedCount() {
    return this.#handle[IDX_STATS_ENDPOINT_SERVER_REFUSED_COUNT];
  }
  ...
  toJSON() {
    return {
      ...
      serverRejectedCount: `${this.serverRejectedCount}`,
      serverRefusedCount: `${this.serverRefusedCount}`,
    };
  }
