...
function createWritableStdioStream(fd) {
  ...
  switch (guessHandleType(fd)) {
    ...
    case 'FILE': {
      ...
      stream = new SyncWriteStream(fd, { __proto__: null, autoClose: false });
      stream._type = 'fs';
      break;
    }
...
function getStdin() {
  ...
  switch (guessHandleType(fd)) {
    ...
    case 'FILE': {
      const fs = require('fs');
      stdin = new fs.ReadStream(null, { __proto__: null, fd: fd, autoClose: false });
      break;
    }
    ...
    default: {
      ...
      stdin = new Readable({ __proto__: null, read() {} });
      stdin.push(null);
    }
  }
