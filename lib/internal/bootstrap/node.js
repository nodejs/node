...
// Set up methods on the process object for all threads
{
  ...
  process.registerFreeOnExit = wrapped.registerFreeOnExit;
  process.registerFreeOnBeforeExit = wrapped.registerFreeOnBeforeExit;
  process.unregisterFree = wrapped.unregisterFree;
