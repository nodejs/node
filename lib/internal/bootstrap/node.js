...
(function bootstrapNodeJSCore(process,
  ...
  function setupRepl() {
    // used by https://github.com/nodejs/repl
    if (process.env.NODE_EXTERNAL_REPL_MODULE) {
      const CJSModule = NativeModule
        .require('internal/modules/cjs/loader');
      CJSModule._load(process.env.NODE_EXTERNAL_REPL_MODULE, undefined, true);
    } else {
