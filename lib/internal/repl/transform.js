...
// TODO(@avivkeller): Amaro exposes `transformModuleSyntax()` for this purpose,
// but currently it rewrites references to imported bindings instead of
// declaring them, so bindings are not visible to later REPL input.
const {
  parse: acornParse,
