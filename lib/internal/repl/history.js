...
class ReplHistory {
  constructor(context, options) {
    ...
    this[kSize] = options.historySize ?? context.historySize ?? kHistorySize;
  ...
  static [kGetHistoryPath](options) {
    let historyPath = options.historyFile;
  ...
  static [kNormalizeLineEndings](line, from, to, reverse = true) {
  ...
  [kValidateOptions](options) {
    ...
    if (typeof options.historySize !== 'undefined') {
      validateNumber(options.historySize, 'historySize', 0);
    }
  }
