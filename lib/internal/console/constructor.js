...
const consoleMethods = {
  ...
  warn(...args) {
    const color = shouldColorise(args) && lazyUtilColors().yellow;
    this[kWriteToConsole](kUseStderr, this[kFormatForStderr](args), color);
  },

  error(...args) {
    const color = shouldColorise(args) && lazyUtilColors().red;
    this[kWriteToConsole](kUseStderr, this[kFormatForStderr](args), color);
  },
...
const shouldColorise = (args) => {
  return lazyUtilColors().hasColors && ArrayPrototypeEvery(args, (arg) => typeof arg === 'string');
};
