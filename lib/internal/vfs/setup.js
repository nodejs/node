    ...
    if (vfsStat(vfs, pjsonPath) === 0) {
      ...
      if (content !== null) {
        ...
        try {
          ...
          // Match native GetPackageJSON: syntactically malformed
          // package.json aborts the walk with ERR_INVALID_PACKAGE_CONFIG
          // instead of silently continuing past a corrupt file.
          throw new ERR_INVALID_PACKAGE_CONFIG(
            pjsonPath, undefined, err.message);
        }
