...
// Layer 0 is reserved for the file system a --vfs-load mounts, so that source
// lands at the same reserved mount point in every thread whatever else a
// thread mounts, and a path into it stays valid in a worker. Everything else
// is numbered from 1, in the order it is mounted.
