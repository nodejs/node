...
function getArgDescription(type) {
  if (
    typeLookup[type] === 'kNoOp' ||
    typeLookup[type] === 'kV8Option' ||
    typeLookup[type] === 'kBoolean' ||
    typeLookup[type] === undefined
  ) {
    return;
  }
  if (typeLookup[type] === 'kHostPort') {
    return '[host:]port';
  }
  require('assert')(
    typeLookup[type] === 'kInteger' ||
    typeLookup[type] === 'kUInteger' ||
    typeLookup[type] === 'kString' ||
    typeLookup[type] === 'kStringList',
