...
port.on('message', (message) => {
  if (message.type === LOAD_SCRIPT) {
    ...
    if (stdoutIsTTY || stderrIsTTY) {
      ...
      const setupTTYProperties = (stream) => {
        ObjectDefineProperty(stream, 'isTTY', {
          __proto__: null,
          configurable: true,
          enumerable: true,
          value: true,
        ...
        ObjectDefineProperty(stream, 'getColorDepth', {
          __proto__: null,
          configurable: true,
          enumerable: true,
          value: getColorDepth,
        ...
        ObjectDefineProperty(stream, 'hasColors', {
          __proto__: null,
          configurable: true,
          enumerable: true,
          value: hasColors,
      ...
      if (stdoutIsTTY) setupTTYProperties(process.stdout);
      if (stderrIsTTY) setupTTYProperties(process.stderr);
    }
