          ...
          switch (nextChar) {
            case 115: // 's'
              ...
              if (typeof tempArg === 'number') {
                ...
                function loopFind(prototype) {
                  if (!Object.getPrototypeOf(prototype) ||
                      builtInObjects.has(prototype.constructor.name)
                  ) {
                    return false;
                    ...
                    return loopFind(Object.getPrototypeOf(prototype));
                  }
                }
                if (typeof tempArg !== 'object' ||
                    ...
                    (typeof tempArg.toString === 'function' &&
                     ...
                     (hasOwnProperty(tempArg, 'toString') ||
                      ...
                      (!builtInObjects.has(tempArg.constructor.name) &&
                       loopFind(tempArg.constructor.prototype))))) {
