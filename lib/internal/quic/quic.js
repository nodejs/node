...
class QuicSession {
  ...
  destroy(error) {
    ...
    const streamsArray = [...this.#streams];
...
function processTlsOptions(tls, forServer) {
  ...
  if (crl !== undefined) {
    ...
    for (let i = 0; i < crlInputs.length; i++) {
      const crlCert = crlInputs[i];
