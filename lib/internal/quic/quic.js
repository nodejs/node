...
class QuicSession {
  ...
  openBidirectionalStream() {
    ...
    const stream = new QuicStream(kPrivateConstructor, handle, this, 0 /* Bidirectional */);
  ...
  openUnidirectionalStream() {
    ...
    const stream = new QuicStream(kPrivateConstructor, handle, this, 1 /* Unidirectional */);
    this.#streams.add(stream);
