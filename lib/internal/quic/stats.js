...
class EndpointStats {
  ...
  constructor(privateSymbol, buffer) {
    ...
    // create new instances of EndpointStats to internal code.
  ...
  /**
   * True if this EndpointStats object is still connected to the underlying
...
class SessionStats {
  ...
  constructor(privateSynbol, buffer) {
    // We use the kPrivateConstructor symbol to restrict the ability to
    // create new instances of SessionStats to internal code.
  ...
  /**
   * True if this SessionStats object is still connected to the underlying
