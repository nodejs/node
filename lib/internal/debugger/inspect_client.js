...
function decodeFrameHybi17(data) {
  ...
  const notComplete = { __proto__: null, closed: false, payload: null, rest: data };
  let payloadOffset = 2;
...
class Client extends EventEmitter {
  ...
  callMethod(method, params) {
    return new Promise((resolve, reject) => {
      ...
      const data = { __proto__: null, id: ++this._lastId, method, params };
