...
// Specialized wrapper for strict-numeric signatures (no pointers). Validates
// each arg the same way the full wrapper does — V8's fast-call coercion
// silently truncates non-integers and out-of-range values when the call site
// is fully optimized (e.g. CheckedNumberAsWord32 wraps mod 2^32; for i64/u64,
// CheckedBigIntTruncatingWord64 wraps to low 64 bits). Skipping the JS check
// would make the same FFI binding throw cold and silently corrupt hot — so
// the per-arg validation stays. The win over the full wrapper is the dropped
// per-arg `if (isPointer)` branch and the smaller closure (no slowInvoke,
// no isPointer table).
  ...
  switch (nargs) {
    ...
    case 1: {
      ...
      return function(a0) {
        ...
        return rawFn(validateAndCoerce(i0, a0, 0));
      };
    }
    case 2: {
      ...
      return function(a0, a1) {
        ...
        const v0 = validateAndCoerce(i0, a0, 0);
        const v1 = validateAndCoerce(i1, a1, 1);
        return rawFn(v0, v1);
      };
    }
    case 3: {
      ...
      return function(a0, a1, a2) {
        ...
        const v0 = validateAndCoerce(i0, a0, 0);
        const v1 = validateAndCoerce(i1, a1, 1);
        const v2 = validateAndCoerce(i2, a2, 2);
    ...
    case 4: {
      ...
      return function(a0, a1, a2, a3) {
        ...
        const v1 = validateAndCoerce(i1, a1, 1);
        const v2 = validateAndCoerce(i2, a2, 2);
        const v3 = validateAndCoerce(i3, a3, 3);
    ...
    case 5: {
      ...
      return function(a0, a1, a2, a3, a4) {
        ...
        const v2 = validateAndCoerce(i2, a2, 2);
        const v3 = validateAndCoerce(i3, a3, 3);
        const v4 = validateAndCoerce(i4, a4, 4);
    ...
    case 6: {
      ...
      return function(a0, a1, a2, a3, a4, a5) {
        ...
        const v3 = validateAndCoerce(i3, a3, 3);
        const v4 = validateAndCoerce(i4, a4, 4);
        const v5 = validateAndCoerce(i5, a5, 5);
