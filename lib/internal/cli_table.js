...
// Unicode characters outside of comments in Node.js built-in modules. If they
// are ever removed or rewritten with \u escapes, then a test will need to be
// (re-)added to Node.js core to verify that Unicode characters work in
// built-ins. Otherwise, consumers using Unicode in _third_party_main.js will
// run into problems. Refs: https://github.com/nodejs/node/issues/10673
const tableChars = {
