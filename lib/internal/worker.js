...
class Worker extends EventEmitter {
  constructor(filename, options = kEmptyObject) {
    ...
    this[kParentSideStdio] = { __proto__: null, stdin, stdout, stderr };
  ...
  get resourceLimits() {
    if (this[kHandle] === null) return { __proto__: null };
...
function eventLoopUtilization(util1, util2) {
  ...
  if (!this[kIsOnline] || !this[kHandle]) {
    return { __proto__: null, idle: 0, active: 0, utilization: 0 };
  }
...
module.exports = {
  ...
  SHARE_ENV,
  resourceLimits:
    !isMainThread ? makeResourceLimits(resourceLimitsRaw) : { __proto__: null },
  setEnvironmentData,
  getEnvironmentData,
