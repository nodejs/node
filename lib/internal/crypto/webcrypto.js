...
async function digest(algorithm, data) {
  ...
  webidl.requiredArguments(arguments.length, 2, { __proto__: null, prefix });
...
async function generateKey(
  ...
  webidl.requiredArguments(arguments.length, 3, { __proto__: null, prefix });
  algorithm = webidl.converters.AlgorithmIdentifier(algorithm, {
    __proto__: null,
    prefix,
    context: '1st argument',
...
async function deriveKey(
  ...
  webidl.requiredArguments(arguments.length, 5, { __proto__: null, prefix });
  algorithm = webidl.converters.AlgorithmIdentifier(algorithm, {
    __proto__: null,
    prefix,
    context: '1st argument',
...
async function importGenericSecretKey(
  ...
  switch (format) {
    case 'raw': {
      ...
      return new InternalCryptoKey(keyObject, { __proto__: null, name }, keyUsages, false);
    }
  }
...
async function importKey(
  ...
  webidl.requiredArguments(arguments.length, 4, { __proto__: null, prefix });
  format = webidl.converters.KeyFormat(format, {
    __proto__: null,
    prefix,
    context: '1st argument',
...
async function unwrapKey(
  ...
  webidl.requiredArguments(arguments.length, 7, { __proto__: null, prefix });
  format = webidl.converters.KeyFormat(format, {
    __proto__: null,
    prefix,
    context: '1st argument',
  ...
  if (format === 'jwk') {
    ...
    const options = process.versions.icu !== undefined ?
      { __proto__: null, fatal: true } : undefined;
...
function getRandomValues(array) {
  ...
  webidl.requiredArguments(arguments.length, 1, { __proto__: null, prefix });
