...
async function ecGenerateKey(algorithm, extractable, keyUsages) {
  ...
  const keypair = await generateKeyPair('ec', { __proto__: null, namedCurve }).catch((err) => {
    throw lazyDOMException(
  ...
  const keyAlgorithm = { __proto__: null, name, namedCurve };
