...
function makeException(message, opts = kEmptyObject) {
  ...
  return codedTypeError(
    ...
    { __proto__: null, code: opts.code || 'ERR_INVALID_ARG_TYPE' },
  );
}
...
const dictRsaKeyGenParams = [
  ...new SafeArrayIterator(dictAlgorithm),
  {
    ...
    key: 'modulusLength',
    converter: (V, opts) =>
      converters['unsigned long'](V, { __proto__: null, ...opts, enforceRange: true }),
    required: true,
  },
  {
    __proto__: null,
...
converters.AesKeyGenParams = createDictionaryConverter(
  'AesKeyGenParams', [
    ...new SafeArrayIterator(dictAlgorithm),
    {
      ...
      key: 'length',
      converter: (V, opts) =>
        converters['unsigned short'](V, { __proto__: null, ...opts, enforceRange: true }),
      required: true,
    },
  ]);
...
const simpleDomStringKey = (key) => ({ __proto__: null, key, converter: converters.DOMString });
...
converters.AesGcmParams = createDictionaryConverter(
  'AesGcmParams', [
    ...
    },
    {
      ...
      key: 'tagLength',
      converter: (V, opts) =>
        converters.octet(V, { __proto__: null, ...opts, enforceRange: true }),
    },
    {
      __proto__: null,
      key: 'additionalData',
