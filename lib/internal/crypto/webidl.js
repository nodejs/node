...
function toNumber(value) {
  switch (typeof value) {
    case 'number':
      return value;
    case 'bigint':
      throw makeException('Cannot convert a BigInt value to a number');
    case 'symbol':
      throw makeException('Cannot convert a Symbol value to a number');
    default:
      return Number(value);
  }
}
...
converters.KeyType = createEnumConverter('KeyType', [
  'public',
  'private',
  'secret',
]);
