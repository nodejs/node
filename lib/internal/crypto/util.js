...
const simpleAlgorithmDictionaries = {
  __proto__: null,
  AesGcmParams: { __proto__: null, iv: 'BufferSource', additionalData: 'BufferSource' },
  RsaHashedKeyGenParams: { __proto__: null, hash: 'HashAlgorithmIdentifier' },
  EcKeyGenParams: { __proto__: null },
  HmacKeyGenParams: { __proto__: null, hash: 'HashAlgorithmIdentifier' },
  RsaPssParams: { __proto__: null },
  EcdsaParams: { __proto__: null, hash: 'HashAlgorithmIdentifier' },
  HmacImportParams: { __proto__: null, hash: 'HashAlgorithmIdentifier' },
  HkdfParams: {
    __proto__: null,
  ...
  Ed448Params: { __proto__: null, context: 'BufferSource' },
  Pbkdf2Params: { __proto__: null, hash: 'HashAlgorithmIdentifier', salt: 'BufferSource' },
  RsaOaepParams: { __proto__: null, label: 'BufferSource' },
  RsaHashedImportParams: { __proto__: null, hash: 'HashAlgorithmIdentifier' },
  EcKeyImportParams: { __proto__: null },
};
...
function normalizeAlgorithm(algorithm, op) {
  if (typeof algorithm === 'string')
    return normalizeAlgorithm({ __proto__: null, name: algorithm }, op);
  ...
  if (desiredType === null)
    return { __proto__: null, name: algName };
...
function secureHeapUsed() {
  ...
  if (val === undefined)
    return { __proto__: null, total: 0, used: 0, utilization: 0, min: 0 };
  ...
  return { __proto__: null, total, used, utilization, min };
}
