...
const kBase64UrlOptions = { __proto__: null, alphabet: 'base64url' };
const kBase64UrlNoPaddingOptions = {
  __proto__: null,
  alphabet: 'base64url',
  omitPadding: true,
};
...
/**
 * Decodes a JWK base64url member and maps invalid input to DataError.
 * @param {string} input
 * @returns {Uint8Array}
 */
function decodeJwkBase64Url(input) {
  try {
    return Uint8ArrayFromBase64(input, kBase64UrlOptions);
  } catch (err) {
