...
const { FunctionPrototypeCall, Promise, Uint8Array } = primordials;
...
const {
  codes: { ERR_INVALID_ARG_TYPE, ERR_OUT_OF_RANGE, ERR_MISSING_OPTION },
  hideStackFrames,
...
function prepareKey(key) {
  ...
  if (isAnyArrayBuffer(key)) return createSecretKey(new Uint8Array(key));
