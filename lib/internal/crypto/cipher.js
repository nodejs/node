...
function createCipher(cipher, password, options, decipher) {
  ...
  FunctionPrototypeCall(createCipherBase, this, cipher,
                        password, options, decipher);
}
...
function Cipher(cipher, password, options) {
  ...
  FunctionPrototypeCall(createCipher, this, cipher, password, options, true);
}
...
function Cipheriv(cipher, key, iv, options) {
  ...
  FunctionPrototypeCall(createCipherWithIV, this, cipher,
                        key, options, true, iv);
}
...
function Decipher(cipher, password, options) {
  ...
  FunctionPrototypeCall(createCipher, this, cipher, password, options, false);
}
