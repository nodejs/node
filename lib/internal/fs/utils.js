...
function getOptions(options, defaultOptions) {
  ...
  if (defaultOptions.bPerRead) {
    if (options.bPerRead === undefined) {
      options.bPerRead = defaultOptions.bPerRead;
    } else if (options.bPerRead !== -1) {
      validateUint32(options.bPerRead, 'options.bPerRead');
    }
  }
