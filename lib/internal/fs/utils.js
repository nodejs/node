...
function validateIfFileFromStats(stats) {
  return (stats[1] & BigInt(S_IFMT)) === BigInt(S_IFREG);
}

function validateIfDirectoryFromStats(stats) {
  return (stats[1] & BigInt(S_IFMT)) === BigInt(S_IFDIR);
}
