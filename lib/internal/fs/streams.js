...
const kHandleCloseListener = Symbol('kHandleCloseListener');
const kHandleCloseListenerCleanup = Symbol('kHandleCloseListenerCleanup');
...
function cleanupHandleCloseListener() {
  if (this[kHandleCloseListener] === undefined) {
    return;
  }
  ...
  this[kHandleCloseListener] = undefined;
  this[kHandleCloseListenerCleanup] = undefined;
}
