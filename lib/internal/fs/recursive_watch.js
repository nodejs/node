...
class FSWatcher extends EventEmitter {
  ...
  constructor(options = kEmptyObject) {
    ...
    // TODO(anonrig): Add non-recursive support to linux-watcher for IBMi support.
    if (recursive != null) {
  ...
  [SymbolAsyncIterator]() {
    ...
    const stream = new Readable({
      destroy(error, callback) {
        self.close();
        // TODO(anonrig): Find the reason of 'break' inside for await Readable stream throwing AbortError.
    ...
    return stream[SymbolAsyncIterator]();
  }
}
