...
class Module {
  ...
  [customInspectSymbol](depth, options) {
    ...
    const o = { __proto__: { __proto__: null, constructor } };
    ...
    return inspect(o, { __proto__: null, ...options, customInspect: false });
  }
}
  ...
  constructor(sourceText, options = kEmptyObject) {
    ...
    this[kLink] = async (linker) => {
      ...
      const promises = this[kWrap].link(async (identifier, assert) => {
        const module = await linker(identifier, this, { __proto__: null, assert });
