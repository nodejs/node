...
function createHandle(fd) {
  ...
  throw new errors.TypeError('ERR_INVALID_FLAG', 'hints');
}
...
Socket.prototype.write = function(chunk, encoding, cb) {
  if (typeof chunk !== 'string' && !(chunk instanceof Buffer)) {
    throw new errors.TypeError('ERR_INVALID_ARG_TYPE', 'chunk',
      ['string', 'buffer']);
  }
...
function lookupAndConnect(self, options) {
  ...
  if (localAddress && !exports.isIP(localAddress))
    throw new errors.TypeError('ERR_INVALID_IP', 'localAddress', localAddress);

  if (localPort && typeof localPort !== 'number')
    throw new errors.RangeError('ERR_INVALID_PORT', 'localPort', localPort);

  if (typeof port !== 'undefined') {
    if (typeof port !== 'number' && typeof port !== 'string')
      throw new errors.TypeError('ERR_INVALID_ARG_TYPE', 'port',
        ['number', 'string']);
    if (!isLegalPort(port))
