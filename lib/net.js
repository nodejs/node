...
function createHandle(fd) {
  ...
  throw new errors.TypeError('INVALIDARGVALUE', 'fd', 'type');
}
...
function connect(self, address, port, addressType, localAddress, localPort) {
  ...
  if (localAddress || localPort) {
    ...
    if (addressType === 4) {
      ...
      self._destroy(new errors.TypeError('INVALIDARGVALUE',
                                         'addressType',
                                         addressType));
      return;
    }
...
function lookupAndConnect(self, options) {
  ...
  if (localAddress && !exports.isIP(localAddress)) {
    throw new errors.TypeError('INVALIDOPT',
                               'localAddress',
                               'valid IP address');
  }

  if (localPort && typeof localPort !== 'number')
    throw new errors.TypeError('INVALIDOPT', 'localPort', 'number');

  if (typeof port !== 'undefined') {
    if (typeof port !== 'number' && typeof port !== 'string')
      throw new errors.TypeError('INVALIDOPT', 'port', ['string', 'number']);
    if (!isLegalPort(port))
      throw new errors.RangeError('PORTRANGE');
  }
  port |= 0;
  ...
  if (options.lookup && typeof options.lookup !== 'function')
    throw new errors.TypeError('INVALIDOPT', 'lookup', 'function');
...
function Server(options, connectionListener) {
  ...
  if (typeof options === 'function') {
    ...
    throw new errors.TypeError('INVALIDARG', 'options', 'object');
  }
