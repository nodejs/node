...
const SenderHixie = require('internal/websockets/SenderHixie');
const ReceiverHixie = require('internal/websockets/ReceiverHixie');
...
// Gracefully closes the connection, after sending a desc. message to the server
...
module.exports.WSWSErrorCodes = WSWSErrorCodes
