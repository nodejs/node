{
  'variables': {
    ...
    'openssl_sources_solaris-x86-gcc': [
      ...
      './config/archs/solaris-x86-gcc/asm/crypto/params_idx.c',
      ...
      './config/archs/solaris-x86-gcc/asm/providers/common/der/der_sm2_gen.c',
      './config/archs/solaris-x86-gcc/asm/providers/common/der/der_digests_gen.c',
      './config/archs/solaris-x86-gcc/asm/providers/common/der/der_dsa_gen.c',
      './config/archs/solaris-x86-gcc/asm/providers/common/der/der_ec_gen.c',
      './config/archs/solaris-x86-gcc/asm/providers/common/der/der_ecx_gen.c',
      './config/archs/solaris-x86-gcc/asm/providers/common/der/der_ml_dsa_gen.c',
      './config/archs/solaris-x86-gcc/asm/providers/common/der/der_rsa_gen.c',
      './config/archs/solaris-x86-gcc/asm/providers/common/der/der_slh_dsa_gen.c',
      './config/archs/solaris-x86-gcc/asm/providers/common/der/der_wrap_gen.c',
