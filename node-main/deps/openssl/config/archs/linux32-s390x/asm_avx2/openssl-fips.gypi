{
  'variables': {
    ...
    'openssl_sources_linux32-s390x': [
      ...
      './config/archs/linux32-s390x/asm_avx2/crypto/params_idx.c',
      ...
      './config/archs/linux32-s390x/asm_avx2/providers/common/der/der_ml_dsa_gen.c',
      './config/archs/linux32-s390x/asm_avx2/providers/common/der/der_rsa_gen.c',
      './config/archs/linux32-s390x/asm_avx2/providers/common/der/der_slh_dsa_gen.c',
      './config/archs/linux32-s390x/asm_avx2/providers/common/der/der_wrap_gen.c',
      './config/archs/linux32-s390x/asm_avx2/providers/legacy.ld',
    ...
    'linker_script': '<(PRODUCT_DIR)/../../deps/openssl/config/archs/linux32-s390x/asm_avx2/providers/fips.ld'
  },
  'include_dirs': [
    '.',
    './include',
